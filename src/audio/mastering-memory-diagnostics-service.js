// FoxBear mastering memory diagnostics and adaptive governor service v1.6.106.
'use strict';

(function attachFoxBearMasteringMemoryDiagnosticsService(global) {
    const BUILD_INFO = global.FoxBearBuildInfo || {};
    const VERSION = BUILD_INFO.assetVersion || '1.6.106-kakao-adaptive-memory-governor';
    const MB = 1024 * 1024;
