// FoxBear mastering orchestrator service v1.7.4 - batch flow and risk-specific one-shot quality recovery planning
'use strict';
...
(function attachFoxBearMasteringOrchestratorService(global) {
    ...
    function createAdaptiveDecisionPlan(input = {}) {
        ...
        return Object.freeze({ version: '1.7.4-reference-aware-adaptive' , mode: 'single-render-candidate-selection', selectedId: selected.id, selectedLabel: selected.label, confidence, riskLoad: roundMetric(riskLoad), risks, referenceMatch, requestedSettings: baseSettings, effectiveSettings: selected.settings, candidates: Object.freeze(candidates), reason: `${selected.label} 선택 · ${reasons.slice(0, 3).join(' · ')}` });
    }
    ...
    function createMasteringBatchRunner(options = {}) {
        ...
        return Object.freeze({
            version: '1.7.4-performance-recovery-stage-hud',
            runBatch,
            cancelActiveBatch,
            pauseActiveBatch,
            resumeActiveBatch,
