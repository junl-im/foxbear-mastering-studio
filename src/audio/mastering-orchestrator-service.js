// FoxBear mastering orchestrator service v1.5.80 - batch flow and risk-specific one-shot quality recovery planning
'use strict';
...
(function attachFoxBearMasteringOrchestratorService(global) {
    ...
    function createMasteringBatchRunner(options = {}) {
        ...
        return Object.freeze({
            version: '1.5.80-bulk-pause-skip-reorder-summary',
            runBatch,
            cancelActiveBatch,
            pauseActiveBatch,
            resumeActiveBatch,
