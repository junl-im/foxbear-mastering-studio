// FoxBear QualityGate v2.2 service v1.6.101 - dynamics, spectral preservation, phase, pumping, and True Peak checks
'use strict';
...
(function attachFoxBearQualityGateService(global) {
    ...
    global.FoxBearQualityGateService = Object.freeze({
        version: '1.6.101-engine-quality-regression', legacyVersion: '1.5.0-engine-quality-gate',
        rules: DEFAULT_RULES,
        createReport
    });
})(window);
