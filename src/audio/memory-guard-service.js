// FoxBear memory guard service v1.6.111 - release-after-encode PCM retention policy and diagnostics
'use strict';

(function attachFoxBearMemoryGuardService(global) {
    const VERSION = 'v1.6.111-ui-mode-session-contract-hardening';
