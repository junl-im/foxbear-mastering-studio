// FoxBear memory guard service v1.6.73 - release-after-encode PCM retention policy and diagnostics
'use strict';

(function attachFoxBearMemoryGuardService(global) {
    const VERSION = 'v1.6.73-csp-memory-admission-runtime-config';
