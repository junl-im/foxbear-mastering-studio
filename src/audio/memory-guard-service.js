// FoxBear memory guard service v1.6.105 - release-after-encode PCM retention policy and diagnostics
'use strict';

(function attachFoxBearMemoryGuardService(global) {
    const VERSION = 'v1.6.105-header-dock-css-ownership-hardening';
