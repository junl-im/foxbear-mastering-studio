// FoxBear memory guard service v1.5.59 - release-after-encode PCM retention policy and diagnostics
'use strict';

(function attachFoxBearMemoryGuardService(global) {
    const VERSION = 'v1.5.59-kakao-session-handoff-memory-diagnostics';
