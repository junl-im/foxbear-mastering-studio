// FoxBear memory guard service v1.6.22 - release-after-encode PCM retention policy and diagnostics
'use strict';

(function attachFoxBearMemoryGuardService(global) {
    const VERSION = 'v1.6.22-incident-recovery-coalescing-time-decay';
