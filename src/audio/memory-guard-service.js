// FoxBear memory guard service v1.5.84 - release-after-encode PCM retention policy and diagnostics
'use strict';

(function attachFoxBearMemoryGuardService(global) {
    const VERSION = 'v1.5.84-trusted-types-browser-gate-recovery';
