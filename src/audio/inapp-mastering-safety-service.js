// FoxBear in-app mastering safety service v1.6.104 - Kakao adaptive memory governor and recovery guard.
'use strict';

(function attachFoxBearInAppMasteringSafetyService(global) {
    const VERSION = '1.6.104-kakao-adaptive-memory-governor';
    const MB = 1024 * 1024;
