// FoxBear in-app mastering safety service v1.6.103 - Kakao adaptive memory governor and recovery guard.
'use strict';

(function attachFoxBearInAppMasteringSafetyService(global) {
    const VERSION = '1.6.103-kakao-adaptive-memory-governor';
    const MB = 1024 * 1024;
