// FoxBear UI shell recovery v1.7.0 - replacement-aware resource retry settlement
(function attachFoxBearUiShellRecoveryService(global) {
  'use strict';

  const VERSION = global.FoxBearBuildInfo?.assetVersion || '1.7.0-adaptive-mastering-decision-phase1';
