// FoxBear export guard service v1.6.86 - ZIP filename collision preflight and STORE-only packaging
'use strict';

(function attachFoxBearExportGuardService(global) {
    const VERSION = 'v1.6.86-header-order-mobile-overflow-browser-gate-recovery';
