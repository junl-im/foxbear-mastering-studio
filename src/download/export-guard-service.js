// FoxBear export guard service v1.6.71 - ZIP filename collision preflight and STORE-only packaging
'use strict';

(function attachFoxBearExportGuardService(global) {
    const VERSION = 'v1.6.71-pwa-share-lease-handoff-deploy-policy-e2e';
