// FoxBear export guard service v1.6.103 - ZIP filename collision preflight and STORE-only packaging
'use strict';

(function attachFoxBearExportGuardService(global) {
    const VERSION = 'v1.6.103-ci-hygiene-mail-routing-hardening';
