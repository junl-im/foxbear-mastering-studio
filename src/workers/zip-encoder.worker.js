// FoxBear ZIP encoder worker v1.5.93 - low-copy cancellable STORE packaging off the main thread
'use strict';

importScripts('../../vendor/jszip/jszip.min.js?v=1.5.93-external-engine-transfer-admin-export-openai-readiness&lib=3.10.1');
