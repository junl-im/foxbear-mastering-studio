// FoxBear ZIP encoder worker v1.6.25 - low-copy cancellable STORE packaging off the main thread
'use strict';

importScripts('../../vendor/jszip/jszip.min.js?v=1.6.25-incident-recovery-timeout-abort-stress&lib=3.10.1');
