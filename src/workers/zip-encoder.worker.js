// FoxBear ZIP encoder worker v1.5.84 - low-copy cancellable STORE packaging off the main thread
'use strict';

importScripts('../../vendor/jszip/jszip.min.js?v=1.5.84-trusted-types-browser-gate-recovery&lib=3.10.1');
