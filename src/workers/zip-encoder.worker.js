// FoxBear ZIP encoder worker v1.6.111 - low-copy cancellable STORE packaging off the main thread
'use strict';

importScripts('../download/file-name-policy-service.js?v=1.6.111-ui-mode-session-contract-hardening');
importScripts('../../vendor/jszip/jszip.min.js?v=1.6.111-ui-mode-session-contract-hardening&lib=3.10.1');
