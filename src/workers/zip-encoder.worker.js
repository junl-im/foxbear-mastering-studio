// FoxBear ZIP encoder worker v1.6.37 - low-copy cancellable STORE packaging off the main thread
'use strict';

importScripts('../../vendor/jszip/jszip.min.js?v=1.6.37-ui-shell-cross-generation-recovery&lib=3.10.1');
