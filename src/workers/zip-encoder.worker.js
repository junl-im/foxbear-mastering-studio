// FoxBear ZIP encoder worker v1.6.83 - low-copy cancellable STORE packaging off the main thread
'use strict';

importScripts('../download/file-name-policy-service.js?v=1.6.83-browser-ui-mode-fixture-source-hygiene-recovery');
importScripts('../../vendor/jszip/jszip.min.js?v=1.6.83-browser-ui-mode-fixture-source-hygiene-recovery&lib=3.10.1');
