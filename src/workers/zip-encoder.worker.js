// FoxBear ZIP encoder worker v1.6.46 - low-copy cancellable STORE packaging off the main thread
'use strict';

importScripts('../../vendor/jszip/jszip.min.js?v=1.6.46-google-auth-same-origin-network-recovery&lib=3.10.1');
