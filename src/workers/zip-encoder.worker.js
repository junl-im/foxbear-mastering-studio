// FoxBear ZIP encoder worker v1.6.4 - low-copy cancellable STORE packaging off the main thread
'use strict';

importScripts('../../vendor/jszip/jszip.min.js?v=1.6.4-incident-callable-csp-recovery&lib=3.10.1');
