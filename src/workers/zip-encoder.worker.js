// FoxBear ZIP encoder worker v1.5.98 - low-copy cancellable STORE packaging off the main thread
'use strict';

importScripts('../../vendor/jszip/jszip.min.js?v=1.5.98-worker-retry-health-levels&lib=3.10.1');
