// FoxBear ZIP encoder worker v1.5.73 - low-copy cancellable STORE packaging off the main thread
'use strict';

importScripts('../../vendor/jszip/jszip.min.js?v=1.5.73-bulk-control-eta-result-filter-ui&lib=3.10.1');
