// FoxBear ZIP encoder worker v1.6.86 - low-copy cancellable STORE packaging off the main thread
'use strict';

importScripts('../download/file-name-policy-service.js?v=1.6.86-header-order-mobile-overflow-browser-gate-recovery');
importScripts('../../vendor/jszip/jszip.min.js?v=1.6.86-header-order-mobile-overflow-browser-gate-recovery&lib=3.10.1');
