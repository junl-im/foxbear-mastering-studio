// FoxBear ZIP encoder worker v1.5.90 - low-copy cancellable STORE packaging off the main thread
'use strict';

importScripts('../../vendor/jszip/jszip.min.js?v=1.5.90-browser-retry-integrity-metadata-aware-scope&lib=3.10.1');
