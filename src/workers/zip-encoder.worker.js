// FoxBear ZIP encoder worker v1.6.39 - low-copy cancellable STORE packaging off the main thread
'use strict';

importScripts('../../vendor/jszip/jszip.min.js?v=1.6.39-ui-shell-partial-script-probe-isolation&lib=3.10.1');
