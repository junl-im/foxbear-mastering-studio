// FoxBear ZIP encoder worker v1.6.74 - low-copy cancellable STORE packaging off the main thread
'use strict';

importScripts('../download/file-name-policy-service.js?v=1.6.74-incident-admission-spark-retention-download-memory');
importScripts('../../vendor/jszip/jszip.min.js?v=1.6.74-incident-admission-spark-retention-download-memory&lib=3.10.1');
