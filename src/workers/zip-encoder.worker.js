// FoxBear ZIP encoder worker v1.6.7 - low-copy cancellable STORE packaging off the main thread
'use strict';

importScripts('../../vendor/jszip/jszip.min.js?v=1.6.7-incident-readiness-history-sync-performance-hud&lib=3.10.1');
