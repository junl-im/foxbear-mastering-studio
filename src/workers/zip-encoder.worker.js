// FoxBear ZIP encoder worker v1.6.34 - low-copy cancellable STORE packaging off the main thread
'use strict';

importScripts('../../vendor/jszip/jszip.min.js?v=1.6.34-history-hard-stall-sw-activity-lifecycle&lib=3.10.1');
