// FoxBear ZIP encoder worker v1.5.54 - low-copy cancellable STORE packaging off the main thread
'use strict';

importScripts('../../vendor/jszip/jszip.min.js?v=1.5.54-quality-recovery-profiles-browser-qa&lib=3.10.1');
