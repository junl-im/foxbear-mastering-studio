// FoxBear ZIP encoder worker v1.6.10 - low-copy cancellable STORE packaging off the main thread
'use strict';

importScripts('../../vendor/jszip/jszip.min.js?v=1.6.10-incident-readiness-contract-csp-cache-hardening&lib=3.10.1');
