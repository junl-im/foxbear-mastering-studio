// FoxBear ZIP encoder worker v1.5.69 - low-copy cancellable STORE packaging off the main thread
'use strict';

importScripts('../../vendor/jszip/jszip.min.js?v=1.5.69-mail-receipt-confirmation-history-branded-template&lib=3.10.1');
