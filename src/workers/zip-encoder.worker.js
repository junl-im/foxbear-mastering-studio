// FoxBear ZIP encoder worker v1.6.78 - low-copy cancellable STORE packaging off the main thread
'use strict';

importScripts('../download/file-name-policy-service.js?v=1.6.78-release-generation-assist-url-playback-invalidation');
importScripts('../../vendor/jszip/jszip.min.js?v=1.6.78-release-generation-assist-url-playback-invalidation&lib=3.10.1');
