// FoxBear ZIP encoder worker v1.5.74 - low-copy cancellable STORE packaging off the main thread
'use strict';

importScripts('../../vendor/jszip/jszip.min.js?v=1.5.74-bulk-pause-skip-reorder-mobile-download&lib=3.10.1');
