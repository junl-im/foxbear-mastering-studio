// FoxBear ZIP encoder worker v1.6.12 - low-copy cancellable STORE packaging off the main thread
'use strict';

importScripts('../../vendor/jszip/jszip.min.js?v=1.6.12-mastering-tone-loudness-fastpath&lib=3.10.1');
