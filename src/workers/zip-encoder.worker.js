// FoxBear ZIP encoder worker v1.6.92 - low-copy cancellable STORE packaging off the main thread
'use strict';

importScripts('../download/file-name-policy-service.js?v=1.6.92-spectrum-panel-mount-lifecycle-recovery');
importScripts('../../vendor/jszip/jszip.min.js?v=1.6.92-spectrum-panel-mount-lifecycle-recovery&lib=3.10.1');
