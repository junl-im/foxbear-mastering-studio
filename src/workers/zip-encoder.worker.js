// FoxBear ZIP encoder worker v1.6.13 - low-copy cancellable STORE packaging off the main thread
'use strict';

importScripts('../../vendor/jszip/jszip.min.js?v=1.6.13-download-format-context-menu&lib=3.10.1');
