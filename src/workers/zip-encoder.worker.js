// FoxBear ZIP encoder worker v1.6.71 - low-copy cancellable STORE packaging off the main thread
'use strict';

importScripts('../download/file-name-policy-service.js?v=1.6.71-pwa-share-lease-handoff-deploy-policy-e2e');
importScripts('../../vendor/jszip/jszip.min.js?v=1.6.71-pwa-share-lease-handoff-deploy-policy-e2e&lib=3.10.1');
