// FoxBear ZIP encoder worker v1.5.67 - low-copy cancellable STORE packaging off the main thread
'use strict';

importScripts('../../vendor/jszip/jszip.min.js?v=1.5.67-incident-admin-audit-webhook-failover-index-health&lib=3.10.1');
