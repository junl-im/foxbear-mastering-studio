// FoxBear ZIP encoder worker v1.6.43 - low-copy cancellable STORE packaging off the main thread
'use strict';

importScripts('../../vendor/jszip/jszip.min.js?v=1.6.43-google-auth-trusted-types-csp-recovery&lib=3.10.1');
