// FoxBear ZIP encoder worker v1.6.9 - low-copy cancellable STORE packaging off the main thread
'use strict';

importScripts('../../vendor/jszip/jszip.min.js?v=1.6.9-incident-readiness-history-recovery-copy-events&lib=3.10.1');
