// FoxBear ZIP encoder worker v1.6.110 - low-copy cancellable STORE packaging off the main thread
'use strict';

importScripts('../download/file-name-policy-service.js?v=1.6.110-ui-mode-early-boot-recovery');
importScripts('../../vendor/jszip/jszip.min.js?v=1.6.110-ui-mode-early-boot-recovery&lib=3.10.1');
