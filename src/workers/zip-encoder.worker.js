// FoxBear ZIP encoder worker v1.5.92 - low-copy cancellable STORE packaging off the main thread
'use strict';

importScripts('../../vendor/jszip/jszip.min.js?v=1.5.92-python-bytecode-ci-hygiene-node24-cache&lib=3.10.1');
