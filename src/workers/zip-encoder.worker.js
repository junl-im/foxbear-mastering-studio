// FoxBear ZIP encoder worker v1.5.82 - low-copy cancellable STORE packaging off the main thread
'use strict';

importScripts('../../vendor/jszip/jszip.min.js?v=1.5.82-mastering-cancel-playback-resume-recovery&lib=3.10.1');
