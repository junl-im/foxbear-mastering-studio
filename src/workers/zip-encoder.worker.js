// FoxBear ZIP encoder worker v1.6.104 - low-copy cancellable STORE packaging off the main thread
'use strict';

importScripts('../download/file-name-policy-service.js?v=1.6.104-boot-emergency-visit-privacy-hardening');
importScripts('../../vendor/jszip/jszip.min.js?v=1.6.104-boot-emergency-visit-privacy-hardening&lib=3.10.1');
