// FoxBear AI Mastering Studio Pro v1.5.97 - progress ETA, stall recovery, and safe dialog lifecycle
'use strict';
...
(function attachFoxBearDownloadDialogView(global) {
    function showDownloadOptionsDialog(track, deps = {}) {
        ...
        // Legacy wording: 공유/저장 먼저. The visible v1.5.97 CTA is 기기에 저장/공유.
        ...
        // v1.5.97 mobile hierarchy: MP3/WAV family first, then quality options.
