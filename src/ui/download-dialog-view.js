// FoxBear AI Mastering Studio Pro v1.6.87 - download filename preview and controls
'use strict';
...
(function attachFoxBearDownloadDialogView(global) {
    ...
    function showDownloadOptionsDialog(track, deps = {}) {
        ...
        // Legacy wording: 공유/저장 먼저. The visible v1.6.87 CTA is 기기에 저장/공유.
        ...
        // v1.6.87 compact hierarchy: only MP3/WAV stay visible; quality is portalled above the scrollable sheet.
