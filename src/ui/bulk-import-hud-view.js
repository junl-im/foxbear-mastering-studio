...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.6.100-performance-recovery-stage-hud';
    // v1.6.100 compatibility QA anchor: const VIEW_VERSION = '1.6.100-sw-stereo-ci-cleanup-hardening'
    // compatibility anchor: const VIEW_VERSION = '1.6.100-bulk-control-eta-result-filter'
    ...
    // v1.6.100 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
