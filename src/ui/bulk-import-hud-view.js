...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.5.81-bulk-pause-skip-reorder-summary';
    // v1.5.81 compatibility QA anchor: const VIEW_VERSION = '1.5.81-master-preview-cancellation-native-result-isolation'
    // compatibility anchor: const VIEW_VERSION = '1.5.81-bulk-control-eta-result-filter'
    ...
    // v1.5.81 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
