...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.6.89-performance-recovery-stage-hud';
    // v1.6.89 compatibility QA anchor: const VIEW_VERSION = '1.6.89-mobile-header-flex-ownership-browser-gate-recovery'
    // compatibility anchor: const VIEW_VERSION = '1.6.89-bulk-control-eta-result-filter'
    ...
    // v1.6.89 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
