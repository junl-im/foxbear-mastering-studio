...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.6.102-performance-recovery-stage-hud';
    // v1.6.102 compatibility QA anchor: const VIEW_VERSION = '1.6.102-admin-lazyload-sw-hygiene-hardening'
    // compatibility anchor: const VIEW_VERSION = '1.6.102-bulk-control-eta-result-filter'
    ...
    // v1.6.102 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
