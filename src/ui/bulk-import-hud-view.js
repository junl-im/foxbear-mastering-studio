...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.6.34-performance-recovery-stage-hud';
    // v1.6.34 compatibility QA anchor: const VIEW_VERSION = '1.6.34-history-hard-stall-sw-activity-lifecycle'
    // compatibility anchor: const VIEW_VERSION = '1.6.34-bulk-control-eta-result-filter'
    ...
    // v1.6.34 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
