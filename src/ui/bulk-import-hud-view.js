...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.6.111-performance-recovery-stage-hud';
    // v1.6.111 compatibility QA anchor: const VIEW_VERSION = '1.6.111-ui-mode-session-contract-hardening'
    // compatibility anchor: const VIEW_VERSION = '1.6.111-bulk-control-eta-result-filter'
    ...
    // v1.6.111 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
