...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.7.0-performance-recovery-stage-hud';
    // v1.7.0 compatibility QA anchor: const VIEW_VERSION = '1.7.0-adaptive-mastering-decision-phase1'
    // compatibility anchor: const VIEW_VERSION = '1.7.0-bulk-control-eta-result-filter'
    ...
    // v1.7.0 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
