...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.6.95-performance-recovery-stage-hud';
    // v1.6.95 compatibility QA anchor: const VIEW_VERSION = '1.6.95-release-artifact-safety'
    // compatibility anchor: const VIEW_VERSION = '1.6.95-bulk-control-eta-result-filter'
    ...
    // v1.6.95 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
