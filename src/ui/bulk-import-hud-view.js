...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.5.82-bulk-pause-skip-reorder-summary';
    // v1.5.82 compatibility QA anchor: const VIEW_VERSION = '1.5.82-mastering-cancel-playback-resume-recovery'
    // compatibility anchor: const VIEW_VERSION = '1.5.82-bulk-control-eta-result-filter'
    ...
    // v1.5.82 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
