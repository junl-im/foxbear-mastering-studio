...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.6.93-performance-recovery-stage-hud';
    // v1.6.93 compatibility QA anchor: const VIEW_VERSION = '1.6.93-mobile-dock-visibility-integrity-recovery'
    // compatibility anchor: const VIEW_VERSION = '1.6.93-bulk-control-eta-result-filter'
    ...
    // v1.6.93 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
