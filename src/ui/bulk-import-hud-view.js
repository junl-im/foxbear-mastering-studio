...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.6.98-performance-recovery-stage-hud';
    // v1.6.98 compatibility QA anchor: const VIEW_VERSION = '1.6.98-spectrum-retirement-mobile-header-integrity'
    // compatibility anchor: const VIEW_VERSION = '1.6.98-bulk-control-eta-result-filter'
    ...
    // v1.6.98 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
