...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.6.94-performance-recovery-stage-hud';
    // v1.6.94 compatibility QA anchor: const VIEW_VERSION = '1.6.94-release-integrity-hardening'
    // compatibility anchor: const VIEW_VERSION = '1.6.94-bulk-control-eta-result-filter'
    ...
    // v1.6.94 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
