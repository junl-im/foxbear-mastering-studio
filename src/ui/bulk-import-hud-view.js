...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.6.0-bulk-pause-skip-reorder-summary';
    // v1.6.0 compatibility QA anchor: const VIEW_VERSION = '1.6.0-incident-mail-pipeline-health'
    // compatibility anchor: const VIEW_VERSION = '1.6.0-bulk-control-eta-result-filter'
    ...
    // v1.6.0 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
