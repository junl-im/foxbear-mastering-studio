...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.6.101-performance-recovery-stage-hud';
    // v1.6.101 compatibility QA anchor: const VIEW_VERSION = '1.6.101-admin-lazyload-repo-cleanup'
    // compatibility anchor: const VIEW_VERSION = '1.6.101-bulk-control-eta-result-filter'
    ...
    // v1.6.101 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
