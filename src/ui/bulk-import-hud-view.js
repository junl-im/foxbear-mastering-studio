...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.6.71-performance-recovery-stage-hud';
    // v1.6.71 compatibility QA anchor: const VIEW_VERSION = '1.6.71-pwa-share-lease-handoff-deploy-policy-e2e'
    // compatibility anchor: const VIEW_VERSION = '1.6.71-bulk-control-eta-result-filter'
    ...
    // v1.6.71 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
