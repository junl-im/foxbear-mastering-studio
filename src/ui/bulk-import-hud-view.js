...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.6.40-performance-recovery-stage-hud';
    // v1.6.40 compatibility QA anchor: const VIEW_VERSION = '1.6.40-ui-shell-retry-replacement-settlement'
    // compatibility anchor: const VIEW_VERSION = '1.6.40-bulk-control-eta-result-filter'
    ...
    // v1.6.40 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
