...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.6.113-performance-recovery-stage-hud';
    // v1.6.113 compatibility QA anchor: const VIEW_VERSION = '1.6.113-incident-finalizer-p1-hardening'
    // compatibility anchor: const VIEW_VERSION = '1.6.113-bulk-control-eta-result-filter'
    ...
    // v1.6.113 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
