...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.6.92-performance-recovery-stage-hud';
    // v1.6.92 compatibility QA anchor: const VIEW_VERSION = '1.6.92-spectrum-panel-mount-lifecycle-recovery'
    // compatibility anchor: const VIEW_VERSION = '1.6.92-bulk-control-eta-result-filter'
    ...
    // v1.6.92 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
