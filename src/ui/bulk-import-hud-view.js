...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.6.112-performance-recovery-stage-hud';
    // v1.6.112 compatibility QA anchor: const VIEW_VERSION = '1.6.112-mastering-lifecycle-race-hardening'
    // compatibility anchor: const VIEW_VERSION = '1.6.112-bulk-control-eta-result-filter'
    ...
    // v1.6.112 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
