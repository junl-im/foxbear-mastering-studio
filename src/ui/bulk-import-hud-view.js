...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.6.50-performance-recovery-stage-hud';
    // v1.6.50 compatibility QA anchor: const VIEW_VERSION = '1.6.50-kakao-centered-entry-notice'
    // compatibility anchor: const VIEW_VERSION = '1.6.50-bulk-control-eta-result-filter'
    ...
    // v1.6.50 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
