...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.6.22-performance-recovery-stage-hud';
    // v1.6.22 compatibility QA anchor: const VIEW_VERSION = '1.6.22-incident-recovery-coalescing-time-decay'
    // compatibility anchor: const VIEW_VERSION = '1.6.22-bulk-control-eta-result-filter'
    ...
    // v1.6.22 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
