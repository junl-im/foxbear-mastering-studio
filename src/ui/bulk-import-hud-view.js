...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.6.72-performance-recovery-stage-hud';
    // v1.6.72 compatibility QA anchor: const VIEW_VERSION = '1.6.72-ci-safe-hygiene-self-repair'
    // compatibility anchor: const VIEW_VERSION = '1.6.72-bulk-control-eta-result-filter'
    ...
    // v1.6.72 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
