...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.6.99-performance-recovery-stage-hud';
    // v1.6.99 compatibility QA anchor: const VIEW_VERSION = '1.6.99-header-role-focus-integrity'
    // compatibility anchor: const VIEW_VERSION = '1.6.99-bulk-control-eta-result-filter'
    ...
    // v1.6.99 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
