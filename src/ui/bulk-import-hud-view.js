...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.5.94-bulk-pause-skip-reorder-summary';
    // v1.5.94 compatibility QA anchor: const VIEW_VERSION = '1.5.94-aiff-fallback-worker-diagnostics-reporting-contract'
    // compatibility anchor: const VIEW_VERSION = '1.5.94-bulk-control-eta-result-filter'
    ...
    // v1.5.94 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
