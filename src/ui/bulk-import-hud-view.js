...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.6.65-performance-recovery-stage-hud';
    // v1.6.65 compatibility QA anchor: const VIEW_VERSION = '1.6.65-firestore-write-fencing'
    // compatibility anchor: const VIEW_VERSION = '1.6.65-bulk-control-eta-result-filter'
    ...
    // v1.6.65 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
