...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.6.106-performance-recovery-stage-hud';
    // v1.6.106 compatibility QA anchor: const VIEW_VERSION = '1.6.106-browser-geometry-history-recovery'
    // compatibility anchor: const VIEW_VERSION = '1.6.106-bulk-control-eta-result-filter'
    ...
    // v1.6.106 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
