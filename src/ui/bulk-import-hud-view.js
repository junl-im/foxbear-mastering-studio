...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.6.46-performance-recovery-stage-hud';
    // v1.6.46 compatibility QA anchor: const VIEW_VERSION = '1.6.46-google-auth-same-origin-network-recovery'
    // compatibility anchor: const VIEW_VERSION = '1.6.46-bulk-control-eta-result-filter'
    ...
    // v1.6.46 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
