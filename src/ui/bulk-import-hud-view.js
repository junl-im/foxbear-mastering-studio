...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.6.10-performance-recovery-stage-hud';
    // v1.6.10 compatibility QA anchor: const VIEW_VERSION = '1.6.10-incident-readiness-contract-csp-cache-hardening'
    // compatibility anchor: const VIEW_VERSION = '1.6.10-bulk-control-eta-result-filter'
    ...
    // v1.6.10 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
