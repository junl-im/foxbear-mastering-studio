...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.6.9-performance-recovery-stage-hud';
    // v1.6.9 compatibility QA anchor: const VIEW_VERSION = '1.6.9-incident-readiness-history-recovery-copy-events'
    // compatibility anchor: const VIEW_VERSION = '1.6.9-bulk-control-eta-result-filter'
    ...
    // v1.6.9 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
