...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.6.79-performance-recovery-stage-hud';
    // v1.6.79 compatibility QA anchor: const VIEW_VERSION = '1.6.79-manifestless-patch-playback-retirement'
    // compatibility anchor: const VIEW_VERSION = '1.6.79-bulk-control-eta-result-filter'
    ...
    // v1.6.79 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
