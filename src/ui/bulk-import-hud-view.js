...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.6.43-performance-recovery-stage-hud';
    // v1.6.43 compatibility QA anchor: const VIEW_VERSION = '1.6.43-google-auth-trusted-types-csp-recovery'
    // compatibility anchor: const VIEW_VERSION = '1.6.43-bulk-control-eta-result-filter'
    ...
    // v1.6.43 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
