...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.6.105-performance-recovery-stage-hud';
    // v1.6.105 compatibility QA anchor: const VIEW_VERSION = '1.6.105-header-dock-css-ownership-hardening'
    // compatibility anchor: const VIEW_VERSION = '1.6.105-bulk-control-eta-result-filter'
    ...
    // v1.6.105 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
