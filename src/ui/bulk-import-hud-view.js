...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.6.73-performance-recovery-stage-hud';
    // v1.6.73 compatibility QA anchor: const VIEW_VERSION = '1.6.73-csp-memory-admission-runtime-config'
    // compatibility anchor: const VIEW_VERSION = '1.6.73-bulk-control-eta-result-filter'
    ...
    // v1.6.73 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
