...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.5.80-bulk-pause-skip-reorder-summary';
    // v1.5.80 compatibility QA anchor: const VIEW_VERSION = '1.5.80-mobile-return-media-focus-recovery'
    // compatibility anchor: const VIEW_VERSION = '1.5.80-bulk-control-eta-result-filter'
    ...
    // v1.5.80 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
