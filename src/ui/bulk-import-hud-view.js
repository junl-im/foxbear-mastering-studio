...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.5.97-bulk-pause-skip-reorder-summary';
    // v1.5.97 compatibility QA anchor: const VIEW_VERSION = '1.5.97-worker-recovery-diagnostics'
    // compatibility anchor: const VIEW_VERSION = '1.5.97-bulk-control-eta-result-filter'
    ...
    // v1.5.97 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
