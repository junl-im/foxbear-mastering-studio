...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.6.20-performance-recovery-stage-hud';
    // v1.6.20 compatibility QA anchor: const VIEW_VERSION = '1.6.20-incident-background-sync-network-decay'
    // compatibility anchor: const VIEW_VERSION = '1.6.20-bulk-control-eta-result-filter'
    ...
    // v1.6.20 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
