...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.6.25-performance-recovery-stage-hud';
    // v1.6.25 compatibility QA anchor: const VIEW_VERSION = '1.6.25-incident-recovery-timeout-abort-stress'
    // compatibility anchor: const VIEW_VERSION = '1.6.25-bulk-control-eta-result-filter'
    ...
    // v1.6.25 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
