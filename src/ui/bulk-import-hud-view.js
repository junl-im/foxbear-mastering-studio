...
(function initBulkImportHudView(global) {
    ...
    const VIEW_VERSION = '1.6.97-performance-recovery-stage-hud';
    // v1.6.97 compatibility QA anchor: const VIEW_VERSION = '1.6.97-boot-payload-delivery-privacy-hardening'
    // compatibility anchor: const VIEW_VERSION = '1.6.97-bulk-control-eta-result-filter'
    ...
    // v1.6.97 compatibility: ['all', 'active', 'completed', 'failed', 'cancelled', 'pending']
