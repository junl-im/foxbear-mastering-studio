// FoxBear AI Mastering Studio Pro v1.5.68 - site and UI guard helpers
'use strict';

(function attachFoxBearSiteGuards(global) {
    const DEFAULT_CSS_HREF = 'assets/css/studio.css?v=1.5.68-mail-delivery-verification-sender-subject-rules';
