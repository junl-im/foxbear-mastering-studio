// FoxBear AI Mastering Studio Pro v1.5.46 - site and UI guard helpers
'use strict';

(function attachFoxBearSiteGuards(global) {
    const DEFAULT_CSS_HREF = 'assets/css/studio.css?v=1.5.46-engine-recommendation-api-audit';
