// FoxBear AI Mastering Studio Pro v1.6.2 - site and UI guard helpers
'use strict';

(function attachFoxBearSiteGuards(global) {
    const DEFAULT_CSS_HREF = 'assets/css/studio.css?v=1.6.2-nonblocking-health-status-design-polish';
