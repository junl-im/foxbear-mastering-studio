// FoxBear AI Mastering Studio Pro v1.6.10 - site and UI guard helpers
'use strict';

(function attachFoxBearSiteGuards(global) {
    const DEFAULT_CSS_HREF = 'assets/css/studio.css?v=1.6.10-incident-readiness-contract-csp-cache-hardening';
