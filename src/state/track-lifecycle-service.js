...
(function attachFoxBearTrackLifecycleService(global) {
    ...
    function createTrackModel(file, options = {}) {
        ...
        return {
            ...
            bulkMasteringSource: '',
            bulkMasteringResult: '',
            bulkMasteringQueuedAt: 0,
            bulkMasteringTrackStartedAt: 0,
    ...
    function releaseTrackResources(track, options = {}) {
        ...
        let revoked = 0;
        try { track.masteringAbortController?.abort?.('track-resources-released'); } catch (error) {}
