// FoxBear AI Mastering Studio Pro v1.6.1 - runtime constants
'use strict';

(function attachFoxBearRuntimeConfig(global) {
    const BUILD_INFO = global.FoxBearBuildInfo || {};
    const ASSET_VERSION = '1.6.1-transient-performance-diagnostics';
    ...
    global.FoxBearRuntimeConfig = Object.freeze({
        APP_VERSION: BUILD_INFO.appVersion || 'Pro v1.6.1',
        ASSET_VERSION,
