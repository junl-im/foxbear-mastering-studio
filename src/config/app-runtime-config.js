// FoxBear AI Mastering Studio Pro v1.5.94 - runtime constants
'use strict';

(function attachFoxBearRuntimeConfig(global) {
    const BUILD_INFO = global.FoxBearBuildInfo || {};
    const ASSET_VERSION = '1.5.94-aiff-fallback-worker-diagnostics-reporting-contract';
    ...
    global.FoxBearRuntimeConfig = Object.freeze({
        APP_VERSION: BUILD_INFO.appVersion || 'Pro v1.5.94',
        ASSET_VERSION,
