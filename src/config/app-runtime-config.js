// FoxBear AI Mastering Studio Pro v1.5.64 - runtime constants
'use strict';

(function attachFoxBearRuntimeConfig(global) {
    const BUILD_INFO = global.FoxBearBuildInfo || {};
    const ASSET_VERSION = '1.5.64-incident-operations-health-self-diagnostics';
    ...
    global.FoxBearRuntimeConfig = Object.freeze({
        APP_VERSION: BUILD_INFO.appVersion || 'Pro v1.5.64',
        ASSET_VERSION,
