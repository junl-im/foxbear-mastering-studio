// FoxBear AI Mastering Studio Pro v1.6.76 - runtime constants
'use strict';

(function attachFoxBearRuntimeConfig(global) {
    const BUILD_INFO = global.FoxBearBuildInfo || {};
    const ASSET_VERSION = '1.6.76-download-viewport-runtime-fault-diagnostics';
    ...
    global.FoxBearRuntimeConfig = Object.freeze({
        APP_VERSION: BUILD_INFO.appVersion || 'Pro v1.6.76',
        ASSET_VERSION,
        APP_CHECK_POLICY,
