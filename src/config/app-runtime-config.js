// FoxBear AI Mastering Studio Pro v1.6.113 - runtime constants
'use strict';

(function attachFoxBearRuntimeConfig(global) {
    const BUILD_INFO = global.FoxBearBuildInfo || {};
    const ASSET_VERSION = '1.6.113-incident-finalizer-p1-hardening';
    ...
    global.FoxBearRuntimeConfig = Object.freeze({
        APP_VERSION: BUILD_INFO.appVersion || 'Pro v1.6.113',
        ASSET_VERSION,
        APP_CHECK_POLICY,
