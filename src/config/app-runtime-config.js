// FoxBear AI Mastering Studio Pro v1.6.92 - runtime constants
'use strict';

(function attachFoxBearRuntimeConfig(global) {
    const BUILD_INFO = global.FoxBearBuildInfo || {};
    const ASSET_VERSION = '1.6.92-spectrum-panel-mount-lifecycle-recovery';
    ...
    global.FoxBearRuntimeConfig = Object.freeze({
        APP_VERSION: BUILD_INFO.appVersion || 'Pro v1.6.92',
        ASSET_VERSION,
        APP_CHECK_POLICY,
