// FoxBear AI Mastering Studio Pro v1.6.102 - runtime constants
'use strict';

(function attachFoxBearRuntimeConfig(global) {
    const BUILD_INFO = global.FoxBearBuildInfo || {};
    const ASSET_VERSION = '1.6.102-admin-lazyload-sw-hygiene-hardening';
    ...
    global.FoxBearRuntimeConfig = Object.freeze({
        APP_VERSION: BUILD_INFO.appVersion || 'Pro v1.6.102',
        ASSET_VERSION,
        APP_CHECK_POLICY,
