// FoxBear AI Mastering Studio Pro v1.7.1 - runtime constants
'use strict';

(function attachFoxBearRuntimeConfig(global) {
    const BUILD_INFO = global.FoxBearBuildInfo || {};
    const ASSET_VERSION = '1.7.1-reference-match-2-phase1';
    ...
    global.FoxBearRuntimeConfig = Object.freeze({
        APP_VERSION: BUILD_INFO.appVersion || 'Pro v1.7.1',
        ASSET_VERSION,
        APP_CHECK_POLICY,
