...
const phases = {
  static: ['source:hygiene:repair', 'source:hygiene', 'version:check', 'handoff:check', 'dependencies:check', 'check:static'],
  browser: ['qa:browser'],
  full: ['source:hygiene:repair', 'source:hygiene', 'version:check', 'handoff:check', 'dependencies:check', 'check:static', 'qa:browser']
};
