# FoxBear AI Mastering Studio Pro v1.5.65

## v1.5.65 핵심 변경

- SMTP와 독립된 선택적 HTTPS 웹훅 운영 경보를 지원합니다.
- 관리자가 미발송 또는 최종 실패 메일을 최대 8건씩 일괄 복구할 수 있습니다.
- 자동 복구 실행 결과와 30일 운영 상태 이력을 관리자 화면에 표시합니다.
- 새 Firestore 규칙이 순차 배포 중이어도 관리자 오류 화면은 기존 기능으로 계속 열립니다.
