// FoxBear AI Mastering Studio Pro v1.6.79 service worker · manifestless-patch-playback-retirement
'use strict';

function loadSharePolicy() {
  try {
    if (typeof importScripts === 'function') importScripts('./src/config/pwa-share-policy.js?v=1.6.79-manifestless-patch-playback-retirement');
  } catch (error) {
...
const CORE_ASSETS = [
  ...
  './index.html',
  './404.html',
  './assets/css/route-recovery.css?v=1.6.79-manifestless-patch-playback-retirement',
  './src/boot/route-recovery.js?v=1.6.79-manifestless-patch-playback-retirement',
  './foxbear-root.json',
  './external-browser.html',
  './assets/css/external-browser.css?v=1.6.79-manifestless-patch-playback-retirement',
  './design-preview.html',
  './assets/css/design-preview.css?v=1.6.79-manifestless-patch-playback-retirement',
  ...
  './src/security/trusted-types-bootstrap.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/boot/kakao-entry-guard.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/boot/kakao-entry-notice.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/boot/kakao-external-browser.js?v=1.6.79-manifestless-patch-playback-retirement',
  ...
  './src/workers/wav-encoder.worker.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/workers/mp3-encoder.worker.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/workers/analysis.worker.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/workers/master-finalizer.worker.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/workers/pitch-wsola.worker.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/workers/zip-encoder.worker.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/engines/pitch-engine-adapter.js',
  './assets/icons/foxbear-icon-48.png?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/icons/foxbear-icon-72.png?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/icons/foxbear-icon-96.png?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/icons/foxbear-icon-128.png?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/icons/foxbear-icon-144.png?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/icons/foxbear-icon-152.png?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/icons/foxbear-icon-180.png?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/icons/foxbear-icon-192.png?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/icons/foxbear-icon-384.png?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/icons/foxbear-icon-512.png?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/icons/foxbear-icon-16.png?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/icons/foxbear-icon-32.png?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/icons/apple-touch-icon.png?v=1.6.79-manifestless-patch-playback-retirement',
  './manifest.webmanifest?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/css/boot/performance-diagnostics.css?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/css/boot/runtime-health.css?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/css/boot/ui-shell-recovery.css?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/css/boot/kakao-entry-notice.css?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/css/theme.css?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/css/layout.css?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/css/components/base-components.css?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/css/components/forms.css?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/css/components/cards.css?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/css/components/preview-system.css?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/css/components/playback-link.css?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/css/studio.css?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/css/components/admin-incident-monitor.css?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/css/dock.css?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/css/dock-waveform.css?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/css/waveform-compare.css?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/css/spectrum-visualizer.css?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/css/export.css?v=1.6.79-manifestless-patch-playback-retirement&h=export-progress-v156',
  './assets/css/download-dialog.css?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/css/bulk-import-hud.css?v=1.6.79-manifestless-patch-playback-retirement&h=bulk-hud-close-hotfix&ui=v153',
  './assets/css/mobile-native.css?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/css/dock-ui-repair.css?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/css/components/floating-overlays.css?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/css/header-command-bar.css?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/css/components/support-settings.css?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/css/components/modal-close-system.css?v=1.6.79-manifestless-patch-playback-retirement',
  './vendor/jszip/jszip.min.js?v=1.6.79-manifestless-patch-playback-retirement&lib=3.10.1',
  './src/config/build-info.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/boot/release-presentation-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/boot/runtime-fault-counters.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/boot/session-handoff-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/boot/incident-route-policy.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/boot/incident-submission-identity-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/firebase-bootstrap.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/boot/incident-support-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/boot/incident-state-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/boot/incident-mail-sync-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/boot/incident-lifecycle-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/boot/incident-recovery-sweep-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/boot/incident-service-recovery-controller.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/boot/incident-recovery-policy.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/boot/incident-local-queue-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/boot/incident-queue-coordination-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/boot/incident-service-diagnostics.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/boot/incident-diagnostics-view-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/boot/incident-controls-view-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/boot/incident-reporter.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/config/mastering-presets.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/config/genre-presets.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/config/reference-targets.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/config/app-runtime-config.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/config/pwa-share-policy.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/state/app-state.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/settings/settings-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/utils/core-utils.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/utils/worker-job-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/recommendation/recommendation-engine.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/audio/mastering-inspector.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/audio/highlight-compare-inspector.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/audio/playback-link-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/audio/playback-transition-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/audio/playback-source-recovery-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/audio/playback-lifecycle-recovery-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/audio/post-master-playback-recovery-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/audio/audio-context-manager.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/audio/preview-translation-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/audio/audio-import-capability-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/audio/audio-decode-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/audio/inapp-mastering-safety-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/audio/import-preflight-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/audio/import-queue-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/audio/analysis-cache-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/audio/memory-guard-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/audio/mastering-memory-diagnostics-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/audio/reference-profile-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/audio/loudness-measurement-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/audio/mastering-input-guard-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/audio/mastering-quality-audit-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/audio/quality-gate-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/audio/mastering-orchestrator-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/audio/master-preview-job-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/state/track-lifecycle-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/audio/waveform-control-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/ui/waveform-control-view.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/ui/spectrum-visualizer.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/ui/modal-controller.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/ui/dock-controller.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/ui/mobile-native-view.js?v=1.6.79-manifestless-patch-playback-retirement&h=bulk-hud-restore-v153',
  './src/ui/admin-access-controller.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/download/file-name-policy-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/download/file-name-workflow-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/download/download-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/download/export-guard-service.js?v=1.6.79-manifestless-patch-playback-retirement&h=export-v156',
  './src/download/export-progress-view.js?v=1.6.79-manifestless-patch-playback-retirement&h=export-progress-v156',
  './src/download/zip-export-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/download/export-queue-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/ui/download-dialog-view.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/ui/bulk-import-hud-view.js?v=1.6.79-manifestless-patch-playback-retirement&h=bulk-hud-v153',
  './src/ui/waveform-compare-view.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/ui/detail-panels-view.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/ui/detail-view.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/ui/admin-incident-monitor-view.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/security/site-guards.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/boot/runtime-health.js?v=1.6.79-manifestless-patch-playback-retirement&h=boot-sri-v1679',
  './src/boot/ui-shell-recovery-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/boot/update-safety-service.js?v=1.6.79-manifestless-patch-playback-retirement&h=update-safety-v1679',
  './src/boot/service-worker-update-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/boot/service-worker-recovery-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/boot/worker-recovery-coordinator.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/boot/performance-diagnostics.js?v=1.6.79-manifestless-patch-playback-retirement&h=boot-sri-v1679',
  './src/boot/render-scheduler.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/boot/pwa-share-target-service.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/boot/pwa-runtime-bridge.js?v=1.6.79-manifestless-patch-playback-retirement',
  './src/app.js?v=1.6.79-manifestless-patch-playback-retirement&h=boot-sri-v1679',
  './src/boot/worker-recovery-app-bridge.js?v=1.6.79-manifestless-patch-playback-retirement',
  './assets/icons/foxbear-music.png?v=1.6.79-manifestless-patch-playback-retirement'
];
