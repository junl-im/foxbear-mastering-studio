// FoxBear AI Mastering Studio Pro v1.6.76 service worker · download-viewport-runtime-fault-diagnostics
'use strict';

function loadSharePolicy() {
  try {
    if (typeof importScripts === 'function') importScripts('./src/config/pwa-share-policy.js?v=1.6.76-download-viewport-runtime-fault-diagnostics');
  } catch (error) {
...
const CACHE_NAME = 'foxbear-shell-v1.6.76-download-viewport-runtime-fault-diagnostics';
const CURRENT_ASSET_VERSION = '1.6.76-download-viewport-runtime-fault-diagnostics';
const LEGACY_CACHE_NAMES = ['foxbear-shell-v1.5.4-boot-sri-recovery', 'foxbear-shell-v1.5.5-update-safety', 'foxbear-shell-v1.5.6-export-progress-recovery', 'foxbear-shell-v1.6.56-playback-blob-source-resilience', 'foxbear-shell-v1.6.57-firebase-hosting-payload-boundary', 'foxbear-shell-v1.6.58-piano-transient-integrity', 'foxbear-shell-v1.6.59-readiness-corp-security-hardening', 'foxbear-shell-v1.6.60-bulk-zip-hud-navigation', 'foxbear-shell-v1.6.61-human-readable-download-filenames', 'foxbear-shell-v1.6.62-download-filename-preview-controls', 'foxbear-shell-v1.6.63-download-filename-review-hardening', 'foxbear-shell-v1.6.64-github-desktop-delivery-contract', 'foxbear-shell-v1.6.65-firestore-write-fencing', 'foxbear-shell-v1.6.66-static-gate-hygiene-repair', 'foxbear-shell-v1.6.67-ci-strict-hygiene-policy', 'foxbear-shell-v1.6.68-public-shell-cache-integrity', 'foxbear-shell-v1.6.69-ci-appcheck-share-target-hardening', 'foxbear-shell-v1.6.70-share-retry-policy-drift-ci-efficiency', 'foxbear-shell-v1.6.71-pwa-share-lease-handoff-deploy-policy-e2e', 'foxbear-shell-v1.6.72-ci-safe-hygiene-self-repair', 'foxbear-shell-v1.6.73-csp-memory-admission-runtime-config', 'foxbear-shell-v1.6.74-incident-admission-spark-retention-download-memory', 'foxbear-shell-v1.6.75-download-progress-admission-fallback-closure'];
...
const CORE_ASSETS = [
  ...
  './index.html',
  './404.html',
  './assets/css/route-recovery.css?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/boot/route-recovery.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './foxbear-root.json',
  './external-browser.html',
  './assets/css/external-browser.css?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './design-preview.html',
  './assets/css/design-preview.css?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  ...
  './src/security/trusted-types-bootstrap.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/boot/kakao-entry-guard.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/boot/kakao-entry-notice.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/boot/kakao-external-browser.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  ...
  './src/workers/wav-encoder.worker.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/workers/mp3-encoder.worker.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/workers/analysis.worker.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/workers/master-finalizer.worker.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/workers/pitch-wsola.worker.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/workers/zip-encoder.worker.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/engines/pitch-engine-adapter.js',
  './assets/icons/foxbear-icon-48.png?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/icons/foxbear-icon-72.png?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/icons/foxbear-icon-96.png?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/icons/foxbear-icon-128.png?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/icons/foxbear-icon-144.png?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/icons/foxbear-icon-152.png?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/icons/foxbear-icon-180.png?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/icons/foxbear-icon-192.png?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/icons/foxbear-icon-384.png?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/icons/foxbear-icon-512.png?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/icons/foxbear-icon-16.png?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/icons/foxbear-icon-32.png?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/icons/apple-touch-icon.png?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './manifest.webmanifest?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/css/boot/performance-diagnostics.css?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/css/boot/runtime-health.css?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/css/boot/ui-shell-recovery.css?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/css/boot/kakao-entry-notice.css?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/css/theme.css?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/css/layout.css?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/css/components/base-components.css?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/css/components/forms.css?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/css/components/cards.css?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/css/components/preview-system.css?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/css/components/playback-link.css?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/css/studio.css?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/css/components/admin-incident-monitor.css?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/css/dock.css?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/css/dock-waveform.css?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/css/waveform-compare.css?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/css/spectrum-visualizer.css?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/css/export.css?v=1.6.76-download-viewport-runtime-fault-diagnostics&h=export-progress-v156',
  './assets/css/download-dialog.css?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/css/bulk-import-hud.css?v=1.6.76-download-viewport-runtime-fault-diagnostics&h=bulk-hud-close-hotfix&ui=v153',
  './assets/css/mobile-native.css?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/css/dock-ui-repair.css?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/css/components/floating-overlays.css?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/css/header-command-bar.css?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/css/components/support-settings.css?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/css/components/modal-close-system.css?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './vendor/jszip/jszip.min.js?v=1.6.76-download-viewport-runtime-fault-diagnostics&lib=3.10.1',
  './src/config/build-info.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/boot/release-presentation-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/boot/runtime-fault-counters.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/boot/session-handoff-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/boot/incident-route-policy.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/boot/incident-submission-identity-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/firebase-bootstrap.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/boot/incident-support-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/boot/incident-state-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/boot/incident-mail-sync-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/boot/incident-lifecycle-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/boot/incident-recovery-sweep-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/boot/incident-service-recovery-controller.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/boot/incident-recovery-policy.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/boot/incident-local-queue-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/boot/incident-queue-coordination-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/boot/incident-service-diagnostics.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/boot/incident-diagnostics-view-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/boot/incident-controls-view-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/boot/incident-reporter.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/config/mastering-presets.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/config/genre-presets.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/config/reference-targets.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/config/app-runtime-config.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/config/pwa-share-policy.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/state/app-state.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/settings/settings-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/utils/core-utils.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/utils/worker-job-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/recommendation/recommendation-engine.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/audio/mastering-inspector.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/audio/highlight-compare-inspector.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/audio/playback-link-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/audio/playback-transition-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/audio/playback-source-recovery-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/audio/playback-lifecycle-recovery-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/audio/post-master-playback-recovery-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/audio/audio-context-manager.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/audio/preview-translation-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/audio/audio-import-capability-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/audio/audio-decode-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/audio/inapp-mastering-safety-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/audio/import-preflight-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/audio/import-queue-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/audio/analysis-cache-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/audio/memory-guard-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/audio/mastering-memory-diagnostics-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/audio/reference-profile-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/audio/loudness-measurement-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/audio/mastering-input-guard-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/audio/mastering-quality-audit-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/audio/quality-gate-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/audio/mastering-orchestrator-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/audio/master-preview-job-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/state/track-lifecycle-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/audio/waveform-control-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/ui/waveform-control-view.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/ui/spectrum-visualizer.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/ui/modal-controller.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/ui/dock-controller.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/ui/mobile-native-view.js?v=1.6.76-download-viewport-runtime-fault-diagnostics&h=bulk-hud-restore-v153',
  './src/ui/admin-access-controller.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/download/file-name-policy-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/download/file-name-workflow-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/download/download-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/download/export-guard-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics&h=export-v156',
  './src/download/export-progress-view.js?v=1.6.76-download-viewport-runtime-fault-diagnostics&h=export-progress-v156',
  './src/download/zip-export-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/download/export-queue-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/ui/download-dialog-view.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/ui/bulk-import-hud-view.js?v=1.6.76-download-viewport-runtime-fault-diagnostics&h=bulk-hud-v153',
  './src/ui/waveform-compare-view.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/ui/detail-panels-view.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/ui/detail-view.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/ui/admin-incident-monitor-view.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/security/site-guards.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/boot/runtime-health.js?v=1.6.76-download-viewport-runtime-fault-diagnostics&h=boot-sri-v1676',
  './src/boot/ui-shell-recovery-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/boot/update-safety-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics&h=update-safety-v1676',
  './src/boot/service-worker-update-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/boot/service-worker-recovery-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/boot/worker-recovery-coordinator.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/boot/performance-diagnostics.js?v=1.6.76-download-viewport-runtime-fault-diagnostics&h=boot-sri-v1676',
  './src/boot/render-scheduler.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/boot/pwa-share-target-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/boot/pwa-runtime-bridge.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './src/app.js?v=1.6.76-download-viewport-runtime-fault-diagnostics&h=boot-sri-v1676',
  './src/boot/worker-recovery-app-bridge.js?v=1.6.76-download-viewport-runtime-fault-diagnostics',
  './assets/icons/foxbear-music.png?v=1.6.76-download-viewport-runtime-fault-diagnostics'
];
