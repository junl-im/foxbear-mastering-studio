...
const CORE_ASSETS = [
  ...
  './src/boot/kakao-entry-guard.js?v=1.6.42-spark-google-admin-auth',
  ...
  './src/workers/wav-encoder.worker.js?v=1.6.42-spark-google-admin-auth',
  './src/workers/mp3-encoder.worker.js?v=1.6.42-spark-google-admin-auth',
  './src/workers/analysis.worker.js?v=1.6.42-spark-google-admin-auth',
  './src/workers/master-finalizer.worker.js?v=1.6.42-spark-google-admin-auth',
  './src/workers/pitch-wsola.worker.js?v=1.6.42-spark-google-admin-auth',
  './src/workers/zip-encoder.worker.js?v=1.6.42-spark-google-admin-auth',
  ...
  './assets/icons/foxbear-icon-16.png?v=1.6.42-spark-google-admin-auth',
  './assets/icons/foxbear-icon-32.png?v=1.6.42-spark-google-admin-auth',
  './assets/icons/foxbear-icon-192.png?v=1.6.42-spark-google-admin-auth',
  './assets/icons/foxbear-icon-512.png?v=1.6.42-spark-google-admin-auth',
  './assets/icons/apple-touch-icon.png?v=1.6.42-spark-google-admin-auth',
  './manifest.webmanifest?v=1.6.42-spark-google-admin-auth',
  './assets/css/boot/performance-diagnostics.css?v=1.6.42-spark-google-admin-auth',
  './assets/css/boot/runtime-health.css?v=1.6.42-spark-google-admin-auth',
  './assets/css/boot/ui-shell-recovery.css?v=1.6.42-spark-google-admin-auth',
  './assets/css/theme.css?v=1.6.42-spark-google-admin-auth',
  './assets/css/layout.css?v=1.6.42-spark-google-admin-auth',
  './assets/css/components/base-components.css?v=1.6.42-spark-google-admin-auth',
  './assets/css/components/forms.css?v=1.6.42-spark-google-admin-auth',
  './assets/css/components/cards.css?v=1.6.42-spark-google-admin-auth',
  './assets/css/components/preview-system.css?v=1.6.42-spark-google-admin-auth',
  './assets/css/components/playback-link.css?v=1.6.42-spark-google-admin-auth',
  './assets/css/studio.css?v=1.6.42-spark-google-admin-auth',
  './assets/css/components/admin-incident-monitor.css?v=1.6.42-spark-google-admin-auth',
  './assets/css/dock.css?v=1.6.42-spark-google-admin-auth',
  './assets/css/dock-waveform.css?v=1.6.42-spark-google-admin-auth',
  './assets/css/waveform-compare.css?v=1.6.42-spark-google-admin-auth',
  './assets/css/spectrum-visualizer.css?v=1.6.42-spark-google-admin-auth',
  './assets/css/export.css?v=1.6.42-spark-google-admin-auth&h=export-progress-v156',
  './assets/css/download-dialog.css?v=1.6.42-spark-google-admin-auth',
  './assets/css/bulk-import-hud.css?v=1.6.42-spark-google-admin-auth&h=bulk-hud-close-hotfix&ui=v153',
  './assets/css/mobile-native.css?v=1.6.42-spark-google-admin-auth',
  './assets/css/dock-ui-repair.css?v=1.6.42-spark-google-admin-auth',
  './assets/css/components/floating-overlays.css?v=1.6.42-spark-google-admin-auth',
  './assets/css/header-command-bar.css?v=1.6.42-spark-google-admin-auth',
  './assets/css/components/support-settings.css?v=1.6.42-spark-google-admin-auth',
  './assets/css/components/modal-close-system.css?v=1.6.42-spark-google-admin-auth',
  './vendor/jszip/jszip.min.js?v=1.6.42-spark-google-admin-auth&lib=3.10.1',
  './src/config/build-info.js?v=1.6.42-spark-google-admin-auth',
  './src/boot/release-presentation-service.js?v=1.6.42-spark-google-admin-auth',
  './src/boot/session-handoff-service.js?v=1.6.42-spark-google-admin-auth',
  './src/boot/incident-route-policy.js?v=1.6.42-spark-google-admin-auth',
  './src/boot/incident-submission-identity-service.js?v=1.6.42-spark-google-admin-auth',
  './src/firebase-bootstrap.js?v=1.6.42-spark-google-admin-auth',
  './src/boot/incident-support-service.js?v=1.6.42-spark-google-admin-auth',
  './src/boot/incident-state-service.js?v=1.6.42-spark-google-admin-auth',
  './src/boot/incident-mail-sync-service.js?v=1.6.42-spark-google-admin-auth',
  './src/boot/incident-lifecycle-service.js?v=1.6.42-spark-google-admin-auth',
  './src/boot/incident-recovery-sweep-service.js?v=1.6.42-spark-google-admin-auth',
  './src/boot/incident-service-recovery-controller.js?v=1.6.42-spark-google-admin-auth',
  './src/boot/incident-recovery-policy.js?v=1.6.42-spark-google-admin-auth',
  './src/boot/incident-local-queue-service.js?v=1.6.42-spark-google-admin-auth',
  './src/boot/incident-queue-coordination-service.js?v=1.6.42-spark-google-admin-auth',
  './src/boot/incident-service-diagnostics.js?v=1.6.42-spark-google-admin-auth',
  './src/boot/incident-diagnostics-view-service.js?v=1.6.42-spark-google-admin-auth',
  './src/boot/incident-controls-view-service.js?v=1.6.42-spark-google-admin-auth',
  './src/boot/incident-reporter.js?v=1.6.42-spark-google-admin-auth',
  './src/config/mastering-presets.js?v=1.6.42-spark-google-admin-auth',
  './src/config/genre-presets.js?v=1.6.42-spark-google-admin-auth',
  './src/config/reference-targets.js?v=1.6.42-spark-google-admin-auth',
  './src/config/app-runtime-config.js?v=1.6.42-spark-google-admin-auth',
  './src/state/app-state.js?v=1.6.42-spark-google-admin-auth',
  './src/settings/settings-service.js?v=1.6.42-spark-google-admin-auth',
  './src/utils/core-utils.js?v=1.6.42-spark-google-admin-auth',
  './src/utils/worker-job-service.js?v=1.6.42-spark-google-admin-auth',
  './src/recommendation/recommendation-engine.js?v=1.6.42-spark-google-admin-auth',
  './src/audio/mastering-inspector.js?v=1.6.42-spark-google-admin-auth',
  './src/audio/highlight-compare-inspector.js?v=1.6.42-spark-google-admin-auth',
  './src/audio/playback-link-service.js?v=1.6.42-spark-google-admin-auth',
  './src/audio/playback-transition-service.js?v=1.6.42-spark-google-admin-auth',
  './src/audio/audio-context-manager.js?v=1.6.42-spark-google-admin-auth',
  './src/audio/preview-translation-service.js?v=1.6.42-spark-google-admin-auth',
  './src/audio/audio-import-capability-service.js?v=1.6.42-spark-google-admin-auth',
  './src/audio/audio-decode-service.js?v=1.6.42-spark-google-admin-auth',
  './src/audio/inapp-mastering-safety-service.js?v=1.6.42-spark-google-admin-auth',
  './src/audio/import-preflight-service.js?v=1.6.42-spark-google-admin-auth',
  './src/audio/import-queue-service.js?v=1.6.42-spark-google-admin-auth',
  './src/audio/analysis-cache-service.js?v=1.6.42-spark-google-admin-auth',
  './src/audio/memory-guard-service.js?v=1.6.42-spark-google-admin-auth',
  './src/audio/mastering-memory-diagnostics-service.js?v=1.6.42-spark-google-admin-auth',
  './src/audio/reference-profile-service.js?v=1.6.42-spark-google-admin-auth',
  './src/audio/loudness-measurement-service.js?v=1.6.42-spark-google-admin-auth',
  './src/audio/mastering-input-guard-service.js?v=1.6.42-spark-google-admin-auth',
  './src/audio/mastering-quality-audit-service.js?v=1.6.42-spark-google-admin-auth',
  './src/audio/quality-gate-service.js?v=1.6.42-spark-google-admin-auth',
  './src/audio/mastering-orchestrator-service.js?v=1.6.42-spark-google-admin-auth',
  './src/audio/master-preview-job-service.js?v=1.6.42-spark-google-admin-auth',
  './src/state/track-lifecycle-service.js?v=1.6.42-spark-google-admin-auth',
  './src/audio/waveform-control-service.js?v=1.6.42-spark-google-admin-auth',
  './src/ui/waveform-control-view.js?v=1.6.42-spark-google-admin-auth',
  './src/ui/spectrum-visualizer.js?v=1.6.42-spark-google-admin-auth',
  './src/ui/modal-controller.js?v=1.6.42-spark-google-admin-auth',
  './src/ui/dock-controller.js?v=1.6.42-spark-google-admin-auth',
  './src/ui/mobile-native-view.js?v=1.6.42-spark-google-admin-auth&h=bulk-hud-restore-v153',
  './src/ui/admin-access-controller.js?v=1.6.42-spark-google-admin-auth',
  './src/download/download-service.js?v=1.6.42-spark-google-admin-auth',
  './src/download/export-guard-service.js?v=1.6.42-spark-google-admin-auth&h=export-v156',
  './src/download/export-progress-view.js?v=1.6.42-spark-google-admin-auth&h=export-progress-v156',
  './src/download/zip-export-service.js?v=1.6.42-spark-google-admin-auth',
  './src/download/export-queue-service.js?v=1.6.42-spark-google-admin-auth',
  './src/ui/download-dialog-view.js?v=1.6.42-spark-google-admin-auth',
  './src/ui/bulk-import-hud-view.js?v=1.6.42-spark-google-admin-auth&h=bulk-hud-v153',
  './src/ui/waveform-compare-view.js?v=1.6.42-spark-google-admin-auth',
  './src/ui/detail-panels-view.js?v=1.6.42-spark-google-admin-auth',
  './src/ui/detail-view.js?v=1.6.42-spark-google-admin-auth',
  './src/ui/admin-incident-monitor-view.js?v=1.6.42-spark-google-admin-auth',
  './src/security/site-guards.js?v=1.6.42-spark-google-admin-auth',
  './src/boot/runtime-health.js?v=1.6.42-spark-google-admin-auth&h=boot-sri-v1642-google-admin',
  './src/boot/ui-shell-recovery-service.js?v=1.6.42-spark-google-admin-auth',
  './src/boot/update-safety-service.js?v=1.6.42-spark-google-admin-auth&h=update-safety-v1642-google-admin',
  './src/boot/service-worker-update-service.js?v=1.6.42-spark-google-admin-auth',
  './src/boot/service-worker-recovery-service.js?v=1.6.42-spark-google-admin-auth',
  './src/boot/worker-recovery-coordinator.js?v=1.6.42-spark-google-admin-auth',
  './src/boot/performance-diagnostics.js?v=1.6.42-spark-google-admin-auth&h=boot-sri-v1642-google-admin',
  './src/boot/render-scheduler.js?v=1.6.42-spark-google-admin-auth',
  './src/app.js?v=1.6.42-spark-google-admin-auth&h=boot-sri-v1642-google-admin',
  './src/boot/worker-recovery-app-bridge.js?v=1.6.42-spark-google-admin-auth',
  './assets/icons/foxbear-music.png?v=1.6.42-spark-google-admin-auth'
];
