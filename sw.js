// FoxBear AI Mastering Studio Pro v1.6.80 service worker · ai-mastering-expert-workspace
'use strict';

function loadSharePolicy() {
  try {
    if (typeof importScripts === 'function') importScripts('./src/config/pwa-share-policy.js?v=1.6.80-ai-mastering-expert-workspace');
  } catch (error) {
...
const CORE_ASSETS = [
  ...
  './index.html',
  './404.html',
  './assets/css/route-recovery.css?v=1.6.80-ai-mastering-expert-workspace',
  './src/boot/route-recovery.js?v=1.6.80-ai-mastering-expert-workspace',
  './foxbear-root.json',
  './external-browser.html',
  './assets/css/external-browser.css?v=1.6.80-ai-mastering-expert-workspace',
  './design-preview.html',
  './assets/css/design-preview.css?v=1.6.80-ai-mastering-expert-workspace',
  ...
  './src/security/trusted-types-bootstrap.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/boot/kakao-entry-guard.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/boot/kakao-entry-notice.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/boot/kakao-external-browser.js?v=1.6.80-ai-mastering-expert-workspace',
  ...
  './src/workers/wav-encoder.worker.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/workers/mp3-encoder.worker.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/workers/analysis.worker.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/workers/master-finalizer.worker.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/workers/pitch-wsola.worker.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/workers/zip-encoder.worker.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/engines/pitch-engine-adapter.js',
  './assets/icons/foxbear-icon-48.png?v=1.6.80-ai-mastering-expert-workspace',
  './assets/icons/foxbear-icon-72.png?v=1.6.80-ai-mastering-expert-workspace',
  './assets/icons/foxbear-icon-96.png?v=1.6.80-ai-mastering-expert-workspace',
  './assets/icons/foxbear-icon-128.png?v=1.6.80-ai-mastering-expert-workspace',
  './assets/icons/foxbear-icon-144.png?v=1.6.80-ai-mastering-expert-workspace',
  './assets/icons/foxbear-icon-152.png?v=1.6.80-ai-mastering-expert-workspace',
  './assets/icons/foxbear-icon-180.png?v=1.6.80-ai-mastering-expert-workspace',
  './assets/icons/foxbear-icon-192.png?v=1.6.80-ai-mastering-expert-workspace',
  './assets/icons/foxbear-icon-384.png?v=1.6.80-ai-mastering-expert-workspace',
  './assets/icons/foxbear-icon-512.png?v=1.6.80-ai-mastering-expert-workspace',
  './assets/icons/foxbear-icon-16.png?v=1.6.80-ai-mastering-expert-workspace',
  './assets/icons/foxbear-icon-32.png?v=1.6.80-ai-mastering-expert-workspace',
  './assets/icons/apple-touch-icon.png?v=1.6.80-ai-mastering-expert-workspace',
  './manifest.webmanifest?v=1.6.80-ai-mastering-expert-workspace',
  './assets/css/boot/performance-diagnostics.css?v=1.6.80-ai-mastering-expert-workspace',
  './assets/css/boot/runtime-health.css?v=1.6.80-ai-mastering-expert-workspace',
  './assets/css/boot/ui-shell-recovery.css?v=1.6.80-ai-mastering-expert-workspace',
  './assets/css/boot/kakao-entry-notice.css?v=1.6.80-ai-mastering-expert-workspace',
  './assets/css/theme.css?v=1.6.80-ai-mastering-expert-workspace',
  './assets/css/layout.css?v=1.6.80-ai-mastering-expert-workspace',
  './assets/css/components/base-components.css?v=1.6.80-ai-mastering-expert-workspace',
  './assets/css/components/forms.css?v=1.6.80-ai-mastering-expert-workspace',
  './assets/css/components/cards.css?v=1.6.80-ai-mastering-expert-workspace',
  './assets/css/components/preview-system.css?v=1.6.80-ai-mastering-expert-workspace',
  './assets/css/components/playback-link.css?v=1.6.80-ai-mastering-expert-workspace',
  './assets/css/studio.css?v=1.6.80-ai-mastering-expert-workspace',
  './assets/css/ui-mode.css?v=1.6.80-ai-mastering-expert-workspace',
  './assets/css/components/admin-incident-monitor.css?v=1.6.80-ai-mastering-expert-workspace',
  './assets/css/dock.css?v=1.6.80-ai-mastering-expert-workspace',
  './assets/css/dock-waveform.css?v=1.6.80-ai-mastering-expert-workspace',
  './assets/css/waveform-compare.css?v=1.6.80-ai-mastering-expert-workspace',
  './assets/css/spectrum-visualizer.css?v=1.6.80-ai-mastering-expert-workspace',
  './assets/css/export.css?v=1.6.80-ai-mastering-expert-workspace&h=export-progress-v156',
  './assets/css/download-dialog.css?v=1.6.80-ai-mastering-expert-workspace',
  './assets/css/bulk-import-hud.css?v=1.6.80-ai-mastering-expert-workspace&h=bulk-hud-close-hotfix&ui=v153',
  './assets/css/mobile-native.css?v=1.6.80-ai-mastering-expert-workspace',
  './assets/css/dock-ui-repair.css?v=1.6.80-ai-mastering-expert-workspace',
  './assets/css/components/floating-overlays.css?v=1.6.80-ai-mastering-expert-workspace',
  './assets/css/header-command-bar.css?v=1.6.80-ai-mastering-expert-workspace',
  './assets/css/components/support-settings.css?v=1.6.80-ai-mastering-expert-workspace',
  './assets/css/components/modal-close-system.css?v=1.6.80-ai-mastering-expert-workspace',
  './vendor/jszip/jszip.min.js?v=1.6.80-ai-mastering-expert-workspace&lib=3.10.1',
  './src/config/build-info.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/boot/release-presentation-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/boot/runtime-fault-counters.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/boot/session-handoff-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/boot/incident-route-policy.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/boot/incident-submission-identity-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/firebase-bootstrap.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/boot/incident-support-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/boot/incident-state-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/boot/incident-mail-sync-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/boot/incident-lifecycle-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/boot/incident-recovery-sweep-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/boot/incident-service-recovery-controller.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/boot/incident-recovery-policy.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/boot/incident-local-queue-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/boot/incident-queue-coordination-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/boot/incident-service-diagnostics.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/boot/incident-diagnostics-view-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/boot/incident-controls-view-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/boot/incident-reporter.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/config/mastering-presets.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/config/genre-presets.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/config/reference-targets.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/config/app-runtime-config.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/config/pwa-share-policy.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/state/app-state.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/settings/settings-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/utils/core-utils.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/utils/worker-job-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/recommendation/recommendation-engine.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/audio/mastering-inspector.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/audio/highlight-compare-inspector.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/audio/playback-link-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/audio/playback-transition-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/audio/playback-source-recovery-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/audio/playback-lifecycle-recovery-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/audio/post-master-playback-recovery-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/audio/audio-context-manager.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/audio/preview-translation-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/audio/audio-import-capability-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/audio/audio-decode-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/audio/inapp-mastering-safety-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/audio/import-preflight-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/audio/import-queue-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/audio/analysis-cache-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/audio/memory-guard-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/audio/mastering-memory-diagnostics-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/audio/reference-profile-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/audio/loudness-measurement-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/audio/mastering-input-guard-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/audio/mastering-quality-audit-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/audio/quality-gate-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/audio/mastering-orchestrator-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/audio/master-preview-job-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/state/track-lifecycle-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/audio/waveform-control-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/ui/waveform-control-view.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/ui/spectrum-visualizer.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/ui/modal-controller.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/ui/ui-mode-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/ui/dock-controller.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/ui/mobile-native-view.js?v=1.6.80-ai-mastering-expert-workspace&h=bulk-hud-restore-v153',
  './src/ui/admin-access-controller.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/download/file-name-policy-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/download/file-name-workflow-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/download/download-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/download/export-guard-service.js?v=1.6.80-ai-mastering-expert-workspace&h=export-v156',
  './src/download/export-progress-view.js?v=1.6.80-ai-mastering-expert-workspace&h=export-progress-v156',
  './src/download/zip-export-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/download/export-queue-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/ui/download-dialog-view.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/ui/bulk-import-hud-view.js?v=1.6.80-ai-mastering-expert-workspace&h=bulk-hud-v153',
  './src/ui/waveform-compare-view.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/ui/detail-panels-view.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/ui/detail-view.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/ui/admin-incident-monitor-view.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/security/site-guards.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/boot/runtime-health.js?v=1.6.80-ai-mastering-expert-workspace&h=boot-sri-v1680',
  './src/boot/ui-shell-recovery-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/boot/update-safety-service.js?v=1.6.80-ai-mastering-expert-workspace&h=update-safety-v1680',
  './src/boot/service-worker-update-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/boot/service-worker-recovery-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/boot/worker-recovery-coordinator.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/boot/performance-diagnostics.js?v=1.6.80-ai-mastering-expert-workspace&h=boot-sri-v1680',
  './src/boot/render-scheduler.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/boot/pwa-share-target-service.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/boot/pwa-runtime-bridge.js?v=1.6.80-ai-mastering-expert-workspace',
  './src/app.js?v=1.6.80-ai-mastering-expert-workspace&h=boot-sri-v1680',
  './src/boot/worker-recovery-app-bridge.js?v=1.6.80-ai-mastering-expert-workspace',
  './assets/icons/foxbear-music.png?v=1.6.80-ai-mastering-expert-workspace'
];
