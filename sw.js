...
const CORE_ASSETS = [
  ...
  './src/security/trusted-types-bootstrap.js?v=1.6.56-playback-blob-source-resilience',
  './src/boot/kakao-entry-guard.js?v=1.6.56-playback-blob-source-resilience',
  './src/boot/kakao-entry-notice.js?v=1.6.56-playback-blob-source-resilience',
  ...
  './src/workers/wav-encoder.worker.js?v=1.6.56-playback-blob-source-resilience',
  './src/workers/mp3-encoder.worker.js?v=1.6.56-playback-blob-source-resilience',
  './src/workers/analysis.worker.js?v=1.6.56-playback-blob-source-resilience',
  './src/workers/master-finalizer.worker.js?v=1.6.56-playback-blob-source-resilience',
  './src/workers/pitch-wsola.worker.js?v=1.6.56-playback-blob-source-resilience',
  './src/workers/zip-encoder.worker.js?v=1.6.56-playback-blob-source-resilience',
  ...
  './assets/icons/foxbear-icon-16.png?v=1.6.56-playback-blob-source-resilience',
  './assets/icons/foxbear-icon-32.png?v=1.6.56-playback-blob-source-resilience',
  './assets/icons/foxbear-icon-192.png?v=1.6.56-playback-blob-source-resilience',
  './assets/icons/foxbear-icon-512.png?v=1.6.56-playback-blob-source-resilience',
  './assets/icons/apple-touch-icon.png?v=1.6.56-playback-blob-source-resilience',
  './manifest.webmanifest?v=1.6.56-playback-blob-source-resilience',
  './assets/css/boot/performance-diagnostics.css?v=1.6.56-playback-blob-source-resilience',
  './assets/css/boot/runtime-health.css?v=1.6.56-playback-blob-source-resilience',
  './assets/css/boot/ui-shell-recovery.css?v=1.6.56-playback-blob-source-resilience',
  './assets/css/boot/kakao-entry-notice.css?v=1.6.56-playback-blob-source-resilience',
  './assets/css/theme.css?v=1.6.56-playback-blob-source-resilience',
  './assets/css/layout.css?v=1.6.56-playback-blob-source-resilience',
  './assets/css/components/base-components.css?v=1.6.56-playback-blob-source-resilience',
  './assets/css/components/forms.css?v=1.6.56-playback-blob-source-resilience',
  './assets/css/components/cards.css?v=1.6.56-playback-blob-source-resilience',
  './assets/css/components/preview-system.css?v=1.6.56-playback-blob-source-resilience',
  './assets/css/components/playback-link.css?v=1.6.56-playback-blob-source-resilience',
  './assets/css/studio.css?v=1.6.56-playback-blob-source-resilience',
  './assets/css/components/admin-incident-monitor.css?v=1.6.56-playback-blob-source-resilience',
  './assets/css/dock.css?v=1.6.56-playback-blob-source-resilience',
  './assets/css/dock-waveform.css?v=1.6.56-playback-blob-source-resilience',
  './assets/css/waveform-compare.css?v=1.6.56-playback-blob-source-resilience',
  './assets/css/spectrum-visualizer.css?v=1.6.56-playback-blob-source-resilience',
  './assets/css/export.css?v=1.6.56-playback-blob-source-resilience&h=export-progress-v156',
  './assets/css/download-dialog.css?v=1.6.56-playback-blob-source-resilience',
  './assets/css/bulk-import-hud.css?v=1.6.56-playback-blob-source-resilience&h=bulk-hud-close-hotfix&ui=v153',
  './assets/css/mobile-native.css?v=1.6.56-playback-blob-source-resilience',
  './assets/css/dock-ui-repair.css?v=1.6.56-playback-blob-source-resilience',
  './assets/css/components/floating-overlays.css?v=1.6.56-playback-blob-source-resilience',
  './assets/css/header-command-bar.css?v=1.6.56-playback-blob-source-resilience',
  './assets/css/components/support-settings.css?v=1.6.56-playback-blob-source-resilience',
  './assets/css/components/modal-close-system.css?v=1.6.56-playback-blob-source-resilience',
  './vendor/jszip/jszip.min.js?v=1.6.56-playback-blob-source-resilience&lib=3.10.1',
  './src/config/build-info.js?v=1.6.56-playback-blob-source-resilience',
  './src/boot/release-presentation-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/boot/session-handoff-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/boot/incident-route-policy.js?v=1.6.56-playback-blob-source-resilience',
  './src/boot/incident-submission-identity-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/firebase-bootstrap.js?v=1.6.56-playback-blob-source-resilience',
  './src/boot/incident-support-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/boot/incident-state-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/boot/incident-mail-sync-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/boot/incident-lifecycle-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/boot/incident-recovery-sweep-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/boot/incident-service-recovery-controller.js?v=1.6.56-playback-blob-source-resilience',
  './src/boot/incident-recovery-policy.js?v=1.6.56-playback-blob-source-resilience',
  './src/boot/incident-local-queue-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/boot/incident-queue-coordination-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/boot/incident-service-diagnostics.js?v=1.6.56-playback-blob-source-resilience',
  './src/boot/incident-diagnostics-view-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/boot/incident-controls-view-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/boot/incident-reporter.js?v=1.6.56-playback-blob-source-resilience',
  './src/config/mastering-presets.js?v=1.6.56-playback-blob-source-resilience',
  './src/config/genre-presets.js?v=1.6.56-playback-blob-source-resilience',
  './src/config/reference-targets.js?v=1.6.56-playback-blob-source-resilience',
  './src/config/app-runtime-config.js?v=1.6.56-playback-blob-source-resilience',
  './src/state/app-state.js?v=1.6.56-playback-blob-source-resilience',
  './src/settings/settings-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/utils/core-utils.js?v=1.6.56-playback-blob-source-resilience',
  './src/utils/worker-job-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/recommendation/recommendation-engine.js?v=1.6.56-playback-blob-source-resilience',
  './src/audio/mastering-inspector.js?v=1.6.56-playback-blob-source-resilience',
  './src/audio/highlight-compare-inspector.js?v=1.6.56-playback-blob-source-resilience',
  './src/audio/playback-link-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/audio/playback-transition-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/audio/playback-source-recovery-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/audio/playback-lifecycle-recovery-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/audio/post-master-playback-recovery-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/audio/audio-context-manager.js?v=1.6.56-playback-blob-source-resilience',
  './src/audio/preview-translation-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/audio/audio-import-capability-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/audio/audio-decode-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/audio/inapp-mastering-safety-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/audio/import-preflight-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/audio/import-queue-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/audio/analysis-cache-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/audio/memory-guard-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/audio/mastering-memory-diagnostics-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/audio/reference-profile-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/audio/loudness-measurement-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/audio/mastering-input-guard-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/audio/mastering-quality-audit-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/audio/quality-gate-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/audio/mastering-orchestrator-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/audio/master-preview-job-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/state/track-lifecycle-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/audio/waveform-control-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/ui/waveform-control-view.js?v=1.6.56-playback-blob-source-resilience',
  './src/ui/spectrum-visualizer.js?v=1.6.56-playback-blob-source-resilience',
  './src/ui/modal-controller.js?v=1.6.56-playback-blob-source-resilience',
  './src/ui/dock-controller.js?v=1.6.56-playback-blob-source-resilience',
  './src/ui/mobile-native-view.js?v=1.6.56-playback-blob-source-resilience&h=bulk-hud-restore-v153',
  './src/ui/admin-access-controller.js?v=1.6.56-playback-blob-source-resilience',
  './src/download/download-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/download/export-guard-service.js?v=1.6.56-playback-blob-source-resilience&h=export-v156',
  './src/download/export-progress-view.js?v=1.6.56-playback-blob-source-resilience&h=export-progress-v156',
  './src/download/zip-export-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/download/export-queue-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/ui/download-dialog-view.js?v=1.6.56-playback-blob-source-resilience',
  './src/ui/bulk-import-hud-view.js?v=1.6.56-playback-blob-source-resilience&h=bulk-hud-v153',
  './src/ui/waveform-compare-view.js?v=1.6.56-playback-blob-source-resilience',
  './src/ui/detail-panels-view.js?v=1.6.56-playback-blob-source-resilience',
  './src/ui/detail-view.js?v=1.6.56-playback-blob-source-resilience',
  './src/ui/admin-incident-monitor-view.js?v=1.6.56-playback-blob-source-resilience',
  './src/security/site-guards.js?v=1.6.56-playback-blob-source-resilience',
  './src/boot/runtime-health.js?v=1.6.56-playback-blob-source-resilience&h=boot-sri-v1656-playback-source',
  './src/boot/ui-shell-recovery-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/boot/update-safety-service.js?v=1.6.56-playback-blob-source-resilience&h=update-safety-v1656-playback-source',
  './src/boot/service-worker-update-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/boot/service-worker-recovery-service.js?v=1.6.56-playback-blob-source-resilience',
  './src/boot/worker-recovery-coordinator.js?v=1.6.56-playback-blob-source-resilience',
  './src/boot/performance-diagnostics.js?v=1.6.56-playback-blob-source-resilience&h=boot-sri-v1656-playback-source',
  './src/boot/render-scheduler.js?v=1.6.56-playback-blob-source-resilience',
  './src/app.js?v=1.6.56-playback-blob-source-resilience&h=boot-sri-v1656-playback-source',
  './src/boot/worker-recovery-app-bridge.js?v=1.6.56-playback-blob-source-resilience',
  './assets/icons/foxbear-music.png?v=1.6.56-playback-blob-source-resilience'
];
