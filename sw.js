// FoxBear AI Mastering Studio Pro v1.7.4 service worker · reload-reentry-mode-chooser
'use strict';

function loadSharePolicy() {
  try {
    if (typeof importScripts === 'function') importScripts('./src/config/pwa-share-policy.js?v=1.7.4-reload-reentry-mode-chooser');
  } catch (error) {
...
const CACHE_NAME = 'foxbear-shell-v1.7.4-reload-reentry-mode-chooser';
const CURRENT_ASSET_VERSION = '1.7.4-reload-reentry-mode-chooser';
const LEGACY_CACHE_NAMES = ['foxbear-shell-v1.5.4-boot-sri-recovery', 'foxbear-shell-v1.5.5-update-safety', 'foxbear-shell-v1.5.6-export-progress-recovery', 'foxbear-shell-v1.6.99-header-role-focus-integrity', 'foxbear-shell-v1.6.100-sw-stereo-ci-cleanup-hardening', 'foxbear-shell-v1.6.101-admin-lazyload-repo-cleanup', 'foxbear-shell-v1.6.102-admin-lazyload-sw-hygiene-hardening', 'foxbear-shell-v1.6.103-ci-hygiene-mail-routing-hardening', 'foxbear-shell-v1.6.104-boot-emergency-visit-privacy-hardening', 'foxbear-shell-v1.6.105-header-dock-css-ownership-hardening', 'foxbear-shell-v1.6.106-browser-geometry-history-recovery', 'foxbear-shell-v1.6.107-boot-payload-phase1', 'foxbear-shell-v1.6.108-mastering-progress-visibility-hardening', 'foxbear-shell-v1.6.109-mastering-cooperative-pcm-responsiveness', 'foxbear-shell-v1.6.110-ui-mode-early-boot-recovery', 'foxbear-shell-v1.6.111-ui-mode-session-contract-hardening', 'foxbear-shell-v1.6.112-mastering-lifecycle-race-hardening', 'foxbear-shell-v1.6.113-incident-finalizer-p1-hardening', 'foxbear-shell-v1.6.114-reference-profile-64band-upgrade', 'foxbear-shell-v1.7.0-adaptive-mastering-decision-phase1', 'foxbear-shell-v1.7.1-reference-match-2-phase1', 'foxbear-shell-v1.7.2-expert-workspace-default-entry', 'foxbear-shell-v1.7.3-reference-match-inspector'];
...
const CORE_ASSETS = [
  ...
  './index.html',
  './404.html',
  './assets/css/route-recovery.css?v=1.7.4-reload-reentry-mode-chooser',
  './src/boot/route-recovery.js?v=1.7.4-reload-reentry-mode-chooser',
  './foxbear-root.json',
  './external-browser.html',
  './assets/css/external-browser.css?v=1.7.4-reload-reentry-mode-chooser',
  './design-preview.html',
  './assets/css/design-preview.css?v=1.7.4-reload-reentry-mode-chooser',
  ...
  './src/security/trusted-types-bootstrap.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/boot/kakao-entry-guard.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/boot/kakao-entry-notice.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/boot/kakao-external-browser.js?v=1.7.4-reload-reentry-mode-chooser',
  ...
  './src/workers/wav-encoder.worker.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/workers/mp3-encoder.worker.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/workers/analysis.worker.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/workers/master-finalizer.worker.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/workers/pitch-wsola.worker.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/workers/zip-encoder.worker.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/engines/pitch-engine-adapter.js',
  './assets/icons/foxbear-icon-48.png?v=1.7.4-reload-reentry-mode-chooser',
  './assets/icons/foxbear-icon-72.png?v=1.7.4-reload-reentry-mode-chooser',
  './assets/icons/foxbear-icon-96.png?v=1.7.4-reload-reentry-mode-chooser',
  './assets/icons/foxbear-icon-128.png?v=1.7.4-reload-reentry-mode-chooser',
  './assets/icons/foxbear-icon-144.png?v=1.7.4-reload-reentry-mode-chooser',
  './assets/icons/foxbear-icon-152.png?v=1.7.4-reload-reentry-mode-chooser',
  './assets/icons/foxbear-icon-180.png?v=1.7.4-reload-reentry-mode-chooser',
  './assets/icons/foxbear-icon-192.png?v=1.7.4-reload-reentry-mode-chooser',
  './assets/icons/foxbear-icon-384.png?v=1.7.4-reload-reentry-mode-chooser',
  './assets/icons/foxbear-icon-512.png?v=1.7.4-reload-reentry-mode-chooser',
  './assets/icons/foxbear-icon-16.png?v=1.7.4-reload-reentry-mode-chooser',
  './assets/icons/foxbear-icon-32.png?v=1.7.4-reload-reentry-mode-chooser',
  './assets/icons/apple-touch-icon.png?v=1.7.4-reload-reentry-mode-chooser',
  './manifest.webmanifest?v=1.7.4-reload-reentry-mode-chooser',
  './assets/css/boot/performance-diagnostics.css?v=1.7.4-reload-reentry-mode-chooser',
  './assets/css/boot/runtime-health.css?v=1.7.4-reload-reentry-mode-chooser',
  './assets/css/boot/ui-shell-recovery.css?v=1.7.4-reload-reentry-mode-chooser',
  './assets/css/boot/kakao-entry-notice.css?v=1.7.4-reload-reentry-mode-chooser',
  './assets/css/theme.css?v=1.7.4-reload-reentry-mode-chooser',
  './assets/css/layout.css?v=1.7.4-reload-reentry-mode-chooser',
  './assets/css/components/base-components.css?v=1.7.4-reload-reentry-mode-chooser',
  './assets/css/components/forms.css?v=1.7.4-reload-reentry-mode-chooser',
  './assets/css/components/cards.css?v=1.7.4-reload-reentry-mode-chooser',
  './assets/css/components/preview-system.css?v=1.7.4-reload-reentry-mode-chooser',
  './assets/css/components/playback-link.css?v=1.7.4-reload-reentry-mode-chooser',
  './assets/css/studio.css?v=1.7.4-reload-reentry-mode-chooser',
  './assets/css/ui-mode.css?v=1.7.4-reload-reentry-mode-chooser',
  './assets/css/dock.css?v=1.7.4-reload-reentry-mode-chooser',
  './assets/css/dock-waveform.css?v=1.7.4-reload-reentry-mode-chooser',
  './assets/css/waveform-compare.css?v=1.7.4-reload-reentry-mode-chooser',
  './assets/css/export.css?v=1.7.4-reload-reentry-mode-chooser&h=export-progress-v156',
  './assets/css/download-dialog.css?v=1.7.4-reload-reentry-mode-chooser',
  './assets/css/bulk-import-hud.css?v=1.7.4-reload-reentry-mode-chooser&h=bulk-hud-close-hotfix&ui=v153',
  './assets/css/mobile-native.css?v=1.7.4-reload-reentry-mode-chooser',
  './assets/css/dock-ui-repair.css?v=1.7.4-reload-reentry-mode-chooser',
  './assets/css/components/floating-overlays.css?v=1.7.4-reload-reentry-mode-chooser',
  './assets/css/header-command-bar.css?v=1.7.4-reload-reentry-mode-chooser',
  './assets/css/components/support-settings.css?v=1.7.4-reload-reentry-mode-chooser',
  './assets/css/components/modal-close-system.css?v=1.7.4-reload-reentry-mode-chooser',
  './vendor/jszip/jszip.min.js?v=1.7.4-reload-reentry-mode-chooser&lib=3.10.1',
  './src/config/build-info.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/boot/release-presentation-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/boot/runtime-fault-counters.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/boot/session-handoff-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/boot/incident-route-policy.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/boot/incident-submission-identity-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/firebase-bootstrap.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/boot/incident-support-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/boot/incident-state-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/boot/incident-mail-sync-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/boot/incident-lifecycle-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/boot/incident-recovery-sweep-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/boot/incident-service-recovery-controller.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/boot/incident-recovery-policy.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/boot/incident-local-queue-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/boot/incident-queue-coordination-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/boot/incident-service-diagnostics.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/boot/incident-diagnostics-view-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/boot/incident-controls-view-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/boot/incident-reporter.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/config/mastering-presets.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/config/genre-presets.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/config/reference-targets.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/config/app-runtime-config.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/config/pwa-share-policy.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/state/app-state.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/settings/settings-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/utils/core-utils.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/utils/worker-job-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/recommendation/recommendation-engine.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/audio/mastering-inspector.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/audio/highlight-compare-inspector.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/audio/playback-link-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/audio/playback-transition-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/audio/playback-source-recovery-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/audio/playback-lifecycle-recovery-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/audio/post-master-playback-recovery-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/audio/audio-context-manager.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/audio/preview-translation-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/audio/audio-import-capability-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/audio/audio-decode-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/audio/inapp-mastering-safety-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/audio/import-preflight-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/audio/import-queue-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/audio/analysis-cache-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/audio/memory-guard-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/audio/mastering-memory-diagnostics-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/audio/reference-profile-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/audio/loudness-measurement-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/audio/mastering-input-guard-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/audio/mastering-quality-audit-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/audio/quality-gate-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/audio/mastering-orchestrator-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/audio/master-preview-job-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/audio/master-finalizer-fallback-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/state/track-lifecycle-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/audio/waveform-control-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/ui/waveform-control-view.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/ui/modal-controller.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/ui/engine-control-interaction-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/ui/ui-mode-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/ui/bottom-preview-dock-integrity-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/ui/dock-controller.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/ui/mobile-native-view.js?v=1.7.4-reload-reentry-mode-chooser&h=bulk-hud-restore-v153',
  './src/ui/admin-access-controller.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/download/file-name-policy-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/download/file-name-workflow-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/download/download-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/download/export-guard-service.js?v=1.7.4-reload-reentry-mode-chooser&h=export-v156',
  './src/download/export-progress-view.js?v=1.7.4-reload-reentry-mode-chooser&h=export-progress-v156',
  './src/download/zip-export-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/download/export-queue-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/ui/download-dialog-view.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/ui/bulk-import-hud-view.js?v=1.7.4-reload-reentry-mode-chooser&h=bulk-hud-v153',
  './src/ui/waveform-compare-view.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/ui/detail-panels-view.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/ui/detail-view.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/ui/admin-incident-loader-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/security/site-guards.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/boot/runtime-health.js?v=1.7.4-reload-reentry-mode-chooser&h=boot-sri-v174',
  './src/boot/ui-shell-recovery-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/boot/update-safety-service.js?v=1.7.4-reload-reentry-mode-chooser&h=update-safety-v174',
  './src/boot/service-worker-update-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/boot/service-worker-recovery-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/boot/worker-recovery-coordinator.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/boot/performance-diagnostics.js?v=1.7.4-reload-reentry-mode-chooser&h=boot-sri-v174',
  './src/boot/render-scheduler.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/boot/pwa-share-target-service.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/boot/pwa-runtime-bridge.js?v=1.7.4-reload-reentry-mode-chooser',
  './src/app.js?v=1.7.4-reload-reentry-mode-chooser&h=boot-sri-v174',
  './src/boot/worker-recovery-app-bridge.js?v=1.7.4-reload-reentry-mode-chooser',
  './assets/icons/foxbear-music.png?v=1.7.4-reload-reentry-mode-chooser'
];
