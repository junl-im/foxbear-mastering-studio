...
const CORE_ASSETS = [
  ...
  './assets/icons/foxbear-icon-16.png?v=1.5.33-codec-truth-download-hardening',
  './assets/icons/foxbear-icon-32.png?v=1.5.33-codec-truth-download-hardening',
  './assets/icons/foxbear-icon-192.png?v=1.5.33-codec-truth-download-hardening',
  './assets/icons/foxbear-icon-512.png?v=1.5.33-codec-truth-download-hardening',
  './assets/icons/apple-touch-icon.png?v=1.5.33-codec-truth-download-hardening',
  './manifest.webmanifest?v=1.5.33-codec-truth-download-hardening',
  './assets/css/boot/performance-diagnostics.css?v=1.5.33-codec-truth-download-hardening',
  './assets/css/boot/runtime-health.css?v=1.5.33-codec-truth-download-hardening',
  './assets/css/theme.css?v=1.5.33-codec-truth-download-hardening',
  './assets/css/layout.css?v=1.5.33-codec-truth-download-hardening',
  './assets/css/components/base-components.css?v=1.5.33-codec-truth-download-hardening',
  './assets/css/components/forms.css?v=1.5.33-codec-truth-download-hardening',
  './assets/css/components/cards.css?v=1.5.33-codec-truth-download-hardening',
  './assets/css/components/preview-system.css?v=1.5.33-codec-truth-download-hardening',
  './assets/css/components/playback-link.css?v=1.5.33-codec-truth-download-hardening',
  './assets/css/studio.css?v=1.5.33-codec-truth-download-hardening',
  './assets/css/dock.css?v=1.5.33-codec-truth-download-hardening',
  './assets/css/dock-waveform.css?v=1.5.33-codec-truth-download-hardening',
  './assets/css/waveform-compare.css?v=1.5.33-codec-truth-download-hardening',
  './assets/css/spectrum-visualizer.css?v=1.5.33-codec-truth-download-hardening',
  './assets/css/export.css?v=1.5.33-codec-truth-download-hardening&h=export-progress-v156',
  './assets/css/download-dialog.css?v=1.5.33-codec-truth-download-hardening',
  './assets/css/bulk-import-hud.css?v=1.5.33-codec-truth-download-hardening&h=bulk-hud-close-hotfix&ui=v153',
  './assets/css/mobile-native.css?v=1.5.33-codec-truth-download-hardening',
  './assets/css/dock-ui-repair.css?v=1.5.33-codec-truth-download-hardening',
  './assets/css/components/floating-overlays.css?v=1.5.33-codec-truth-download-hardening',
  './assets/css/header-command-bar.css?v=1.5.33-codec-truth-download-hardening',
  './vendor/jszip/jszip.min.js?v=3.10.1',
  './src/config/build-info.js?v=1.5.33-codec-truth-download-hardening',
  './src/boot/release-presentation-service.js?v=1.5.33-codec-truth-download-hardening',
  './src/firebase-bootstrap.js?v=1.5.33-codec-truth-download-hardening',
  './src/config/mastering-presets.js?v=1.5.33-codec-truth-download-hardening',
  './src/config/genre-presets.js?v=1.5.33-codec-truth-download-hardening',
  './src/config/reference-targets.js?v=1.5.33-codec-truth-download-hardening',
  './src/config/app-runtime-config.js?v=1.5.33-codec-truth-download-hardening',
  './src/state/app-state.js?v=1.5.33-codec-truth-download-hardening',
  './src/settings/settings-service.js?v=1.5.33-codec-truth-download-hardening',
  './src/utils/core-utils.js?v=1.5.33-codec-truth-download-hardening',
  './src/recommendation/recommendation-engine.js?v=1.5.33-codec-truth-download-hardening',
  './src/audio/mastering-inspector.js?v=1.5.33-codec-truth-download-hardening',
  './src/audio/highlight-compare-inspector.js?v=1.5.33-codec-truth-download-hardening',
  './src/audio/playback-link-service.js?v=1.5.33-codec-truth-download-hardening',
  './src/audio/playback-transition-service.js?v=1.5.33-codec-truth-download-hardening',
  './src/audio/audio-context-manager.js?v=1.5.33-codec-truth-download-hardening',
  './src/audio/preview-translation-service.js?v=1.5.33-codec-truth-download-hardening',
  './src/audio/audio-import-capability-service.js?v=1.5.33-codec-truth-download-hardening',
  './src/audio/audio-decode-service.js?v=1.5.33-codec-truth-download-hardening',
  './src/audio/import-queue-service.js?v=1.5.33-codec-truth-download-hardening',
  './src/audio/analysis-cache-service.js?v=1.5.33-codec-truth-download-hardening',
  './src/audio/memory-guard-service.js?v=1.5.33-codec-truth-download-hardening',
  './src/audio/reference-profile-service.js?v=1.5.33-codec-truth-download-hardening',
  './src/audio/quality-gate-service.js?v=1.5.33-codec-truth-download-hardening',
  './src/audio/mastering-orchestrator-service.js?v=1.5.33-codec-truth-download-hardening',
  './src/state/track-lifecycle-service.js?v=1.5.33-codec-truth-download-hardening',
  './src/audio/waveform-control-service.js?v=1.5.33-codec-truth-download-hardening',
  './src/ui/waveform-control-view.js?v=1.5.33-codec-truth-download-hardening',
  './src/ui/spectrum-visualizer.js?v=1.5.33-codec-truth-download-hardening',
  './src/ui/modal-controller.js?v=1.5.33-codec-truth-download-hardening',
  './src/ui/dock-controller.js?v=1.5.33-codec-truth-download-hardening',
  './src/ui/mobile-native-view.js?v=1.5.33-codec-truth-download-hardening&h=bulk-hud-restore-v153',
  './src/download/download-service.js?v=1.5.33-codec-truth-download-hardening',
  './src/download/export-guard-service.js?v=1.5.33-codec-truth-download-hardening&h=export-v156',
  './src/download/export-progress-view.js?v=1.5.33-codec-truth-download-hardening&h=export-progress-v156',
  './src/ui/download-dialog-view.js?v=1.5.33-codec-truth-download-hardening',
  './src/ui/bulk-import-hud-view.js?v=1.5.33-codec-truth-download-hardening&h=bulk-hud-v153',
  './src/ui/waveform-compare-view.js?v=1.5.33-codec-truth-download-hardening',
  './src/ui/detail-panels-view.js?v=1.5.33-codec-truth-download-hardening',
  './src/ui/detail-view.js?v=1.5.33-codec-truth-download-hardening',
  './src/security/site-guards.js?v=1.5.33-codec-truth-download-hardening',
  './src/boot/runtime-health.js?v=1.5.33-codec-truth-download-hardening&h=boot-sri-v1533',
  './src/boot/update-safety-service.js?v=1.5.33-codec-truth-download-hardening&h=update-safety-v1533',
  './src/boot/service-worker-update-service.js?v=1.5.33-codec-truth-download-hardening',
  './src/boot/performance-diagnostics.js?v=1.5.33-codec-truth-download-hardening&h=boot-sri-v1533',
  './src/boot/render-scheduler.js?v=1.5.33-codec-truth-download-hardening',
  './src/app.js?v=1.5.33-codec-truth-download-hardening&h=boot-sri-v1533',
  './assets/icons/foxbear-music.png?v=1.5.33-codec-truth-download-hardening'
];
