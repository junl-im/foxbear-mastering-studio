...
const CORE_ASSETS = [
  ...
  './assets/icons/foxbear-icon-16.png?v=1.4.26-wake-lock-state-sync',
  './assets/icons/foxbear-icon-32.png?v=1.4.26-wake-lock-state-sync',
  './assets/icons/foxbear-icon-192.png?v=1.4.26-wake-lock-state-sync',
  './assets/icons/foxbear-icon-512.png?v=1.4.26-wake-lock-state-sync',
  './assets/icons/apple-touch-icon.png?v=1.4.26-wake-lock-state-sync',
  './manifest.webmanifest?v=1.4.26-wake-lock-state-sync',
  './assets/css/boot/performance-diagnostics.css?v=1.4.26-wake-lock-state-sync',
  './assets/css/boot/runtime-health.css?v=1.4.26-wake-lock-state-sync',
  './assets/css/theme.css?v=1.4.26-wake-lock-state-sync',
  './assets/css/layout.css?v=1.4.26-wake-lock-state-sync',
  './assets/css/components/base-components.css?v=1.4.26-wake-lock-state-sync',
  './assets/css/components/forms.css?v=1.4.26-wake-lock-state-sync',
  './assets/css/components/cards.css?v=1.4.26-wake-lock-state-sync',
  './assets/css/components/preview-system.css?v=1.4.26-wake-lock-state-sync',
  './assets/css/components/playback-link.css?v=1.4.26-wake-lock-state-sync',
  './assets/css/studio.css?v=1.4.26-wake-lock-state-sync',
  './assets/css/dock.css?v=1.4.26-wake-lock-state-sync',
  ...
  './src/firebase-bootstrap.js?v=1.4.26-wake-lock-state-sync',
  './src/config/mastering-presets.js?v=1.4.26-wake-lock-state-sync',
  './src/config/genre-presets.js?v=1.4.26-wake-lock-state-sync',
  './src/config/reference-targets.js?v=1.4.26-wake-lock-state-sync',
  './src/config/app-runtime-config.js?v=1.4.26-wake-lock-state-sync',
  './src/state/app-state.js?v=1.4.26-wake-lock-state-sync',
  './src/settings/settings-service.js?v=1.4.26-wake-lock-state-sync',
  './src/utils/core-utils.js?v=1.4.26-wake-lock-state-sync',
  './src/recommendation/recommendation-engine.js?v=1.4.26-wake-lock-state-sync',
  './src/audio/mastering-inspector.js?v=1.4.26-wake-lock-state-sync',
  './src/audio/highlight-compare-inspector.js?v=1.4.26-wake-lock-state-sync',
