// FoxBear AI Mastering Studio Pro v1.6.89 service worker · mobile-header-flex-ownership-browser-gate-recovery
'use strict';

function loadSharePolicy() {
  try {
    if (typeof importScripts === 'function') importScripts('./src/config/pwa-share-policy.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery');
  } catch (error) {
...
const CORE_ASSETS = [
  ...
  './index.html',
  './404.html',
  './assets/css/route-recovery.css?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/boot/route-recovery.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './foxbear-root.json',
  './external-browser.html',
  './assets/css/external-browser.css?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './design-preview.html',
  './assets/css/design-preview.css?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  ...
  './src/security/trusted-types-bootstrap.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/boot/kakao-entry-guard.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/boot/kakao-entry-notice.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/boot/kakao-external-browser.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  ...
  './src/workers/wav-encoder.worker.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/workers/mp3-encoder.worker.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/workers/analysis.worker.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/workers/master-finalizer.worker.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/workers/pitch-wsola.worker.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/workers/zip-encoder.worker.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/engines/pitch-engine-adapter.js',
  './assets/icons/foxbear-icon-48.png?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/icons/foxbear-icon-72.png?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/icons/foxbear-icon-96.png?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/icons/foxbear-icon-128.png?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/icons/foxbear-icon-144.png?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/icons/foxbear-icon-152.png?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/icons/foxbear-icon-180.png?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/icons/foxbear-icon-192.png?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/icons/foxbear-icon-384.png?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/icons/foxbear-icon-512.png?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/icons/foxbear-icon-16.png?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/icons/foxbear-icon-32.png?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/icons/apple-touch-icon.png?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './manifest.webmanifest?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/css/boot/performance-diagnostics.css?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/css/boot/runtime-health.css?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/css/boot/ui-shell-recovery.css?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/css/boot/kakao-entry-notice.css?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/css/theme.css?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/css/layout.css?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/css/components/base-components.css?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/css/components/forms.css?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/css/components/cards.css?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/css/components/preview-system.css?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/css/components/playback-link.css?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/css/studio.css?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/css/ui-mode.css?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/css/components/admin-incident-monitor.css?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/css/dock.css?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/css/dock-waveform.css?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/css/waveform-compare.css?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/css/spectrum-visualizer.css?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/css/export.css?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery&h=export-progress-v156',
  './assets/css/download-dialog.css?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/css/bulk-import-hud.css?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery&h=bulk-hud-close-hotfix&ui=v153',
  './assets/css/mobile-native.css?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/css/dock-ui-repair.css?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/css/components/floating-overlays.css?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/css/header-command-bar.css?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/css/components/support-settings.css?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/css/components/modal-close-system.css?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './vendor/jszip/jszip.min.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery&lib=3.10.1',
  './src/config/build-info.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/boot/release-presentation-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/boot/runtime-fault-counters.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/boot/session-handoff-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/boot/incident-route-policy.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/boot/incident-submission-identity-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/firebase-bootstrap.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/boot/incident-support-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/boot/incident-state-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/boot/incident-mail-sync-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/boot/incident-lifecycle-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/boot/incident-recovery-sweep-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/boot/incident-service-recovery-controller.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/boot/incident-recovery-policy.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/boot/incident-local-queue-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/boot/incident-queue-coordination-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/boot/incident-service-diagnostics.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/boot/incident-diagnostics-view-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/boot/incident-controls-view-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/boot/incident-reporter.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/config/mastering-presets.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/config/genre-presets.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/config/reference-targets.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/config/app-runtime-config.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/config/pwa-share-policy.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/state/app-state.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/settings/settings-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/utils/core-utils.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/utils/worker-job-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/recommendation/recommendation-engine.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/audio/mastering-inspector.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/audio/highlight-compare-inspector.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/audio/playback-link-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/audio/playback-transition-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/audio/playback-source-recovery-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/audio/playback-lifecycle-recovery-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/audio/post-master-playback-recovery-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/audio/audio-context-manager.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/audio/preview-translation-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/audio/audio-import-capability-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/audio/audio-decode-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/audio/inapp-mastering-safety-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/audio/import-preflight-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/audio/import-queue-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/audio/analysis-cache-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/audio/memory-guard-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/audio/mastering-memory-diagnostics-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/audio/reference-profile-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/audio/loudness-measurement-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/audio/mastering-input-guard-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/audio/mastering-quality-audit-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/audio/quality-gate-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/audio/mastering-orchestrator-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/audio/master-preview-job-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/state/track-lifecycle-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/audio/waveform-control-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/ui/waveform-control-view.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/ui/spectrum-visualizer.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/ui/modal-controller.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/ui/ui-mode-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/ui/dock-controller.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/ui/mobile-native-view.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery&h=bulk-hud-restore-v153',
  './src/ui/admin-access-controller.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/download/file-name-policy-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/download/file-name-workflow-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/download/download-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/download/export-guard-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery&h=export-v156',
  './src/download/export-progress-view.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery&h=export-progress-v156',
  './src/download/zip-export-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/download/export-queue-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/ui/download-dialog-view.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/ui/bulk-import-hud-view.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery&h=bulk-hud-v153',
  './src/ui/waveform-compare-view.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/ui/detail-panels-view.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/ui/detail-view.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/ui/admin-incident-monitor-view.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/security/site-guards.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/boot/runtime-health.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery&h=boot-sri-v1689',
  './src/boot/ui-shell-recovery-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/boot/update-safety-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery&h=update-safety-v1689',
  './src/boot/service-worker-update-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/boot/service-worker-recovery-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/boot/worker-recovery-coordinator.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/boot/performance-diagnostics.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery&h=boot-sri-v1689',
  './src/boot/render-scheduler.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/boot/pwa-share-target-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/boot/pwa-runtime-bridge.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './src/app.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery&h=boot-sri-v1689',
  './src/boot/worker-recovery-app-bridge.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery',
  './assets/icons/foxbear-music.png?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery'
];
