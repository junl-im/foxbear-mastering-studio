// FoxBear AI Mastering Studio Pro v1.6.64 service worker · github-desktop-delivery-contract
'use strict';

const CACHE_NAME = 'foxbear-shell-v1.6.64-github-desktop-delivery-contract';
const CURRENT_ASSET_VERSION = '1.6.64-github-desktop-delivery-contract';
const LEGACY_CACHE_NAMES = ['foxbear-shell-v1.5.4-boot-sri-recovery', 'foxbear-shell-v1.5.5-update-safety', 'foxbear-shell-v1.5.6-export-progress-recovery', 'foxbear-shell-v1.6.44-google-auth-gapi-module-trusted-types-recovery', 'foxbear-shell-v1.6.45-windows-release-gate-spark-hosting-no-app-check', 'foxbear-shell-v1.6.46-google-auth-same-origin-network-recovery', 'foxbear-shell-v1.6.47-external-host-admin-auth-opaque-error-recovery', 'foxbear-shell-v1.6.48-post-master-download-format-quality', 'foxbear-shell-v1.6.49-download-variant-cache-reuse', 'foxbear-shell-v1.6.50-kakao-centered-entry-notice', 'foxbear-shell-v1.6.51-stability-concurrency-input-guard', 'foxbear-shell-v1.6.52-post-master-playback-readiness-recovery', 'foxbear-shell-v1.6.53-playback-crossfade-settlement-guard', 'foxbear-shell-v1.6.54-playback-intent-arbitration', 'foxbear-shell-v1.6.55-mobile-focus-resume-reconciliation', 'foxbear-shell-v1.6.56-playback-blob-source-resilience', 'foxbear-shell-v1.6.57-firebase-hosting-payload-boundary', 'foxbear-shell-v1.6.58-piano-transient-integrity', 'foxbear-shell-v1.6.59-readiness-corp-security-hardening', 'foxbear-shell-v1.6.60-bulk-zip-hud-navigation', 'foxbear-shell-v1.6.61-human-readable-download-filenames', 'foxbear-shell-v1.6.62-download-filename-preview-controls', 'foxbear-shell-v1.6.63-download-filename-review-hardening'];
...
const CORE_ASSETS = [
  ...
  './src/security/trusted-types-bootstrap.js?v=1.6.64-github-desktop-delivery-contract',
  './src/boot/kakao-entry-guard.js?v=1.6.64-github-desktop-delivery-contract',
  './src/boot/kakao-entry-notice.js?v=1.6.64-github-desktop-delivery-contract',
  ...
  './src/workers/wav-encoder.worker.js?v=1.6.64-github-desktop-delivery-contract',
  './src/workers/mp3-encoder.worker.js?v=1.6.64-github-desktop-delivery-contract',
  './src/workers/analysis.worker.js?v=1.6.64-github-desktop-delivery-contract',
  './src/workers/master-finalizer.worker.js?v=1.6.64-github-desktop-delivery-contract',
  './src/workers/pitch-wsola.worker.js?v=1.6.64-github-desktop-delivery-contract',
  './src/workers/zip-encoder.worker.js?v=1.6.64-github-desktop-delivery-contract',
  ...
  './assets/icons/foxbear-icon-16.png?v=1.6.64-github-desktop-delivery-contract',
  './assets/icons/foxbear-icon-32.png?v=1.6.64-github-desktop-delivery-contract',
  './assets/icons/foxbear-icon-192.png?v=1.6.64-github-desktop-delivery-contract',
  './assets/icons/foxbear-icon-512.png?v=1.6.64-github-desktop-delivery-contract',
  './assets/icons/apple-touch-icon.png?v=1.6.64-github-desktop-delivery-contract',
  './manifest.webmanifest?v=1.6.64-github-desktop-delivery-contract',
  './assets/css/boot/performance-diagnostics.css?v=1.6.64-github-desktop-delivery-contract',
  './assets/css/boot/runtime-health.css?v=1.6.64-github-desktop-delivery-contract',
  './assets/css/boot/ui-shell-recovery.css?v=1.6.64-github-desktop-delivery-contract',
  './assets/css/boot/kakao-entry-notice.css?v=1.6.64-github-desktop-delivery-contract',
  './assets/css/theme.css?v=1.6.64-github-desktop-delivery-contract',
  './assets/css/layout.css?v=1.6.64-github-desktop-delivery-contract',
  './assets/css/components/base-components.css?v=1.6.64-github-desktop-delivery-contract',
  './assets/css/components/forms.css?v=1.6.64-github-desktop-delivery-contract',
  './assets/css/components/cards.css?v=1.6.64-github-desktop-delivery-contract',
  './assets/css/components/preview-system.css?v=1.6.64-github-desktop-delivery-contract',
  './assets/css/components/playback-link.css?v=1.6.64-github-desktop-delivery-contract',
  './assets/css/studio.css?v=1.6.64-github-desktop-delivery-contract',
  './assets/css/components/admin-incident-monitor.css?v=1.6.64-github-desktop-delivery-contract',
  './assets/css/dock.css?v=1.6.64-github-desktop-delivery-contract',
  './assets/css/dock-waveform.css?v=1.6.64-github-desktop-delivery-contract',
  './assets/css/waveform-compare.css?v=1.6.64-github-desktop-delivery-contract',
  './assets/css/spectrum-visualizer.css?v=1.6.64-github-desktop-delivery-contract',
  './assets/css/export.css?v=1.6.64-github-desktop-delivery-contract&h=export-progress-v156',
  './assets/css/download-dialog.css?v=1.6.64-github-desktop-delivery-contract',
  './assets/css/bulk-import-hud.css?v=1.6.64-github-desktop-delivery-contract&h=bulk-hud-close-hotfix&ui=v153',
  './assets/css/mobile-native.css?v=1.6.64-github-desktop-delivery-contract',
  './assets/css/dock-ui-repair.css?v=1.6.64-github-desktop-delivery-contract',
  './assets/css/components/floating-overlays.css?v=1.6.64-github-desktop-delivery-contract',
  './assets/css/header-command-bar.css?v=1.6.64-github-desktop-delivery-contract',
  './assets/css/components/support-settings.css?v=1.6.64-github-desktop-delivery-contract',
  './assets/css/components/modal-close-system.css?v=1.6.64-github-desktop-delivery-contract',
  './vendor/jszip/jszip.min.js?v=1.6.64-github-desktop-delivery-contract&lib=3.10.1',
  './src/config/build-info.js?v=1.6.64-github-desktop-delivery-contract',
  './src/boot/release-presentation-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/boot/session-handoff-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/boot/incident-route-policy.js?v=1.6.64-github-desktop-delivery-contract',
  './src/boot/incident-submission-identity-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/firebase-bootstrap.js?v=1.6.64-github-desktop-delivery-contract',
  './src/boot/incident-support-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/boot/incident-state-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/boot/incident-mail-sync-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/boot/incident-lifecycle-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/boot/incident-recovery-sweep-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/boot/incident-service-recovery-controller.js?v=1.6.64-github-desktop-delivery-contract',
  './src/boot/incident-recovery-policy.js?v=1.6.64-github-desktop-delivery-contract',
  './src/boot/incident-local-queue-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/boot/incident-queue-coordination-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/boot/incident-service-diagnostics.js?v=1.6.64-github-desktop-delivery-contract',
  './src/boot/incident-diagnostics-view-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/boot/incident-controls-view-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/boot/incident-reporter.js?v=1.6.64-github-desktop-delivery-contract',
  './src/config/mastering-presets.js?v=1.6.64-github-desktop-delivery-contract',
  './src/config/genre-presets.js?v=1.6.64-github-desktop-delivery-contract',
  './src/config/reference-targets.js?v=1.6.64-github-desktop-delivery-contract',
  './src/config/app-runtime-config.js?v=1.6.64-github-desktop-delivery-contract',
  './src/state/app-state.js?v=1.6.64-github-desktop-delivery-contract',
  './src/settings/settings-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/utils/core-utils.js?v=1.6.64-github-desktop-delivery-contract',
  './src/utils/worker-job-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/recommendation/recommendation-engine.js?v=1.6.64-github-desktop-delivery-contract',
  './src/audio/mastering-inspector.js?v=1.6.64-github-desktop-delivery-contract',
  './src/audio/highlight-compare-inspector.js?v=1.6.64-github-desktop-delivery-contract',
  './src/audio/playback-link-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/audio/playback-transition-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/audio/playback-source-recovery-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/audio/playback-lifecycle-recovery-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/audio/post-master-playback-recovery-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/audio/audio-context-manager.js?v=1.6.64-github-desktop-delivery-contract',
  './src/audio/preview-translation-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/audio/audio-import-capability-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/audio/audio-decode-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/audio/inapp-mastering-safety-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/audio/import-preflight-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/audio/import-queue-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/audio/analysis-cache-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/audio/memory-guard-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/audio/mastering-memory-diagnostics-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/audio/reference-profile-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/audio/loudness-measurement-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/audio/mastering-input-guard-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/audio/mastering-quality-audit-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/audio/quality-gate-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/audio/mastering-orchestrator-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/audio/master-preview-job-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/state/track-lifecycle-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/audio/waveform-control-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/ui/waveform-control-view.js?v=1.6.64-github-desktop-delivery-contract',
  './src/ui/spectrum-visualizer.js?v=1.6.64-github-desktop-delivery-contract',
  './src/ui/modal-controller.js?v=1.6.64-github-desktop-delivery-contract',
  './src/ui/dock-controller.js?v=1.6.64-github-desktop-delivery-contract',
  './src/ui/mobile-native-view.js?v=1.6.64-github-desktop-delivery-contract&h=bulk-hud-restore-v153',
  './src/ui/admin-access-controller.js?v=1.6.64-github-desktop-delivery-contract',
  './src/download/file-name-policy-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/download/file-name-workflow-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/download/download-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/download/export-guard-service.js?v=1.6.64-github-desktop-delivery-contract&h=export-v156',
  './src/download/export-progress-view.js?v=1.6.64-github-desktop-delivery-contract&h=export-progress-v156',
  './src/download/zip-export-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/download/export-queue-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/ui/download-dialog-view.js?v=1.6.64-github-desktop-delivery-contract',
  './src/ui/bulk-import-hud-view.js?v=1.6.64-github-desktop-delivery-contract&h=bulk-hud-v153',
  './src/ui/waveform-compare-view.js?v=1.6.64-github-desktop-delivery-contract',
  './src/ui/detail-panels-view.js?v=1.6.64-github-desktop-delivery-contract',
  './src/ui/detail-view.js?v=1.6.64-github-desktop-delivery-contract',
  './src/ui/admin-incident-monitor-view.js?v=1.6.64-github-desktop-delivery-contract',
  './src/security/site-guards.js?v=1.6.64-github-desktop-delivery-contract',
  './src/boot/runtime-health.js?v=1.6.64-github-desktop-delivery-contract&h=boot-sri-v1664-delivery-contract',
  './src/boot/ui-shell-recovery-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/boot/update-safety-service.js?v=1.6.64-github-desktop-delivery-contract&h=update-safety-v1664-delivery-contract',
  './src/boot/service-worker-update-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/boot/service-worker-recovery-service.js?v=1.6.64-github-desktop-delivery-contract',
  './src/boot/worker-recovery-coordinator.js?v=1.6.64-github-desktop-delivery-contract',
  './src/boot/performance-diagnostics.js?v=1.6.64-github-desktop-delivery-contract&h=boot-sri-v1664-delivery-contract',
  './src/boot/render-scheduler.js?v=1.6.64-github-desktop-delivery-contract',
  './src/app.js?v=1.6.64-github-desktop-delivery-contract&h=boot-sri-v1664-delivery-contract',
  './src/boot/worker-recovery-app-bridge.js?v=1.6.64-github-desktop-delivery-contract',
  './assets/icons/foxbear-music.png?v=1.6.64-github-desktop-delivery-contract'
];
