...
const CORE_ASSETS = [
  ...
  './assets/icons/foxbear-icon-16.png?v=1.5.31-player-download-stability',
  './assets/icons/foxbear-icon-32.png?v=1.5.31-player-download-stability',
  './assets/icons/foxbear-icon-192.png?v=1.5.31-player-download-stability',
  './assets/icons/foxbear-icon-512.png?v=1.5.31-player-download-stability',
  './assets/icons/apple-touch-icon.png?v=1.5.31-player-download-stability',
  './manifest.webmanifest?v=1.5.31-player-download-stability',
  './assets/css/boot/performance-diagnostics.css?v=1.5.31-player-download-stability',
  './assets/css/boot/runtime-health.css?v=1.5.31-player-download-stability',
  './assets/css/theme.css?v=1.5.31-player-download-stability',
  './assets/css/layout.css?v=1.5.31-player-download-stability',
  './assets/css/components/base-components.css?v=1.5.31-player-download-stability',
  './assets/css/components/forms.css?v=1.5.31-player-download-stability',
  './assets/css/components/cards.css?v=1.5.31-player-download-stability',
  './assets/css/components/preview-system.css?v=1.5.31-player-download-stability',
  './assets/css/components/playback-link.css?v=1.5.31-player-download-stability',
  './assets/css/studio.css?v=1.5.31-player-download-stability',
  './assets/css/dock.css?v=1.5.31-player-download-stability',
  './assets/css/dock-waveform.css?v=1.5.31-player-download-stability',
  './assets/css/waveform-compare.css?v=1.5.31-player-download-stability',
  './assets/css/spectrum-visualizer.css?v=1.5.31-player-download-stability',
  './assets/css/export.css?v=1.5.31-player-download-stability&h=export-progress-v156',
  './assets/css/download-dialog.css?v=1.5.31-player-download-stability',
  './assets/css/bulk-import-hud.css?v=1.5.31-player-download-stability&h=bulk-hud-close-hotfix&ui=v153',
  './assets/css/mobile-native.css?v=1.5.31-player-download-stability',
  './assets/css/dock-ui-repair.css?v=1.5.31-player-download-stability',
  './assets/css/components/floating-overlays.css?v=1.5.31-player-download-stability',
  './assets/css/header-command-bar.css?v=1.5.31-player-download-stability',
  './vendor/jszip/jszip.min.js?v=3.10.1',
  './src/config/build-info.js?v=1.5.31-player-download-stability',
  './src/boot/release-presentation-service.js?v=1.5.31-player-download-stability',
  './src/firebase-bootstrap.js?v=1.5.31-player-download-stability',
  './src/config/mastering-presets.js?v=1.5.31-player-download-stability',
  './src/config/genre-presets.js?v=1.5.31-player-download-stability',
  './src/config/reference-targets.js?v=1.5.31-player-download-stability',
  './src/config/app-runtime-config.js?v=1.5.31-player-download-stability',
  './src/state/app-state.js?v=1.5.31-player-download-stability',
  './src/settings/settings-service.js?v=1.5.31-player-download-stability',
  './src/utils/core-utils.js?v=1.5.31-player-download-stability',
  './src/recommendation/recommendation-engine.js?v=1.5.31-player-download-stability',
  './src/audio/mastering-inspector.js?v=1.5.31-player-download-stability',
  './src/audio/highlight-compare-inspector.js?v=1.5.31-player-download-stability',
  './src/audio/playback-link-service.js?v=1.5.31-player-download-stability',
  './src/audio/playback-transition-service.js?v=1.5.31-player-download-stability',
  './src/audio/audio-context-manager.js?v=1.5.31-player-download-stability',
  './src/audio/preview-translation-service.js?v=1.5.31-player-download-stability',
  './src/audio/audio-decode-service.js?v=1.5.31-player-download-stability',
  './src/audio/import-queue-service.js?v=1.5.31-player-download-stability',
  './src/audio/analysis-cache-service.js?v=1.5.31-player-download-stability',
  './src/audio/memory-guard-service.js?v=1.5.31-player-download-stability',
  './src/audio/reference-profile-service.js?v=1.5.31-player-download-stability',
  './src/audio/quality-gate-service.js?v=1.5.31-player-download-stability',
  './src/audio/mastering-orchestrator-service.js?v=1.5.31-player-download-stability',
  './src/state/track-lifecycle-service.js?v=1.5.31-player-download-stability',
  './src/audio/waveform-control-service.js?v=1.5.31-player-download-stability',
  './src/ui/waveform-control-view.js?v=1.5.31-player-download-stability',
  './src/ui/spectrum-visualizer.js?v=1.5.31-player-download-stability',
  './src/ui/modal-controller.js?v=1.5.31-player-download-stability',
  './src/ui/dock-controller.js?v=1.5.31-player-download-stability',
  './src/ui/mobile-native-view.js?v=1.5.31-player-download-stability&h=bulk-hud-restore-v153',
  './src/download/download-service.js?v=1.5.31-player-download-stability',
  './src/download/export-guard-service.js?v=1.5.31-player-download-stability&h=export-v156',
  './src/download/export-progress-view.js?v=1.5.31-player-download-stability&h=export-progress-v156',
  './src/ui/download-dialog-view.js?v=1.5.31-player-download-stability',
  './src/ui/bulk-import-hud-view.js?v=1.5.31-player-download-stability&h=bulk-hud-v153',
  './src/ui/waveform-compare-view.js?v=1.5.31-player-download-stability',
  './src/ui/detail-panels-view.js?v=1.5.31-player-download-stability',
  './src/ui/detail-view.js?v=1.5.31-player-download-stability',
  './src/security/site-guards.js?v=1.5.31-player-download-stability',
  './src/boot/runtime-health.js?v=1.5.31-player-download-stability&h=boot-sri-v1531',
  './src/boot/update-safety-service.js?v=1.5.31-player-download-stability&h=update-safety-v1531',
  './src/boot/service-worker-update-service.js?v=1.5.31-player-download-stability',
  './src/boot/performance-diagnostics.js?v=1.5.31-player-download-stability&h=boot-sri-v1531',
  './src/boot/render-scheduler.js?v=1.5.31-player-download-stability',
  './src/app.js?v=1.5.31-player-download-stability&h=boot-sri-v1531',
  './assets/icons/foxbear-music.png?v=1.5.31-player-download-stability'
];
