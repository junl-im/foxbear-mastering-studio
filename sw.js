...
const CORE_ASSETS = [
  ...
  './src/boot/kakao-entry-guard.js?v=1.5.52-ci-parallel-release-gate',
  ...
  './src/workers/wav-encoder.worker.js?v=1.5.52-ci-parallel-release-gate',
  './src/workers/mp3-encoder.worker.js?v=1.5.52-ci-parallel-release-gate',
  './src/workers/analysis.worker.js?v=1.5.52-ci-parallel-release-gate',
  './src/workers/master-finalizer.worker.js?v=1.5.52-ci-parallel-release-gate',
  './src/workers/pitch-wsola.worker.js?v=1.5.52-ci-parallel-release-gate',
  './src/workers/zip-encoder.worker.js?v=1.5.52-ci-parallel-release-gate',
  ...
  './assets/icons/foxbear-icon-16.png?v=1.5.52-ci-parallel-release-gate',
  './assets/icons/foxbear-icon-32.png?v=1.5.52-ci-parallel-release-gate',
  './assets/icons/foxbear-icon-192.png?v=1.5.52-ci-parallel-release-gate',
  './assets/icons/foxbear-icon-512.png?v=1.5.52-ci-parallel-release-gate',
  './assets/icons/apple-touch-icon.png?v=1.5.52-ci-parallel-release-gate',
  './manifest.webmanifest?v=1.5.52-ci-parallel-release-gate',
  './assets/css/boot/performance-diagnostics.css?v=1.5.52-ci-parallel-release-gate',
  './assets/css/boot/runtime-health.css?v=1.5.52-ci-parallel-release-gate',
  './assets/css/theme.css?v=1.5.52-ci-parallel-release-gate',
  './assets/css/layout.css?v=1.5.52-ci-parallel-release-gate',
  './assets/css/components/base-components.css?v=1.5.52-ci-parallel-release-gate',
  './assets/css/components/forms.css?v=1.5.52-ci-parallel-release-gate',
  './assets/css/components/cards.css?v=1.5.52-ci-parallel-release-gate',
  './assets/css/components/preview-system.css?v=1.5.52-ci-parallel-release-gate',
  './assets/css/components/playback-link.css?v=1.5.52-ci-parallel-release-gate',
  './assets/css/studio.css?v=1.5.52-ci-parallel-release-gate',
  './assets/css/dock.css?v=1.5.52-ci-parallel-release-gate',
  './assets/css/dock-waveform.css?v=1.5.52-ci-parallel-release-gate',
  './assets/css/waveform-compare.css?v=1.5.52-ci-parallel-release-gate',
  './assets/css/spectrum-visualizer.css?v=1.5.52-ci-parallel-release-gate',
  './assets/css/export.css?v=1.5.52-ci-parallel-release-gate&h=export-progress-v156',
  './assets/css/download-dialog.css?v=1.5.52-ci-parallel-release-gate',
  './assets/css/bulk-import-hud.css?v=1.5.52-ci-parallel-release-gate&h=bulk-hud-close-hotfix&ui=v153',
  './assets/css/mobile-native.css?v=1.5.52-ci-parallel-release-gate',
  './assets/css/dock-ui-repair.css?v=1.5.52-ci-parallel-release-gate',
  './assets/css/components/floating-overlays.css?v=1.5.52-ci-parallel-release-gate',
  './assets/css/header-command-bar.css?v=1.5.52-ci-parallel-release-gate',
  './vendor/jszip/jszip.min.js?v=3.10.1',
  './src/config/build-info.js?v=1.5.52-ci-parallel-release-gate',
  './src/boot/release-presentation-service.js?v=1.5.52-ci-parallel-release-gate',
  './src/firebase-bootstrap.js?v=1.5.52-ci-parallel-release-gate',
  './src/config/mastering-presets.js?v=1.5.52-ci-parallel-release-gate',
  './src/config/genre-presets.js?v=1.5.52-ci-parallel-release-gate',
  './src/config/reference-targets.js?v=1.5.52-ci-parallel-release-gate',
  './src/config/app-runtime-config.js?v=1.5.52-ci-parallel-release-gate',
  './src/state/app-state.js?v=1.5.52-ci-parallel-release-gate',
  './src/settings/settings-service.js?v=1.5.52-ci-parallel-release-gate',
  './src/utils/core-utils.js?v=1.5.52-ci-parallel-release-gate',
  './src/utils/worker-job-service.js?v=1.5.52-ci-parallel-release-gate',
  './src/recommendation/recommendation-engine.js?v=1.5.52-ci-parallel-release-gate',
  './src/audio/mastering-inspector.js?v=1.5.52-ci-parallel-release-gate',
  './src/audio/highlight-compare-inspector.js?v=1.5.52-ci-parallel-release-gate',
  './src/audio/playback-link-service.js?v=1.5.52-ci-parallel-release-gate',
  './src/audio/playback-transition-service.js?v=1.5.52-ci-parallel-release-gate',
  './src/audio/audio-context-manager.js?v=1.5.52-ci-parallel-release-gate',
  './src/audio/preview-translation-service.js?v=1.5.52-ci-parallel-release-gate',
  './src/audio/audio-import-capability-service.js?v=1.5.52-ci-parallel-release-gate',
  './src/audio/audio-decode-service.js?v=1.5.52-ci-parallel-release-gate',
  './src/audio/import-preflight-service.js?v=1.5.52-ci-parallel-release-gate',
  './src/audio/import-queue-service.js?v=1.5.52-ci-parallel-release-gate',
  './src/audio/analysis-cache-service.js?v=1.5.52-ci-parallel-release-gate',
  './src/audio/memory-guard-service.js?v=1.5.52-ci-parallel-release-gate',
  './src/audio/reference-profile-service.js?v=1.5.52-ci-parallel-release-gate',
  './src/audio/mastering-input-guard-service.js?v=1.5.52-ci-parallel-release-gate',
  './src/audio/mastering-quality-audit-service.js?v=1.5.52-ci-parallel-release-gate',
  './src/audio/quality-gate-service.js?v=1.5.52-ci-parallel-release-gate',
  './src/audio/mastering-orchestrator-service.js?v=1.5.52-ci-parallel-release-gate',
  './src/state/track-lifecycle-service.js?v=1.5.52-ci-parallel-release-gate',
  './src/audio/waveform-control-service.js?v=1.5.52-ci-parallel-release-gate',
  './src/ui/waveform-control-view.js?v=1.5.52-ci-parallel-release-gate',
  './src/ui/spectrum-visualizer.js?v=1.5.52-ci-parallel-release-gate',
  './src/ui/modal-controller.js?v=1.5.52-ci-parallel-release-gate',
  './src/ui/dock-controller.js?v=1.5.52-ci-parallel-release-gate',
  './src/ui/mobile-native-view.js?v=1.5.52-ci-parallel-release-gate&h=bulk-hud-restore-v153',
  './src/download/download-service.js?v=1.5.52-ci-parallel-release-gate',
  './src/download/export-guard-service.js?v=1.5.52-ci-parallel-release-gate&h=export-v156',
  './src/download/export-progress-view.js?v=1.5.52-ci-parallel-release-gate&h=export-progress-v156',
  './src/download/zip-export-service.js?v=1.5.52-ci-parallel-release-gate',
  './src/download/export-queue-service.js?v=1.5.52-ci-parallel-release-gate',
  './src/ui/download-dialog-view.js?v=1.5.52-ci-parallel-release-gate',
  './src/ui/bulk-import-hud-view.js?v=1.5.52-ci-parallel-release-gate&h=bulk-hud-v153',
  './src/ui/waveform-compare-view.js?v=1.5.52-ci-parallel-release-gate',
  './src/ui/detail-panels-view.js?v=1.5.52-ci-parallel-release-gate',
  './src/ui/detail-view.js?v=1.5.52-ci-parallel-release-gate',
  './src/security/site-guards.js?v=1.5.52-ci-parallel-release-gate',
  './src/boot/runtime-health.js?v=1.5.52-ci-parallel-release-gate&h=boot-sri-v1552',
  './src/boot/update-safety-service.js?v=1.5.52-ci-parallel-release-gate&h=update-safety-v1552',
  './src/boot/service-worker-update-service.js?v=1.5.52-ci-parallel-release-gate',
  './src/boot/service-worker-recovery-service.js?v=1.5.52-ci-parallel-release-gate',
  './src/boot/performance-diagnostics.js?v=1.5.52-ci-parallel-release-gate&h=boot-sri-v1552',
  './src/boot/render-scheduler.js?v=1.5.52-ci-parallel-release-gate',
  './src/app.js?v=1.5.52-ci-parallel-release-gate&h=boot-sri-v1552',
  './assets/icons/foxbear-music.png?v=1.5.52-ci-parallel-release-gate'
];
