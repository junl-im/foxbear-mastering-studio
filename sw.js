// FoxBear AI Mastering Studio Pro v1.6.72 service worker · ci-safe-hygiene-self-repair
'use strict';

function loadSharePolicy() {
  try {
    if (typeof importScripts === 'function') importScripts('./src/config/pwa-share-policy.js?v=1.6.72-ci-safe-hygiene-self-repair');
  } catch (error) {
...
const CORE_ASSETS = [
  ...
  './assets/css/external-browser.css?v=1.6.72-ci-safe-hygiene-self-repair',
  './design-preview.html',
  './assets/css/design-preview.css?v=1.6.72-ci-safe-hygiene-self-repair',
  ...
  './src/security/trusted-types-bootstrap.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/boot/kakao-entry-guard.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/boot/kakao-entry-notice.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/boot/kakao-external-browser.js?v=1.6.72-ci-safe-hygiene-self-repair',
  ...
  './src/workers/wav-encoder.worker.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/workers/mp3-encoder.worker.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/workers/analysis.worker.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/workers/master-finalizer.worker.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/workers/pitch-wsola.worker.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/workers/zip-encoder.worker.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/engines/pitch-engine-adapter.js',
  './assets/icons/foxbear-icon-48.png?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/icons/foxbear-icon-72.png?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/icons/foxbear-icon-96.png?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/icons/foxbear-icon-128.png?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/icons/foxbear-icon-144.png?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/icons/foxbear-icon-152.png?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/icons/foxbear-icon-180.png?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/icons/foxbear-icon-192.png?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/icons/foxbear-icon-384.png?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/icons/foxbear-icon-512.png?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/icons/foxbear-icon-16.png?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/icons/foxbear-icon-32.png?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/icons/apple-touch-icon.png?v=1.6.72-ci-safe-hygiene-self-repair',
  './manifest.webmanifest?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/css/boot/performance-diagnostics.css?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/css/boot/runtime-health.css?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/css/boot/ui-shell-recovery.css?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/css/boot/kakao-entry-notice.css?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/css/theme.css?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/css/layout.css?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/css/components/base-components.css?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/css/components/forms.css?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/css/components/cards.css?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/css/components/preview-system.css?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/css/components/playback-link.css?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/css/studio.css?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/css/components/admin-incident-monitor.css?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/css/dock.css?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/css/dock-waveform.css?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/css/waveform-compare.css?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/css/spectrum-visualizer.css?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/css/export.css?v=1.6.72-ci-safe-hygiene-self-repair&h=export-progress-v156',
  './assets/css/download-dialog.css?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/css/bulk-import-hud.css?v=1.6.72-ci-safe-hygiene-self-repair&h=bulk-hud-close-hotfix&ui=v153',
  './assets/css/mobile-native.css?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/css/dock-ui-repair.css?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/css/components/floating-overlays.css?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/css/header-command-bar.css?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/css/components/support-settings.css?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/css/components/modal-close-system.css?v=1.6.72-ci-safe-hygiene-self-repair',
  './vendor/jszip/jszip.min.js?v=1.6.72-ci-safe-hygiene-self-repair&lib=3.10.1',
  './src/config/build-info.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/boot/release-presentation-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/boot/session-handoff-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/boot/incident-route-policy.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/boot/incident-submission-identity-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/firebase-bootstrap.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/boot/incident-support-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/boot/incident-state-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/boot/incident-mail-sync-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/boot/incident-lifecycle-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/boot/incident-recovery-sweep-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/boot/incident-service-recovery-controller.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/boot/incident-recovery-policy.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/boot/incident-local-queue-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/boot/incident-queue-coordination-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/boot/incident-service-diagnostics.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/boot/incident-diagnostics-view-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/boot/incident-controls-view-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/boot/incident-reporter.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/config/mastering-presets.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/config/genre-presets.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/config/reference-targets.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/config/app-runtime-config.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/config/pwa-share-policy.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/state/app-state.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/settings/settings-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/utils/core-utils.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/utils/worker-job-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/recommendation/recommendation-engine.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/audio/mastering-inspector.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/audio/highlight-compare-inspector.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/audio/playback-link-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/audio/playback-transition-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/audio/playback-source-recovery-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/audio/playback-lifecycle-recovery-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/audio/post-master-playback-recovery-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/audio/audio-context-manager.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/audio/preview-translation-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/audio/audio-import-capability-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/audio/audio-decode-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/audio/inapp-mastering-safety-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/audio/import-preflight-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/audio/import-queue-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/audio/analysis-cache-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/audio/memory-guard-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/audio/mastering-memory-diagnostics-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/audio/reference-profile-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/audio/loudness-measurement-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/audio/mastering-input-guard-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/audio/mastering-quality-audit-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/audio/quality-gate-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/audio/mastering-orchestrator-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/audio/master-preview-job-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/state/track-lifecycle-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/audio/waveform-control-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/ui/waveform-control-view.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/ui/spectrum-visualizer.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/ui/modal-controller.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/ui/dock-controller.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/ui/mobile-native-view.js?v=1.6.72-ci-safe-hygiene-self-repair&h=bulk-hud-restore-v153',
  './src/ui/admin-access-controller.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/download/file-name-policy-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/download/file-name-workflow-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/download/download-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/download/export-guard-service.js?v=1.6.72-ci-safe-hygiene-self-repair&h=export-v156',
  './src/download/export-progress-view.js?v=1.6.72-ci-safe-hygiene-self-repair&h=export-progress-v156',
  './src/download/zip-export-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/download/export-queue-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/ui/download-dialog-view.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/ui/bulk-import-hud-view.js?v=1.6.72-ci-safe-hygiene-self-repair&h=bulk-hud-v153',
  './src/ui/waveform-compare-view.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/ui/detail-panels-view.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/ui/detail-view.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/ui/admin-incident-monitor-view.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/security/site-guards.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/boot/runtime-health.js?v=1.6.72-ci-safe-hygiene-self-repair&h=boot-sri-v1672-ci-hygiene',
  './src/boot/ui-shell-recovery-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/boot/update-safety-service.js?v=1.6.72-ci-safe-hygiene-self-repair&h=update-safety-v1672-ci-hygiene',
  './src/boot/service-worker-update-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/boot/service-worker-recovery-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/boot/worker-recovery-coordinator.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/boot/performance-diagnostics.js?v=1.6.72-ci-safe-hygiene-self-repair&h=boot-sri-v1672-ci-hygiene',
  './src/boot/render-scheduler.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/boot/pwa-share-target-service.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/boot/pwa-runtime-bridge.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './src/app.js?v=1.6.72-ci-safe-hygiene-self-repair&h=boot-sri-v1672-ci-hygiene',
  './src/boot/worker-recovery-app-bridge.js?v=1.6.72-ci-safe-hygiene-self-repair',
  './assets/icons/foxbear-music.png?v=1.6.72-ci-safe-hygiene-self-repair'
];
