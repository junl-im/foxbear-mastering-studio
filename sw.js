...
const CORE_ASSETS = [
  ...
  './src/security/trusted-types-bootstrap.js?v=1.6.63-download-filename-review-hardening',
  './src/boot/kakao-entry-guard.js?v=1.6.63-download-filename-review-hardening',
  './src/boot/kakao-entry-notice.js?v=1.6.63-download-filename-review-hardening',
  ...
  './src/workers/wav-encoder.worker.js?v=1.6.63-download-filename-review-hardening',
  './src/workers/mp3-encoder.worker.js?v=1.6.63-download-filename-review-hardening',
  './src/workers/analysis.worker.js?v=1.6.63-download-filename-review-hardening',
  './src/workers/master-finalizer.worker.js?v=1.6.63-download-filename-review-hardening',
  './src/workers/pitch-wsola.worker.js?v=1.6.63-download-filename-review-hardening',
  './src/workers/zip-encoder.worker.js?v=1.6.63-download-filename-review-hardening',
  ...
  './assets/icons/foxbear-icon-16.png?v=1.6.63-download-filename-review-hardening',
  './assets/icons/foxbear-icon-32.png?v=1.6.63-download-filename-review-hardening',
  './assets/icons/foxbear-icon-192.png?v=1.6.63-download-filename-review-hardening',
  './assets/icons/foxbear-icon-512.png?v=1.6.63-download-filename-review-hardening',
  './assets/icons/apple-touch-icon.png?v=1.6.63-download-filename-review-hardening',
  './manifest.webmanifest?v=1.6.63-download-filename-review-hardening',
  './assets/css/boot/performance-diagnostics.css?v=1.6.63-download-filename-review-hardening',
  './assets/css/boot/runtime-health.css?v=1.6.63-download-filename-review-hardening',
  './assets/css/boot/ui-shell-recovery.css?v=1.6.63-download-filename-review-hardening',
  './assets/css/boot/kakao-entry-notice.css?v=1.6.63-download-filename-review-hardening',
  './assets/css/theme.css?v=1.6.63-download-filename-review-hardening',
  './assets/css/layout.css?v=1.6.63-download-filename-review-hardening',
  './assets/css/components/base-components.css?v=1.6.63-download-filename-review-hardening',
  './assets/css/components/forms.css?v=1.6.63-download-filename-review-hardening',
  './assets/css/components/cards.css?v=1.6.63-download-filename-review-hardening',
  './assets/css/components/preview-system.css?v=1.6.63-download-filename-review-hardening',
  './assets/css/components/playback-link.css?v=1.6.63-download-filename-review-hardening',
  './assets/css/studio.css?v=1.6.63-download-filename-review-hardening',
  './assets/css/components/admin-incident-monitor.css?v=1.6.63-download-filename-review-hardening',
  './assets/css/dock.css?v=1.6.63-download-filename-review-hardening',
  './assets/css/dock-waveform.css?v=1.6.63-download-filename-review-hardening',
  './assets/css/waveform-compare.css?v=1.6.63-download-filename-review-hardening',
  './assets/css/spectrum-visualizer.css?v=1.6.63-download-filename-review-hardening',
  './assets/css/export.css?v=1.6.63-download-filename-review-hardening&h=export-progress-v156',
  './assets/css/download-dialog.css?v=1.6.63-download-filename-review-hardening',
  './assets/css/bulk-import-hud.css?v=1.6.63-download-filename-review-hardening&h=bulk-hud-close-hotfix&ui=v153',
  './assets/css/mobile-native.css?v=1.6.63-download-filename-review-hardening',
  './assets/css/dock-ui-repair.css?v=1.6.63-download-filename-review-hardening',
  './assets/css/components/floating-overlays.css?v=1.6.63-download-filename-review-hardening',
  './assets/css/header-command-bar.css?v=1.6.63-download-filename-review-hardening',
  './assets/css/components/support-settings.css?v=1.6.63-download-filename-review-hardening',
  './assets/css/components/modal-close-system.css?v=1.6.63-download-filename-review-hardening',
  './vendor/jszip/jszip.min.js?v=1.6.63-download-filename-review-hardening&lib=3.10.1',
  './src/config/build-info.js?v=1.6.63-download-filename-review-hardening',
  './src/boot/release-presentation-service.js?v=1.6.63-download-filename-review-hardening',
  './src/boot/session-handoff-service.js?v=1.6.63-download-filename-review-hardening',
  './src/boot/incident-route-policy.js?v=1.6.63-download-filename-review-hardening',
  './src/boot/incident-submission-identity-service.js?v=1.6.63-download-filename-review-hardening',
  './src/firebase-bootstrap.js?v=1.6.63-download-filename-review-hardening',
  './src/boot/incident-support-service.js?v=1.6.63-download-filename-review-hardening',
  './src/boot/incident-state-service.js?v=1.6.63-download-filename-review-hardening',
  './src/boot/incident-mail-sync-service.js?v=1.6.63-download-filename-review-hardening',
  './src/boot/incident-lifecycle-service.js?v=1.6.63-download-filename-review-hardening',
  './src/boot/incident-recovery-sweep-service.js?v=1.6.63-download-filename-review-hardening',
  './src/boot/incident-service-recovery-controller.js?v=1.6.63-download-filename-review-hardening',
  './src/boot/incident-recovery-policy.js?v=1.6.63-download-filename-review-hardening',
  './src/boot/incident-local-queue-service.js?v=1.6.63-download-filename-review-hardening',
  './src/boot/incident-queue-coordination-service.js?v=1.6.63-download-filename-review-hardening',
  './src/boot/incident-service-diagnostics.js?v=1.6.63-download-filename-review-hardening',
  './src/boot/incident-diagnostics-view-service.js?v=1.6.63-download-filename-review-hardening',
  './src/boot/incident-controls-view-service.js?v=1.6.63-download-filename-review-hardening',
  './src/boot/incident-reporter.js?v=1.6.63-download-filename-review-hardening',
  './src/config/mastering-presets.js?v=1.6.63-download-filename-review-hardening',
  './src/config/genre-presets.js?v=1.6.63-download-filename-review-hardening',
  './src/config/reference-targets.js?v=1.6.63-download-filename-review-hardening',
  './src/config/app-runtime-config.js?v=1.6.63-download-filename-review-hardening',
  './src/state/app-state.js?v=1.6.63-download-filename-review-hardening',
  './src/settings/settings-service.js?v=1.6.63-download-filename-review-hardening',
  './src/utils/core-utils.js?v=1.6.63-download-filename-review-hardening',
  './src/utils/worker-job-service.js?v=1.6.63-download-filename-review-hardening',
  './src/recommendation/recommendation-engine.js?v=1.6.63-download-filename-review-hardening',
  './src/audio/mastering-inspector.js?v=1.6.63-download-filename-review-hardening',
  './src/audio/highlight-compare-inspector.js?v=1.6.63-download-filename-review-hardening',
  './src/audio/playback-link-service.js?v=1.6.63-download-filename-review-hardening',
  './src/audio/playback-transition-service.js?v=1.6.63-download-filename-review-hardening',
  './src/audio/playback-source-recovery-service.js?v=1.6.63-download-filename-review-hardening',
  './src/audio/playback-lifecycle-recovery-service.js?v=1.6.63-download-filename-review-hardening',
  './src/audio/post-master-playback-recovery-service.js?v=1.6.63-download-filename-review-hardening',
  './src/audio/audio-context-manager.js?v=1.6.63-download-filename-review-hardening',
  './src/audio/preview-translation-service.js?v=1.6.63-download-filename-review-hardening',
  './src/audio/audio-import-capability-service.js?v=1.6.63-download-filename-review-hardening',
  './src/audio/audio-decode-service.js?v=1.6.63-download-filename-review-hardening',
  './src/audio/inapp-mastering-safety-service.js?v=1.6.63-download-filename-review-hardening',
  './src/audio/import-preflight-service.js?v=1.6.63-download-filename-review-hardening',
  './src/audio/import-queue-service.js?v=1.6.63-download-filename-review-hardening',
  './src/audio/analysis-cache-service.js?v=1.6.63-download-filename-review-hardening',
  './src/audio/memory-guard-service.js?v=1.6.63-download-filename-review-hardening',
  './src/audio/mastering-memory-diagnostics-service.js?v=1.6.63-download-filename-review-hardening',
  './src/audio/reference-profile-service.js?v=1.6.63-download-filename-review-hardening',
  './src/audio/loudness-measurement-service.js?v=1.6.63-download-filename-review-hardening',
  './src/audio/mastering-input-guard-service.js?v=1.6.63-download-filename-review-hardening',
  './src/audio/mastering-quality-audit-service.js?v=1.6.63-download-filename-review-hardening',
  './src/audio/quality-gate-service.js?v=1.6.63-download-filename-review-hardening',
  './src/audio/mastering-orchestrator-service.js?v=1.6.63-download-filename-review-hardening',
  './src/audio/master-preview-job-service.js?v=1.6.63-download-filename-review-hardening',
  './src/state/track-lifecycle-service.js?v=1.6.63-download-filename-review-hardening',
  './src/audio/waveform-control-service.js?v=1.6.63-download-filename-review-hardening',
  './src/ui/waveform-control-view.js?v=1.6.63-download-filename-review-hardening',
  './src/ui/spectrum-visualizer.js?v=1.6.63-download-filename-review-hardening',
  './src/ui/modal-controller.js?v=1.6.63-download-filename-review-hardening',
  './src/ui/dock-controller.js?v=1.6.63-download-filename-review-hardening',
  './src/ui/mobile-native-view.js?v=1.6.63-download-filename-review-hardening&h=bulk-hud-restore-v153',
  './src/ui/admin-access-controller.js?v=1.6.63-download-filename-review-hardening',
  './src/download/file-name-policy-service.js?v=1.6.63-download-filename-review-hardening',
  './src/download/file-name-workflow-service.js?v=1.6.63-download-filename-review-hardening',
  './src/download/download-service.js?v=1.6.63-download-filename-review-hardening',
  './src/download/export-guard-service.js?v=1.6.63-download-filename-review-hardening&h=export-v156',
  './src/download/export-progress-view.js?v=1.6.63-download-filename-review-hardening&h=export-progress-v156',
  './src/download/zip-export-service.js?v=1.6.63-download-filename-review-hardening',
  './src/download/export-queue-service.js?v=1.6.63-download-filename-review-hardening',
  './src/ui/download-dialog-view.js?v=1.6.63-download-filename-review-hardening',
  './src/ui/bulk-import-hud-view.js?v=1.6.63-download-filename-review-hardening&h=bulk-hud-v153',
  './src/ui/waveform-compare-view.js?v=1.6.63-download-filename-review-hardening',
  './src/ui/detail-panels-view.js?v=1.6.63-download-filename-review-hardening',
  './src/ui/detail-view.js?v=1.6.63-download-filename-review-hardening',
  './src/ui/admin-incident-monitor-view.js?v=1.6.63-download-filename-review-hardening',
  './src/security/site-guards.js?v=1.6.63-download-filename-review-hardening',
  './src/boot/runtime-health.js?v=1.6.63-download-filename-review-hardening&h=boot-sri-v1663-filename-review',
  './src/boot/ui-shell-recovery-service.js?v=1.6.63-download-filename-review-hardening',
  './src/boot/update-safety-service.js?v=1.6.63-download-filename-review-hardening&h=update-safety-v1663-filename-review',
  './src/boot/service-worker-update-service.js?v=1.6.63-download-filename-review-hardening',
  './src/boot/service-worker-recovery-service.js?v=1.6.63-download-filename-review-hardening',
  './src/boot/worker-recovery-coordinator.js?v=1.6.63-download-filename-review-hardening',
  './src/boot/performance-diagnostics.js?v=1.6.63-download-filename-review-hardening&h=boot-sri-v1663-filename-review',
  './src/boot/render-scheduler.js?v=1.6.63-download-filename-review-hardening',
  './src/app.js?v=1.6.63-download-filename-review-hardening&h=boot-sri-v1663-filename-review',
  './src/boot/worker-recovery-app-bridge.js?v=1.6.63-download-filename-review-hardening',
  './assets/icons/foxbear-music.png?v=1.6.63-download-filename-review-hardening'
];
