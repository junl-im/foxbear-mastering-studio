// FoxBear AI Mastering Studio Pro v1.6.75 service worker · download-progress-admission-fallback-closure
'use strict';

function loadSharePolicy() {
  try {
    if (typeof importScripts === 'function') importScripts('./src/config/pwa-share-policy.js?v=1.6.75-download-progress-admission-fallback-closure');
  } catch (error) {
...
const CORE_ASSETS = [
  ...
  './index.html',
  './404.html',
  './assets/css/route-recovery.css?v=1.6.75-download-progress-admission-fallback-closure',
  './src/boot/route-recovery.js?v=1.6.75-download-progress-admission-fallback-closure',
  './foxbear-root.json',
  './external-browser.html',
  './assets/css/external-browser.css?v=1.6.75-download-progress-admission-fallback-closure',
  './design-preview.html',
  './assets/css/design-preview.css?v=1.6.75-download-progress-admission-fallback-closure',
  ...
  './src/security/trusted-types-bootstrap.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/boot/kakao-entry-guard.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/boot/kakao-entry-notice.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/boot/kakao-external-browser.js?v=1.6.75-download-progress-admission-fallback-closure',
  ...
  './src/workers/wav-encoder.worker.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/workers/mp3-encoder.worker.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/workers/analysis.worker.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/workers/master-finalizer.worker.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/workers/pitch-wsola.worker.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/workers/zip-encoder.worker.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/engines/pitch-engine-adapter.js',
  './assets/icons/foxbear-icon-48.png?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/icons/foxbear-icon-72.png?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/icons/foxbear-icon-96.png?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/icons/foxbear-icon-128.png?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/icons/foxbear-icon-144.png?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/icons/foxbear-icon-152.png?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/icons/foxbear-icon-180.png?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/icons/foxbear-icon-192.png?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/icons/foxbear-icon-384.png?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/icons/foxbear-icon-512.png?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/icons/foxbear-icon-16.png?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/icons/foxbear-icon-32.png?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/icons/apple-touch-icon.png?v=1.6.75-download-progress-admission-fallback-closure',
  './manifest.webmanifest?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/css/boot/performance-diagnostics.css?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/css/boot/runtime-health.css?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/css/boot/ui-shell-recovery.css?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/css/boot/kakao-entry-notice.css?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/css/theme.css?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/css/layout.css?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/css/components/base-components.css?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/css/components/forms.css?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/css/components/cards.css?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/css/components/preview-system.css?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/css/components/playback-link.css?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/css/studio.css?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/css/components/admin-incident-monitor.css?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/css/dock.css?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/css/dock-waveform.css?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/css/waveform-compare.css?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/css/spectrum-visualizer.css?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/css/export.css?v=1.6.75-download-progress-admission-fallback-closure&h=export-progress-v156',
  './assets/css/download-dialog.css?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/css/bulk-import-hud.css?v=1.6.75-download-progress-admission-fallback-closure&h=bulk-hud-close-hotfix&ui=v153',
  './assets/css/mobile-native.css?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/css/dock-ui-repair.css?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/css/components/floating-overlays.css?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/css/header-command-bar.css?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/css/components/support-settings.css?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/css/components/modal-close-system.css?v=1.6.75-download-progress-admission-fallback-closure',
  './vendor/jszip/jszip.min.js?v=1.6.75-download-progress-admission-fallback-closure&lib=3.10.1',
  './src/config/build-info.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/boot/release-presentation-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/boot/session-handoff-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/boot/incident-route-policy.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/boot/incident-submission-identity-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/firebase-bootstrap.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/boot/incident-support-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/boot/incident-state-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/boot/incident-mail-sync-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/boot/incident-lifecycle-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/boot/incident-recovery-sweep-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/boot/incident-service-recovery-controller.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/boot/incident-recovery-policy.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/boot/incident-local-queue-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/boot/incident-queue-coordination-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/boot/incident-service-diagnostics.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/boot/incident-diagnostics-view-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/boot/incident-controls-view-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/boot/incident-reporter.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/config/mastering-presets.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/config/genre-presets.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/config/reference-targets.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/config/app-runtime-config.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/config/pwa-share-policy.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/state/app-state.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/settings/settings-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/utils/core-utils.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/utils/worker-job-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/recommendation/recommendation-engine.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/audio/mastering-inspector.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/audio/highlight-compare-inspector.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/audio/playback-link-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/audio/playback-transition-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/audio/playback-source-recovery-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/audio/playback-lifecycle-recovery-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/audio/post-master-playback-recovery-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/audio/audio-context-manager.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/audio/preview-translation-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/audio/audio-import-capability-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/audio/audio-decode-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/audio/inapp-mastering-safety-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/audio/import-preflight-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/audio/import-queue-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/audio/analysis-cache-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/audio/memory-guard-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/audio/mastering-memory-diagnostics-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/audio/reference-profile-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/audio/loudness-measurement-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/audio/mastering-input-guard-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/audio/mastering-quality-audit-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/audio/quality-gate-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/audio/mastering-orchestrator-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/audio/master-preview-job-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/state/track-lifecycle-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/audio/waveform-control-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/ui/waveform-control-view.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/ui/spectrum-visualizer.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/ui/modal-controller.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/ui/dock-controller.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/ui/mobile-native-view.js?v=1.6.75-download-progress-admission-fallback-closure&h=bulk-hud-restore-v153',
  './src/ui/admin-access-controller.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/download/file-name-policy-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/download/file-name-workflow-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/download/download-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/download/export-guard-service.js?v=1.6.75-download-progress-admission-fallback-closure&h=export-v156',
  './src/download/export-progress-view.js?v=1.6.75-download-progress-admission-fallback-closure&h=export-progress-v156',
  './src/download/zip-export-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/download/export-queue-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/ui/download-dialog-view.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/ui/bulk-import-hud-view.js?v=1.6.75-download-progress-admission-fallback-closure&h=bulk-hud-v153',
  './src/ui/waveform-compare-view.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/ui/detail-panels-view.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/ui/detail-view.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/ui/admin-incident-monitor-view.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/security/site-guards.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/boot/runtime-health.js?v=1.6.75-download-progress-admission-fallback-closure&h=boot-sri-v1675',
  './src/boot/ui-shell-recovery-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/boot/update-safety-service.js?v=1.6.75-download-progress-admission-fallback-closure&h=update-safety-v1675',
  './src/boot/service-worker-update-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/boot/service-worker-recovery-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/boot/worker-recovery-coordinator.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/boot/performance-diagnostics.js?v=1.6.75-download-progress-admission-fallback-closure&h=boot-sri-v1675',
  './src/boot/render-scheduler.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/boot/pwa-share-target-service.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/boot/pwa-runtime-bridge.js?v=1.6.75-download-progress-admission-fallback-closure',
  './src/app.js?v=1.6.75-download-progress-admission-fallback-closure&h=boot-sri-v1675',
  './src/boot/worker-recovery-app-bridge.js?v=1.6.75-download-progress-admission-fallback-closure',
  './assets/icons/foxbear-music.png?v=1.6.75-download-progress-admission-fallback-closure'
];
