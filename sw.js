...
const CORE_ASSETS = [
  ...
  './src/boot/kakao-entry-guard.js?v=1.6.41-admin-secret-pin-session',
  ...
  './src/workers/wav-encoder.worker.js?v=1.6.41-admin-secret-pin-session',
  './src/workers/mp3-encoder.worker.js?v=1.6.41-admin-secret-pin-session',
  './src/workers/analysis.worker.js?v=1.6.41-admin-secret-pin-session',
  './src/workers/master-finalizer.worker.js?v=1.6.41-admin-secret-pin-session',
  './src/workers/pitch-wsola.worker.js?v=1.6.41-admin-secret-pin-session',
  './src/workers/zip-encoder.worker.js?v=1.6.41-admin-secret-pin-session',
  ...
  './assets/icons/foxbear-icon-16.png?v=1.6.41-admin-secret-pin-session',
  './assets/icons/foxbear-icon-32.png?v=1.6.41-admin-secret-pin-session',
  './assets/icons/foxbear-icon-192.png?v=1.6.41-admin-secret-pin-session',
  './assets/icons/foxbear-icon-512.png?v=1.6.41-admin-secret-pin-session',
  './assets/icons/apple-touch-icon.png?v=1.6.41-admin-secret-pin-session',
  './manifest.webmanifest?v=1.6.41-admin-secret-pin-session',
  './assets/css/boot/performance-diagnostics.css?v=1.6.41-admin-secret-pin-session',
  './assets/css/boot/runtime-health.css?v=1.6.41-admin-secret-pin-session',
  './assets/css/boot/ui-shell-recovery.css?v=1.6.41-admin-secret-pin-session',
  './assets/css/theme.css?v=1.6.41-admin-secret-pin-session',
  './assets/css/layout.css?v=1.6.41-admin-secret-pin-session',
  './assets/css/components/base-components.css?v=1.6.41-admin-secret-pin-session',
  './assets/css/components/forms.css?v=1.6.41-admin-secret-pin-session',
  './assets/css/components/cards.css?v=1.6.41-admin-secret-pin-session',
  './assets/css/components/preview-system.css?v=1.6.41-admin-secret-pin-session',
  './assets/css/components/playback-link.css?v=1.6.41-admin-secret-pin-session',
  './assets/css/studio.css?v=1.6.41-admin-secret-pin-session',
  './assets/css/components/admin-incident-monitor.css?v=1.6.41-admin-secret-pin-session',
  './assets/css/dock.css?v=1.6.41-admin-secret-pin-session',
  './assets/css/dock-waveform.css?v=1.6.41-admin-secret-pin-session',
  './assets/css/waveform-compare.css?v=1.6.41-admin-secret-pin-session',
  './assets/css/spectrum-visualizer.css?v=1.6.41-admin-secret-pin-session',
  './assets/css/export.css?v=1.6.41-admin-secret-pin-session&h=export-progress-v156',
  './assets/css/download-dialog.css?v=1.6.41-admin-secret-pin-session',
  './assets/css/bulk-import-hud.css?v=1.6.41-admin-secret-pin-session&h=bulk-hud-close-hotfix&ui=v153',
  './assets/css/mobile-native.css?v=1.6.41-admin-secret-pin-session',
  './assets/css/dock-ui-repair.css?v=1.6.41-admin-secret-pin-session',
  './assets/css/components/floating-overlays.css?v=1.6.41-admin-secret-pin-session',
  './assets/css/header-command-bar.css?v=1.6.41-admin-secret-pin-session',
  './assets/css/components/support-settings.css?v=1.6.41-admin-secret-pin-session',
  './assets/css/components/modal-close-system.css?v=1.6.41-admin-secret-pin-session',
  './vendor/jszip/jszip.min.js?v=1.6.41-admin-secret-pin-session&lib=3.10.1',
  './src/config/build-info.js?v=1.6.41-admin-secret-pin-session',
  './src/boot/release-presentation-service.js?v=1.6.41-admin-secret-pin-session',
  './src/boot/session-handoff-service.js?v=1.6.41-admin-secret-pin-session',
  './src/boot/incident-route-policy.js?v=1.6.41-admin-secret-pin-session',
  './src/boot/incident-submission-identity-service.js?v=1.6.41-admin-secret-pin-session',
  './src/firebase-bootstrap.js?v=1.6.41-admin-secret-pin-session',
  './src/boot/incident-support-service.js?v=1.6.41-admin-secret-pin-session',
  './src/boot/incident-state-service.js?v=1.6.41-admin-secret-pin-session',
  './src/boot/incident-mail-sync-service.js?v=1.6.41-admin-secret-pin-session',
  './src/boot/incident-lifecycle-service.js?v=1.6.41-admin-secret-pin-session',
  './src/boot/incident-recovery-sweep-service.js?v=1.6.41-admin-secret-pin-session',
  './src/boot/incident-service-recovery-controller.js?v=1.6.41-admin-secret-pin-session',
  './src/boot/incident-recovery-policy.js?v=1.6.41-admin-secret-pin-session',
  './src/boot/incident-local-queue-service.js?v=1.6.41-admin-secret-pin-session',
  './src/boot/incident-queue-coordination-service.js?v=1.6.41-admin-secret-pin-session',
  './src/boot/incident-service-diagnostics.js?v=1.6.41-admin-secret-pin-session',
  './src/boot/incident-diagnostics-view-service.js?v=1.6.41-admin-secret-pin-session',
  './src/boot/incident-controls-view-service.js?v=1.6.41-admin-secret-pin-session',
  './src/boot/incident-reporter.js?v=1.6.41-admin-secret-pin-session',
  './src/config/mastering-presets.js?v=1.6.41-admin-secret-pin-session',
  './src/config/genre-presets.js?v=1.6.41-admin-secret-pin-session',
  './src/config/reference-targets.js?v=1.6.41-admin-secret-pin-session',
  './src/config/app-runtime-config.js?v=1.6.41-admin-secret-pin-session',
  './src/state/app-state.js?v=1.6.41-admin-secret-pin-session',
  './src/settings/settings-service.js?v=1.6.41-admin-secret-pin-session',
  './src/utils/core-utils.js?v=1.6.41-admin-secret-pin-session',
  './src/utils/worker-job-service.js?v=1.6.41-admin-secret-pin-session',
  './src/recommendation/recommendation-engine.js?v=1.6.41-admin-secret-pin-session',
  './src/audio/mastering-inspector.js?v=1.6.41-admin-secret-pin-session',
  './src/audio/highlight-compare-inspector.js?v=1.6.41-admin-secret-pin-session',
  './src/audio/playback-link-service.js?v=1.6.41-admin-secret-pin-session',
  './src/audio/playback-transition-service.js?v=1.6.41-admin-secret-pin-session',
  './src/audio/audio-context-manager.js?v=1.6.41-admin-secret-pin-session',
  './src/audio/preview-translation-service.js?v=1.6.41-admin-secret-pin-session',
  './src/audio/audio-import-capability-service.js?v=1.6.41-admin-secret-pin-session',
  './src/audio/audio-decode-service.js?v=1.6.41-admin-secret-pin-session',
  './src/audio/inapp-mastering-safety-service.js?v=1.6.41-admin-secret-pin-session',
  './src/audio/import-preflight-service.js?v=1.6.41-admin-secret-pin-session',
  './src/audio/import-queue-service.js?v=1.6.41-admin-secret-pin-session',
  './src/audio/analysis-cache-service.js?v=1.6.41-admin-secret-pin-session',
  './src/audio/memory-guard-service.js?v=1.6.41-admin-secret-pin-session',
  './src/audio/mastering-memory-diagnostics-service.js?v=1.6.41-admin-secret-pin-session',
  './src/audio/reference-profile-service.js?v=1.6.41-admin-secret-pin-session',
  './src/audio/loudness-measurement-service.js?v=1.6.41-admin-secret-pin-session',
  './src/audio/mastering-input-guard-service.js?v=1.6.41-admin-secret-pin-session',
  './src/audio/mastering-quality-audit-service.js?v=1.6.41-admin-secret-pin-session',
  './src/audio/quality-gate-service.js?v=1.6.41-admin-secret-pin-session',
  './src/audio/mastering-orchestrator-service.js?v=1.6.41-admin-secret-pin-session',
  './src/audio/master-preview-job-service.js?v=1.6.41-admin-secret-pin-session',
  './src/state/track-lifecycle-service.js?v=1.6.41-admin-secret-pin-session',
  './src/audio/waveform-control-service.js?v=1.6.41-admin-secret-pin-session',
  './src/ui/waveform-control-view.js?v=1.6.41-admin-secret-pin-session',
  './src/ui/spectrum-visualizer.js?v=1.6.41-admin-secret-pin-session',
  './src/ui/modal-controller.js?v=1.6.41-admin-secret-pin-session',
  './src/ui/dock-controller.js?v=1.6.41-admin-secret-pin-session',
  './src/ui/mobile-native-view.js?v=1.6.41-admin-secret-pin-session&h=bulk-hud-restore-v153',
  './src/ui/admin-access-controller.js?v=1.6.41-admin-secret-pin-session',
  './src/download/download-service.js?v=1.6.41-admin-secret-pin-session',
  './src/download/export-guard-service.js?v=1.6.41-admin-secret-pin-session&h=export-v156',
  './src/download/export-progress-view.js?v=1.6.41-admin-secret-pin-session&h=export-progress-v156',
  './src/download/zip-export-service.js?v=1.6.41-admin-secret-pin-session',
  './src/download/export-queue-service.js?v=1.6.41-admin-secret-pin-session',
  './src/ui/download-dialog-view.js?v=1.6.41-admin-secret-pin-session',
  './src/ui/bulk-import-hud-view.js?v=1.6.41-admin-secret-pin-session&h=bulk-hud-v153',
  './src/ui/waveform-compare-view.js?v=1.6.41-admin-secret-pin-session',
  './src/ui/detail-panels-view.js?v=1.6.41-admin-secret-pin-session',
  './src/ui/detail-view.js?v=1.6.41-admin-secret-pin-session',
  './src/ui/admin-incident-monitor-view.js?v=1.6.41-admin-secret-pin-session',
  './src/security/site-guards.js?v=1.6.41-admin-secret-pin-session',
  './src/boot/runtime-health.js?v=1.6.41-admin-secret-pin-session&h=boot-sri-v1641',
  './src/boot/ui-shell-recovery-service.js?v=1.6.41-admin-secret-pin-session',
  './src/boot/update-safety-service.js?v=1.6.41-admin-secret-pin-session&h=update-safety-v1641',
  './src/boot/service-worker-update-service.js?v=1.6.41-admin-secret-pin-session',
  './src/boot/service-worker-recovery-service.js?v=1.6.41-admin-secret-pin-session',
  './src/boot/worker-recovery-coordinator.js?v=1.6.41-admin-secret-pin-session',
  './src/boot/performance-diagnostics.js?v=1.6.41-admin-secret-pin-session&h=boot-sri-v1641',
  './src/boot/render-scheduler.js?v=1.6.41-admin-secret-pin-session',
  './src/app.js?v=1.6.41-admin-secret-pin-session&h=boot-sri-v1641',
  './src/boot/worker-recovery-app-bridge.js?v=1.6.41-admin-secret-pin-session',
  './assets/icons/foxbear-music.png?v=1.6.41-admin-secret-pin-session'
];
