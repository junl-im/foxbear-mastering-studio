// FoxBear AI Mastering Studio Pro v1.6.109 service worker · mastering-cooperative-pcm-responsiveness
'use strict';

function loadSharePolicy() {
  try {
    if (typeof importScripts === 'function') importScripts('./src/config/pwa-share-policy.js?v=1.6.109-mastering-cooperative-pcm-responsiveness');
  } catch (error) {
...
const CACHE_NAME = 'foxbear-shell-v1.6.109-mastering-cooperative-pcm-responsiveness';
const CURRENT_ASSET_VERSION = '1.6.109-mastering-cooperative-pcm-responsiveness';
const LEGACY_CACHE_NAMES = ['foxbear-shell-v1.5.4-boot-sri-recovery', 'foxbear-shell-v1.5.5-update-safety', 'foxbear-shell-v1.5.6-export-progress-recovery', 'foxbear-shell-v1.6.89-mobile-header-flex-ownership-browser-gate-recovery', 'foxbear-shell-v1.6.90-engine-control-overlay-isolation-header-contract-recovery', 'foxbear-shell-v1.6.91-runtime-health-hidden-geometry-contract-recovery', 'foxbear-shell-v1.6.92-spectrum-panel-mount-lifecycle-recovery', 'foxbear-shell-v1.6.93-mobile-dock-visibility-integrity-recovery', 'foxbear-shell-v1.6.94-release-integrity-hardening', 'foxbear-shell-v1.6.95-release-artifact-safety', 'foxbear-shell-v1.6.96-update-resilience-hygiene-hardening', 'foxbear-shell-v1.6.97-boot-payload-delivery-privacy-hardening', 'foxbear-shell-v1.6.98-spectrum-retirement-mobile-header-integrity', 'foxbear-shell-v1.6.99-header-role-focus-integrity', 'foxbear-shell-v1.6.100-sw-stereo-ci-cleanup-hardening', 'foxbear-shell-v1.6.101-admin-lazyload-repo-cleanup', 'foxbear-shell-v1.6.102-admin-lazyload-sw-hygiene-hardening', 'foxbear-shell-v1.6.103-ci-hygiene-mail-routing-hardening', 'foxbear-shell-v1.6.104-boot-emergency-visit-privacy-hardening', 'foxbear-shell-v1.6.105-header-dock-css-ownership-hardening', 'foxbear-shell-v1.6.106-browser-geometry-history-recovery', 'foxbear-shell-v1.6.107-boot-payload-phase1', 'foxbear-shell-v1.6.108-mastering-progress-visibility-hardening'];
...
const CORE_ASSETS = [
  ...
  './index.html',
  './404.html',
  './assets/css/route-recovery.css?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/boot/route-recovery.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './foxbear-root.json',
  './external-browser.html',
  './assets/css/external-browser.css?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './design-preview.html',
  './assets/css/design-preview.css?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  ...
  './src/security/trusted-types-bootstrap.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/boot/kakao-entry-guard.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/boot/kakao-entry-notice.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/boot/kakao-external-browser.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  ...
  './src/workers/wav-encoder.worker.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/workers/mp3-encoder.worker.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/workers/analysis.worker.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/workers/master-finalizer.worker.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/workers/pitch-wsola.worker.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/workers/zip-encoder.worker.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/engines/pitch-engine-adapter.js',
  './assets/icons/foxbear-icon-48.png?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/icons/foxbear-icon-72.png?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/icons/foxbear-icon-96.png?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/icons/foxbear-icon-128.png?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/icons/foxbear-icon-144.png?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/icons/foxbear-icon-152.png?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/icons/foxbear-icon-180.png?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/icons/foxbear-icon-192.png?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/icons/foxbear-icon-384.png?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/icons/foxbear-icon-512.png?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/icons/foxbear-icon-16.png?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/icons/foxbear-icon-32.png?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/icons/apple-touch-icon.png?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './manifest.webmanifest?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/css/boot/performance-diagnostics.css?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/css/boot/runtime-health.css?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/css/boot/ui-shell-recovery.css?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/css/boot/kakao-entry-notice.css?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/css/theme.css?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/css/layout.css?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/css/components/base-components.css?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/css/components/forms.css?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/css/components/cards.css?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/css/components/preview-system.css?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/css/components/playback-link.css?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/css/studio.css?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/css/ui-mode.css?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/css/dock.css?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/css/dock-waveform.css?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/css/waveform-compare.css?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/css/export.css?v=1.6.109-mastering-cooperative-pcm-responsiveness&h=export-progress-v156',
  './assets/css/download-dialog.css?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/css/bulk-import-hud.css?v=1.6.109-mastering-cooperative-pcm-responsiveness&h=bulk-hud-close-hotfix&ui=v153',
  './assets/css/mobile-native.css?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/css/dock-ui-repair.css?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/css/components/floating-overlays.css?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/css/header-command-bar.css?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/css/components/support-settings.css?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/css/components/modal-close-system.css?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './vendor/jszip/jszip.min.js?v=1.6.109-mastering-cooperative-pcm-responsiveness&lib=3.10.1',
  './src/config/build-info.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/boot/release-presentation-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/boot/runtime-fault-counters.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/boot/session-handoff-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/boot/incident-route-policy.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/boot/incident-submission-identity-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/firebase-bootstrap.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/boot/incident-support-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/boot/incident-state-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/boot/incident-mail-sync-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/boot/incident-lifecycle-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/boot/incident-recovery-sweep-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/boot/incident-service-recovery-controller.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/boot/incident-recovery-policy.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/boot/incident-local-queue-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/boot/incident-queue-coordination-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/boot/incident-service-diagnostics.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/boot/incident-diagnostics-view-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/boot/incident-controls-view-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/boot/incident-reporter.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/config/mastering-presets.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/config/genre-presets.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/config/reference-targets.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/config/app-runtime-config.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/config/pwa-share-policy.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/state/app-state.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/settings/settings-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/utils/core-utils.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/utils/worker-job-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/recommendation/recommendation-engine.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/audio/mastering-inspector.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/audio/highlight-compare-inspector.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/audio/playback-link-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/audio/playback-transition-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/audio/playback-source-recovery-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/audio/playback-lifecycle-recovery-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/audio/post-master-playback-recovery-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/audio/audio-context-manager.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/audio/preview-translation-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/audio/audio-import-capability-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/audio/audio-decode-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/audio/inapp-mastering-safety-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/audio/import-preflight-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/audio/import-queue-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/audio/analysis-cache-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/audio/memory-guard-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/audio/mastering-memory-diagnostics-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/audio/reference-profile-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/audio/loudness-measurement-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/audio/mastering-input-guard-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/audio/mastering-quality-audit-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/audio/quality-gate-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/audio/mastering-orchestrator-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/audio/master-preview-job-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/state/track-lifecycle-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/audio/waveform-control-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/ui/waveform-control-view.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/ui/modal-controller.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/ui/engine-control-interaction-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/ui/ui-mode-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/ui/bottom-preview-dock-integrity-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/ui/dock-controller.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/ui/mobile-native-view.js?v=1.6.109-mastering-cooperative-pcm-responsiveness&h=bulk-hud-restore-v153',
  './src/ui/admin-access-controller.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/download/file-name-policy-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/download/file-name-workflow-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/download/download-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/download/export-guard-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness&h=export-v156',
  './src/download/export-progress-view.js?v=1.6.109-mastering-cooperative-pcm-responsiveness&h=export-progress-v156',
  './src/download/zip-export-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/download/export-queue-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/ui/download-dialog-view.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/ui/bulk-import-hud-view.js?v=1.6.109-mastering-cooperative-pcm-responsiveness&h=bulk-hud-v153',
  './src/ui/waveform-compare-view.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/ui/detail-panels-view.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/ui/detail-view.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/ui/admin-incident-loader-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/security/site-guards.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/boot/runtime-health.js?v=1.6.109-mastering-cooperative-pcm-responsiveness&h=boot-sri-v16109',
  './src/boot/ui-shell-recovery-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/boot/update-safety-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness&h=update-safety-v16109',
  './src/boot/service-worker-update-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/boot/service-worker-recovery-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/boot/worker-recovery-coordinator.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/boot/performance-diagnostics.js?v=1.6.109-mastering-cooperative-pcm-responsiveness&h=boot-sri-v16109',
  './src/boot/render-scheduler.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/boot/pwa-share-target-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/boot/pwa-runtime-bridge.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './src/app.js?v=1.6.109-mastering-cooperative-pcm-responsiveness&h=boot-sri-v16109',
  './src/boot/worker-recovery-app-bridge.js?v=1.6.109-mastering-cooperative-pcm-responsiveness',
  './assets/icons/foxbear-music.png?v=1.6.109-mastering-cooperative-pcm-responsiveness'
];

const REQUIRED_INSTALL_ASSETS = CORE_ASSETS.filter(asset =>
...
const WARM_ASSETS = CORE_ASSETS.filter(asset => !REQUIRED_INSTALL_ASSET_SET.has(asset));
WARM_ASSETS.splice(0, WARM_ASSETS.length, ...new Map(WARM_ASSETS.map(asset => [String(asset).split(/[?#]/, 1)[0], asset])).values());
...
async function warmFoxBearCoreCache(options = {}) {
  ...
  warmCachePromise = (async () => {
    ...
    await Promise.all(Array.from({ length: Math.min(WARM_CACHE_CONCURRENCY, Math.max(1, WARM_ASSETS.length)) }, worker));
...
self.addEventListener('install', event => {
  event.waitUntil((async () => {
    const cache = await caches.open(CACHE_NAME);
    // Installation blocks only on the minimum recovery shell. The normal boot
    // graph is warmed after activation, so a new worker is not held open by a
    // multi-megabyte optional download batch. Feature-only assets stay truly
    // on-demand and are cached by the normal fetch path after first use.
...
async function purgeLegacyShellCaches(options = {}) {
  ...
  if (options.probeClients === true) {
    ...
    const rollbackNames = LEGACY_CACHE_NAMES.slice(-RETAINED_LEGACY_SHELL_COUNT);
    const protectedNames = new Set([CACHE_NAME, ...rollbackNames, ...probe.cacheNames].filter(Boolean));
...
async function matchExactAcrossShellCaches(request) {
  const names = await caches.keys();
  // Exact stale-generation requests are already content-addressed by their
  // versioned URL/SRI key. Search every FoxBear shell cache so a browser that
  // restarted the SW process can still serve a long-lived offline tab even
  // before client generation reports are rebuilt in memory.
  const candidates = [CACHE_NAME, ...names.filter(name => name.startsWith('foxbear-shell-') && name !== CACHE_NAME).reverse()];
