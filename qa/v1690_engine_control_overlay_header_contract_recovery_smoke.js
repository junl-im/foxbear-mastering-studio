...
assert(fs.readFileSync('index.html', 'utf8').includes('src/ui/engine-control-interaction-service.js?v=1.6.97-boot-payload-delivery-privacy-hardening'), 'engine interaction service must load before app');
assert(fs.readFileSync('sw.js', 'utf8').includes('./src/ui/engine-control-interaction-service.js?v=1.6.97-boot-payload-delivery-privacy-hardening'), 'engine interaction service must be precached');
