...
assert(fs.readFileSync('index.html', 'utf8').includes('src/ui/engine-control-interaction-service.js?v=1.6.106-browser-geometry-history-recovery'), 'engine interaction service must load before app');
assert(fs.readFileSync('sw.js', 'utf8').includes('./src/ui/engine-control-interaction-service.js?v=1.6.106-browser-geometry-history-recovery'), 'engine interaction service must be precached');
