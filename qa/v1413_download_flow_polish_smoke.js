...
assert(index.includes('data-build="1.6.59"'), 'index build should be 1.6.59');
assert(index.includes('1.6.59-readiness-corp-security-hardening'), 'asset cache key should use v1.6.59 flow polish');
assert(sw.includes('foxbear-shell-v1.6.59-readiness-corp-security-hardening'), 'service worker cache should use v1.6.59 flow polish');
...
assert(service.includes("version: '1.6.59'"), 'download flow/diagnostics should report v1.6.59');
...
assert(matrix.includes('v1.4.26 Download flow polish'), 'QA matrix should document v1.6.59 flow polish');
