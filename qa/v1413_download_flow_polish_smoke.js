...
assert(index.includes('data-build="1.6.78"'), 'index build should be 1.6.78');
assert(index.includes('1.6.78-release-generation-assist-url-playback-invalidation'), 'asset cache key should use v1.6.78 flow polish');
assert(sw.includes('foxbear-shell-v1.6.78-release-generation-assist-url-playback-invalidation'), 'service worker cache should use v1.6.78 flow polish');
...
assert(service.includes("version: '1.6.78'"), 'download flow/diagnostics should report v1.6.78');
...
assert(matrix.includes('v1.4.26 Download flow polish'), 'QA matrix should document v1.6.78 flow polish');
