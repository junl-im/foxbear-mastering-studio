...
assert(index.includes('data-build="1.5.15"'), 'index build should be 1.5.15');
assert(index.includes('1.5.15-e2e-runtime-classification'), 'asset cache key should use v1.5.15 flow polish');
assert(sw.includes('foxbear-shell-v1.5.15-e2e-runtime-classification'), 'service worker cache should use v1.5.15 flow polish');
...
assert(service.includes("version: '1.5.15'"), 'download flow/diagnostics should report v1.5.15');
...
assert(matrix.includes('v1.4.26 Download flow polish'), 'QA matrix should document v1.5.15 flow polish');
