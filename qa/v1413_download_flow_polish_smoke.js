...
assert(index.includes('data-build="1.6.44"'), 'index build should be 1.6.44');
assert(index.includes('1.6.44-google-auth-gapi-module-trusted-types-recovery'), 'asset cache key should use v1.6.44 flow polish');
assert(sw.includes('foxbear-shell-v1.6.44-google-auth-gapi-module-trusted-types-recovery'), 'service worker cache should use v1.6.44 flow polish');
...
assert(service.includes("version: '1.6.44'"), 'download flow/diagnostics should report v1.6.44');
...
assert(matrix.includes('v1.4.26 Download flow polish'), 'QA matrix should document v1.6.44 flow polish');
