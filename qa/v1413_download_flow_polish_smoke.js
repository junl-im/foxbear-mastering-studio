...
assert(index.includes('data-build="1.6.66"'), 'index build should be 1.6.66');
assert(index.includes('1.6.66-static-gate-hygiene-repair'), 'asset cache key should use v1.6.66 flow polish');
assert(sw.includes('foxbear-shell-v1.6.66-static-gate-hygiene-repair'), 'service worker cache should use v1.6.66 flow polish');
...
assert(service.includes("version: '1.6.66'"), 'download flow/diagnostics should report v1.6.66');
...
assert(matrix.includes('v1.4.26 Download flow polish'), 'QA matrix should document v1.6.66 flow polish');
