...
assert(index.includes('data-build="1.6.79"'), 'index build should be 1.6.79');
assert(index.includes('1.6.79-manifestless-patch-playback-retirement'), 'asset cache key should use v1.6.79 flow polish');
assert(sw.includes('foxbear-shell-v1.6.79-manifestless-patch-playback-retirement'), 'service worker cache should use v1.6.79 flow polish');
...
assert(service.includes("version: '1.6.79'"), 'download flow/diagnostics should report v1.6.79');
...
assert(matrix.includes('v1.4.26 Download flow polish'), 'QA matrix should document v1.6.79 flow polish');
