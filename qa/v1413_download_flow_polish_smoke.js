...
assert(index.includes('data-build="1.5.69"'), 'index build should be 1.5.69');
assert(index.includes('1.5.69-mail-receipt-confirmation-history-branded-template'), 'asset cache key should use v1.5.69 flow polish');
assert(sw.includes('foxbear-shell-v1.5.69-mail-receipt-confirmation-history-branded-template'), 'service worker cache should use v1.5.69 flow polish');
...
assert(service.includes("version: '1.5.69'"), 'download flow/diagnostics should report v1.5.69');
...
assert(matrix.includes('v1.4.26 Download flow polish'), 'QA matrix should document v1.5.69 flow polish');
