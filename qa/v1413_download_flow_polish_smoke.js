...
assert(index.includes('data-build="1.6.45"'), 'index build should be 1.6.45');
assert(index.includes('1.6.45-windows-release-gate-spark-hosting-no-app-check'), 'asset cache key should use v1.6.45 flow polish');
assert(sw.includes('foxbear-shell-v1.6.45-windows-release-gate-spark-hosting-no-app-check'), 'service worker cache should use v1.6.45 flow polish');
...
assert(service.includes("version: '1.6.45'"), 'download flow/diagnostics should report v1.6.45');
...
assert(matrix.includes('v1.4.26 Download flow polish'), 'QA matrix should document v1.6.45 flow polish');
