...
assert(index.includes('data-build="1.4.26"'), 'index build should be 1.4.26');
assert(index.includes('1.4.26-wake-lock-state-sync'), 'asset cache key should use v1.4.26 flow polish');
assert(sw.includes('foxbear-shell-v1.4.26-wake-lock-state-sync'), 'service worker cache should use v1.4.26 flow polish');
...
assert(service.includes("version: '1.4.26'"), 'download flow/diagnostics should report v1.4.26');
...
assert(matrix.includes('v1.4.26 Download flow polish'), 'QA matrix should document v1.4.26 flow polish');
