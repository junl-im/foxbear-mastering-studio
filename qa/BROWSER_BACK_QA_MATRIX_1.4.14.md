# v1.4.20 Download action clarity QA matrix
...
- v1.4.20 Dock FFT/back confirm focus remains cumulative from v1.4.6/v1.4.7 stability work.
...
- v1.4.20 Download flow polish remains cumulative while v1.4.20 Download action clarity resolves button/action ambiguity.
