...
must(studioCss.includes('.dock-integrated-waveform-bars.has-live-playhead') || dockCss.includes('.dock-integrated-waveform-bars.has-live-playhead') || dockWaveformCss.includes('.dock-integrated-waveform-bars.has-live-playhead'), 'dock integrated live playhead styling missing');
