...
must(studioCss.includes('--waveform-playhead-pct') || dockCss.includes('--waveform-playhead-pct') || compareCss.includes('--waveform-playhead-pct'), 'live playhead CSS variable missing');
