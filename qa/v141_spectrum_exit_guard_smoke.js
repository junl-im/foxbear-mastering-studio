...
must(pkg.qaChecks.includes('node qa/v141_spectrum_exit_guard_smoke.js'), 'package should run v1.4.23 smoke');
...
must(handoff.includes('v1.4.23') && handoff.includes('Spectrum'), 'handoff should mention v1.4.23 spectrum update');
must(notes.includes('v1.4.23') && notes.includes('Exit Guard'), 'project notes should mention v1.4.23 exit guard');
must(changelog.includes('v1.4.23') && changelog.includes('Spectrum'), 'changelog should include v1.4.23 entry');

console.log('PASS v1.4.23 spectrum visualizer and exit guard smoke');
