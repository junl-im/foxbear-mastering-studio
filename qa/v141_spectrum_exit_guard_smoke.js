...
must(pkg.qaChecks.includes('node qa/v141_spectrum_exit_guard_smoke.js'), 'package should run v1.4.8 smoke');
...
must(handoff.includes('v1.4.8') && handoff.includes('Spectrum'), 'handoff should mention v1.4.8 spectrum update');
must(notes.includes('v1.4.8') && notes.includes('Exit Guard'), 'project notes should mention v1.4.8 exit guard');
must(changelog.includes('v1.4.8') && changelog.includes('Spectrum'), 'changelog should include v1.4.8 entry');

console.log('PASS v1.4.8 spectrum visualizer and exit guard smoke');
