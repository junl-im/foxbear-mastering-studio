...
must(pkg.qaChecks.includes('node qa/v141_spectrum_exit_guard_smoke.js'), 'package should run v1.5.10 smoke');
...
must(handoff.includes('v1.5.10') && handoff.includes('Spectrum'), 'handoff should mention v1.5.10 spectrum update');
must(notes.includes('v1.5.10') && notes.includes('Exit Guard'), 'project notes should mention v1.5.10 exit guard');
must(changelog.includes('v1.5.10') && changelog.includes('Spectrum'), 'changelog should include v1.5.10 entry');
