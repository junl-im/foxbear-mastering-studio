...
assert(index.includes('data-build="1.5.61"'), 'index data-build should be 1.5.61');
assert(index.includes('1.5.61-worker-mail-delivery-recovery'), 'index assets should use v1.5.61 cache key');
