...
assert(index.includes('data-build="1.5.74"'), 'index data-build should be 1.5.74');
assert(index.includes('1.5.74-bulk-pause-skip-reorder-mobile-download'), 'index assets should use v1.5.74 cache key');
