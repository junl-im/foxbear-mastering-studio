...
assert(index.includes('data-build="1.5.25"'), 'index data-build should be 1.5.25');
assert(index.includes('1.5.25-e2e-preview-stability'), 'index assets should use v1.5.25 cache key');
