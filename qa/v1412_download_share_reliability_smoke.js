...
assert(index.includes('data-build="1.6.91"'), 'index data-build should be 1.6.91');
assert(index.includes('1.6.91-runtime-health-hidden-geometry-contract-recovery'), 'index assets should use v1.6.91 cache key');
