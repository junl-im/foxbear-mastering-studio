...
assert(index.includes('data-build="1.5.27"'), 'index data-build should be 1.5.27');
assert(index.includes('1.5.27-device-glyph-sri-hardening'), 'index assets should use v1.5.27 cache key');
