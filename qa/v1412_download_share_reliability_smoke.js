...
assert(index.includes('data-build="1.6.86"'), 'index data-build should be 1.6.86');
assert(index.includes('1.6.86-header-order-mobile-overflow-browser-gate-recovery'), 'index assets should use v1.6.86 cache key');
