...
assert(index.includes('data-build="1.6.92"'), 'index data-build should be 1.6.92');
assert(index.includes('1.6.92-spectrum-panel-mount-lifecycle-recovery'), 'index assets should use v1.6.92 cache key');
