...
assert(index.includes('data-build="1.5.49"'), 'index data-build should be 1.5.49');
assert(index.includes('1.5.49-asset-generation-route-recovery'), 'index assets should use v1.5.49 cache key');
