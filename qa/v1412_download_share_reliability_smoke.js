...
assert(index.includes('data-build="1.5.19"'), 'index data-build should be 1.5.19');
assert(index.includes('1.5.19-ci-runtime-isolation-package-hardening'), 'index assets should use v1.5.19 cache key');
