...
assert(index.includes('data-build="1.5.42"'), 'index data-build should be 1.5.42');
assert(index.includes('1.5.42-zip-worker-cancellation'), 'index assets should use v1.5.42 cache key');
