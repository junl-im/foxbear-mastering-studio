...
assert(index.includes('data-build="1.5.9"'), 'index data-build should be 1.5.9');
assert(index.includes('1.5.9-version-display-cache-recovery'), 'index assets should use v1.5.9 cache key');
