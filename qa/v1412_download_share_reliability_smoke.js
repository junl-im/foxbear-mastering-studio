...
assert(index.includes('data-build="1.6.73"'), 'index data-build should be 1.6.73');
assert(index.includes('1.6.73-csp-memory-admission-runtime-config'), 'index assets should use v1.6.73 cache key');
