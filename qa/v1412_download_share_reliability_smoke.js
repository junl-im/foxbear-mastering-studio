...
assert(index.includes('data-build="1.6.70"'), 'index data-build should be 1.6.70');
assert(index.includes('1.6.70-share-retry-policy-drift-ci-efficiency'), 'index assets should use v1.6.70 cache key');
