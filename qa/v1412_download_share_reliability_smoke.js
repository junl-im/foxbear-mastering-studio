...
assert(index.includes('data-build="1.6.59"'), 'index data-build should be 1.6.59');
assert(index.includes('1.6.59-readiness-corp-security-hardening'), 'index assets should use v1.6.59 cache key');
