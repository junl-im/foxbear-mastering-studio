...
assert(index.includes('data-build="1.5.20"'), 'index data-build should be 1.5.20');
assert(index.includes('1.5.20-idempotent-pwa-cache-warm'), 'index assets should use v1.5.20 cache key');
