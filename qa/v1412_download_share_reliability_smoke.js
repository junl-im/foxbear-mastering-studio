...
assert(index.includes('data-build="1.6.102"'), 'index data-build should be 1.6.102');
assert(index.includes('1.6.102-admin-lazyload-sw-hygiene-hardening'), 'index assets should use v1.6.102 cache key');
