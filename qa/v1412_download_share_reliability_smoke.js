...
assert(index.includes('data-build="1.6.87"'), 'index data-build should be 1.6.87');
assert(index.includes('1.6.87-mobile-header-device-label-overlap-recovery'), 'index assets should use v1.6.87 cache key');
