...
assert(index.includes('data-build="1.5.41"'), 'index data-build should be 1.5.41');
assert(index.includes('1.5.41-export-eta-download-recovery'), 'index assets should use v1.5.41 cache key');
