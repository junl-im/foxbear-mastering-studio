...
assert(index.includes('data-build="1.5.67"'), 'index data-build should be 1.5.67');
assert(index.includes('1.5.67-incident-admin-audit-webhook-failover-index-health'), 'index assets should use v1.5.67 cache key');
