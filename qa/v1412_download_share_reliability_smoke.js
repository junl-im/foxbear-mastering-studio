...
assert(index.includes('data-build="1.5.79"'), 'index data-build should be 1.5.79');
assert(index.includes('1.5.79-preview-download-ownership-recovery'), 'index assets should use v1.5.79 cache key');
