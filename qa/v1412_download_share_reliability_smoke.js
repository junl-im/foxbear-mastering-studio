...
assert(index.includes('data-build="1.6.103"'), 'index data-build should be 1.6.103');
assert(index.includes('1.6.103-ci-hygiene-mail-routing-hardening'), 'index assets should use v1.6.103 cache key');
