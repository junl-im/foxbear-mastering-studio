...
assert(index.includes('data-build="1.5.38"'), 'index data-build should be 1.5.38');
assert(index.includes('1.5.38-preflight-worker-multitab-hardening'), 'index assets should use v1.5.38 cache key');
