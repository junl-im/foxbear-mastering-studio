...
assert(index.includes('data-build="1.6.13"'), 'index data-build should be 1.6.13');
assert(index.includes('1.6.13-download-format-context-menu'), 'index assets should use v1.6.13 cache key');
