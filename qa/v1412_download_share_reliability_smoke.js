...
assert(index.includes('data-build="1.5.54"'), 'index data-build should be 1.5.54');
assert(index.includes('1.5.54-quality-recovery-profiles-browser-qa'), 'index assets should use v1.5.54 cache key');
