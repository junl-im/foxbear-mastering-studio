...
assert(index.includes('data-build="1.5.96"'), 'index data-build should be 1.5.96');
assert(index.includes('1.5.96-modal-focus-memory-diagnostics'), 'index assets should use v1.5.96 cache key');
