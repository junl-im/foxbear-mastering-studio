...
assert(index.includes('data-build="1.6.66"'), 'index data-build should be 1.6.66');
assert(index.includes('1.6.66-static-gate-hygiene-repair'), 'index assets should use v1.6.66 cache key');
