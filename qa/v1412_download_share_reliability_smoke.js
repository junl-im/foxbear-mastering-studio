...
assert(index.includes('data-build="1.6.79"'), 'index data-build should be 1.6.79');
assert(index.includes('1.6.79-manifestless-patch-playback-retirement'), 'index assets should use v1.6.79 cache key');
