...
assert(index.includes('data-build="1.6.4"'), 'index data-build should be 1.6.4');
assert(index.includes('1.6.4-incident-callable-csp-recovery'), 'index assets should use v1.6.4 cache key');
