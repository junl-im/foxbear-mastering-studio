...
assert(index.includes('data-build="1.5.50"'), 'index data-build should be 1.5.50');
assert(index.includes('1.5.50-pwa-current-cache-test-recovery'), 'index assets should use v1.5.50 cache key');
