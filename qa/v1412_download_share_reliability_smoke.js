...
assert(index.includes('data-build="1.5.51"'), 'index data-build should be 1.5.51');
assert(index.includes('1.5.51-ci-runtime-contract-hardening'), 'index assets should use v1.5.51 cache key');
