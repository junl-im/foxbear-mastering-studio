...
assert(index.includes('data-build="1.6.93"'), 'index data-build should be 1.6.93');
assert(index.includes('1.6.93-mobile-dock-visibility-integrity-recovery'), 'index assets should use v1.6.93 cache key');
