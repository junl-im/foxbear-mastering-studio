...
assert(index.includes('data-build="1.5.18"'), 'index data-build should be 1.5.18');
assert(index.includes('1.5.18-ci-diagnostics-pwa-readiness'), 'index assets should use v1.5.18 cache key');
