...
assert(index.includes('data-build="1.5.31"'), 'index data-build should be 1.5.31');
assert(index.includes('1.5.31-player-download-stability'), 'index assets should use v1.5.31 cache key');
