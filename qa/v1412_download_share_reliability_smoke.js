...
assert(index.includes('data-build="1.6.111"'), 'index data-build should be 1.6.111');
assert(index.includes('1.6.111-ui-mode-session-contract-hardening'), 'index assets should use v1.6.111 cache key');
