...
assert(index.includes('data-build="1.5.68"'), 'index data-build should be 1.5.68');
assert(index.includes('1.5.68-mail-delivery-verification-sender-subject-rules'), 'index assets should use v1.5.68 cache key');
