...
assert(index.includes('data-build="1.5.91"'), 'index data-build should be 1.5.91');
assert(index.includes('1.5.91-cancellable-audio-pipeline-performance-guards'), 'index assets should use v1.5.91 cache key');
