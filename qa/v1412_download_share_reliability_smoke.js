...
assert(index.includes('data-build="1.5.93"'), 'index data-build should be 1.5.93');
assert(index.includes('1.5.93-external-engine-transfer-admin-export-openai-readiness'), 'index assets should use v1.5.93 cache key');
