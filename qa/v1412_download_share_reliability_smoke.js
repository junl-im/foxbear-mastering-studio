...
assert(index.includes('data-build="1.6.113"'), 'index data-build should be 1.6.113');
assert(index.includes('1.6.113-incident-finalizer-p1-hardening'), 'index assets should use v1.6.113 cache key');
