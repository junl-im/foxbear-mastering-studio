...
assert(index.includes('data-build="1.5.22"'), 'index data-build should be 1.5.22');
assert(index.includes('1.5.22-header-preview-routing-polish'), 'index assets should use v1.5.22 cache key');
