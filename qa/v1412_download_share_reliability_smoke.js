...
assert(index.includes('data-build="1.6.105"'), 'index data-build should be 1.6.105');
assert(index.includes('1.6.105-header-dock-css-ownership-hardening'), 'index assets should use v1.6.105 cache key');
