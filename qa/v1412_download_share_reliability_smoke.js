...
assert(index.includes('data-build="1.5.17"'), 'index data-build should be 1.5.17');
assert(index.includes('1.5.17-browser-contract-fix'), 'index assets should use v1.5.17 cache key');
