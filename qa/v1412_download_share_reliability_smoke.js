...
assert(index.includes('data-build="1.6.106"'), 'index data-build should be 1.6.106');
assert(index.includes('1.6.106-browser-geometry-history-recovery'), 'index assets should use v1.6.106 cache key');
