...
assert(index.includes('data-build="1.5.66"'), 'index data-build should be 1.5.66');
assert(index.includes('1.5.66-incident-operations-action-guard-deploy-verification'), 'index assets should use v1.5.66 cache key');
