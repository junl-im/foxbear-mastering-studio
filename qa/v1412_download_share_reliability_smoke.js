...
assert(index.includes('data-build="1.6.104"'), 'index data-build should be 1.6.104');
assert(index.includes('1.6.104-boot-emergency-visit-privacy-hardening'), 'index assets should use v1.6.104 cache key');
