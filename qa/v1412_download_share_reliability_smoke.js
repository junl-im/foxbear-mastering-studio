...
assert(index.includes('data-build="1.6.37"'), 'index data-build should be 1.6.37');
assert(index.includes('1.6.37-ui-shell-cross-generation-recovery'), 'index assets should use v1.6.37 cache key');
