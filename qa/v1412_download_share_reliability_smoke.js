...
assert(index.includes('data-build="1.5.7"'), 'index data-build should be 1.5.7');
assert(index.includes('1.5.7-release-foundation'), 'index assets should use v1.5.7 cache key');
