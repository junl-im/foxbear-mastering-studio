...
assert(index.includes('data-build="1.6.39"'), 'index data-build should be 1.6.39');
assert(index.includes('1.6.39-ui-shell-partial-script-probe-isolation'), 'index assets should use v1.6.39 cache key');
