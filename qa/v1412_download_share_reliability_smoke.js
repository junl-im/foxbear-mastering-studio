...
assert(index.includes('data-build="1.6.112"'), 'index data-build should be 1.6.112');
assert(index.includes('1.6.112-mastering-lifecycle-race-hardening'), 'index assets should use v1.6.112 cache key');
