...
assert(index.includes('data-build="1.6.50"'), 'index data-build should be 1.6.50');
assert(index.includes('1.6.50-kakao-centered-entry-notice'), 'index assets should use v1.6.50 cache key');
