...
assert(index.includes('data-build="1.5.99"'), 'index data-build should be 1.5.99');
assert(index.includes('1.5.99-incident-callable-mail-recovery'), 'index assets should use v1.5.99 cache key');
