...
assert(index.includes('data-build="1.5.94"'), 'index data-build should be 1.5.94');
assert(index.includes('1.5.94-aiff-fallback-worker-diagnostics-reporting-contract'), 'index assets should use v1.5.94 cache key');
