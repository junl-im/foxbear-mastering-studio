...
assert(index.includes('data-build="1.6.22"'), 'index data-build should be 1.6.22');
assert(index.includes('1.6.22-incident-recovery-coalescing-time-decay'), 'index assets should use v1.6.22 cache key');
