...
assert(index.includes('data-build="1.5.21"'), 'index data-build should be 1.5.21');
assert(index.includes('1.5.21-history-csp-console-contract-fix'), 'index assets should use v1.5.21 cache key');
