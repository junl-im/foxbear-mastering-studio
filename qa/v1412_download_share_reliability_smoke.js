...
assert(index.includes('data-build="1.5.10"'), 'index data-build should be 1.5.10');
assert(index.includes('1.5.10-header-settings-relocation'), 'index assets should use v1.5.10 cache key');
