...
assert(index.includes('data-build="1.6.89"'), 'index data-build should be 1.6.89');
assert(index.includes('1.6.89-mobile-header-flex-ownership-browser-gate-recovery'), 'index assets should use v1.6.89 cache key');
