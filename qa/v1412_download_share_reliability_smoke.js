...
assert(index.includes('data-build="1.6.34"'), 'index data-build should be 1.6.34');
assert(index.includes('1.6.34-history-hard-stall-sw-activity-lifecycle'), 'index assets should use v1.6.34 cache key');
