...
assert(index.includes('data-build="1.6.83"'), 'index data-build should be 1.6.83');
assert(index.includes('1.6.83-browser-ui-mode-fixture-source-hygiene-recovery'), 'index assets should use v1.6.83 cache key');
