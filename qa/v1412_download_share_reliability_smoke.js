...
assert(index.includes('data-build="1.5.34"'), 'index data-build should be 1.5.34');
assert(index.includes('1.5.34-kakao-landing-recovery'), 'index assets should use v1.5.34 cache key');
