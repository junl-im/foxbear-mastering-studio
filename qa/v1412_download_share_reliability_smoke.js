...
assert(index.includes('data-build="1.5.65"'), 'index data-build should be 1.5.65');
assert(index.includes('1.5.65-incident-recovery-control-alert-history'), 'index assets should use v1.5.65 cache key');
