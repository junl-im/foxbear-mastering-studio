...
const assert = (condition, message) => {
  if (!condition) {
    console.error(`FAIL v1.4.24 download/share reliability smoke: ${message}`);
    process.exit(1);
  }
};
...
assert(index.includes('data-build="1.4.24"'), 'index data-build should be 1.4.24');
assert(index.includes('1.4.24-bulk-import-hud'), 'index assets should use v1.4.24 cache key');
...
console.log('PASS v1.4.24 download/share reliability smoke');
