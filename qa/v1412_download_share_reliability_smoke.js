...
assert(index.includes('data-build="1.5.28"'), 'index data-build should be 1.5.28');
assert(index.includes('1.5.28-resilience-lifecycle-offline-recovery'), 'index assets should use v1.5.28 cache key');
