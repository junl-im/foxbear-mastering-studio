...
assert(index.includes('data-build="1.7.0"'), 'index data-build should be 1.7.0');
assert(index.includes('1.7.0-adaptive-mastering-decision-phase1'), 'index assets should use v1.7.0 cache key');
