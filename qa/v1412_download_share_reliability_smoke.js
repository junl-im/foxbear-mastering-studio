...
assert(index.includes('data-build="1.6.99"'), 'index data-build should be 1.6.99');
assert(index.includes('1.6.99-header-role-focus-integrity'), 'index assets should use v1.6.99 cache key');
