...
assert(index.includes('data-build="1.5.16"'), 'index data-build should be 1.5.16');
assert(index.includes('1.5.16-e2e-server-pipe-deadlock-fix'), 'index assets should use v1.5.16 cache key');
