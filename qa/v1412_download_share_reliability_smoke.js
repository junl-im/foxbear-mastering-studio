...
assert(index.includes('data-build="1.5.47"'), 'index data-build should be 1.5.47');
assert(index.includes('1.5.47-engine-edgecase-quality-gate'), 'index assets should use v1.5.47 cache key');
