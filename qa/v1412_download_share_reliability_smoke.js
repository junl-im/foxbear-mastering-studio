...
assert(index.includes('data-build="1.5.82"'), 'index data-build should be 1.5.82');
assert(index.includes('1.5.82-mastering-cancel-playback-resume-recovery'), 'index assets should use v1.5.82 cache key');
