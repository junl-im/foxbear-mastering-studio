...
assert(index.includes('data-build="1.6.82"'), 'index data-build should be 1.6.82');
assert(index.includes('1.6.82-overlay-focus-ancestor-hardening'), 'index assets should use v1.6.82 cache key');
