...
assert(index.includes('data-build="1.5.53"'), 'index data-build should be 1.5.53');
assert(index.includes('1.5.53-engine-recovery-performance-diagnostics'), 'index assets should use v1.5.53 cache key');
