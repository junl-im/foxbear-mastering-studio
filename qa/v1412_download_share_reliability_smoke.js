...
assert(index.includes('data-build="1.5.36"'), 'index data-build should be 1.5.36');
assert(index.includes('1.5.36-interaction-lifecycle-hardening'), 'index assets should use v1.5.36 cache key');
