...
assert(index.includes('data-build="1.5.37"'), 'index data-build should be 1.5.37');
assert(index.includes('1.5.37-memory-import-waveform-hardening'), 'index assets should use v1.5.37 cache key');
