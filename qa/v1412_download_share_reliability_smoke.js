...
assert(index.includes('data-build="1.6.97"'), 'index data-build should be 1.6.97');
assert(index.includes('1.6.97-boot-payload-delivery-privacy-hardening'), 'index assets should use v1.6.97 cache key');
