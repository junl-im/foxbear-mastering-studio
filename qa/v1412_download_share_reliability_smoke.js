...
assert(index.includes('data-build="1.6.78"'), 'index data-build should be 1.6.78');
assert(index.includes('1.6.78-release-generation-assist-url-playback-invalidation'), 'index assets should use v1.6.78 cache key');
