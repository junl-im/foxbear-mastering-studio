...
assert(index.includes('data-build="1.6.108"'), 'index data-build should be 1.6.108');
assert(index.includes('1.6.108-mastering-progress-visibility-hardening'), 'index assets should use v1.6.108 cache key');
