...
assert(index.includes('data-build="1.6.12"'), 'index data-build should be 1.6.12');
assert(index.includes('1.6.12-mastering-tone-loudness-fastpath'), 'index assets should use v1.6.12 cache key');
