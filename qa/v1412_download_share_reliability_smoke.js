...
assert(index.includes('data-build="1.5.84"'), 'index data-build should be 1.5.84');
assert(index.includes('1.5.84-trusted-types-browser-gate-recovery'), 'index assets should use v1.5.84 cache key');
