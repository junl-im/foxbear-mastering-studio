...
assert(index.includes('data-build="1.6.88"'), 'index data-build should be 1.6.88');
assert(index.includes('1.6.88-mobile-header-grid-ownership-recovery'), 'index assets should use v1.6.88 cache key');
