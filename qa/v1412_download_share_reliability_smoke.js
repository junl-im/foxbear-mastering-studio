...
assert(index.includes('data-build="1.5.59"'), 'index data-build should be 1.5.59');
assert(index.includes('1.5.59-kakao-session-handoff-memory-diagnostics'), 'index assets should use v1.5.59 cache key');
