...
assert(index.includes('data-build="1.6.71"'), 'index data-build should be 1.6.71');
assert(index.includes('1.6.71-pwa-share-lease-handoff-deploy-policy-e2e'), 'index assets should use v1.6.71 cache key');
