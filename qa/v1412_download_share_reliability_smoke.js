...
assert(index.includes('data-build="1.4.26"'), 'index data-build should be 1.4.26');
assert(index.includes('1.4.26-wake-lock-state-sync'), 'index assets should use v1.4.26 cache key');
