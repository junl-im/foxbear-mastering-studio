...
assert(index.includes('data-build="1.6.40"'), 'index data-build should be 1.6.40');
assert(index.includes('1.6.40-ui-shell-retry-replacement-settlement'), 'index assets should use v1.6.40 cache key');
