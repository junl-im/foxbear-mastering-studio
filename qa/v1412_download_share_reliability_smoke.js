...
assert(index.includes('data-build="1.6.61"'), 'index data-build should be 1.6.61');
assert(index.includes('1.6.61-human-readable-download-filenames'), 'index assets should use v1.6.61 cache key');
