...
assert(index.includes('data-build="1.6.47"'), 'index data-build should be 1.6.47');
assert(index.includes('1.6.47-external-host-admin-auth-opaque-error-recovery'), 'index assets should use v1.6.47 cache key');
