...
assert(index.includes('data-build="1.5.90"'), 'index data-build should be 1.5.90');
assert(index.includes('1.5.90-browser-retry-integrity-metadata-aware-scope'), 'index assets should use v1.5.90 cache key');
