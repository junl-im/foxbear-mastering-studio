...
assert(index.includes('data-build="1.6.100"'), 'index data-build should be 1.6.100');
assert(index.includes('1.6.100-sw-stereo-ci-cleanup-hardening'), 'index assets should use v1.6.100 cache key');
