...
assert(index.includes('data-build="1.5.30"'), 'index data-build should be 1.5.30');
assert(index.includes('1.5.30-inapp-playback-recovery'), 'index assets should use v1.5.30 cache key');
