...
assert(index.includes('data-build="1.5.56"'), 'index data-build should be 1.5.56');
assert(index.includes('1.5.56-incident-operations-app-check'), 'index assets should use v1.5.56 cache key');
