...
assert(index.includes('data-build="1.5.80"'), 'index data-build should be 1.5.80');
assert(index.includes('1.5.80-mobile-return-media-focus-recovery'), 'index assets should use v1.5.80 cache key');
