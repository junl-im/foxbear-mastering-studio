...
assert(index.includes('data-build="1.6.90"'), 'index data-build should be 1.6.90');
assert(index.includes('1.6.90-engine-control-overlay-isolation-header-contract-recovery'), 'index assets should use v1.6.90 cache key');
