...
assert(index.includes('data-build="1.5.62"'), 'index data-build should be 1.5.62');
assert(index.includes('1.5.62-incident-delivery-watchdog-package-gate'), 'index assets should use v1.5.62 cache key');
