...
assert(index.includes('data-build="1.5.55"'), 'index data-build should be 1.5.55');
assert(index.includes('1.5.55-automatic-incident-mail-reporting'), 'index assets should use v1.5.55 cache key');
