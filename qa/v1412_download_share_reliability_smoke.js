...
assert(index.includes('data-build="1.5.45"'), 'index data-build should be 1.5.45');
assert(index.includes('1.5.45-export-queue-recovery'), 'index assets should use v1.5.45 cache key');
