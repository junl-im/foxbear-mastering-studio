...
assert(index.includes('data-build="1.5.64"'), 'index data-build should be 1.5.64');
assert(index.includes('1.5.64-incident-operations-health-self-diagnostics'), 'index assets should use v1.5.64 cache key');
