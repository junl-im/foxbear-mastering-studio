...
assert(index.includes('data-build="1.5.15"'), 'index data-build should be 1.5.15');
assert(index.includes('1.5.15-e2e-runtime-classification'), 'index assets should use v1.5.15 cache key');
