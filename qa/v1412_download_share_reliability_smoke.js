...
assert(index.includes('data-build="1.6.49"'), 'index data-build should be 1.6.49');
assert(index.includes('1.6.49-download-variant-cache-reuse'), 'index assets should use v1.6.49 cache key');
