...
assert(index.includes('data-build="1.6.20"'), 'index data-build should be 1.6.20');
assert(index.includes('1.6.20-incident-background-sync-network-decay'), 'index assets should use v1.6.20 cache key');
