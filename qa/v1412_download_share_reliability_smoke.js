...
assert(index.includes('data-build="1.6.25"'), 'index data-build should be 1.6.25');
assert(index.includes('1.6.25-incident-recovery-timeout-abort-stress'), 'index assets should use v1.6.25 cache key');
