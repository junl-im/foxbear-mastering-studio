...
assert(index.includes('data-build="1.5.29"'), 'index data-build should be 1.5.29');
assert(index.includes('1.5.29-analysis-update-lifecycle'), 'index assets should use v1.5.29 cache key');
