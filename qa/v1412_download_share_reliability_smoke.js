...
assert(index.includes('data-build="1.5.98"'), 'index data-build should be 1.5.98');
assert(index.includes('1.5.98-worker-retry-health-levels'), 'index assets should use v1.5.98 cache key');
