...
assert(index.includes('data-build="1.5.92"'), 'index data-build should be 1.5.92');
assert(index.includes('1.5.92-python-bytecode-ci-hygiene-node24-cache'), 'index assets should use v1.5.92 cache key');
