...
assert(index.includes('data-build="1.6.101"'), 'index data-build should be 1.6.101');
assert(index.includes('1.6.101-admin-lazyload-repo-cleanup'), 'index assets should use v1.6.101 cache key');
