...
assert(index.includes('data-build="1.6.109"'), 'index data-build should be 1.6.109');
assert(index.includes('1.6.109-mastering-cooperative-pcm-responsiveness'), 'index assets should use v1.6.109 cache key');
