...
assert(index.includes('data-build="1.6.110"'), 'index data-build should be 1.6.110');
assert(index.includes('1.6.110-ui-mode-early-boot-recovery'), 'index assets should use v1.6.110 cache key');
