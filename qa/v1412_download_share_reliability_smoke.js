...
assert(index.includes('data-build="1.6.80"'), 'index data-build should be 1.6.80');
assert(index.includes('1.6.80-ai-mastering-expert-workspace'), 'index assets should use v1.6.80 cache key');
