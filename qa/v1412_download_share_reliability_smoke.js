...
assert(index.includes('data-build="1.6.85"'), 'index data-build should be 1.6.85');
assert(index.includes('1.6.85-browser-sentinel-ui-mode-header-recovery'), 'index assets should use v1.6.85 cache key');
