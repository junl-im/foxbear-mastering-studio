...
assert(index.includes('data-build="1.5.14"'), 'index data-build should be 1.5.14');
assert(index.includes('1.5.14-github-desktop-handoff-preflight'), 'index assets should use v1.5.14 cache key');
