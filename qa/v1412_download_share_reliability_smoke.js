...
assert(index.includes('data-build="1.5.81"'), 'index data-build should be 1.5.81');
assert(index.includes('1.5.81-master-preview-cancellation-native-result-isolation'), 'index assets should use v1.5.81 cache key');
