...
assert(index.includes('data-build="1.6.58"'), 'index data-build should be 1.6.58');
assert(index.includes('1.6.58-piano-transient-integrity'), 'index assets should use v1.6.58 cache key');
