...
assert(index.includes('data-build="1.6.98"'), 'index data-build should be 1.6.98');
assert(index.includes('1.6.98-spectrum-retirement-mobile-header-integrity'), 'index assets should use v1.6.98 cache key');
