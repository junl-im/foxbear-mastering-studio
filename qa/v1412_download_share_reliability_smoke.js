...
assert(index.includes('data-build="1.6.94"'), 'index data-build should be 1.6.94');
assert(index.includes('1.6.94-release-integrity-hardening'), 'index assets should use v1.6.94 cache key');
