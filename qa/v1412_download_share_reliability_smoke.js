...
assert(index.includes('data-build="1.5.95"'), 'index data-build should be 1.5.95');
assert(index.includes('1.5.95-popup-settings-mail-test-recovery'), 'index assets should use v1.5.95 cache key');
