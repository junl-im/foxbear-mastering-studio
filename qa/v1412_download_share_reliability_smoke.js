...
assert(index.includes('data-build="1.5.26"'), 'index data-build should be 1.5.26');
assert(index.includes('1.5.26-engraved-command-header'), 'index assets should use v1.5.26 cache key');
