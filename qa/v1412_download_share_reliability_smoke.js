...
assert(index.includes('data-build="1.6.56"'), 'index data-build should be 1.6.56');
assert(index.includes('1.6.56-playback-blob-source-resilience'), 'index assets should use v1.6.56 cache key');
