...
assert(index.includes('data-build="1.7.4"'), 'index data-build should be 1.7.4');
assert(index.includes('1.7.4-reload-reentry-mode-chooser'), 'index assets should use v1.7.4 cache key');
