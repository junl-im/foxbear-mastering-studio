...
assert(index.includes('data-build="1.6.95"'), 'index data-build should be 1.6.95');
assert(index.includes('1.6.95-release-artifact-safety'), 'index assets should use v1.6.95 cache key');
