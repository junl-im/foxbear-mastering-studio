...
assert(index.includes('data-build="1.5.46"'), 'index data-build should be 1.5.46');
assert(index.includes('1.5.46-engine-recommendation-api-audit'), 'index assets should use v1.5.46 cache key');
