...
assert(index.includes('data-build="1.6.9"'), 'index data-build should be 1.6.9');
assert(index.includes('1.6.9-incident-readiness-history-recovery-copy-events'), 'index assets should use v1.6.9 cache key');
