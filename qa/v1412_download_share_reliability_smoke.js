...
assert(index.includes('data-build="1.5.60"'), 'index data-build should be 1.5.60');
assert(index.includes('1.5.60-kakao-inapp-entry-memory-governor'), 'index assets should use v1.5.60 cache key');
