...
assert(index.includes('data-build="1.5.13"'), 'index data-build should be 1.5.13');
assert(index.includes('1.5.13-handoff-package-integrity'), 'index assets should use v1.5.13 cache key');
