...
assert(index.includes('data-build="1.6.84"'), 'index data-build should be 1.6.84');
assert(index.includes('1.6.84-tracked-windows-cleanup-static-gate-recovery'), 'index assets should use v1.6.84 cache key');
