...
assert(index.includes('data-build="1.5.43"'), 'index data-build should be 1.5.43');
assert(index.includes('1.5.43-export-pipeline-integrity'), 'index assets should use v1.5.43 cache key');
