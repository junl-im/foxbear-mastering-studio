...
assert(index.includes('data-build="1.6.2"'), 'index data-build should be 1.6.2');
assert(index.includes('1.6.2-nonblocking-health-status-design-polish'), 'index assets should use v1.6.2 cache key');
