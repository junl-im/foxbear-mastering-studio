...
assert(index.includes('data-build="1.6.7"'), 'index data-build should be 1.6.7');
assert(index.includes('1.6.7-incident-readiness-history-sync-performance-hud'), 'index assets should use v1.6.7 cache key');
