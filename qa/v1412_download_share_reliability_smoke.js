...
assert(index.includes('data-build="1.6.63"'), 'index data-build should be 1.6.63');
assert(index.includes('1.6.63-download-filename-review-hardening'), 'index assets should use v1.6.63 cache key');
