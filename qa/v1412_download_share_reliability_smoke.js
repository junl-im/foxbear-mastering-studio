...
assert(index.includes('data-build="1.6.72"'), 'index data-build should be 1.6.72');
assert(index.includes('1.6.72-ci-safe-hygiene-self-repair'), 'index assets should use v1.6.72 cache key');
