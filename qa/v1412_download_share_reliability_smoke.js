...
assert(index.includes('data-build="1.5.52"'), 'index data-build should be 1.5.52');
assert(index.includes('1.5.52-ci-parallel-release-gate'), 'index assets should use v1.5.52 cache key');
