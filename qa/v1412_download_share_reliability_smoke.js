...
assert(index.includes('data-build="1.6.76"'), 'index data-build should be 1.6.76');
assert(index.includes('1.6.76-download-viewport-runtime-fault-diagnostics'), 'index assets should use v1.6.76 cache key');
