...
assert(index.includes('data-build="1.6.10"'), 'index data-build should be 1.6.10');
assert(index.includes('1.6.10-incident-readiness-contract-csp-cache-hardening'), 'index assets should use v1.6.10 cache key');
