...
assert(index.includes('data-build="1.5.97"'), 'index data-build should be 1.5.97');
assert(index.includes('1.5.97-worker-recovery-diagnostics'), 'index assets should use v1.5.97 cache key');
