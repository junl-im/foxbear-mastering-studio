...
assert(sw.includes('./src/ui/waveform-compare-view.js?v=1.6.71-pwa-share-lease-handoff-deploy-policy-e2e'), 'service worker does not precache compare view module');
assert(sw.includes('./assets/css/waveform-compare.css?v=1.6.71-pwa-share-lease-handoff-deploy-policy-e2e'), 'service worker does not precache compare CSS');
