...
assert(sw.includes('./src/ui/waveform-compare-view.js?v=1.5.60-kakao-inapp-entry-memory-governor'), 'service worker does not precache compare view module');
assert(sw.includes('./assets/css/waveform-compare.css?v=1.5.60-kakao-inapp-entry-memory-governor'), 'service worker does not precache compare CSS');
