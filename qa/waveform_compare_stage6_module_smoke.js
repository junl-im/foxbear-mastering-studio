...
assert(sw.includes('./src/ui/waveform-compare-view.js?v=1.4.0-stage21-unified-preview-system'), 'service worker does not precache compare view module');
assert(sw.includes('./assets/css/waveform-compare.css?v=1.4.0-stage21-unified-preview-system'), 'service worker does not precache compare CSS');
