...
assert(sw.includes('./src/ui/waveform-compare-view.js?v=1.6.22-incident-recovery-coalescing-time-decay'), 'service worker does not precache compare view module');
assert(sw.includes('./assets/css/waveform-compare.css?v=1.6.22-incident-recovery-coalescing-time-decay'), 'service worker does not precache compare CSS');
