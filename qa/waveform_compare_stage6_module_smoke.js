...
assert(sw.includes('./src/ui/waveform-compare-view.js?v=1.7.1-reference-match-2-phase1'), 'service worker does not precache compare view module');
assert(sw.includes('./assets/css/waveform-compare.css?v=1.7.1-reference-match-2-phase1'), 'service worker does not precache compare CSS');
