...
assert(sw.includes('./src/ui/waveform-compare-view.js?v=1.7.4-reload-reentry-mode-chooser'), 'service worker does not precache compare view module');
assert(sw.includes('./assets/css/waveform-compare.css?v=1.7.4-reload-reentry-mode-chooser'), 'service worker does not precache compare CSS');
