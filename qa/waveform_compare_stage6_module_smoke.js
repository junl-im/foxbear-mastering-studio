...
assert(sw.includes('./src/ui/waveform-compare-view.js?v=1.6.9-incident-readiness-history-recovery-copy-events'), 'service worker does not precache compare view module');
assert(sw.includes('./assets/css/waveform-compare.css?v=1.6.9-incident-readiness-history-recovery-copy-events'), 'service worker does not precache compare CSS');
