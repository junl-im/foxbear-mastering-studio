...
assert(sw.includes('./src/ui/waveform-compare-view.js?v=1.3.84-stage12.2-cachefix'), 'service worker does not precache compare view module');
assert(sw.includes('./assets/css/waveform-compare.css?v=1.3.84-stage12.2-cachefix'), 'service worker does not precache compare CSS');
