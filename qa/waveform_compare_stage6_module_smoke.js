...
assert(sw.includes('./src/ui/waveform-compare-view.js?v=1.5.90-browser-retry-integrity-metadata-aware-scope'), 'service worker does not precache compare view module');
assert(sw.includes('./assets/css/waveform-compare.css?v=1.5.90-browser-retry-integrity-metadata-aware-scope'), 'service worker does not precache compare CSS');
