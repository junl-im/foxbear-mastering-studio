...
assert(sw.includes('./src/ui/waveform-compare-view.js?v=1.5.84-trusted-types-browser-gate-recovery'), 'service worker does not precache compare view module');
assert(sw.includes('./assets/css/waveform-compare.css?v=1.5.84-trusted-types-browser-gate-recovery'), 'service worker does not precache compare CSS');
