...
assert(sw.includes('./src/ui/waveform-compare-view.js?v=1.6.76-download-viewport-runtime-fault-diagnostics'), 'service worker does not precache compare view module');
assert(sw.includes('./assets/css/waveform-compare.css?v=1.6.76-download-viewport-runtime-fault-diagnostics'), 'service worker does not precache compare CSS');
