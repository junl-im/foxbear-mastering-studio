...
assert(sw.includes('./src/ui/waveform-compare-view.js?v=1.6.83-browser-ui-mode-fixture-source-hygiene-recovery'), 'service worker does not precache compare view module');
assert(sw.includes('./assets/css/waveform-compare.css?v=1.6.83-browser-ui-mode-fixture-source-hygiene-recovery'), 'service worker does not precache compare CSS');
