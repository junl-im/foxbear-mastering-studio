...
assert(sw.includes('./src/ui/waveform-compare-view.js?v=1.6.87-mobile-header-device-label-overlap-recovery'), 'service worker does not precache compare view module');
assert(sw.includes('./assets/css/waveform-compare.css?v=1.6.87-mobile-header-device-label-overlap-recovery'), 'service worker does not precache compare CSS');
