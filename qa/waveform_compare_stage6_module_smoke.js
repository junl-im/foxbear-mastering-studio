...
assert(sw.includes('./src/ui/waveform-compare-view.js?v=1.5.25-e2e-preview-stability'), 'service worker does not precache compare view module');
assert(sw.includes('./assets/css/waveform-compare.css?v=1.5.25-e2e-preview-stability'), 'service worker does not precache compare CSS');
