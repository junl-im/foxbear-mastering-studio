...
assert(index.includes('src/audio/playback-source-recovery-service.js?v=1.6.93-mobile-dock-visibility-integrity-recovery'));
assert(sw.includes("'./src/audio/playback-source-recovery-service.js?v=1.6.93-mobile-dock-visibility-integrity-recovery'"));
