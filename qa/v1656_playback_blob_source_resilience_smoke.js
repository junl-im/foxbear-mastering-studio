...
assert(index.includes('src/audio/playback-source-recovery-service.js?v=1.6.86-header-order-mobile-overflow-browser-gate-recovery'));
assert(sw.includes("'./src/audio/playback-source-recovery-service.js?v=1.6.86-header-order-mobile-overflow-browser-gate-recovery'"));
