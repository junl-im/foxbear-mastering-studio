...
assert(index.includes('src/audio/playback-source-recovery-service.js?v=1.6.78-release-generation-assist-url-playback-invalidation'));
assert(sw.includes("'./src/audio/playback-source-recovery-service.js?v=1.6.78-release-generation-assist-url-playback-invalidation'"));
