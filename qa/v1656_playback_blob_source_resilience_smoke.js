...
assert(index.includes('src/audio/playback-source-recovery-service.js?v=1.6.82-overlay-focus-ancestor-hardening'));
assert(sw.includes("'./src/audio/playback-source-recovery-service.js?v=1.6.82-overlay-focus-ancestor-hardening'"));
