...
assert(index.includes('src/audio/playback-source-recovery-service.js?v=1.6.58-piano-transient-integrity'));
assert(sw.includes("'./src/audio/playback-source-recovery-service.js?v=1.6.58-piano-transient-integrity'"));
