...
assert(index.includes('src/audio/playback-source-recovery-service.js?v=1.6.99-header-role-focus-integrity'));
assert(sw.includes("'./src/audio/playback-source-recovery-service.js?v=1.6.99-header-role-focus-integrity'"));
