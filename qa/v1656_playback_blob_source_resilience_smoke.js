...
assert(index.includes('src/audio/playback-source-recovery-service.js?v=1.6.73-csp-memory-admission-runtime-config'));
assert(sw.includes("'./src/audio/playback-source-recovery-service.js?v=1.6.73-csp-memory-admission-runtime-config'"));
