...
assert(index.includes('src/audio/playback-source-recovery-service.js?v=1.6.56-playback-blob-source-resilience'));
assert(sw.includes("'./src/audio/playback-source-recovery-service.js?v=1.6.56-playback-blob-source-resilience'"));
