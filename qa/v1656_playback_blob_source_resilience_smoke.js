...
assert(index.includes('src/audio/playback-source-recovery-service.js?v=1.6.90-engine-control-overlay-isolation-header-contract-recovery'));
assert(sw.includes("'./src/audio/playback-source-recovery-service.js?v=1.6.90-engine-control-overlay-isolation-header-contract-recovery'"));
