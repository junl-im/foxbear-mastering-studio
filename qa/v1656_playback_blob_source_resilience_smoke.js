...
assert(index.includes('src/audio/playback-source-recovery-service.js?v=1.7.2-expert-workspace-default-entry'));
assert(sw.includes("'./src/audio/playback-source-recovery-service.js?v=1.7.2-expert-workspace-default-entry'"));
