...
assert(index.includes('src/audio/playback-source-recovery-service.js?v=1.6.61-human-readable-download-filenames'));
assert(sw.includes("'./src/audio/playback-source-recovery-service.js?v=1.6.61-human-readable-download-filenames'"));
