...
assert(index.includes('src/audio/playback-source-recovery-service.js?v=1.6.101-admin-lazyload-repo-cleanup'));
assert(sw.includes("'./src/audio/playback-source-recovery-service.js?v=1.6.101-admin-lazyload-repo-cleanup'"));
