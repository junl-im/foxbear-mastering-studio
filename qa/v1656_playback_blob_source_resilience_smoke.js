...
assert(index.includes('src/audio/playback-source-recovery-service.js?v=1.6.65-firestore-write-fencing'));
assert(sw.includes("'./src/audio/playback-source-recovery-service.js?v=1.6.65-firestore-write-fencing'"));
