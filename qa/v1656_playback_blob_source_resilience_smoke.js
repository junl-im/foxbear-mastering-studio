...
assert(index.includes('src/audio/playback-source-recovery-service.js?v=1.6.100-sw-stereo-ci-cleanup-hardening'));
assert(sw.includes("'./src/audio/playback-source-recovery-service.js?v=1.6.100-sw-stereo-ci-cleanup-hardening'"));
