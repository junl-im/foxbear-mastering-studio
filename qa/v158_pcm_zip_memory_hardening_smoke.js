...
assert(pkg.qaChecks.includes('node qa/v158_pcm_zip_memory_hardening_smoke.js'), 'v1.5.11 smoke missing from package QA');
...
assert(app.includes("compression: 'STORE'"), 'downloadZip should use STORE packaging');
assert(app.includes('zipPlan?.requiresIndividualDownload'), 'downloadZip individual fallback gate missing');
