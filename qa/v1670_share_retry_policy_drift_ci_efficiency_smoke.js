...
const beforePackage = {
  ...
  private: true,
  scripts: {
    'package:verify:full': 'node tools/verify-release-zip.js dist/foxbear-mastering-studio-v1.6.109-full.zip',
    'package:verify:patch': 'node tools/verify-patch-zip.js dist/foxbear-mastering-studio-v1.6.109-patch.zip'
  },
  foxbearRelease: {
    buildId: 'old-build',
...
afterPackage.scripts['package:verify:full'] = 'node tools/verify-release-zip.js dist/foxbear-mastering-studio-v1.6.109-full.zip';
afterPackage.scripts['package:verify:patch'] = 'node tools/verify-patch-zip.js dist/foxbear-mastering-studio-v1.6.109-patch.zip';
