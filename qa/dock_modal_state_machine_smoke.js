...
must(html.includes('data-build="1.5.91"'), 'index build should be 1.5.91');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.91-cancellable-audio-pipeline-performance-guards'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.91-cancellable-audio-pipeline-performance-guards'), 'dock controller script should be loaded');
