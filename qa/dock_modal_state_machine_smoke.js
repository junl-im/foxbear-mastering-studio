...
must(html.includes('src/ui/modal-controller.js?v=1.4.0-stage24-settings-overlay-cleanup'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.4.0-stage24-settings-overlay-cleanup'), 'dock controller script should be loaded');
