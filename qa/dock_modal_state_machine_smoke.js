...
must(html.includes('data-build="1.6.10"'), 'index build should be 1.6.10');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.10-incident-readiness-contract-csp-cache-hardening'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.10-incident-readiness-contract-csp-cache-hardening'), 'dock controller script should be loaded');
