...
must(html.includes('data-build="1.5.33"'), 'index build should be 1.5.33');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.33-codec-truth-download-hardening'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.33-codec-truth-download-hardening'), 'dock controller script should be loaded');
