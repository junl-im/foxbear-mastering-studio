...
must(html.includes('data-build="1.6.88"'), 'index build should be 1.6.88');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.88-mobile-header-grid-ownership-recovery'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.88-mobile-header-grid-ownership-recovery'), 'dock controller script should be loaded');
