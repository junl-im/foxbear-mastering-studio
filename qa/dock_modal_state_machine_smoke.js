...
must(html.includes('data-build="1.6.46"'), 'index build should be 1.6.46');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.46-google-auth-same-origin-network-recovery'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.46-google-auth-same-origin-network-recovery'), 'dock controller script should be loaded');
