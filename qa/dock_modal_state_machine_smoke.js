...
must(html.includes('src/ui/modal-controller.js?v=1.4.0-stage19-highlight-diagnostics'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.4.0-stage19-highlight-diagnostics'), 'dock controller script should be loaded');
