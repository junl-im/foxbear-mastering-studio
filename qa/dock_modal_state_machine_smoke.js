...
must(html.includes('data-build="1.5.43"'), 'index build should be 1.5.43');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.43-export-pipeline-integrity'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.43-export-pipeline-integrity'), 'dock controller script should be loaded');
