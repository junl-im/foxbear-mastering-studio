...
must(html.includes('data-build="1.4.2"'), 'index build should be 1.4.2');
...
must(html.includes('src/ui/modal-controller.js?v=1.4.2-crossfade-zoom-spectrum'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.4.2-crossfade-zoom-spectrum'), 'dock controller script should be loaded');
