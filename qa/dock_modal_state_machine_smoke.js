...
must(html.includes('data-build="1.5.68"'), 'index build should be 1.5.68');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.68-mail-delivery-verification-sender-subject-rules'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.68-mail-delivery-verification-sender-subject-rules'), 'dock controller script should be loaded');
