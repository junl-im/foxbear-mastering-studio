...
must(html.includes('data-build="1.5.41"'), 'index build should be 1.5.41');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.41-export-eta-download-recovery'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.41-export-eta-download-recovery'), 'dock controller script should be loaded');
