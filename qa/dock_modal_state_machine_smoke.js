...
must(html.includes('data-build="1.5.27"'), 'index build should be 1.5.27');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.27-device-glyph-sri-hardening'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.27-device-glyph-sri-hardening'), 'dock controller script should be loaded');
