...
must(html.includes('data-build="1.6.95"'), 'index build should be 1.6.95');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.95-release-artifact-safety'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.95-release-artifact-safety'), 'dock controller script should be loaded');
