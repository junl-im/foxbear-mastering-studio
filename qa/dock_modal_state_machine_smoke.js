...
must(html.includes('data-build="1.6.20"'), 'index build should be 1.6.20');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.20-incident-background-sync-network-decay'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.20-incident-background-sync-network-decay'), 'dock controller script should be loaded');
