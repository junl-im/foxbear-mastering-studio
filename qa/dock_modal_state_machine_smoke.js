...
must(html.includes('data-build="1.6.41"'), 'index build should be 1.6.41');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.41-admin-secret-pin-session'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.41-admin-secret-pin-session'), 'dock controller script should be loaded');
