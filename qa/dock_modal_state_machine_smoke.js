...
must(html.includes('data-build="1.6.110"'), 'index build should be 1.6.110');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.110-ui-mode-early-boot-recovery'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.110-ui-mode-early-boot-recovery'), 'dock controller script should be loaded');
