...
must(html.includes('data-build="1.5.50"'), 'index build should be 1.5.50');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.50-pwa-current-cache-test-recovery'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.50-pwa-current-cache-test-recovery'), 'dock controller script should be loaded');
