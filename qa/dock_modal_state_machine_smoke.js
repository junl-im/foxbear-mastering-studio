...
must(html.includes('data-build="1.6.93"'), 'index build should be 1.6.93');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.93-mobile-dock-visibility-integrity-recovery'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.93-mobile-dock-visibility-integrity-recovery'), 'dock controller script should be loaded');
