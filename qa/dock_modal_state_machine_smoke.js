...
must(html.includes('data-build="1.6.25"'), 'index build should be 1.6.25');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.25-incident-recovery-timeout-abort-stress'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.25-incident-recovery-timeout-abort-stress'), 'dock controller script should be loaded');
