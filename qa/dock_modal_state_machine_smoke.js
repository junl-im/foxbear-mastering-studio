...
must(html.includes('data-build="1.5.54"'), 'index build should be 1.5.54');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.54-quality-recovery-profiles-browser-qa'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.54-quality-recovery-profiles-browser-qa'), 'dock controller script should be loaded');
