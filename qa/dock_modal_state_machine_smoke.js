...
must(html.includes('src/ui/modal-controller.js?v=1.4.0-stage25-compare-controls-rehome'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.4.0-stage25-compare-controls-rehome'), 'dock controller script should be loaded');
