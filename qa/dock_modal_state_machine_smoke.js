...
must(html.includes('src/ui/modal-controller.js?v=1.4.0-stage26-unified-waveform-controls'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.4.0-stage26-unified-waveform-controls'), 'dock controller script should be loaded');
