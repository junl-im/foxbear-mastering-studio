...
must(html.includes('data-build="1.4.12"'), 'index build should be 1.4.12');
...
must(html.includes('src/ui/modal-controller.js?v=1.4.12-download-diagnostics'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.4.12-download-diagnostics'), 'dock controller script should be loaded');
