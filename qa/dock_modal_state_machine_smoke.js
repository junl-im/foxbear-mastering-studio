...
must(html.includes('data-build="1.6.71"'), 'index build should be 1.6.71');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.71-pwa-share-lease-handoff-deploy-policy-e2e'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.71-pwa-share-lease-handoff-deploy-policy-e2e'), 'dock controller script should be loaded');
