...
must(html.includes('data-build="1.5.38"'), 'index build should be 1.5.38');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.38-preflight-worker-multitab-hardening'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.38-preflight-worker-multitab-hardening'), 'dock controller script should be loaded');
