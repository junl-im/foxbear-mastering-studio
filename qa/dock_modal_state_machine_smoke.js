...
must(html.includes('src/ui/modal-controller.js?v=1.4.0-stage27-waveform-control-service'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.4.0-stage27-waveform-control-service'), 'dock controller script should be loaded');
