...
must(html.includes('data-build="1.5.19"'), 'index build should be 1.5.19');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.19-ci-runtime-isolation-package-hardening'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.19-ci-runtime-isolation-package-hardening'), 'dock controller script should be loaded');
