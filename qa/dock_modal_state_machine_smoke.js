...
must(html.includes('data-build="1.5.28"'), 'index build should be 1.5.28');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.28-resilience-lifecycle-offline-recovery'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.28-resilience-lifecycle-offline-recovery'), 'dock controller script should be loaded');
