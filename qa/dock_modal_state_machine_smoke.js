...
must(html.includes('data-build="1.5.53"'), 'index build should be 1.5.53');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.53-engine-recovery-performance-diagnostics'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.53-engine-recovery-performance-diagnostics'), 'dock controller script should be loaded');
