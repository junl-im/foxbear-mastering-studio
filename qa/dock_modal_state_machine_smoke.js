...
must(html.includes('data-build="1.5.14"'), 'index build should be 1.5.14');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.14-github-desktop-handoff-preflight'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.14-github-desktop-handoff-preflight'), 'dock controller script should be loaded');
