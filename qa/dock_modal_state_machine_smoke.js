...
must(html.includes('data-build="1.4.14"'), 'index build should be 1.4.14');
...
must(html.includes('src/ui/modal-controller.js?v=1.4.14-download-action-clarity'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.4.14-download-action-clarity'), 'dock controller script should be loaded');
