...
must(html.includes('data-build="1.5.16"'), 'index build should be 1.5.16');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.16-e2e-server-pipe-deadlock-fix'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.16-e2e-server-pipe-deadlock-fix'), 'dock controller script should be loaded');
