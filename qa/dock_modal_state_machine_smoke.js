...
must(html.includes('data-build="1.6.97"'), 'index build should be 1.6.97');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.97-boot-payload-delivery-privacy-hardening'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.97-boot-payload-delivery-privacy-hardening'), 'dock controller script should be loaded');
