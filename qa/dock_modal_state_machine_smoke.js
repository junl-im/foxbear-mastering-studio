...
must(html.includes('data-build="1.6.45"'), 'index build should be 1.6.45');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.45-windows-release-gate-spark-hosting-no-app-check'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.45-windows-release-gate-spark-hosting-no-app-check'), 'dock controller script should be loaded');
