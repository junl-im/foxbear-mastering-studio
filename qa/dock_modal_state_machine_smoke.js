...
must(html.includes('data-build="1.5.11"'), 'index build should be 1.5.11');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.11-audio-context-ci-stability'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.11-audio-context-ci-stability'), 'dock controller script should be loaded');
