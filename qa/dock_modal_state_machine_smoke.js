...
must(html.includes('src/ui/modal-controller.js?v=1.4.0-stage28-waveform-control-view'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.4.0-stage28-waveform-control-view'), 'dock controller script should be loaded');
