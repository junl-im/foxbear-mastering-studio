...
must(html.includes('data-build="1.5.34"'), 'index build should be 1.5.34');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.34-kakao-landing-recovery'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.34-kakao-landing-recovery'), 'dock controller script should be loaded');
