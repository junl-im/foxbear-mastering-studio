...
must(html.includes('data-build="1.6.66"'), 'index build should be 1.6.66');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.66-static-gate-hygiene-repair'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.66-static-gate-hygiene-repair'), 'dock controller script should be loaded');
