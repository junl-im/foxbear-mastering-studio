...
must(html.includes('data-build="1.5.94"'), 'index build should be 1.5.94');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.94-aiff-fallback-worker-diagnostics-reporting-contract'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.94-aiff-fallback-worker-diagnostics-reporting-contract'), 'dock controller script should be loaded');
