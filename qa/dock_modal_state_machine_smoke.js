...
must(html.includes('src/ui/modal-controller.js?v=1.3.84-dock-modal-state-machine'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.3.84-dock-modal-state-machine'), 'dock controller script should be loaded');
