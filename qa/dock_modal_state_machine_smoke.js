...
must(html.includes('data-build="1.5.95"'), 'index build should be 1.5.95');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.95-popup-settings-mail-test-recovery'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.95-popup-settings-mail-test-recovery'), 'dock controller script should be loaded');
