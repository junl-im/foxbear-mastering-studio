...
must(html.includes('data-build="1.5.47"'), 'index build should be 1.5.47');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.47-engine-edgecase-quality-gate'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.47-engine-edgecase-quality-gate'), 'dock controller script should be loaded');
