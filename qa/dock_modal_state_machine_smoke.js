...
must(html.includes('data-build="1.6.84"'), 'index build should be 1.6.84');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.84-tracked-windows-cleanup-static-gate-recovery'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.84-tracked-windows-cleanup-static-gate-recovery'), 'dock controller script should be loaded');
