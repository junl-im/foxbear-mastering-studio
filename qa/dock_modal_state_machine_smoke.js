...
must(html.includes('data-build="1.6.47"'), 'index build should be 1.6.47');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.47-external-host-admin-auth-opaque-error-recovery'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.47-external-host-admin-auth-opaque-error-recovery'), 'dock controller script should be loaded');
