...
must(html.includes('data-build="1.5.84"'), 'index build should be 1.5.84');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.84-trusted-types-browser-gate-recovery'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.84-trusted-types-browser-gate-recovery'), 'dock controller script should be loaded');
