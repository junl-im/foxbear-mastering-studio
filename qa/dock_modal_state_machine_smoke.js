...
must(html.includes('data-build="1.5.99"'), 'index build should be 1.5.99');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.99-incident-callable-mail-recovery'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.99-incident-callable-mail-recovery'), 'dock controller script should be loaded');
