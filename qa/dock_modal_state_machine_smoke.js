...
must(html.includes('data-build="1.5.31"'), 'index build should be 1.5.31');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.31-player-download-stability'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.31-player-download-stability'), 'dock controller script should be loaded');
