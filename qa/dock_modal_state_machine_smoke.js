...
must(html.includes('data-build="1.6.99"'), 'index build should be 1.6.99');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.99-header-role-focus-integrity'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.99-header-role-focus-integrity'), 'dock controller script should be loaded');
