...
must(html.includes('data-build="1.5.60"'), 'index build should be 1.5.60');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.60-kakao-inapp-entry-memory-governor'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.60-kakao-inapp-entry-memory-governor'), 'dock controller script should be loaded');
