...
must(html.includes('data-build="1.6.64"'), 'index build should be 1.6.64');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.64-github-desktop-delivery-contract'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.64-github-desktop-delivery-contract'), 'dock controller script should be loaded');
