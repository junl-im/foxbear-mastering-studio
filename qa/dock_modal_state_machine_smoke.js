...
must(html.includes('data-build="1.5.10"'), 'index build should be 1.5.10');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.10-header-settings-relocation'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.10-header-settings-relocation'), 'dock controller script should be loaded');
