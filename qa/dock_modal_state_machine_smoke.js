...
must(html.includes('data-build="1.6.40"'), 'index build should be 1.6.40');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.40-ui-shell-retry-replacement-settlement'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.40-ui-shell-retry-replacement-settlement'), 'dock controller script should be loaded');
