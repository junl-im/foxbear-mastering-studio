...
must(html.includes('data-build="1.6.98"'), 'index build should be 1.6.98');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.98-spectrum-retirement-mobile-header-integrity'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.98-spectrum-retirement-mobile-header-integrity'), 'dock controller script should be loaded');
