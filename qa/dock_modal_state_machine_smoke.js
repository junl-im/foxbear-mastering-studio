...
must(html.includes('data-build="1.5.36"'), 'index build should be 1.5.36');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.36-interaction-lifecycle-hardening'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.36-interaction-lifecycle-hardening'), 'dock controller script should be loaded');
