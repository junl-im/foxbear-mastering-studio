...
must(html.includes('data-build="1.6.4"'), 'index build should be 1.6.4');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.4-incident-callable-csp-recovery'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.4-incident-callable-csp-recovery'), 'dock controller script should be loaded');
