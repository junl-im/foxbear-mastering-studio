...
must(html.includes('data-build="1.7.1"'), 'index build should be 1.7.1');
...
must(html.includes('src/ui/modal-controller.js?v=1.7.1-reference-match-2-phase1'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.7.1-reference-match-2-phase1'), 'dock controller script should be loaded');
