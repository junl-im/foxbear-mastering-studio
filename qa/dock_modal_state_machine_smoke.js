...
must(html.includes('data-build="1.5.58"'), 'index build should be 1.5.58');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.58-kakao-mastering-runtime-recovery'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.58-kakao-mastering-runtime-recovery'), 'dock controller script should be loaded');
