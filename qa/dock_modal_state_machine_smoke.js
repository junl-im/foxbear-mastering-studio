...
must(html.includes('data-build="1.6.94"'), 'index build should be 1.6.94');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.94-release-integrity-hardening'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.94-release-integrity-hardening'), 'dock controller script should be loaded');
