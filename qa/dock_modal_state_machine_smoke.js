...
must(html.includes('data-build="1.6.43"'), 'index build should be 1.6.43');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.43-google-auth-trusted-types-csp-recovery'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.43-google-auth-trusted-types-csp-recovery'), 'dock controller script should be loaded');
