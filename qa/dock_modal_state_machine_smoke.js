...
must(html.includes('data-build="1.6.65"'), 'index build should be 1.6.65');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.65-firestore-write-fencing'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.65-firestore-write-fencing'), 'dock controller script should be loaded');
