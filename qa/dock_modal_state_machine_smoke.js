...
must(html.includes('src/ui/modal-controller.js?v=1.4.0-stage21-unified-preview-system'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.4.0-stage21-unified-preview-system'), 'dock controller script should be loaded');
