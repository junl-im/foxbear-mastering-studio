...
must(html.includes('data-build="1.5.67"'), 'index build should be 1.5.67');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.67-incident-admin-audit-webhook-failover-index-health'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.67-incident-admin-audit-webhook-failover-index-health'), 'dock controller script should be loaded');
