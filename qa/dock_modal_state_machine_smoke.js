...
must(html.includes('data-build="1.6.74"'), 'index build should be 1.6.74');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.74-incident-admission-spark-retention-download-memory'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.74-incident-admission-spark-retention-download-memory'), 'dock controller script should be loaded');
