...
must(html.includes('data-build="1.6.109"'), 'index build should be 1.6.109');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.109-mastering-cooperative-pcm-responsiveness'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.109-mastering-cooperative-pcm-responsiveness'), 'dock controller script should be loaded');
