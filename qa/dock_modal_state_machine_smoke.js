...
must(html.includes('src/ui/modal-controller.js?v=1.4.0-stage23-playback-orchestration'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.4.0-stage23-playback-orchestration'), 'dock controller script should be loaded');
