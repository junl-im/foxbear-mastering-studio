...
must(html.includes('data-build="1.5.18"'), 'index build should be 1.5.18');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.18-ci-diagnostics-pwa-readiness'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.18-ci-diagnostics-pwa-readiness'), 'dock controller script should be loaded');
