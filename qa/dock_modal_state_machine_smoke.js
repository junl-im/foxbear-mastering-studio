...
must(html.includes('data-build="1.5.69"'), 'index build should be 1.5.69');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.69-mail-receipt-confirmation-history-branded-template'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.69-mail-receipt-confirmation-history-branded-template'), 'dock controller script should be loaded');
