...
must(html.includes('data-build="1.4.23"'), 'index build should be 1.4.23');
...
must(html.includes('src/ui/modal-controller.js?v=1.4.23-audio-decode-memory-guard'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.4.23-audio-decode-memory-guard'), 'dock controller script should be loaded');
