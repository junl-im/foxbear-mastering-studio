...
must(html.includes('data-build="1.7.0"'), 'index build should be 1.7.0');
...
must(html.includes('src/ui/modal-controller.js?v=1.7.0-adaptive-mastering-decision-phase1'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.7.0-adaptive-mastering-decision-phase1'), 'dock controller script should be loaded');
