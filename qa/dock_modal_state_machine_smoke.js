...
must(html.includes('data-build="1.5.93"'), 'index build should be 1.5.93');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.93-external-engine-transfer-admin-export-openai-readiness'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.93-external-engine-transfer-admin-export-openai-readiness'), 'dock controller script should be loaded');
