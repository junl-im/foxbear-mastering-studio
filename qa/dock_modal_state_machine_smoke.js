...
must(html.includes('data-build="1.6.101"'), 'index build should be 1.6.101');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.101-admin-lazyload-repo-cleanup'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.101-admin-lazyload-repo-cleanup'), 'dock controller script should be loaded');
