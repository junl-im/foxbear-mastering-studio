...
must(html.includes('data-build="1.5.22"'), 'index build should be 1.5.22');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.22-header-preview-routing-polish'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.22-header-preview-routing-polish'), 'dock controller script should be loaded');
