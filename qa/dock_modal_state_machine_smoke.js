...
must(html.includes('data-build="1.5.80"'), 'index build should be 1.5.80');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.80-mobile-return-media-focus-recovery'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.80-mobile-return-media-focus-recovery'), 'dock controller script should be loaded');
