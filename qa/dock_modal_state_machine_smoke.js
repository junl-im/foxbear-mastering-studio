...
must(html.includes('data-build="1.5.15"'), 'index build should be 1.5.15');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.15-e2e-runtime-classification'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.15-e2e-runtime-classification'), 'dock controller script should be loaded');
