...
must(html.includes('src/ui/modal-controller.js?v=1.3.84-stage12.2-cachefix'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.3.84-stage12.2-cachefix'), 'dock controller script should be loaded');
