...
must(html.includes('data-build="1.5.46"'), 'index build should be 1.5.46');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.46-engine-recommendation-api-audit'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.46-engine-recommendation-api-audit'), 'dock controller script should be loaded');
