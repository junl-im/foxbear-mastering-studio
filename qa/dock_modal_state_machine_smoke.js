...
must(html.includes('data-build="1.6.103"'), 'index build should be 1.6.103');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.103-ci-hygiene-mail-routing-hardening'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.103-ci-hygiene-mail-routing-hardening'), 'dock controller script should be loaded');
