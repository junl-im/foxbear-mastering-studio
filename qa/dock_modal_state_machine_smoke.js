...
must(html.includes('data-build="1.6.0"'), 'index build should be 1.6.0');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.0-incident-mail-pipeline-health'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.0-incident-mail-pipeline-health'), 'dock controller script should be loaded');
