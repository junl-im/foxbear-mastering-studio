...
must(html.includes('data-build="1.4.20"'), 'index build should be 1.4.20');
...
must(html.includes('src/ui/modal-controller.js?v=1.4.20-bulk-import-guard'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.4.20-bulk-import-guard'), 'dock controller script should be loaded');
