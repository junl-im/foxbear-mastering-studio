...
must(html.includes('data-build="1.5.98"'), 'index build should be 1.5.98');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.98-worker-retry-health-levels'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.98-worker-retry-health-levels'), 'dock controller script should be loaded');
