...
must(html.includes('data-build="1.5.24"'), 'index build should be 1.5.24');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.24-e2e-responsive-preview-control'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.24-e2e-responsive-preview-control'), 'dock controller script should be loaded');
