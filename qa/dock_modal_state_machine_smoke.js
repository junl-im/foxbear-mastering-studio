...
must(html.includes('data-build="1.6.44"'), 'index build should be 1.6.44');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.44-google-auth-gapi-module-trusted-types-recovery'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.44-google-auth-gapi-module-trusted-types-recovery'), 'dock controller script should be loaded');
