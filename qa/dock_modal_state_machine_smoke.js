...
must(html.includes('data-build="1.5.29"'), 'index build should be 1.5.29');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.29-analysis-update-lifecycle'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.29-analysis-update-lifecycle'), 'dock controller script should be loaded');
