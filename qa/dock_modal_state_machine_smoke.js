...
must(html.includes('data-build="1.6.90"'), 'index build should be 1.6.90');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.90-engine-control-overlay-isolation-header-contract-recovery'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.90-engine-control-overlay-isolation-header-contract-recovery'), 'dock controller script should be loaded');
