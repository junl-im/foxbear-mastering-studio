...
must(html.includes('data-build="1.5.82"'), 'index build should be 1.5.82');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.82-mastering-cancel-playback-resume-recovery'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.82-mastering-cancel-playback-resume-recovery'), 'dock controller script should be loaded');
