...
must(html.includes('data-build="1.6.22"'), 'index build should be 1.6.22');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.22-incident-recovery-coalescing-time-decay'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.22-incident-recovery-coalescing-time-decay'), 'dock controller script should be loaded');
