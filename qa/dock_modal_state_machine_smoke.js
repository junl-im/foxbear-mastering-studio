...
must(html.includes('data-build="1.5.64"'), 'index build should be 1.5.64');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.64-incident-operations-health-self-diagnostics'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.64-incident-operations-health-self-diagnostics'), 'dock controller script should be loaded');
