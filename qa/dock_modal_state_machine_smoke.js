...
must(html.includes('src/ui/modal-controller.js?v=1.4.0-stage17-highlight-compare-sync'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.4.0-stage17-highlight-compare-sync'), 'dock controller script should be loaded');
