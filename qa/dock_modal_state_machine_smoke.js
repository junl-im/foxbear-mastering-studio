...
must(html.includes('data-build="1.5.12"'), 'index build should be 1.5.12');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.12-ci-runtime-readiness'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.12-ci-runtime-readiness'), 'dock controller script should be loaded');
