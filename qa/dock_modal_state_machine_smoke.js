...
must(html.includes('data-build="1.5.59"'), 'index build should be 1.5.59');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.59-kakao-session-handoff-memory-diagnostics'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.59-kakao-session-handoff-memory-diagnostics'), 'dock controller script should be loaded');
