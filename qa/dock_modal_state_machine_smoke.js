...
must(html.includes('data-build="1.4.18"'), 'index build should be 1.4.18');
...
must(html.includes('src/ui/modal-controller.js?v=1.4.18-download-dialog-micro-hint'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.4.18-download-dialog-micro-hint'), 'dock controller script should be loaded');
