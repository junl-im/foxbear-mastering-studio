...
must(html.includes('data-build="1.5.56"'), 'index build should be 1.5.56');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.56-incident-operations-app-check'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.56-incident-operations-app-check'), 'dock controller script should be loaded');
