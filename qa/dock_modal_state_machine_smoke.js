...
must(html.includes('src/ui/modal-controller.js?v=1.6.104-boot-emergency-visit-privacy-hardening'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.104-boot-emergency-visit-privacy-hardening'), 'dock controller script should be loaded');
