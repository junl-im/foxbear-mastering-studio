...
must(html.includes('data-build="1.5.79"'), 'index build should be 1.5.79');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.79-preview-download-ownership-recovery'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.79-preview-download-ownership-recovery'), 'dock controller script should be loaded');
