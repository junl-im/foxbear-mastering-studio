...
must(html.includes('data-build="1.6.9"'), 'index build should be 1.6.9');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.9-incident-readiness-history-recovery-copy-events'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.9-incident-readiness-history-recovery-copy-events'), 'dock controller script should be loaded');
