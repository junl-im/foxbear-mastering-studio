...
must(html.includes('data-build="1.4.24"'), 'index build should be 1.4.24');
...
must(html.includes('src/ui/modal-controller.js?v=1.4.24-bulk-import-hud'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.4.24-bulk-import-hud'), 'dock controller script should be loaded');
