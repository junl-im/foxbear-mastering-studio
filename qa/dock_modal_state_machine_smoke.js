...
must(html.includes('data-build="1.5.32"'), 'index build should be 1.5.32');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.32-kakao-external-browser-local-flow'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.32-kakao-external-browser-local-flow'), 'dock controller script should be loaded');
