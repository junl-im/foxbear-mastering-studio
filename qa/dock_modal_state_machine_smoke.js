...
must(html.includes('data-build="1.5.37"'), 'index build should be 1.5.37');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.37-memory-import-waveform-hardening'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.37-memory-import-waveform-hardening'), 'dock controller script should be loaded');
