...
must(html.includes('data-build="1.5.73"'), 'index build should be 1.5.73');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.73-bulk-control-eta-result-filter-ui'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.73-bulk-control-eta-result-filter-ui'), 'dock controller script should be loaded');
