...
must(html.includes('src/ui/modal-controller.js?v=1.6.105-header-dock-css-ownership-hardening'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.105-header-dock-css-ownership-hardening'), 'dock controller script should be loaded');
