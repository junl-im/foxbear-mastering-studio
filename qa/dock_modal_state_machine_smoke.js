...
must(html.includes('data-build="1.6.70"'), 'index build should be 1.6.70');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.70-share-retry-policy-drift-ci-efficiency'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.70-share-retry-policy-drift-ci-efficiency'), 'dock controller script should be loaded');
