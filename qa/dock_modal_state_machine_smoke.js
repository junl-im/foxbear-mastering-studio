...
must(html.includes('data-build="1.5.81"'), 'index build should be 1.5.81');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.81-master-preview-cancellation-native-result-isolation'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.81-master-preview-cancellation-native-result-isolation'), 'dock controller script should be loaded');
