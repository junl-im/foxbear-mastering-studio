...
must(html.includes('data-build="1.5.49"'), 'index build should be 1.5.49');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.49-asset-generation-route-recovery'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.49-asset-generation-route-recovery'), 'dock controller script should be loaded');
