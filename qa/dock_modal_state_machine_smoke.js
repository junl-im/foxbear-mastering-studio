...
must(html.includes('data-build="1.6.59"'), 'index build should be 1.6.59');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.59-readiness-corp-security-hardening'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.59-readiness-corp-security-hardening'), 'dock controller script should be loaded');
