...
must(html.includes('data-build="1.6.39"'), 'index build should be 1.6.39');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.39-ui-shell-partial-script-probe-isolation'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.39-ui-shell-partial-script-probe-isolation'), 'dock controller script should be loaded');
