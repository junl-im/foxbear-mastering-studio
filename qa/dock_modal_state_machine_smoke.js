...
must(html.includes('data-build="1.5.57"'), 'index build should be 1.5.57');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.57-modal-close-consistency'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.57-modal-close-consistency'), 'dock controller script should be loaded');
