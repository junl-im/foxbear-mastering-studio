...
must(html.includes('data-build="1.5.20"'), 'index build should be 1.5.20');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.20-idempotent-pwa-cache-warm'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.20-idempotent-pwa-cache-warm'), 'dock controller script should be loaded');
