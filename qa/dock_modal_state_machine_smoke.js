...
must(html.includes('data-build="1.5.42"'), 'index build should be 1.5.42');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.42-zip-worker-cancellation'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.42-zip-worker-cancellation'), 'dock controller script should be loaded');
