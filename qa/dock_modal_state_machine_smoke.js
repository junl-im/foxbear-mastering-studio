...
must(html.includes('src/ui/modal-controller.js?v=1.6.108-mastering-progress-visibility-hardening'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.108-mastering-progress-visibility-hardening'), 'dock controller script should be loaded');
