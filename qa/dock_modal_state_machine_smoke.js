...
must(html.includes('data-build="1.5.52"'), 'index build should be 1.5.52');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.52-ci-parallel-release-gate'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.52-ci-parallel-release-gate'), 'dock controller script should be loaded');
