...
must(html.includes('data-build="1.5.17"'), 'index build should be 1.5.17');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.17-browser-contract-fix'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.17-browser-contract-fix'), 'dock controller script should be loaded');
