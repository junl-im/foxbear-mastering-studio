...
must(html.includes('data-build="1.6.2"'), 'index build should be 1.6.2');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.2-nonblocking-health-status-design-polish'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.2-nonblocking-health-status-design-polish'), 'dock controller script should be loaded');
