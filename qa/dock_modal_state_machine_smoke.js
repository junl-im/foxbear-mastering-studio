...
must(html.includes('data-build="1.6.102"'), 'index build should be 1.6.102');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.102-admin-lazyload-sw-hygiene-hardening'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.102-admin-lazyload-sw-hygiene-hardening'), 'dock controller script should be loaded');
