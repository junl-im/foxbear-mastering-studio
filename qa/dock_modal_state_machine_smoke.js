...
must(html.includes('data-build="1.6.92"'), 'index build should be 1.6.92');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.92-spectrum-panel-mount-lifecycle-recovery'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.92-spectrum-panel-mount-lifecycle-recovery'), 'dock controller script should be loaded');
