...
must(html.includes('data-build="1.6.87"'), 'index build should be 1.6.87');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.87-mobile-header-device-label-overlap-recovery'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.87-mobile-header-device-label-overlap-recovery'), 'dock controller script should be loaded');
