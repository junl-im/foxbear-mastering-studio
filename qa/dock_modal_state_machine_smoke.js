...
must(html.includes('data-build="1.5.51"'), 'index build should be 1.5.51');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.51-ci-runtime-contract-hardening'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.51-ci-runtime-contract-hardening'), 'dock controller script should be loaded');
