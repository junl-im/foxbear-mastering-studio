...
must(html.includes('src/ui/modal-controller.js?v=1.4.0-stage22-playback-link-audit'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.4.0-stage22-playback-link-audit'), 'dock controller script should be loaded');
