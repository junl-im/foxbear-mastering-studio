...
must(html.includes('data-build="1.6.91"'), 'index build should be 1.6.91');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.91-runtime-health-hidden-geometry-contract-recovery'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.91-runtime-health-hidden-geometry-contract-recovery'), 'dock controller script should be loaded');
