...
must(html.includes('data-build="1.5.23"'), 'index build should be 1.5.23');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.23-e2e-preview-readiness'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.23-e2e-preview-readiness'), 'dock controller script should be loaded');
