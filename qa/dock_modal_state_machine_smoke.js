...
must(html.includes('data-build="1.6.100"'), 'index build should be 1.6.100');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.100-sw-stereo-ci-cleanup-hardening'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.100-sw-stereo-ci-cleanup-hardening'), 'dock controller script should be loaded');
