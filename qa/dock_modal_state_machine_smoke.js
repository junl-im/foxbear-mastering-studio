...
must(html.includes('data-build="1.5.9"'), 'index build should be 1.5.9');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.9-version-display-cache-recovery'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.9-version-display-cache-recovery'), 'dock controller script should be loaded');
