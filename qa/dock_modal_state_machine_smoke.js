...
must(html.includes('data-build="1.5.21"'), 'index build should be 1.5.21');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.21-history-csp-console-contract-fix'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.21-history-csp-console-contract-fix'), 'dock controller script should be loaded');
