...
must(html.includes('data-build="1.5.7"'), 'index build should be 1.5.7');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.7-release-foundation'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.7-release-foundation'), 'dock controller script should be loaded');
