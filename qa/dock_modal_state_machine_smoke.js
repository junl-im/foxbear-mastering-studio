...
must(html.includes('data-build="1.5.45"'), 'index build should be 1.5.45');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.45-export-queue-recovery'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.45-export-queue-recovery'), 'dock controller script should be loaded');
