...
must(html.includes('src/ui/modal-controller.js?v=1.4.0-stage18-settings-persistence'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.4.0-stage18-settings-persistence'), 'dock controller script should be loaded');
