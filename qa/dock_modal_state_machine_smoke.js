...
must(html.includes('data-build="1.5.74"'), 'index build should be 1.5.74');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.74-bulk-pause-skip-reorder-mobile-download'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.74-bulk-pause-skip-reorder-mobile-download'), 'dock controller script should be loaded');
