...
must(html.includes('data-build="1.5.55"'), 'index build should be 1.5.55');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.55-automatic-incident-mail-reporting'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.55-automatic-incident-mail-reporting'), 'dock controller script should be loaded');
