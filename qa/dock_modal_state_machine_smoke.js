...
must(html.includes('data-build="1.6.111"'), 'index build should be 1.6.111');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.111-ui-mode-session-contract-hardening'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.111-ui-mode-session-contract-hardening'), 'dock controller script should be loaded');
