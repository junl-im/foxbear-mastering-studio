...
must(html.includes('data-build="1.5.90"'), 'index build should be 1.5.90');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.90-browser-retry-integrity-metadata-aware-scope'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.90-browser-retry-integrity-metadata-aware-scope'), 'dock controller script should be loaded');
