...
must(html.includes('data-build="1.6.42"'), 'index build should be 1.6.42');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.42-spark-google-admin-auth'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.42-spark-google-admin-auth'), 'dock controller script should be loaded');
