...
must(html.includes('src/ui/modal-controller.js?v=1.3.84-stage13-runtime-safety'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.3.84-stage13-runtime-safety'), 'dock controller script should be loaded');
