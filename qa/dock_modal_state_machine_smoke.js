...
must(html.includes('src/ui/modal-controller.js?v=1.3.84-stage14-runtime-recovery'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.3.84-stage14-runtime-recovery'), 'dock controller script should be loaded');
