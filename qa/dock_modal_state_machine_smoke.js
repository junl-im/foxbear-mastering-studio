...
must(html.includes('src/ui/modal-controller.js?v=1.6.7-incident-readiness-history-sync-performance-hud'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.7-incident-readiness-history-sync-performance-hud'), 'dock controller script should be loaded');
