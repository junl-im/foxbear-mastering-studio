...
must(html.includes('data-build="1.4.26"'), 'index build should be 1.4.26');
...
must(html.includes('src/ui/modal-controller.js?v=1.4.26-wake-lock-state-sync'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.4.26-wake-lock-state-sync'), 'dock controller script should be loaded');
