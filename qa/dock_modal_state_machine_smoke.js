...
must(html.includes('data-build="1.5.92"'), 'index build should be 1.5.92');
...
must(html.includes('src/ui/modal-controller.js?v=1.5.92-python-bytecode-ci-hygiene-node24-cache'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.5.92-python-bytecode-ci-hygiene-node24-cache'), 'dock controller script should be loaded');
