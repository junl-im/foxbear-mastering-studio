...
must(html.includes('data-build="1.6.1"'), 'index build should be 1.6.1');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.1-transient-performance-diagnostics'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.1-transient-performance-diagnostics'), 'dock controller script should be loaded');
