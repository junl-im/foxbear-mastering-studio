...
must(html.includes('data-build="1.6.89"'), 'index build should be 1.6.89');
...
must(html.includes('src/ui/modal-controller.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery'), 'dock controller script should be loaded');
