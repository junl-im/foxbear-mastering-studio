...
must(html.includes('src/ui/modal-controller.js?v=1.6.106-browser-geometry-history-recovery'), 'modal controller script should be loaded');
must(html.includes('src/ui/dock-controller.js?v=1.6.106-browser-geometry-history-recovery'), 'dock controller script should be loaded');
