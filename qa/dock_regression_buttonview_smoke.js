...
must(app.includes("const SHARED_DSP_PROFILE_VERSION = 'v1.3.79-dock-purpose-realign'"), 'DSP profile slug should be v1.3.79');
...
must(css.includes('v1.3.79 Dock Purpose Realignment'), 'v1.3.79 CSS guard missing');
