...
must(app.includes("const APP_VERSION = 'Pro v1.3.80'"), 'app version should be v1.3.80');
must(app.includes("const SHARED_DSP_PROFILE_VERSION = 'v1.3.80-icons-buttonview-close'"), 'DSP profile slug should be v1.3.80');
...
must(app.includes("['pointerdown', 'mousedown', 'click', 'touchend']"), 'feature pointer/mouse/click/touch fallback missing');
must(css.includes('v1.3.80 Icon Refresh / Button View Close Repair'), 'v1.3.80 CSS guard missing');
