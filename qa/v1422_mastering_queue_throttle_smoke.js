...
assert(pkg.qaChecks.includes('node qa/v1422_mastering_queue_throttle_smoke.js'), 'package QA should include v1.5.43 smoke');
assert(matrix.includes('v1.4.26 Mastering Queue Throttle'), 'matrix should document v1.5.43 scope');
