...
assert(pkg.includes('Stage26 unified waveform controls') || pkg.includes('Stage26 unified waveform controls') || pkg.includes('Stage25 compare controls rehome') || pkg.includes('Stage23 playback orchestration'), 'package description should identify current Stage23+ line');
