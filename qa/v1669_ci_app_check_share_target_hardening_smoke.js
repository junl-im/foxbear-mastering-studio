...
runtimeSandbox.FoxBearBuildInfo = { appVersion: 'Pro v1.6.78', assetVersion: pkg.foxbearRelease.assetVersion };
...
assert(swSource.includes('SHARE_RECORD_TTL_MS'));
assert(swSource.includes('SHARE_RECORD_LIMIT = 8'));
