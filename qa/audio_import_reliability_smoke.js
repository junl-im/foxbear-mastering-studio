...
must(html.includes('src/app.js?v=1.3.74-dock-integrated-waveform'), 'index app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.74-dock-integrated-waveform'), 'service worker cache key missing');
