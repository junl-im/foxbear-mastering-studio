...
must(html.includes('src/app.js?v=1.3.69-dock-action-runtime-fix'), 'index app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.69-dock-action-target-fix'), 'service worker cache key missing');
