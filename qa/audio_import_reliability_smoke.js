...
must(html.includes('src/app.js?v=1.3.84-stage15-settings-panel'), 'index app cache bust key missing');
must(/foxbear-shell-v1\.3\.84/.test(sw) && /stage(?:15|14|13|12(?:\.1|\.2)?|11|10|9)/.test(sw), 'service worker cache key missing or stale');
