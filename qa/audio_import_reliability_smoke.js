...
must(html.includes('src/app.js?v=1.3.84-dock-modal-state-machine'), 'index app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.84-dock-modal-state-machine'), 'service worker cache key missing');
