...
must(html.includes('src/app.js?v=1.3.66-dock-master-player-order'), 'index app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.66-dock-master-player-order'), 'service worker cache key missing');
