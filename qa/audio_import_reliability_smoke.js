...
must(html.includes('src/app.js?v=1.3.79-dock-purpose-realign'), 'index app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.79-dock-purpose-realign'), 'service worker cache key missing');
