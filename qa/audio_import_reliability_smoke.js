...
must(html.includes('src/app.js?v=1.3.68-dock-action-runtime-fix'), 'index app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.68-dock-action-runtime-fix'), 'service worker cache key missing');
