...
must(html.includes('src/app.js?v=1.3.83-pc-dock-modal-hardfix'), 'index app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.83-pc-dock-modal-hardfix'), 'service worker cache key missing');
