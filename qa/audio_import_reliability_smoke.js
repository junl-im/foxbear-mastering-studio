...
must(html.includes('src/app.js?v=1.3.82-pc-dock-modal-rootfix'), 'index app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.82-pc-dock-modal-rootfix'), 'service worker cache key missing');
