...
must(html.includes('src/app.js?v=1.3.77-dock-waveform-polish'), 'index app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.77-dock-waveform-polish'), 'service worker cache key missing');
