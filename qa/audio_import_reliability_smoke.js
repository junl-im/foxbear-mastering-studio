...
must(html.includes('src/app.js?v=1.3.78-cleanup-buttonview-layer'), 'index app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.78-cleanup-buttonview-layer'), 'service worker cache key missing');
