...
must(html.includes('src/app.js?v=1.3.84-stage12.2-cachefix'), 'index app cache bust key missing');
must(/foxbear-shell-v1\.3\.84/.test(sw) && /stage(?:12(?:\.1|\.2)?|11|10|9)/.test(sw), 'service worker cache key missing or stale');
