...
must(html.includes('src/app.js?v=1.3.80-icons-buttonview-close'), 'index app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.80-icons-buttonview-close'), 'service worker cache key missing');
