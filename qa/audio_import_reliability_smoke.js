...
must(html.includes('src/app.js?v=1.3.75-dock-wave-download-fix'), 'index app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.75-dock-wave-download-fix'), 'service worker cache key missing');
