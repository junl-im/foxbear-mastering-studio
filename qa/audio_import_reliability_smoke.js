...
must(html.includes('src/app.js?v=1.4.0-stage24-settings-overlay-cleanup'), 'index app cache bust key missing');
must(/foxbear-shell-v1\.4\.0/.test(sw) && /stage(?:24|23|22|21|20|19|18|17|16|15|14|13|12(?:\.1|\.2)?|11|10|9)/.test(sw), 'service worker cache key missing or stale');
