...
must(html.includes('src/app.js?v=1.3.81-modal-dock-layout-integrity'), 'index app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.81-modal-dock-layout-integrity'), 'service worker cache key missing');
