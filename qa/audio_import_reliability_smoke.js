...
must(html.includes('src/app.js?v=1.3.70-dock-peak-toast-stack'), 'index app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.70-dock-peak-toast-stack'), 'service worker cache key missing');
