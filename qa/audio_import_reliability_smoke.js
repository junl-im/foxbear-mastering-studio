...
must(html.includes('src/app.js?v=1.3.64-kakao-upload-rootfix'), 'index app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.64-kakao-upload-rootfix'), 'service worker cache key missing');
