...
must(app.includes("const APP_VERSION = 'Pro v1.3.63'"), 'app version must be v1.3.63');
...
must(html.includes('src/app.js?v=1.3.63-loudness-ui'), 'index app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.63-loudness-ui'), 'service worker cache key missing');
