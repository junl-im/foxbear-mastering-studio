...
must(html.includes('src/app.js?v=1.3.76-dock-regression-buttonview'), 'index app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.76-dock-regression-buttonview'), 'service worker cache key missing');
