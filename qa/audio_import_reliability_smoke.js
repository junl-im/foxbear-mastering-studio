...
must(html.includes('src/app.js?v=1.3.73-dock-event-repair'), 'index app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.73-dock-event-repair'), 'service worker cache key missing');
