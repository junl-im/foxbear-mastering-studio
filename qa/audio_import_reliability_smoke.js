...
must(html.includes('src/app.js?v=1.3.67-dock-action-single-line'), 'index app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.67-dock-action-single-line'), 'service worker cache key missing');
