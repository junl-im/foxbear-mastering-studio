...
must(html.includes('src/app.js?v=1.3.65-dock-import-init-cleanup'), 'index app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.65-dock-import-init-cleanup'), 'service worker cache key missing');
