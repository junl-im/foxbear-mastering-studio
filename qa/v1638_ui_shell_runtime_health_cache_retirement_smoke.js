...
(async () => {
  ...
  const cacheNames = new Set([
    ...
    'foxbear-shell-v1.6.79-manifestless-patch-playback-retirement'
  ]);
  const deleted = [];
  const client = {
    id: 'client-current',
  ...
  assert(!deleted.includes('foxbear-shell-v1.6.79-manifestless-patch-playback-retirement'), 'latest rollback shell must remain available');
