...
(async () => {
  ...
  const cacheNames = new Set([
    ...
    'foxbear-shell-v1.6.109-mastering-cooperative-pcm-responsiveness'
  ]);
  const deleted = [];
  const client = {
    id: 'client-current',
  ...
  assert(!deleted.includes('foxbear-shell-v1.6.109-mastering-cooperative-pcm-responsiveness'), 'latest rollback shell must remain available');
