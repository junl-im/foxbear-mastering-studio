...
(async () => {
  ...
  const cacheNames = new Set([
    ...
    'foxbear-shell-v1.6.80-ai-mastering-expert-workspace'
  ]);
  const deleted = [];
  const client = {
    id: 'client-current',
  ...
  assert(!deleted.includes('foxbear-shell-v1.6.80-ai-mastering-expert-workspace'), 'latest rollback shell must remain available');
