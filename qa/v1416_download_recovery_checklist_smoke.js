...
must(html.includes('data-build="1.6.106"'), 'index build marker should be 1.6.106');
must(html.includes('1.6.106-browser-geometry-history-recovery'), 'index should use v1.6.106 asset key');
must(sw.includes('foxbear-shell-v1.6.106-browser-geometry-history-recovery'), 'service worker cache should use v1.6.106 key');
...
must(service.includes("version: '1.6.106'"), 'download helpers should report v1.6.106');
...
must(css.includes('Download recovery checklist'), 'CSS should include v1.6.106 checklist comment');
...
must(pkg.qaChecks.includes('node qa/v1416_download_recovery_checklist_smoke.js'), 'package qaChecks should include v1.6.106 smoke');
must(fs.existsSync(path.join(root, 'qa/BROWSER_BACK_QA_MATRIX_1.4.26.md')), 'v1.6.106 browser matrix should exist');
must(qaReport.includes('v1.6.106'), 'QA report should mention v1.6.106');
must(changelog.includes('v1.6.106'), 'changelog should mention v1.6.106');
must(handoff.includes('v1.6.106'), 'handoff should mention v1.6.106');
