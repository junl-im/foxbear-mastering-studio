...
assert(index.includes('src/download/export-guard-service.js?v=1.5.24-e2e-responsive-preview-control'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.24-e2e-responsive-preview-control'), 'export guard not precached');
