...
assert(index.includes('src/download/export-guard-service.js?v=1.5.68-mail-delivery-verification-sender-subject-rules'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.68-mail-delivery-verification-sender-subject-rules'), 'export guard not precached');
