...
assert(index.includes('src/download/export-guard-service.js?v=1.6.73-csp-memory-admission-runtime-config'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.73-csp-memory-admission-runtime-config'), 'export guard not precached');
