...
assert(index.includes('src/download/export-guard-service.js?v=1.5.60-kakao-inapp-entry-memory-governor'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.60-kakao-inapp-entry-memory-governor'), 'export guard not precached');
