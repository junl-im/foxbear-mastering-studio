...
assert(index.includes('src/download/export-guard-service.js?v=1.6.105-header-dock-css-ownership-hardening'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.105-header-dock-css-ownership-hardening'), 'export guard not precached');
