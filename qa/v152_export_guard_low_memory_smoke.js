...
assert(index.includes('src/download/export-guard-service.js?v=1.7.0-adaptive-mastering-decision-phase1'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.7.0-adaptive-mastering-decision-phase1'), 'export guard not precached');
