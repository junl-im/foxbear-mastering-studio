...
assert(index.includes('src/download/export-guard-service.js?v=1.6.45-windows-release-gate-spark-hosting-no-app-check'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.45-windows-release-gate-spark-hosting-no-app-check'), 'export guard not precached');
