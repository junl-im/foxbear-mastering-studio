...
assert(index.includes('src/download/export-guard-service.js?v=1.5.22-header-preview-routing-polish'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.22-header-preview-routing-polish'), 'export guard not precached');
