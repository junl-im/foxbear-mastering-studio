...
assert(index.includes('src/download/export-guard-service.js?v=1.6.58-piano-transient-integrity'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.58-piano-transient-integrity'), 'export guard not precached');
