...
assert(index.includes('src/download/export-guard-service.js?v=1.5.65-incident-recovery-control-alert-history'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.65-incident-recovery-control-alert-history'), 'export guard not precached');
