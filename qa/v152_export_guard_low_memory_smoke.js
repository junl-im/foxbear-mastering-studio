...
assert(index.includes('src/download/export-guard-service.js?v=1.5.62-incident-delivery-watchdog-package-gate'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.62-incident-delivery-watchdog-package-gate'), 'export guard not precached');
