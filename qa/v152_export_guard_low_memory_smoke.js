...
assert(index.includes('src/download/export-guard-service.js?v=1.5.54-quality-recovery-profiles-browser-qa'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.54-quality-recovery-profiles-browser-qa'), 'export guard not precached');
