...
assert(index.includes('src/download/export-guard-service.js?v=1.6.56-playback-blob-source-resilience'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.56-playback-blob-source-resilience'), 'export guard not precached');
