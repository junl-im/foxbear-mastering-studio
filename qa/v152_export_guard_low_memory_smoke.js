...
assert(index.includes('src/download/export-guard-service.js?v=1.6.64-github-desktop-delivery-contract'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.64-github-desktop-delivery-contract'), 'export guard not precached');
