...
assert(index.includes('src/download/export-guard-service.js?v=1.5.23-e2e-preview-readiness'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.23-e2e-preview-readiness'), 'export guard not precached');
