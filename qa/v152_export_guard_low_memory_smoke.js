...
assert(index.includes('src/download/export-guard-service.js?v=1.5.42-zip-worker-cancellation'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.42-zip-worker-cancellation'), 'export guard not precached');
