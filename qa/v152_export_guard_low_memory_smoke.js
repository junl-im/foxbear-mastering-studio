...
assert(index.includes('src/download/export-guard-service.js?v=1.6.43-google-auth-trusted-types-csp-recovery'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.43-google-auth-trusted-types-csp-recovery'), 'export guard not precached');
