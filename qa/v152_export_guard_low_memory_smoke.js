...
assert(index.includes('src/download/export-guard-service.js?v=1.5.74-bulk-pause-skip-reorder-mobile-download'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.74-bulk-pause-skip-reorder-mobile-download'), 'export guard not precached');
