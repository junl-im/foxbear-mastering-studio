...
assert(index.includes('src/download/export-guard-service.js?v=1.6.66-static-gate-hygiene-repair'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.66-static-gate-hygiene-repair'), 'export guard not precached');
