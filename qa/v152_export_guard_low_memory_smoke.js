...
assert(index.includes('src/download/export-guard-service.js?v=1.5.73-bulk-control-eta-result-filter-ui'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.73-bulk-control-eta-result-filter-ui'), 'export guard not precached');
