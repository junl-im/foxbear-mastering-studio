...
assert(index.includes('src/download/export-guard-service.js?v=1.5.94-aiff-fallback-worker-diagnostics-reporting-contract'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.94-aiff-fallback-worker-diagnostics-reporting-contract'), 'export guard not precached');
