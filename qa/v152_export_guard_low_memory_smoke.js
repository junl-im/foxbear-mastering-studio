...
assert(index.includes('src/download/export-guard-service.js?v=1.5.21-history-csp-console-contract-fix'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.21-history-csp-console-contract-fix'), 'export guard not precached');
