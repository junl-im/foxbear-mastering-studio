...
assert(index.includes('src/download/export-guard-service.js?v=1.5.64-incident-operations-health-self-diagnostics'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.64-incident-operations-health-self-diagnostics'), 'export guard not precached');
