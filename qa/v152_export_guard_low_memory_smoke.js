...
assert(index.includes('src/download/export-guard-service.js?v=1.6.0-incident-mail-pipeline-health'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.0-incident-mail-pipeline-health'), 'export guard not precached');
