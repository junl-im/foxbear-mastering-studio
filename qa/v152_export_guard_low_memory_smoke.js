...
assert(index.includes('src/download/export-guard-service.js?v=1.5.36-interaction-lifecycle-hardening'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.36-interaction-lifecycle-hardening'), 'export guard not precached');
