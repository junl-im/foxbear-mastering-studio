...
assert(index.includes('src/download/export-guard-service.js?v=1.5.45-export-queue-recovery'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.45-export-queue-recovery'), 'export guard not precached');
