...
assert(index.includes('src/download/export-guard-service.js?v=1.5.91-cancellable-audio-pipeline-performance-guards'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.91-cancellable-audio-pipeline-performance-guards'), 'export guard not precached');
