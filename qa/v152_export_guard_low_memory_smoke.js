...
assert(index.includes('src/download/export-guard-service.js?v=1.5.46-engine-recommendation-api-audit'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.46-engine-recommendation-api-audit'), 'export guard not precached');
