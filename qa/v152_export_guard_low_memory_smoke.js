...
assert(index.includes('src/download/export-guard-service.js?v=1.5.25-e2e-preview-stability'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.25-e2e-preview-stability'), 'export guard not precached');
