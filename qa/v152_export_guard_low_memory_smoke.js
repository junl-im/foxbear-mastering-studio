...
assert(index.includes('src/download/export-guard-service.js?v=1.5.18-ci-diagnostics-pwa-readiness'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.18-ci-diagnostics-pwa-readiness'), 'export guard not precached');
