...
assert(index.includes('src/download/export-guard-service.js?v=1.6.40-ui-shell-retry-replacement-settlement'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.40-ui-shell-retry-replacement-settlement'), 'export guard not precached');
