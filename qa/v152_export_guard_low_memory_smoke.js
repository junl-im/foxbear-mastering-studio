...
assert(index.includes('src/download/export-guard-service.js?v=1.5.32-kakao-external-browser-local-flow'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.32-kakao-external-browser-local-flow'), 'export guard not precached');
