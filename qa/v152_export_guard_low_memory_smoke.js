...
assert(index.includes('src/download/export-guard-service.js?v=1.5.93-external-engine-transfer-admin-export-openai-readiness'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.93-external-engine-transfer-admin-export-openai-readiness'), 'export guard not precached');
