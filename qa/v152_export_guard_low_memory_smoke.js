...
assert(index.includes('src/download/export-guard-service.js?v=1.6.86-header-order-mobile-overflow-browser-gate-recovery'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.86-header-order-mobile-overflow-browser-gate-recovery'), 'export guard not precached');
