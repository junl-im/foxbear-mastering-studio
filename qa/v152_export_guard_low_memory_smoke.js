...
assert(index.includes('src/download/export-guard-service.js?v=1.6.50-kakao-centered-entry-notice'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.50-kakao-centered-entry-notice'), 'export guard not precached');
