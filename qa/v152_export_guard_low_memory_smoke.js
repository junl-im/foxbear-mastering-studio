...
assert(index.includes('src/download/export-guard-service.js?v=1.6.9-incident-readiness-history-recovery-copy-events'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.9-incident-readiness-history-recovery-copy-events'), 'export guard not precached');
