...
assert(index.includes('src/download/export-guard-service.js?v=1.6.72-ci-safe-hygiene-self-repair'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.72-ci-safe-hygiene-self-repair'), 'export guard not precached');
