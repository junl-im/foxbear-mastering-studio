...
assert(index.includes('src/download/export-guard-service.js?v=1.5.51-ci-runtime-contract-hardening'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.51-ci-runtime-contract-hardening'), 'export guard not precached');
