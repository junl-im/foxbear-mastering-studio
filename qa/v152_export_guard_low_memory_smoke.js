...
assert(index.includes('src/download/export-guard-service.js?v=1.6.112-mastering-lifecycle-race-hardening'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.112-mastering-lifecycle-race-hardening'), 'export guard not precached');
