...
assert(index.includes('src/download/export-guard-service.js?v=1.6.49-download-variant-cache-reuse'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.49-download-variant-cache-reuse'), 'export guard not precached');
