...
assert(index.includes('src/download/export-guard-service.js?v=1.6.99-header-role-focus-integrity'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.99-header-role-focus-integrity'), 'export guard not precached');
