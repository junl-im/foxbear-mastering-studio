...
assert(index.includes('src/download/export-guard-service.js?v=1.6.101-admin-lazyload-repo-cleanup'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.101-admin-lazyload-repo-cleanup'), 'export guard not precached');
