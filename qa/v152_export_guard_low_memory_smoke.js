...
assert(index.includes('src/download/export-guard-service.js?v=1.7.4-reload-reentry-mode-chooser'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.7.4-reload-reentry-mode-chooser'), 'export guard not precached');
