...
assert(index.includes('src/download/export-guard-service.js?v=1.6.79-manifestless-patch-playback-retirement'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.79-manifestless-patch-playback-retirement'), 'export guard not precached');
