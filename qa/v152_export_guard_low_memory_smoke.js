...
assert(index.includes('src/download/export-guard-service.js?v=1.6.1-transient-performance-diagnostics'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.1-transient-performance-diagnostics'), 'export guard not precached');
