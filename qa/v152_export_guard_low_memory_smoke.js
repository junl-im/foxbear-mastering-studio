...
assert(index.includes('src/download/export-guard-service.js?v=1.6.20-incident-background-sync-network-decay'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.20-incident-background-sync-network-decay'), 'export guard not precached');
