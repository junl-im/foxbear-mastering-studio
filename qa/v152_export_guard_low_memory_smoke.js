...
assert(index.includes('src/download/export-guard-service.js?v=1.6.4-incident-callable-csp-recovery'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.4-incident-callable-csp-recovery'), 'export guard not precached');
