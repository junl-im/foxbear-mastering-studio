...
assert(index.includes('src/download/export-guard-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery'), 'export guard not precached');
