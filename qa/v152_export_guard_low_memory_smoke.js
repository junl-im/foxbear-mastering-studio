...
assert(index.includes('src/download/export-guard-service.js?v=1.5.20-idempotent-pwa-cache-warm'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.20-idempotent-pwa-cache-warm'), 'export guard not precached');
