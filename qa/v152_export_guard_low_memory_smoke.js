...
assert(index.includes('src/download/export-guard-service.js?v=1.6.90-engine-control-overlay-isolation-header-contract-recovery'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.90-engine-control-overlay-isolation-header-contract-recovery'), 'export guard not precached');
