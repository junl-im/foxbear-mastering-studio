...
assert(index.includes('src/download/export-guard-service.js?v=1.5.66-incident-operations-action-guard-deploy-verification'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.66-incident-operations-action-guard-deploy-verification'), 'export guard not precached');
