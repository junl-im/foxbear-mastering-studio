...
assert(index.includes('src/download/export-guard-service.js?v=1.5.53-engine-recovery-performance-diagnostics'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.53-engine-recovery-performance-diagnostics'), 'export guard not precached');
