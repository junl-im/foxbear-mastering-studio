...
assert(index.includes('src/download/export-guard-service.js?v=1.5.27-device-glyph-sri-hardening'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.27-device-glyph-sri-hardening'), 'export guard not precached');
