...
assert(index.includes('src/download/export-guard-service.js?v=1.5.92-python-bytecode-ci-hygiene-node24-cache'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.92-python-bytecode-ci-hygiene-node24-cache'), 'export guard not precached');
