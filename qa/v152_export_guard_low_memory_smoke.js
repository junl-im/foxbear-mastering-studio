...
assert(index.includes('src/download/export-guard-service.js?v=1.5.29-analysis-update-lifecycle'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.29-analysis-update-lifecycle'), 'export guard not precached');
