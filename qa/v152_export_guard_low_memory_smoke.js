...
assert(index.includes('src/download/export-guard-service.js?v=1.6.75-download-progress-admission-fallback-closure'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.75-download-progress-admission-fallback-closure'), 'export guard not precached');
