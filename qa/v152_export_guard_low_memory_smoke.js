...
assert(index.includes('src/download/export-guard-service.js?v=1.4.26-wake-lock-state-sync'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.4.26-wake-lock-state-sync'), 'export guard not precached');
...
assert(changelog.startsWith('# v1.5.2 - Export Guard + Low Memory UX'), 'CHANGELOG v1.5.2 entry missing at top');
