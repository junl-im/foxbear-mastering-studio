...
assert(index.includes('src/download/export-guard-service.js?v=1.6.103-ci-hygiene-mail-routing-hardening'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.103-ci-hygiene-mail-routing-hardening'), 'export guard not precached');
