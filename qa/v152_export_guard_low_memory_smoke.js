...
assert(index.includes('src/download/export-guard-service.js?v=1.6.95-release-artifact-safety'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.95-release-artifact-safety'), 'export guard not precached');
