...
assert(index.includes('src/download/export-guard-service.js?v=1.6.93-mobile-dock-visibility-integrity-recovery'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.93-mobile-dock-visibility-integrity-recovery'), 'export guard not precached');
