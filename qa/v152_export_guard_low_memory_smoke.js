...
assert(index.includes('src/download/export-guard-service.js?v=1.6.80-ai-mastering-expert-workspace'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.80-ai-mastering-expert-workspace'), 'export guard not precached');
