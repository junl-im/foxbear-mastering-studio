...
assert(index.includes('src/download/export-guard-service.js?v=1.5.82-mastering-cancel-playback-resume-recovery'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.82-mastering-cancel-playback-resume-recovery'), 'export guard not precached');
