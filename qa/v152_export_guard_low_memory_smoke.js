...
assert(index.includes('src/download/export-guard-service.js?v=1.6.106-browser-geometry-history-recovery'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.106-browser-geometry-history-recovery'), 'export guard not precached');
