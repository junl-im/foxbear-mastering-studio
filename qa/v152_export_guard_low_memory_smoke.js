...
assert(index.includes('src/download/export-guard-service.js?v=1.5.13-handoff-package-integrity'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.13-handoff-package-integrity'), 'export guard not precached');
