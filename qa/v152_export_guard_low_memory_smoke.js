...
assert(index.includes('src/download/export-guard-service.js?v=1.5.31-player-download-stability'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.31-player-download-stability'), 'export guard not precached');
