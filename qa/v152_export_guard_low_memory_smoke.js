...
assert(index.includes('src/download/export-guard-service.js?v=1.6.46-google-auth-same-origin-network-recovery'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.46-google-auth-same-origin-network-recovery'), 'export guard not precached');
