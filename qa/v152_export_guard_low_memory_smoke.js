...
assert(index.includes('src/download/export-guard-service.js?v=1.5.84-trusted-types-browser-gate-recovery'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.84-trusted-types-browser-gate-recovery'), 'export guard not precached');
