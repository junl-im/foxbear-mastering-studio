...
assert(index.includes('src/download/export-guard-service.js?v=1.6.71-pwa-share-lease-handoff-deploy-policy-e2e'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.71-pwa-share-lease-handoff-deploy-policy-e2e'), 'export guard not precached');
