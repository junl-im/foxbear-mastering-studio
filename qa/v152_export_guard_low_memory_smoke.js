...
assert(index.includes('src/download/export-guard-service.js?v=1.6.7-incident-readiness-history-sync-performance-hud'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.7-incident-readiness-history-sync-performance-hud'), 'export guard not precached');
