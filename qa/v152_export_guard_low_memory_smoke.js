...
assert(index.includes('src/download/export-guard-service.js?v=1.6.74-incident-admission-spark-retention-download-memory'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.74-incident-admission-spark-retention-download-memory'), 'export guard not precached');
