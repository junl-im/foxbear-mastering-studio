...
assert(index.includes('src/download/export-guard-service.js?v=1.6.10-incident-readiness-contract-csp-cache-hardening'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.10-incident-readiness-contract-csp-cache-hardening'), 'export guard not precached');
