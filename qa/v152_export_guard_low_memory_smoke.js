...
assert(index.includes('src/download/export-guard-service.js?v=1.5.96-modal-focus-memory-diagnostics'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.96-modal-focus-memory-diagnostics'), 'export guard not precached');
