...
assert(index.includes('src/download/export-guard-service.js?v=1.6.113-incident-finalizer-p1-hardening'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.113-incident-finalizer-p1-hardening'), 'export guard not precached');
