...
assert(index.includes('src/download/export-guard-service.js?v=1.6.88-mobile-header-grid-ownership-recovery'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.88-mobile-header-grid-ownership-recovery'), 'export guard not precached');
