...
assert(index.includes('src/download/export-guard-service.js?v=1.6.42-spark-google-admin-auth'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.42-spark-google-admin-auth'), 'export guard not precached');
