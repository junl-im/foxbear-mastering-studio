...
assert(index.includes('src/download/export-guard-service.js?v=1.6.44-google-auth-gapi-module-trusted-types-recovery'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.44-google-auth-gapi-module-trusted-types-recovery'), 'export guard not precached');
