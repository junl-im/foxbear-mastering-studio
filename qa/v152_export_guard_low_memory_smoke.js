...
assert(index.includes('src/download/export-guard-service.js?v=1.6.65-firestore-write-fencing'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.65-firestore-write-fencing'), 'export guard not precached');
