...
assert(index.includes('src/download/export-guard-service.js?v=1.6.87-mobile-header-device-label-overlap-recovery'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.87-mobile-header-device-label-overlap-recovery'), 'export guard not precached');
