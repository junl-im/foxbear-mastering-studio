...
assert(index.includes('src/download/export-guard-service.js?v=1.5.10-header-settings-relocation'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.10-header-settings-relocation'), 'export guard not precached');
