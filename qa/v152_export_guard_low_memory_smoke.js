...
assert(index.includes('src/download/export-guard-service.js?v=1.6.59-readiness-corp-security-hardening'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.59-readiness-corp-security-hardening'), 'export guard not precached');
