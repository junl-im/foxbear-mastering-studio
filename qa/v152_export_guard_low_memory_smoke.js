...
assert(index.includes('src/download/export-guard-service.js?v=1.5.15-e2e-runtime-classification'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.15-e2e-runtime-classification'), 'export guard not precached');
