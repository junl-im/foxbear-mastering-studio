...
assert(index.includes('src/download/export-guard-service.js?v=1.6.2-nonblocking-health-status-design-polish'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.2-nonblocking-health-status-design-polish'), 'export guard not precached');
