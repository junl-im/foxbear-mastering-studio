...
assert(index.includes('src/download/export-guard-service.js?v=1.5.14-github-desktop-handoff-preflight'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.14-github-desktop-handoff-preflight'), 'export guard not precached');
