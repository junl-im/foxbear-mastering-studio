...
assert(index.includes('src/download/export-guard-service.js?v=1.6.47-external-host-admin-auth-opaque-error-recovery'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.47-external-host-admin-auth-opaque-error-recovery'), 'export guard not precached');
