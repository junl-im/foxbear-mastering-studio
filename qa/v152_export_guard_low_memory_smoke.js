...
assert(index.includes('src/download/export-guard-service.js?v=1.5.38-preflight-worker-multitab-hardening'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.38-preflight-worker-multitab-hardening'), 'export guard not precached');
