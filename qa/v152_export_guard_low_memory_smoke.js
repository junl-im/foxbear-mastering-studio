...
assert(index.includes('src/download/export-guard-service.js?v=1.6.70-share-retry-policy-drift-ci-efficiency'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.70-share-retry-policy-drift-ci-efficiency'), 'export guard not precached');
