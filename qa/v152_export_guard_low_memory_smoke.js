...
assert(index.includes('src/download/export-guard-service.js?v=1.6.13-download-format-context-menu'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.13-download-format-context-menu'), 'export guard not precached');
