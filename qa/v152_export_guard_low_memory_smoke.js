...
assert(index.includes('src/download/export-guard-service.js?v=1.6.34-history-hard-stall-sw-activity-lifecycle'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.34-history-hard-stall-sw-activity-lifecycle'), 'export guard not precached');
