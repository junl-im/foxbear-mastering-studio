...
assert(index.includes('src/download/export-guard-service.js?v=1.6.83-browser-ui-mode-fixture-source-hygiene-recovery'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.83-browser-ui-mode-fixture-source-hygiene-recovery'), 'export guard not precached');
