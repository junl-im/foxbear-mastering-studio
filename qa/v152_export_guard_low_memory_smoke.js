...
assert(index.includes('src/download/export-guard-service.js?v=1.5.52-ci-parallel-release-gate'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.52-ci-parallel-release-gate'), 'export guard not precached');
