...
assert(index.includes('src/download/export-guard-service.js?v=1.6.110-ui-mode-early-boot-recovery'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.110-ui-mode-early-boot-recovery'), 'export guard not precached');
