...
assert(index.includes('src/download/export-guard-service.js?v=1.6.61-human-readable-download-filenames'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.61-human-readable-download-filenames'), 'export guard not precached');
