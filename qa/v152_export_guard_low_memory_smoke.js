...
assert(index.includes('src/download/export-guard-service.js?v=1.5.67-incident-admin-audit-webhook-failover-index-health'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.67-incident-admin-audit-webhook-failover-index-health'), 'export guard not precached');
