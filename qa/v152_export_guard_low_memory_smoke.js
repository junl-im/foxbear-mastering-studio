...
assert(index.includes('src/download/export-guard-service.js?v=1.5.55-automatic-incident-mail-reporting'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.55-automatic-incident-mail-reporting'), 'export guard not precached');
