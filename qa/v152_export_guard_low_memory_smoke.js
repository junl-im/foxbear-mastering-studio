...
assert(index.includes('src/download/export-guard-service.js?v=1.6.12-mastering-tone-loudness-fastpath'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.12-mastering-tone-loudness-fastpath'), 'export guard not precached');
