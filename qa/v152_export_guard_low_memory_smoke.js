...
assert(index.includes('src/download/export-guard-service.js?v=1.6.39-ui-shell-partial-script-probe-isolation'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.39-ui-shell-partial-script-probe-isolation'), 'export guard not precached');
