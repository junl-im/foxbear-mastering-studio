...
assert(index.includes('src/download/export-guard-service.js?v=1.5.90-browser-retry-integrity-metadata-aware-scope'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.90-browser-retry-integrity-metadata-aware-scope'), 'export guard not precached');
