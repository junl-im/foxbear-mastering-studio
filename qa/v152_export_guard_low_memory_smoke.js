...
assert(index.includes('src/download/export-guard-service.js?v=1.5.37-memory-import-waveform-hardening'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.37-memory-import-waveform-hardening'), 'export guard not precached');
