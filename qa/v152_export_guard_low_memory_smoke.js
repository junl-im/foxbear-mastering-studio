...
assert(index.includes('src/download/export-guard-service.js?v=1.5.19-ci-runtime-isolation-package-hardening'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.19-ci-runtime-isolation-package-hardening'), 'export guard not precached');
