...
assert(index.includes('src/download/export-guard-service.js?v=1.6.22-incident-recovery-coalescing-time-decay'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.22-incident-recovery-coalescing-time-decay'), 'export guard not precached');
