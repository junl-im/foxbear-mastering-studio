...
assert(index.includes('src/download/export-guard-service.js?v=1.5.16-e2e-server-pipe-deadlock-fix'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.16-e2e-server-pipe-deadlock-fix'), 'export guard not precached');
