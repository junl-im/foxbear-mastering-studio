...
assert(index.includes('src/download/export-guard-service.js?v=1.5.26-engraved-command-header'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.26-engraved-command-header'), 'export guard not precached');
