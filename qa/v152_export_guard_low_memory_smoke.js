...
assert(index.includes('src/download/export-guard-service.js?v=1.5.98-worker-retry-health-levels'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.98-worker-retry-health-levels'), 'export guard not precached');
