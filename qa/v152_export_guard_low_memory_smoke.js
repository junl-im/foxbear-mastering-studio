...
assert(index.includes('src/download/export-guard-service.js?v=1.6.91-runtime-health-hidden-geometry-contract-recovery'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.91-runtime-health-hidden-geometry-contract-recovery'), 'export guard not precached');
