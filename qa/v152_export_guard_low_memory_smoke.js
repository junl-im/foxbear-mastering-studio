...
assert(index.includes('src/download/export-guard-service.js?v=1.5.30-inapp-playback-recovery'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.30-inapp-playback-recovery'), 'export guard not precached');
