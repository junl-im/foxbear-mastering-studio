...
assert(index.includes('src/download/export-guard-service.js?v=1.5.81-master-preview-cancellation-native-result-isolation'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.81-master-preview-cancellation-native-result-isolation'), 'export guard not precached');
