...
assert(index.includes('src/download/export-guard-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness'), 'export guard not precached');
