...
assert(index.includes('src/download/export-guard-service.js?v=1.5.69-mail-receipt-confirmation-history-branded-template'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.5.69-mail-receipt-confirmation-history-branded-template'), 'export guard not precached');
