...
assert(index.includes('src/download/export-guard-service.js?v=1.6.78-release-generation-assist-url-playback-invalidation'), 'export guard not loaded in index');
...
assert(sw.includes('./src/download/export-guard-service.js?v=1.6.78-release-generation-assist-url-playback-invalidation'), 'export guard not precached');
