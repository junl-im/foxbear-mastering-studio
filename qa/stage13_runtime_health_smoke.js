...
assert(sw.includes(`foxbear-shell-v1.4.18-download-dialog-micro-hint`), 'service worker cache name should be stage14 or later');
...
assert(overwrite.includes('v1.4.18'), 'overwrite package default should be latest stage or later');
