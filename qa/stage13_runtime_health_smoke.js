...
assert(sw.includes(`foxbear-shell-v1.4.26-wake-lock-state-sync`), 'service worker cache name should be stage14 or later');
...
assert(overwrite.includes('v1.4.26'), 'overwrite package default should be latest stage or later');
