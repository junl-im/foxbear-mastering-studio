...
const version = '1.4.0-stage16-version-release';
...
assert(sw.includes(`foxbear-shell-v1.4.0-stage16-version-release`), 'service worker cache name should be stage14 or later');
...
assert(overwrite.includes('v1.4.0-stage16'), 'overwrite package default should be stage16 or later');
