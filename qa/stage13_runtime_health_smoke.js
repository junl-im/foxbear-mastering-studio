...
assert(sw.includes(`foxbear-shell-v1.3.84-stage15-settings-panel`), 'service worker cache name should be stage14 or later');
...
assert(overwrite.includes('v1.3.84-stage15'), 'overwrite package default should be stage15 or later');
