...
assert(sw.includes(`foxbear-shell-v1.4.5-stability-audit`), 'service worker cache name should be stage14 or later');
...
assert(overwrite.includes('v1.4.5'), 'overwrite package default should be latest stage or later');
