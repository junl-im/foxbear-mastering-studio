...
assert(sw.includes(`foxbear-shell-v1.6.90-engine-control-overlay-isolation-header-contract-recovery`), 'service worker cache name should be stage14 or later');
