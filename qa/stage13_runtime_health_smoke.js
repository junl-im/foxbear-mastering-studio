...
assert(sw.includes(`foxbear-shell-v1.4.0-stage21-unified-preview-system`), 'service worker cache name should be stage14 or later');
...
assert(overwrite.includes('v1.4.0-stage21'), 'overwrite package default should be latest stage or later');
