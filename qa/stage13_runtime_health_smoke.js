...
const version = '1.4.0-stage17-highlight-compare-sync';
...
assert(sw.includes(`foxbear-shell-v1.4.0-stage17-highlight-compare-sync`), 'service worker cache name should be stage14 or later');
...
assert(overwrite.includes('v1.4.0-stage17'), 'overwrite package default should be latest stage or later');
