...
assert(sw.includes(`foxbear-shell-v1.4.4-fft-live-hotfix`), 'service worker cache name should be stage14 or later');
...
assert(overwrite.includes('v1.4.4'), 'overwrite package default should be latest stage or later');
