...
assert(sw.includes(`foxbear-shell-v1.4.24-bulk-import-hud`), 'service worker cache name should be stage14 or later');
...
assert(overwrite.includes('v1.4.24'), 'overwrite package default should be latest stage or later');
