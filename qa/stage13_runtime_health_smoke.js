...
assert(sw.includes(`foxbear-shell-v1.4.7-dock-fft-removal`), 'service worker cache name should be stage14 or later');
...
assert(overwrite.includes('v1.4.7'), 'overwrite package default should be latest stage or later');
