...
assert(sw.includes(`foxbear-shell-v1.4.8-dock-spectrum-cleanup`), 'service worker cache name should be stage14 or later');
...
assert(overwrite.includes('v1.4.8'), 'overwrite package default should be latest stage or later');
