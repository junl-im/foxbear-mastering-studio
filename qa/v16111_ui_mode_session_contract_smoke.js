...
assert(source.includes("sameTabReload: 'default-expert'"));
...
assert(browser.includes('defaults to expert on entry'));
...
console.log('PASS v1.7.2 UI mode default expert entry contract');
