...
v1.4.14 keeps Dock FFT removed and adds hidden performance diagnostics. This matrix focuses on confirming that diagnostics are available for troubleshooting without changing the normal user experience.
