# Browser/PWA QA Matrix - v1.4.21 Performance diagnostics

## Scope

v1.4.21 keeps Dock FFT removed and adds hidden performance diagnostics. This matrix focuses on confirming that diagnostics are available for troubleshooting without changing the normal user experience.
...
- v1.4.21 retains Dock mini FFT removal and Back confirm focus from the stability polish line.
