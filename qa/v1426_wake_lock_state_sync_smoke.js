...
must(pkg.qaChecks.includes('node qa/v1426_wake_lock_state_sync_smoke.js'), 'package QA should run v1.6.66 smoke');
must(index.includes('data-build="1.6.66"'), 'index build marker should be 1.6.66');
must(index.includes('1.6.66-static-gate-hygiene-repair'), 'index cache key should use v1.6.66 wake key');
must(sw.includes('foxbear-shell-v1.6.66-static-gate-hygiene-repair'), 'service worker cache should use v1.6.66 wake key');
...
must(runtime.includes('1.6.66-static-gate-hygiene-repair'), 'runtime health fallback version should be v1.6.66');
...
must(report.includes('148/148 PASS') || report.includes('v1.6.66'), 'QA report should mention v1.6.66 or 148/148 PASS');
must(changelog.includes('v1.6.66') && changelog.includes('Wake Lock'), 'changelog should mention v1.6.66 Wake Lock');
