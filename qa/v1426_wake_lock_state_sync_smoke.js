...
must(pkg.qaChecks.includes('node qa/v1426_wake_lock_state_sync_smoke.js'), 'package QA should run v1.6.80 smoke');
must(index.includes('data-build="1.6.80"'), 'index build marker should be 1.6.80');
must(index.includes('1.6.80-ai-mastering-expert-workspace'), 'index cache key should use v1.6.80 wake key');
must(sw.includes('foxbear-shell-v1.6.80-ai-mastering-expert-workspace'), 'service worker cache should use v1.6.80 wake key');
...
must(runtime.includes('1.6.80-ai-mastering-expert-workspace'), 'runtime health fallback version should be v1.6.80');
...
must(report.includes('148/148 PASS') || report.includes('v1.6.80'), 'QA report should mention v1.6.80 or 148/148 PASS');
must(changelog.includes('v1.6.80') && changelog.includes('Wake Lock'), 'changelog should mention v1.6.80 Wake Lock');
