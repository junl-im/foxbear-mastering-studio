...
assert(pkg.version === '1.6.64', 'package version must be v1.6.64');
...
assert(pkg.scripts?.['package:verify:full'] === 'node tools/verify-release-zip.js dist/foxbear-mastering-studio-v1.6.64-full.zip', 'full verifier filename mismatch');
assert(pkg.scripts?.['package:verify:patch'] === 'node tools/verify-patch-zip.js dist/foxbear-mastering-studio-v1.6.64-patch.zip', 'patch verifier filename mismatch');
