...
assert(indexSource.includes('src/audio/master-preview-job-service.js?v=1.6.34-history-hard-stall-sw-activity-lifecycle'));
assert(swSource.includes('./src/audio/master-preview-job-service.js?v=1.6.34-history-hard-stall-sw-activity-lifecycle'));
