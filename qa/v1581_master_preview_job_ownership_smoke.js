...
assert(indexSource.includes('src/audio/master-preview-job-service.js?v=1.6.40-ui-shell-retry-replacement-settlement'));
assert(swSource.includes('./src/audio/master-preview-job-service.js?v=1.6.40-ui-shell-retry-replacement-settlement'));
