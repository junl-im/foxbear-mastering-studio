...
assert(indexSource.includes('src/audio/master-preview-job-service.js?v=1.6.87-mobile-header-device-label-overlap-recovery'));
assert(swSource.includes('./src/audio/master-preview-job-service.js?v=1.6.87-mobile-header-device-label-overlap-recovery'));
