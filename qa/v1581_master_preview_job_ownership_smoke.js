...
assert(indexSource.includes('src/audio/master-preview-job-service.js?v=1.5.97-worker-recovery-diagnostics'));
assert(swSource.includes('./src/audio/master-preview-job-service.js?v=1.5.97-worker-recovery-diagnostics'));
