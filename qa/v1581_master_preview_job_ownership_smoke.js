...
assert(indexSource.includes('src/audio/master-preview-job-service.js?v=1.6.2-nonblocking-health-status-design-polish'));
assert(swSource.includes('./src/audio/master-preview-job-service.js?v=1.6.2-nonblocking-health-status-design-polish'));
