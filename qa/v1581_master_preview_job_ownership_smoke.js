...
assert(indexSource.includes('src/audio/master-preview-job-service.js?v=1.6.41-admin-secret-pin-session'));
assert(swSource.includes('./src/audio/master-preview-job-service.js?v=1.6.41-admin-secret-pin-session'));
