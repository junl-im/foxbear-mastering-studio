...
assert(indexSource.includes('src/audio/master-preview-job-service.js?v=1.6.46-google-auth-same-origin-network-recovery'));
assert(swSource.includes('./src/audio/master-preview-job-service.js?v=1.6.46-google-auth-same-origin-network-recovery'));
