...
assert(indexSource.includes('src/audio/master-preview-job-service.js?v=1.6.70-share-retry-policy-drift-ci-efficiency'));
assert(swSource.includes('./src/audio/master-preview-job-service.js?v=1.6.70-share-retry-policy-drift-ci-efficiency'));
