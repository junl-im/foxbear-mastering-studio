...
assert(indexSource.includes('src/audio/master-preview-job-service.js?v=1.6.25-incident-recovery-timeout-abort-stress'));
assert(swSource.includes('./src/audio/master-preview-job-service.js?v=1.6.25-incident-recovery-timeout-abort-stress'));
