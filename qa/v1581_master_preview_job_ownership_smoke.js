...
assert(indexSource.includes('src/audio/master-preview-job-service.js?v=1.6.65-firestore-write-fencing'));
assert(swSource.includes('./src/audio/master-preview-job-service.js?v=1.6.65-firestore-write-fencing'));
