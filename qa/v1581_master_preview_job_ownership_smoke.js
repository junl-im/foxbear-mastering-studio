...
assert(indexSource.includes('src/audio/master-preview-job-service.js?v=1.6.86-header-order-mobile-overflow-browser-gate-recovery'));
assert(swSource.includes('./src/audio/master-preview-job-service.js?v=1.6.86-header-order-mobile-overflow-browser-gate-recovery'));
