...
assert(indexSource.includes('src/audio/master-preview-job-service.js?v=1.6.93-mobile-dock-visibility-integrity-recovery'));
assert(swSource.includes('./src/audio/master-preview-job-service.js?v=1.6.93-mobile-dock-visibility-integrity-recovery'));
