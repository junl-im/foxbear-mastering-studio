...
assert(indexSource.includes('src/audio/master-preview-job-service.js?v=1.6.74-incident-admission-spark-retention-download-memory'));
assert(swSource.includes('./src/audio/master-preview-job-service.js?v=1.6.74-incident-admission-spark-retention-download-memory'));
