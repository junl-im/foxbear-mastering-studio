...
assert(indexSource.includes('src/audio/master-preview-job-service.js?v=1.6.95-release-artifact-safety'));
assert(swSource.includes('./src/audio/master-preview-job-service.js?v=1.6.95-release-artifact-safety'));
