...
assert(indexSource.includes('src/audio/master-preview-job-service.js?v=1.6.97-boot-payload-delivery-privacy-hardening'));
assert(swSource.includes('./src/audio/master-preview-job-service.js?v=1.6.97-boot-payload-delivery-privacy-hardening'));
