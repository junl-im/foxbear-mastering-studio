...
assert(indexSource.includes('src/audio/master-preview-job-service.js?v=1.6.42-spark-google-admin-auth'));
assert(swSource.includes('./src/audio/master-preview-job-service.js?v=1.6.42-spark-google-admin-auth'));
