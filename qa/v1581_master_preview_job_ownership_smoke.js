...
assert(indexSource.includes('src/audio/master-preview-job-service.js?v=1.6.10-incident-readiness-contract-csp-cache-hardening'));
assert(swSource.includes('./src/audio/master-preview-job-service.js?v=1.6.10-incident-readiness-contract-csp-cache-hardening'));
