...
assert(indexSource.includes('src/audio/master-preview-job-service.js?v=1.6.4-incident-callable-csp-recovery'));
assert(swSource.includes('./src/audio/master-preview-job-service.js?v=1.6.4-incident-callable-csp-recovery'));
