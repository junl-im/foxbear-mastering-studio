...
assert.strictEqual(pkg.foxbearRelease.buildId, 'master-preview-cancellation-native-result-isolation');
...
assert(indexSource.includes('src/audio/master-preview-job-service.js?v=1.5.81-master-preview-cancellation-native-result-isolation'));
assert(swSource.includes('./src/audio/master-preview-job-service.js?v=1.5.81-master-preview-cancellation-native-result-isolation'));
