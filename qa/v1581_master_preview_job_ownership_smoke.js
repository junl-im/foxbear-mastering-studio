...
assert(indexSource.includes('src/audio/master-preview-job-service.js?v=1.6.111-ui-mode-session-contract-hardening'));
assert(swSource.includes('./src/audio/master-preview-job-service.js?v=1.6.111-ui-mode-session-contract-hardening'));
