...
assert(indexSource.includes('src/audio/master-preview-job-service.js?v=1.6.61-human-readable-download-filenames'));
assert(swSource.includes('./src/audio/master-preview-job-service.js?v=1.6.61-human-readable-download-filenames'));
