...
assert(indexSource.includes('src/audio/master-preview-job-service.js?v=1.6.73-csp-memory-admission-runtime-config'));
assert(swSource.includes('./src/audio/master-preview-job-service.js?v=1.6.73-csp-memory-admission-runtime-config'));
