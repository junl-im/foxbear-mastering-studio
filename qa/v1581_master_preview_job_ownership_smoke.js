...
assert(indexSource.includes('src/audio/master-preview-job-service.js?v=1.6.75-download-progress-admission-fallback-closure'));
assert(swSource.includes('./src/audio/master-preview-job-service.js?v=1.6.75-download-progress-admission-fallback-closure'));
