...
assert(indexSource.includes('src/audio/master-preview-job-service.js?v=1.6.45-windows-release-gate-spark-hosting-no-app-check'));
assert(swSource.includes('./src/audio/master-preview-job-service.js?v=1.6.45-windows-release-gate-spark-hosting-no-app-check'));
