...
assert(indexSource.includes('src/audio/master-preview-job-service.js?v=1.6.47-external-host-admin-auth-opaque-error-recovery'));
assert(swSource.includes('./src/audio/master-preview-job-service.js?v=1.6.47-external-host-admin-auth-opaque-error-recovery'));
