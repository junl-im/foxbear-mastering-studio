...
assert(indexSource.includes('src/audio/master-preview-job-service.js?v=1.6.88-mobile-header-grid-ownership-recovery'));
assert(swSource.includes('./src/audio/master-preview-job-service.js?v=1.6.88-mobile-header-grid-ownership-recovery'));
