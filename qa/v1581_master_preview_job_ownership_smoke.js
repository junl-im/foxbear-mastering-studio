...
assert(indexSource.includes('src/audio/master-preview-job-service.js?v=1.6.105-header-dock-css-ownership-hardening'));
assert(swSource.includes('./src/audio/master-preview-job-service.js?v=1.6.105-header-dock-css-ownership-hardening'));
