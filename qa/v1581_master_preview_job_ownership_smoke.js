...
assert(indexSource.includes('src/audio/master-preview-job-service.js?v=1.6.78-release-generation-assist-url-playback-invalidation'));
assert(swSource.includes('./src/audio/master-preview-job-service.js?v=1.6.78-release-generation-assist-url-playback-invalidation'));
