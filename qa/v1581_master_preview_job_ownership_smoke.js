...
assert(indexSource.includes('src/audio/master-preview-job-service.js?v=1.6.101-admin-lazyload-repo-cleanup'));
assert(swSource.includes('./src/audio/master-preview-job-service.js?v=1.6.101-admin-lazyload-repo-cleanup'));
