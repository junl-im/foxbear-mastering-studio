...
assert(indexSource.includes('src/audio/master-preview-job-service.js?v=1.5.96-modal-focus-memory-diagnostics'));
assert(swSource.includes('./src/audio/master-preview-job-service.js?v=1.5.96-modal-focus-memory-diagnostics'));
