...
assert(indexSource.includes('src/audio/master-preview-job-service.js?v=1.6.1-transient-performance-diagnostics'));
assert(swSource.includes('./src/audio/master-preview-job-service.js?v=1.6.1-transient-performance-diagnostics'));
