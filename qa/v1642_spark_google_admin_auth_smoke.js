...
assert(pkg.version === '1.6.42', 'package version must be 1.6.42');
assert(pkg.foxbearRelease?.buildId === 'spark-google-admin-auth', 'release build id must describe Spark Google admin auth');
