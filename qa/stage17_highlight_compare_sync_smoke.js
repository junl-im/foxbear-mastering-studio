...
assert(pkg.description.includes('Stage21') || pkg.description.includes('Stage20') || pkg.description.includes('Stage18') || pkg.description.includes('Stage17'), 'package description should identify latest Stage17+ line');
