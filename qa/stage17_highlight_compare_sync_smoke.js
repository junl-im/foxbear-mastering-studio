...
const assetVersion = '1.4.0-stage26-unified-waveform-controls';

assert(pkg.version === '1.4.0', 'Stage17 should keep official app version at 1.4.0');
assert(pkg.description.includes('Stage26') || pkg.description.includes('Stage25') || pkg.description.includes('Stage23') || pkg.description.includes('Stage21') || pkg.description.includes('Stage20') || pkg.description.includes('Stage18') || pkg.description.includes('Stage17'), 'package description should identify latest Stage17+ line');
