...
must(css.includes('v1.3.68 Dock actions single-line compact layout'), 'single-line dock CSS override missing');
...
must(dockCss.includes('v1.3.68 Dock action row'), 'dock.css single-line override missing');
