...
assert(index.includes('src/audio/reference-profile-service.js?v=1.5.15-e2e-runtime-classification'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.5.15-e2e-runtime-classification'), 'reference profile service not precached');
