...
assert(index.includes('src/audio/reference-profile-service.js?v=1.6.91-runtime-health-hidden-geometry-contract-recovery'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.6.91-runtime-health-hidden-geometry-contract-recovery'), 'reference profile service not precached');
...
assert(gate.includes('1.6.91-engine-quality-regression'), 'quality gate service version missing');
