...
assert(index.includes('src/audio/reference-profile-service.js?v=1.5.27-device-glyph-sri-hardening'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.5.27-device-glyph-sri-hardening'), 'reference profile service not precached');
