...
assert(index.includes('src/audio/reference-profile-service.js?v=1.5.97-worker-recovery-diagnostics'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.5.97-worker-recovery-diagnostics'), 'reference profile service not precached');
...
assert(gate.includes('1.5.97-engine-quality-regression'), 'quality gate service version missing');
