...
assert(index.includes('src/audio/reference-profile-service.js?v=1.5.82-mastering-cancel-playback-resume-recovery'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.5.82-mastering-cancel-playback-resume-recovery'), 'reference profile service not precached');
...
assert(gate.includes('1.5.82-engine-quality-regression'), 'quality gate service version missing');
