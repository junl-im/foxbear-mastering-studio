...
assert(index.includes('src/audio/reference-profile-service.js?v=1.5.57-modal-close-consistency'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.5.57-modal-close-consistency'), 'reference profile service not precached');
...
assert(gate.includes('1.5.57-engine-quality-regression'), 'quality gate service version missing');
