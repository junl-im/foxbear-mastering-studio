...
assert(index.includes('src/audio/reference-profile-service.js?v=1.5.60-kakao-inapp-entry-memory-governor'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.5.60-kakao-inapp-entry-memory-governor'), 'reference profile service not precached');
...
assert(gate.includes('1.5.60-engine-quality-regression'), 'quality gate service version missing');
