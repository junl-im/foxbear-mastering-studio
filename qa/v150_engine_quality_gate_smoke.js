...
assert(index.includes('src/audio/reference-profile-service.js?v=1.6.90-engine-control-overlay-isolation-header-contract-recovery'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.6.90-engine-control-overlay-isolation-header-contract-recovery'), 'reference profile service not precached');
...
assert(gate.includes('1.6.90-engine-quality-regression'), 'quality gate service version missing');
...
assert(app.includes('const shortTermLufs = measureShortTermLufsStats(working)') || app.includes('const shortTermLufs = finalLoudness.shortTerm'), 'fallback finalizer shortTermLufs telemetry missing');
