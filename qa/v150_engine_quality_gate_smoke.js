...
assert(index.includes('src/audio/reference-profile-service.js?v=1.5.32-kakao-external-browser-local-flow'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.5.32-kakao-external-browser-local-flow'), 'reference profile service not precached');
