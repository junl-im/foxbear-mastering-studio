...
assert(index.includes('src/audio/reference-profile-service.js?v=1.7.4-reload-reentry-mode-chooser'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.7.4-reload-reentry-mode-chooser'), 'reference profile service not precached');
...
assert(gate.includes('1.7.4-engine-quality-regression'), 'quality gate service version missing');
