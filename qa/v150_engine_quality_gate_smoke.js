...
assert(index.includes('src/audio/reference-profile-service.js?v=1.5.23-e2e-preview-readiness'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.5.23-e2e-preview-readiness'), 'reference profile service not precached');
