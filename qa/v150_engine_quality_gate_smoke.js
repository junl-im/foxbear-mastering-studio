...
assert(index.includes('src/audio/reference-profile-service.js?v=1.5.65-incident-recovery-control-alert-history'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.5.65-incident-recovery-control-alert-history'), 'reference profile service not precached');
...
assert(gate.includes('1.5.65-engine-quality-regression'), 'quality gate service version missing');
