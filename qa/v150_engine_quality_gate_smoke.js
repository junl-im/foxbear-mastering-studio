...
assert(index.includes('src/audio/reference-profile-service.js?v=1.5.66-incident-operations-action-guard-deploy-verification'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.5.66-incident-operations-action-guard-deploy-verification'), 'reference profile service not precached');
...
assert(gate.includes('1.5.66-engine-quality-regression'), 'quality gate service version missing');
