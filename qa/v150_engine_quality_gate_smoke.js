...
assert(index.includes('src/audio/reference-profile-service.js?v=1.5.24-e2e-responsive-preview-control'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.5.24-e2e-responsive-preview-control'), 'reference profile service not precached');
