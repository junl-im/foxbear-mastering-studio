...
assert(index.includes('src/audio/reference-profile-service.js?v=1.6.47-external-host-admin-auth-opaque-error-recovery'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.6.47-external-host-admin-auth-opaque-error-recovery'), 'reference profile service not precached');
...
assert(gate.includes('1.6.47-engine-quality-regression'), 'quality gate service version missing');
