...
assert(index.includes('src/audio/reference-profile-service.js?v=1.5.50-pwa-current-cache-test-recovery'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.5.50-pwa-current-cache-test-recovery'), 'reference profile service not precached');
...
assert(gate.includes('1.5.50-engine-quality-regression'), 'quality gate service version missing');
