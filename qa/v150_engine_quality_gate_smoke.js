...
assert(index.includes('src/audio/reference-profile-service.js?v=1.5.16-e2e-server-pipe-deadlock-fix'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.5.16-e2e-server-pipe-deadlock-fix'), 'reference profile service not precached');
