...
assert(index.includes('src/audio/reference-profile-service.js?v=1.5.30-inapp-playback-recovery'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.5.30-inapp-playback-recovery'), 'reference profile service not precached');
