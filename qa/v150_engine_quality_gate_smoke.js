...
assert(index.includes('src/audio/reference-profile-service.js?v=1.5.41-export-eta-download-recovery'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.5.41-export-eta-download-recovery'), 'reference profile service not precached');
