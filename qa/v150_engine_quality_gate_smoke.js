...
assert(index.includes('src/audio/reference-profile-service.js?v=1.5.43-export-pipeline-integrity'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.5.43-export-pipeline-integrity'), 'reference profile service not precached');
