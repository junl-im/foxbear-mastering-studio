...
assert(index.includes('src/audio/reference-profile-service.js?v=1.6.74-incident-admission-spark-retention-download-memory'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.6.74-incident-admission-spark-retention-download-memory'), 'reference profile service not precached');
...
assert(gate.includes('1.6.74-engine-quality-regression'), 'quality gate service version missing');
