...
assert(index.includes('src/audio/reference-profile-service.js?v=1.6.99-header-role-focus-integrity'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.6.99-header-role-focus-integrity'), 'reference profile service not precached');
...
assert(gate.includes('1.6.99-engine-quality-regression'), 'quality gate service version missing');
