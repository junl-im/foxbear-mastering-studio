...
assert(index.includes('src/audio/reference-profile-service.js?v=1.5.59-kakao-session-handoff-memory-diagnostics'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.5.59-kakao-session-handoff-memory-diagnostics'), 'reference profile service not precached');
...
assert(gate.includes('1.5.59-engine-quality-regression'), 'quality gate service version missing');
