...
assert(index.includes('src/audio/reference-profile-service.js?v=1.5.45-export-queue-recovery'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.5.45-export-queue-recovery'), 'reference profile service not precached');
