...
assert(index.includes('src/audio/reference-profile-service.js?v=1.5.10-header-settings-relocation'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.5.10-header-settings-relocation'), 'reference profile service not precached');
