...
assert(index.includes('src/audio/reference-profile-service.js?v=1.5.25-e2e-preview-stability'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.5.25-e2e-preview-stability'), 'reference profile service not precached');
