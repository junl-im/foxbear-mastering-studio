...
assert(index.includes('src/audio/reference-profile-service.js?v=1.5.28-resilience-lifecycle-offline-recovery'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.5.28-resilience-lifecycle-offline-recovery'), 'reference profile service not precached');
