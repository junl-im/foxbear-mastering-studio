...
assert(index.includes('src/audio/reference-profile-service.js?v=1.5.9-version-display-cache-recovery'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.5.9-version-display-cache-recovery'), 'reference profile service not precached');
