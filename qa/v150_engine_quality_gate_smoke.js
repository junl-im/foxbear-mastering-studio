...
assert(index.includes('src/audio/reference-profile-service.js?v=1.5.96-modal-focus-memory-diagnostics'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.5.96-modal-focus-memory-diagnostics'), 'reference profile service not precached');
...
assert(gate.includes('1.5.96-engine-quality-regression'), 'quality gate service version missing');
