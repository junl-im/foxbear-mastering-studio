...
assert(index.includes('src/audio/reference-profile-service.js?v=1.5.91-cancellable-audio-pipeline-performance-guards'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.5.91-cancellable-audio-pipeline-performance-guards'), 'reference profile service not precached');
...
assert(gate.includes('1.5.91-engine-quality-regression'), 'quality gate service version missing');
