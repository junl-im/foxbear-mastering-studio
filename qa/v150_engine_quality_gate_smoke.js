...
assert(index.includes('src/audio/reference-profile-service.js?v=1.5.21-history-csp-console-contract-fix'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.5.21-history-csp-console-contract-fix'), 'reference profile service not precached');
