...
assert(index.includes('src/audio/reference-profile-service.js?v=1.6.80-ai-mastering-expert-workspace'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.6.80-ai-mastering-expert-workspace'), 'reference profile service not precached');
...
assert(gate.includes('1.6.80-engine-quality-regression'), 'quality gate service version missing');
