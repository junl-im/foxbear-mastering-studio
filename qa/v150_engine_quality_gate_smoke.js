...
assert(index.includes('src/audio/reference-profile-service.js?v=1.6.78-release-generation-assist-url-playback-invalidation'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.6.78-release-generation-assist-url-playback-invalidation'), 'reference profile service not precached');
...
assert(gate.includes('1.6.78-engine-quality-regression'), 'quality gate service version missing');
