...
assert(index.includes('src/audio/reference-profile-service.js?v=1.6.71-pwa-share-lease-handoff-deploy-policy-e2e'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.6.71-pwa-share-lease-handoff-deploy-policy-e2e'), 'reference profile service not precached');
...
assert(gate.includes('1.6.71-engine-quality-regression'), 'quality gate service version missing');
