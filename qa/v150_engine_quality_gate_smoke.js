...
assert(index.includes('src/audio/reference-profile-service.js?v=1.5.17-browser-contract-fix'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.5.17-browser-contract-fix'), 'reference profile service not precached');
