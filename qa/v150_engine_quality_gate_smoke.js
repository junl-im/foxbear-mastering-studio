...
assert(index.includes('src/audio/reference-profile-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery'), 'reference profile service not precached');
...
assert(gate.includes('1.6.89-engine-quality-regression'), 'quality gate service version missing');
