...
assert(index.includes('src/audio/reference-profile-service.js?v=1.6.4-incident-callable-csp-recovery'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.6.4-incident-callable-csp-recovery'), 'reference profile service not precached');
...
assert(gate.includes('1.6.4-engine-quality-regression'), 'quality gate service version missing');
