...
assert(index.includes('src/audio/reference-profile-service.js?v=1.7.0-adaptive-mastering-decision-phase1'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.7.0-adaptive-mastering-decision-phase1'), 'reference profile service not precached');
...
assert(gate.includes('1.7.0-engine-quality-regression'), 'quality gate service version missing');
