...
assert(index.includes('src/audio/reference-profile-service.js?v=1.6.41-admin-secret-pin-session'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.6.41-admin-secret-pin-session'), 'reference profile service not precached');
...
assert(gate.includes('1.6.41-engine-quality-regression'), 'quality gate service version missing');
