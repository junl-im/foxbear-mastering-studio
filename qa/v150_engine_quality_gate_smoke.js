...
assert(index.includes('src/audio/reference-profile-service.js?v=1.5.92-python-bytecode-ci-hygiene-node24-cache'), 'reference profile service not loaded in index');
...
assert(sw.includes('./src/audio/reference-profile-service.js?v=1.5.92-python-bytecode-ci-hygiene-node24-cache'), 'reference profile service not precached');
...
assert(gate.includes('1.5.92-engine-quality-regression'), 'quality gate service version missing');
