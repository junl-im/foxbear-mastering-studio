...
assert.strictEqual(pkg.version, '1.6.72', 'package version should be v1.6.72');
assert(pkg.qaChecks.includes('node qa/v1573_bulk_mastering_control_eta_visual_smoke.js'), 'release QA should include v1.6.72 smoke');
...
assert(hud.includes("const VIEW_VERSION = '1.6.72-bulk-control-eta-result-filter'"), 'HUD version contract missing');
