...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.91-runtime-health-hidden-geometry-contract-recovery'), 'support settings stylesheet must be precached');
