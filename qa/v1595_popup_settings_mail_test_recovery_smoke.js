...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.104-boot-emergency-visit-privacy-hardening'), 'support settings stylesheet must be precached');
