...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.74-incident-admission-spark-retention-download-memory'), 'support settings stylesheet must be precached');
