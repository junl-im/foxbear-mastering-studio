...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.63-download-filename-review-hardening'), 'support settings stylesheet must be precached');
