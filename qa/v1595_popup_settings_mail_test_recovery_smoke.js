...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.44-google-auth-gapi-module-trusted-types-recovery'), 'support settings stylesheet must be precached');
