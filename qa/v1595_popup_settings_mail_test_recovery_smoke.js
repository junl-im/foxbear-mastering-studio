...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.84-tracked-windows-cleanup-static-gate-recovery'), 'support settings stylesheet must be precached');
