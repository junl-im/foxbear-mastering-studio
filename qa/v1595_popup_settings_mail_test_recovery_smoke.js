...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.43-google-auth-trusted-types-csp-recovery'), 'support settings stylesheet must be precached');
