...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery'), 'support settings stylesheet must be precached');
