...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.70-share-retry-policy-drift-ci-efficiency'), 'support settings stylesheet must be precached');
