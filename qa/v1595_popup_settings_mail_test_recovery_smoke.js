...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.83-browser-ui-mode-fixture-source-hygiene-recovery'), 'support settings stylesheet must be precached');
