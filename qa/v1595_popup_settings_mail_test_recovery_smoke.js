...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.92-spectrum-panel-mount-lifecycle-recovery'), 'support settings stylesheet must be precached');
