...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.108-mastering-progress-visibility-hardening'), 'support settings stylesheet must be precached');
