...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.10-incident-readiness-contract-csp-cache-hardening'), 'support settings stylesheet must be precached');
