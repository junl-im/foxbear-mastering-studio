...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.90-engine-control-overlay-isolation-header-contract-recovery'), 'support settings stylesheet must be precached');
