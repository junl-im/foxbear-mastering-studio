...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.97-boot-payload-delivery-privacy-hardening'), 'support settings stylesheet must be precached');
