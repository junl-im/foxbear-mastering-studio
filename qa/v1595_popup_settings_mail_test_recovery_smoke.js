...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.103-ci-hygiene-mail-routing-hardening'), 'support settings stylesheet must be precached');
