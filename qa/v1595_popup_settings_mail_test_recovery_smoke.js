...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.105-header-dock-css-ownership-hardening'), 'support settings stylesheet must be precached');
