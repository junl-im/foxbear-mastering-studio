...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.7-incident-readiness-history-sync-performance-hud'), 'support settings stylesheet must be precached');
