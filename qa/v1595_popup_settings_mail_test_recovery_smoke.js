...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.9-incident-readiness-history-recovery-copy-events'), 'support settings stylesheet must be precached');
