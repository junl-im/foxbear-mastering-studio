...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.45-windows-release-gate-spark-hosting-no-app-check'), 'support settings stylesheet must be precached');
