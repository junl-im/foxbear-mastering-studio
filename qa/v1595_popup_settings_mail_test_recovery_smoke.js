...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.102-admin-lazyload-sw-hygiene-hardening'), 'support settings stylesheet must be precached');
