...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.73-csp-memory-admission-runtime-config'), 'support settings stylesheet must be precached');
