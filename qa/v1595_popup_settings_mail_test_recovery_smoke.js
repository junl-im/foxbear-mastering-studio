...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.37-ui-shell-cross-generation-recovery'), 'support settings stylesheet must be precached');
