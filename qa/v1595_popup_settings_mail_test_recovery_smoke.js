...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.40-ui-shell-retry-replacement-settlement'), 'support settings stylesheet must be precached');
