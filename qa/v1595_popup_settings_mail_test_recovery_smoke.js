...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.109-mastering-cooperative-pcm-responsiveness'), 'support settings stylesheet must be precached');
