...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.61-human-readable-download-filenames'), 'support settings stylesheet must be precached');
