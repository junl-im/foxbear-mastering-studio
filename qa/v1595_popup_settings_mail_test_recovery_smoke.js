...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.86-header-order-mobile-overflow-browser-gate-recovery'), 'support settings stylesheet must be precached');
