...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.76-download-viewport-runtime-fault-diagnostics'), 'support settings stylesheet must be precached');
