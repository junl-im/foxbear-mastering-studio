...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.111-ui-mode-session-contract-hardening'), 'support settings stylesheet must be precached');
