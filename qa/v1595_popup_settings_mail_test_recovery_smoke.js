...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.39-ui-shell-partial-script-probe-isolation'), 'support settings stylesheet must be precached');
