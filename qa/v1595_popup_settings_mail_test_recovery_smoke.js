...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.85-browser-sentinel-ui-mode-header-recovery'), 'support settings stylesheet must be precached');
