...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.59-readiness-corp-security-hardening'), 'support settings stylesheet must be precached');
