...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.22-incident-recovery-coalescing-time-decay'), 'support settings stylesheet must be precached');
