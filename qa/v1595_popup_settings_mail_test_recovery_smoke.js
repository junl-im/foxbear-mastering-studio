...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.106-browser-geometry-history-recovery'), 'support settings stylesheet must be precached');
