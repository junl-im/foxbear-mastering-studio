...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.87-mobile-header-device-label-overlap-recovery'), 'support settings stylesheet must be precached');
