...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.75-download-progress-admission-fallback-closure'), 'support settings stylesheet must be precached');
