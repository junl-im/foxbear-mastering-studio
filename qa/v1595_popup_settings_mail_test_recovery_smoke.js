...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.79-manifestless-patch-playback-retirement'), 'support settings stylesheet must be precached');
