...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.7.0-adaptive-mastering-decision-phase1'), 'support settings stylesheet must be precached');
