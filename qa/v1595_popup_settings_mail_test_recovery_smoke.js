...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.47-external-host-admin-auth-opaque-error-recovery'), 'support settings stylesheet must be precached');
