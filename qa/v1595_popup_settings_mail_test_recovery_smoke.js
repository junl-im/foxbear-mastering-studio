...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.78-release-generation-assist-url-playback-invalidation'), 'support settings stylesheet must be precached');
