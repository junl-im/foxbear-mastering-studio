...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.88-mobile-header-grid-ownership-recovery'), 'support settings stylesheet must be precached');
