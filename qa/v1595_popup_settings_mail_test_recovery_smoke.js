...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.2-nonblocking-health-status-design-polish'), 'support settings stylesheet must be precached');
