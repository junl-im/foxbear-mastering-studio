...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.71-pwa-share-lease-handoff-deploy-policy-e2e'), 'support settings stylesheet must be precached');
