...
assert(sw.includes('./assets/css/components/support-settings.css?v=1.6.46-google-auth-same-origin-network-recovery'), 'support settings stylesheet must be precached');
