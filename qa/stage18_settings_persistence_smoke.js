...
assert(sw.includes(`foxbear-shell-v1.4.0-stage24-settings-overlay-cleanup`), 'service worker cache should use Stage18 or later key');
...
assert(overwrite.includes('v1.4.0-stage24'), 'overwrite package default should be Stage18 or later');
