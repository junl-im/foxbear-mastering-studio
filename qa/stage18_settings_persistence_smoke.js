...
assert(sw.includes(`foxbear-shell-v1.4.10-perf-polish`), 'service worker cache should use Stage18 or later key');
...
assert(overwrite.includes('v1.4.10'), 'overwrite package default should be Stage18 or later');
