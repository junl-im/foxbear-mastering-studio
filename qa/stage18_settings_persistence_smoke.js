...
const version = '1.4.0-stage21-unified-preview-system';
...
assert(sw.includes(`foxbear-shell-v1.4.0-stage21-unified-preview-system`), 'service worker cache should use Stage18 or later key');
...
assert(app.includes('mobile.wakeLockDesired = true;\n        persistRuntimeSettings();'), 'wake lock desired state should persist');
...
assert(overwrite.includes('v1.4.0-stage21'), 'overwrite package default should be Stage18 or later');
