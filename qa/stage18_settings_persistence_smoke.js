...
assert(sw.includes(`foxbear-shell-v1.4.8-dock-spectrum-cleanup`), 'service worker cache should use Stage18 or later key');
...
assert(overwrite.includes('v1.4.8'), 'overwrite package default should be Stage18 or later');
