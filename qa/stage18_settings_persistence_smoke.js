...
assert(sw.includes(`foxbear-shell-v1.4.0-stage23-playback-orchestration`), 'service worker cache should use Stage18 or later key');
...
assert(overwrite.includes('v1.4.0-stage23'), 'overwrite package default should be Stage18 or later');
