...
assert(sw.includes(`foxbear-shell-v1.4.2-crossfade-zoom-spectrum`), 'service worker cache should use Stage18 or later key');
...
assert(overwrite.includes('v1.4.2'), 'overwrite package default should be Stage18 or later');
