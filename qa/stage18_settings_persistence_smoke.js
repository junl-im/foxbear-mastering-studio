...
assert(sw.includes(`foxbear-shell-v1.6.90-engine-control-overlay-isolation-header-contract-recovery`), 'service worker cache should use Stage18 or later key');
