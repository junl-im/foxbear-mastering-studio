...
assert(sw.includes(`foxbear-shell-v1.4.6-stability-polish`), 'service worker cache should use Stage18 or later key');
...
assert(overwrite.includes('v1.4.6'), 'overwrite package default should be Stage18 or later');
