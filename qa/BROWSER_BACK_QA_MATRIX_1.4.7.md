...
v1.4.8 removes the Dock mini FFT view because it was not clear enough for users and consumed Dock space. The detail-page spectrum panel remains available for users who want the FFT evidence view.
...
| Surface | Refresh / close | Back gesture / button | v1.4.8 focus |
| --- | --- | --- | --- |
