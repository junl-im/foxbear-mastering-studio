...
must(index.includes('1.6.110-ui-mode-early-boot-recovery'),'asset version');
must(sw.includes('foxbear-shell-v1.6.110-ui-mode-early-boot-recovery'),'cache version');
