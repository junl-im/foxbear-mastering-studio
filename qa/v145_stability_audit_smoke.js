...
must(index.includes('1.6.100-sw-stereo-ci-cleanup-hardening'),'asset version');
must(sw.includes('foxbear-shell-v1.6.100-sw-stereo-ci-cleanup-hardening'),'cache version');
