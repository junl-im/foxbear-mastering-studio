...
const must = (condition, message) => {
  if (!condition) {
    console.error(`FAIL v1.4.20 stability audit smoke: ${message}`);
    process.exit(1);
  }
};
...
must(html.includes('1.4.20-bulk-import-guard'), 'index should use v1.4.20 cache key');
...
console.log('PASS v1.4.20 stability audit smoke');
