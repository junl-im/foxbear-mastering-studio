...
const must = (condition, message) => {
  if (!condition) {
    console.error(`FAIL v1.4.18 stability audit smoke: ${message}`);
    process.exit(1);
  }
};
...
must(html.includes('1.4.18-download-dialog-micro-hint'), 'index should use v1.4.18 cache key');
...
console.log('PASS v1.4.18 stability audit smoke');
