...
must(index.includes('1.6.104-boot-emergency-visit-privacy-hardening'),'asset version');
must(sw.includes('foxbear-shell-v1.6.104-boot-emergency-visit-privacy-hardening'),'cache version');
