...
must(index.includes('1.6.106-browser-geometry-history-recovery'),'asset version');
must(sw.includes('foxbear-shell-v1.6.106-browser-geometry-history-recovery'),'cache version');
