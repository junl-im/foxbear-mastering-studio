...
must(index.includes('1.6.108-mastering-progress-visibility-hardening'),'asset version');
must(sw.includes('foxbear-shell-v1.6.108-mastering-progress-visibility-hardening'),'cache version');
