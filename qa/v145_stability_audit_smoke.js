...
must(index.includes('1.6.112-mastering-lifecycle-race-hardening'),'asset version');
must(sw.includes('foxbear-shell-v1.6.112-mastering-lifecycle-race-hardening'),'cache version');
