...
must(index.includes('1.6.101-admin-lazyload-repo-cleanup'),'asset version');
must(sw.includes('foxbear-shell-v1.6.101-admin-lazyload-repo-cleanup'),'cache version');
