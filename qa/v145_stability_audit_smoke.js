...
must(index.includes('1.6.113-incident-finalizer-p1-hardening'),'asset version');
must(sw.includes('foxbear-shell-v1.6.113-incident-finalizer-p1-hardening'),'cache version');
