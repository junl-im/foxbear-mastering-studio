...
assert(workerSource.includes('channel-specialized tone dynamics and fused safety scans'), 'v1.6.44 finalizer marker is missing');
...
assert(result.info.peakAfter <= Math.pow(10, -1 / 20) * 1.012, 'v1.6.44 output exceeded ceiling tolerance');
