...
assert(workerSource.includes('piano transient integrity and single-stage transparent limiting'), 'v1.7.0 finalizer ownership marker is missing');
...
assert(result.info.peakAfter <= Math.pow(10, -1 / 20) * 1.012, 'v1.7.0 output exceeded ceiling tolerance');
