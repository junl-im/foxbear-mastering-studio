...
assert(index.includes('1.6.78-release-generation-assist-url-playback-invalidation'), 'index should use declutter asset key');
assert(sw.includes('foxbear-shell-v1.6.78-release-generation-assist-url-playback-invalidation'), 'service worker should use v1.6.78 cache key');
...
assert(pkg.qaChecks.includes('node qa/v1419_download_dialog_declutter_smoke.js'), 'package QA should include v1.6.78 smoke');
assert(matrix.includes('v1.4.26 Download dialog first-screen declutter'), 'matrix should document v1.6.78 scope');
