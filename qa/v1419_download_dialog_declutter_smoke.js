...
assert(index.includes('1.6.91-runtime-health-hidden-geometry-contract-recovery'), 'index should use declutter asset key');
assert(sw.includes('foxbear-shell-v1.6.91-runtime-health-hidden-geometry-contract-recovery'), 'service worker should use v1.6.91 cache key');
...
assert(pkg.qaChecks.includes('node qa/v1419_download_dialog_declutter_smoke.js'), 'package QA should include v1.6.91 smoke');
assert(matrix.includes('v1.4.26 Download dialog first-screen declutter'), 'matrix should document v1.6.91 scope');
