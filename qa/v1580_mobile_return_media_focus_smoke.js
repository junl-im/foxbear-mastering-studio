...
assert.strictEqual(pkg.foxbearRelease.buildId, 'mobile-return-media-focus-recovery');
...
async function testInterruptedContextResumeDeduplication() {
  ...
  const fakeWindow = {
    FoxBearBuildInfo: { assetVersion: '1.5.80-mobile-return-media-focus-recovery' },
