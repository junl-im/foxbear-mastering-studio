...
assert(/stage12(?:\.1|\.2)|stage12\.2-cachefix|stage13|stage14|stage15|stage16|stage17|stage18/.test(sw), 'service worker cache should be bumped to stage12.1 or later');
