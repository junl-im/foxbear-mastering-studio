...
assert(pkg.version === '1.6.112', 'package version should be v1.6.112');
assert(functionsPkg.version === '1.6.112', 'Functions package version should match the release');
assert(pkg.qaChecks.includes('node qa/v1572_bulk_workflow_admin_audit_mobile_ui_smoke.js'), 'release QA should include v1.6.112 smoke');
...
assert(hud.includes("const VIEW_VERSION = '1.6.112-bulk-control-eta-result-filter'"), 'bulk HUD should expose v1.6.112 batch-list continuity contract');
