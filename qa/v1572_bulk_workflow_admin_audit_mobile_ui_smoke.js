...
assert(pkg.version === '1.6.72', 'package version should be v1.6.72');
assert(functionsPkg.version === '1.6.72', 'Functions package version should match the release');
assert(pkg.qaChecks.includes('node qa/v1572_bulk_workflow_admin_audit_mobile_ui_smoke.js'), 'release QA should include v1.6.72 smoke');
...
assert(hud.includes("const VIEW_VERSION = '1.6.72-bulk-control-eta-result-filter'"), 'bulk HUD should expose v1.6.72 batch-list continuity contract');
