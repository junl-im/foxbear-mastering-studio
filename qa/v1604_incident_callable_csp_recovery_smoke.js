...
assert.strictEqual(pkg.foxbearRelease.buildId, 'incident-callable-csp-recovery');
...
assert(functionsSource.includes('const INCIDENT_SERVICE_SCHEMA_VERSION = 2;'));
...
assert.strictEqual(metadata.serviceSchemaVersion, 2);
