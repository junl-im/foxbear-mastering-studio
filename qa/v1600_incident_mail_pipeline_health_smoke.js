...
const sandbox = {
  ...
  FoxBearBuildInfo: { productVersion: '1.6.78', assetVersion: '1.6.78-release-generation-assist-url-playback-invalidation' }
};
...
assert.strictEqual(metadata.productVersion, '1.6.78');
...
serviceStatus.handler({ auth: { uid: 'guest-1' }, app: null }).then(result => {
  assert.strictEqual(result.productVersion, '1.6.78');
