...
const sandbox = {
  ...
  FoxBearBuildInfo: { productVersion: '1.6.80', assetVersion: '1.6.80-ai-mastering-expert-workspace' }
};
...
assert.strictEqual(metadata.productVersion, '1.6.80');
...
serviceStatus.handler({ auth: { uid: 'guest-1' }, app: null }).then(result => {
  assert.strictEqual(result.productVersion, '1.6.80');
