...
const sandbox = {
  ...
  FoxBearBuildInfo: { productVersion: '1.6.82', assetVersion: '1.6.82-overlay-focus-ancestor-hardening' }
};
...
assert.strictEqual(metadata.productVersion, '1.6.82');
...
serviceStatus.handler({ auth: { uid: 'guest-1' }, app: null }).then(result => {
  assert.strictEqual(result.productVersion, '1.6.82');
