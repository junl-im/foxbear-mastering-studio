...
const sandbox = {
  ...
  FoxBearBuildInfo: { productVersion: '1.6.98', assetVersion: '1.6.98-spectrum-retirement-mobile-header-integrity' }
};
...
assert.strictEqual(metadata.productVersion, '1.6.98');
...
serviceStatus.handler({ auth: { uid: 'guest-1' }, app: null }).then(result => {
  assert.strictEqual(result.productVersion, '1.6.98');
