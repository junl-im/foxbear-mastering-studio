...
const sandbox = {
  ...
  FoxBearBuildInfo: { productVersion: '1.6.63', assetVersion: '1.6.63-download-filename-review-hardening' }
};
...
assert.strictEqual(metadata.productVersion, '1.6.63');
...
serviceStatus.handler({ auth: { uid: 'guest-1' }, app: null }).then(result => {
  assert.strictEqual(result.productVersion, '1.6.63');
