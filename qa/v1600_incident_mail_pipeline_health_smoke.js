...
const sandbox = {
  ...
  FoxBearBuildInfo: { productVersion: '1.6.79', assetVersion: '1.6.79-manifestless-patch-playback-retirement' }
};
...
assert.strictEqual(metadata.productVersion, '1.6.79');
...
serviceStatus.handler({ auth: { uid: 'guest-1' }, app: null }).then(result => {
  assert.strictEqual(result.productVersion, '1.6.79');
