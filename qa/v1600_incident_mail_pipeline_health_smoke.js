...
const sandbox = {
  ...
  FoxBearBuildInfo: { productVersion: '1.6.87', assetVersion: '1.6.87-mobile-header-device-label-overlap-recovery' }
};
...
assert.strictEqual(metadata.productVersion, '1.6.87');
...
serviceStatus.handler({ auth: { uid: 'guest-1' }, app: null }).then(result => {
  assert.strictEqual(result.productVersion, '1.6.87');
