...
const sandbox = {
  ...
  FoxBearBuildInfo: { productVersion: '1.6.83', assetVersion: '1.6.83-browser-ui-mode-fixture-source-hygiene-recovery' }
};
...
assert.strictEqual(metadata.productVersion, '1.6.83');
...
serviceStatus.handler({ auth: { uid: 'guest-1' }, app: null }).then(result => {
  assert.strictEqual(result.productVersion, '1.6.83');
