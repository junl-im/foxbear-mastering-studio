...
const sandbox = {
  ...
  FoxBearBuildInfo: { productVersion: '1.6.76', assetVersion: '1.6.76-download-viewport-runtime-fault-diagnostics' }
};
...
assert.strictEqual(metadata.productVersion, '1.6.76');
...
serviceStatus.handler({ auth: { uid: 'guest-1' }, app: null }).then(result => {
  assert.strictEqual(result.productVersion, '1.6.76');
