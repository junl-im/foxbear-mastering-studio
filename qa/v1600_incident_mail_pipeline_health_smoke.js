...
const sandbox = {
  ...
  FoxBearBuildInfo: { productVersion: '1.6.84', assetVersion: '1.6.84-tracked-windows-cleanup-static-gate-recovery' }
};
...
assert.strictEqual(metadata.productVersion, '1.6.84');
...
serviceStatus.handler({ auth: { uid: 'guest-1' }, app: null }).then(result => {
  assert.strictEqual(result.productVersion, '1.6.84');
