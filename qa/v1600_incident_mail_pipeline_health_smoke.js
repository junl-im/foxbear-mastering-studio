...
const sandbox = {
  ...
  FoxBearBuildInfo: { productVersion: '1.6.75', assetVersion: '1.6.75-download-progress-admission-fallback-closure' }
};
...
assert.strictEqual(metadata.productVersion, '1.6.75');
...
serviceStatus.handler({ auth: { uid: 'guest-1' }, app: null }).then(result => {
  assert.strictEqual(result.productVersion, '1.6.75');
