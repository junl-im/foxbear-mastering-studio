...
const sandbox = {
  ...
  FoxBearBuildInfo: { productVersion: '1.6.49', assetVersion: '1.6.49-download-variant-cache-reuse' }
};
...
assert.strictEqual(metadata.productVersion, '1.6.49');
...
serviceStatus.handler({ auth: { uid: 'guest-1' }, app: null }).then(result => {
  assert.strictEqual(result.productVersion, '1.6.49');
