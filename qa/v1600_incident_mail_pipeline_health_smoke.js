...
const sandbox = {
  ...
  FoxBearBuildInfo: { productVersion: '1.6.50', assetVersion: '1.6.50-kakao-centered-entry-notice' }
};
...
assert.strictEqual(metadata.productVersion, '1.6.50');
...
serviceStatus.handler({ auth: { uid: 'guest-1' }, app: null }).then(result => {
  assert.strictEqual(result.productVersion, '1.6.50');
