...
const sandbox = {
  ...
  FoxBearBuildInfo: { productVersion: '1.6.72', assetVersion: '1.6.72-ci-safe-hygiene-self-repair' }
};
...
assert.strictEqual(metadata.productVersion, '1.6.72');
...
serviceStatus.handler({ auth: { uid: 'guest-1' }, app: null }).then(result => {
  assert.strictEqual(result.productVersion, '1.6.72');
