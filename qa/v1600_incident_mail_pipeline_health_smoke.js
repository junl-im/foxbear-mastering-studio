...
const sandbox = {
  ...
  FoxBearBuildInfo: { productVersion: '1.6.43', assetVersion: '1.6.43-google-auth-trusted-types-csp-recovery' }
};
...
assert.strictEqual(metadata.productVersion, '1.6.43');
...
serviceStatus.handler({ auth: { uid: 'guest-1' }, app: null }).then(result => {
  assert.strictEqual(result.productVersion, '1.6.43');
