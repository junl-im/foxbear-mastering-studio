...
const sandbox = {
  ...
  FoxBearBuildInfo: { productVersion: '1.6.90', assetVersion: '1.6.90-engine-control-overlay-isolation-header-contract-recovery' }
};
...
assert.strictEqual(metadata.productVersion, '1.6.90');
...
serviceStatus.handler({ auth: { uid: 'guest-1' }, app: null }).then(result => {
  assert.strictEqual(result.productVersion, '1.6.90');
