...
const sandbox = {
  ...
  FoxBearBuildInfo: { productVersion: '1.6.92', assetVersion: '1.6.92-spectrum-panel-mount-lifecycle-recovery' }
};
...
assert.strictEqual(metadata.productVersion, '1.6.92');
...
serviceStatus.handler({ auth: { uid: 'guest-1' }, app: null }).then(result => {
  assert.strictEqual(result.productVersion, '1.6.92');
