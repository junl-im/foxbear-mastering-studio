...
const sandbox = {
  ...
  FoxBearBuildInfo: { productVersion: '1.6.61', assetVersion: '1.6.61-human-readable-download-filenames' }
};
...
assert.strictEqual(metadata.productVersion, '1.6.61');
...
serviceStatus.handler({ auth: { uid: 'guest-1' }, app: null }).then(result => {
  assert.strictEqual(result.productVersion, '1.6.61');
