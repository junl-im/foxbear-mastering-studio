...
const sandbox = {
  ...
  FoxBearBuildInfo: { productVersion: '1.6.91', assetVersion: '1.6.91-runtime-health-hidden-geometry-contract-recovery' }
};
...
assert.strictEqual(metadata.productVersion, '1.6.91');
...
serviceStatus.handler({ auth: { uid: 'guest-1' }, app: null }).then(result => {
  assert.strictEqual(result.productVersion, '1.6.91');
