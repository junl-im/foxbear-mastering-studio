...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.7.0-adaptive-mastering-decision-phase1'), 'mastering orchestrator must load in the main shell');
