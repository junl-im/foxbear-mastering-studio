...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.7.4-reload-reentry-mode-chooser'), 'mastering orchestrator must load in the main shell');
