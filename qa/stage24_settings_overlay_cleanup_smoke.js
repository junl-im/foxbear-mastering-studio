...
assert(pkg.includes('Stage26 unified waveform controls') || pkg.includes('Stage25 compare controls rehome'), 'package description should identify Stage25');
assert(pkg.includes('node qa/stage24_settings_overlay_cleanup_smoke.js'), 'package should run Stage25 smoke');
assert(overwrite.includes('v1.4.0-stage26'), 'overwrite package default should be Stage25');
