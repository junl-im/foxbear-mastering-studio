...
assert(index.includes('1.5.52-ci-parallel-release-gate'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.52-ci-parallel-release-gate'), 'service worker cache should use Stage16 cache key');
