...
assert(index.includes('1.5.82-mastering-cancel-playback-resume-recovery'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.82-mastering-cancel-playback-resume-recovery'), 'service worker cache should use Stage16 cache key');
