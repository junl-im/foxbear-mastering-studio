...
assert(index.includes('1.5.74-bulk-pause-skip-reorder-mobile-download'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.74-bulk-pause-skip-reorder-mobile-download'), 'service worker cache should use Stage16 cache key');
