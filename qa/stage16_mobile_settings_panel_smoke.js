...
assert(index.includes('1.6.110-ui-mode-early-boot-recovery'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.6.110-ui-mode-early-boot-recovery'), 'service worker cache should use Stage16 cache key');
