...
assert(index.includes('1.6.108-mastering-progress-visibility-hardening'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.6.108-mastering-progress-visibility-hardening'), 'service worker cache should use Stage16 cache key');
