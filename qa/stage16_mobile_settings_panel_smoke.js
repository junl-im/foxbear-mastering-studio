...
assert(index.includes('1.6.101-admin-lazyload-repo-cleanup'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.6.101-admin-lazyload-repo-cleanup'), 'service worker cache should use Stage16 cache key');
