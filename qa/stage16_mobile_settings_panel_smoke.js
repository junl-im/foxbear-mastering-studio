...
assert(index.includes('1.5.64-incident-operations-health-self-diagnostics'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.64-incident-operations-health-self-diagnostics'), 'service worker cache should use Stage16 cache key');
