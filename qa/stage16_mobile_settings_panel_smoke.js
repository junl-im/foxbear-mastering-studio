...
assert(index.includes('1.5.54-quality-recovery-profiles-browser-qa'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.54-quality-recovery-profiles-browser-qa'), 'service worker cache should use Stage16 cache key');
