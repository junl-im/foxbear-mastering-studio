...
assert(index.includes('1.6.106-browser-geometry-history-recovery'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.6.106-browser-geometry-history-recovery'), 'service worker cache should use Stage16 cache key');
