...
assert(index.includes('1.7.1-reference-match-2-phase1'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.7.1-reference-match-2-phase1'), 'service worker cache should use Stage16 cache key');
