...
assert(index.includes('1.4.0-stage25-compare-controls-rehome'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.4.0-stage25-compare-controls-rehome'), 'service worker cache should use Stage16 cache key');
