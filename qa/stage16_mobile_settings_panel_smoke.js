...
assert(index.includes('1.6.98-spectrum-retirement-mobile-header-integrity'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.6.98-spectrum-retirement-mobile-header-integrity'), 'service worker cache should use Stage16 cache key');
