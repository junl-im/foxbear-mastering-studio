...
assert(index.includes('1.5.15-e2e-runtime-classification'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.15-e2e-runtime-classification'), 'service worker cache should use Stage16 cache key');
