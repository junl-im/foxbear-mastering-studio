...
assert(index.includes('1.5.92-python-bytecode-ci-hygiene-node24-cache'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.92-python-bytecode-ci-hygiene-node24-cache'), 'service worker cache should use Stage16 cache key');
