...
assert(index.includes('1.5.53-engine-recovery-performance-diagnostics'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.53-engine-recovery-performance-diagnostics'), 'service worker cache should use Stage16 cache key');
