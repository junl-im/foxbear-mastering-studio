...
assert(index.includes('1.6.93-mobile-dock-visibility-integrity-recovery'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.6.93-mobile-dock-visibility-integrity-recovery'), 'service worker cache should use Stage16 cache key');
