...
assert(index.includes('1.6.7-incident-readiness-history-sync-performance-hud'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.6.7-incident-readiness-history-sync-performance-hud'), 'service worker cache should use Stage16 cache key');
