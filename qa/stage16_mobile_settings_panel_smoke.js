...
assert(index.includes('1.6.25-incident-recovery-timeout-abort-stress'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.6.25-incident-recovery-timeout-abort-stress'), 'service worker cache should use Stage16 cache key');
