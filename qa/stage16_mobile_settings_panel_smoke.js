...
assert(index.includes('1.6.109-mastering-cooperative-pcm-responsiveness'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.6.109-mastering-cooperative-pcm-responsiveness'), 'service worker cache should use Stage16 cache key');
