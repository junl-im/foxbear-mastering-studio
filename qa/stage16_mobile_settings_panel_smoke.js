...
assert(index.includes('1.6.104-boot-emergency-visit-privacy-hardening'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.6.104-boot-emergency-visit-privacy-hardening'), 'service worker cache should use Stage16 cache key');
