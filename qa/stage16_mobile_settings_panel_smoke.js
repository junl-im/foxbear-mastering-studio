...
assert(index.includes('1.4.14-download-action-clarity'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.4.14-download-action-clarity'), 'service worker cache should use Stage16 cache key');
