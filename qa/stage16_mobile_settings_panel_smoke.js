...
assert(index.includes('1.5.69-mail-receipt-confirmation-history-branded-template'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.69-mail-receipt-confirmation-history-branded-template'), 'service worker cache should use Stage16 cache key');
