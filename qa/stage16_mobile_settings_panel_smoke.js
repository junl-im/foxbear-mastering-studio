...
assert(index.includes('1.5.43-export-pipeline-integrity'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.43-export-pipeline-integrity'), 'service worker cache should use Stage16 cache key');
