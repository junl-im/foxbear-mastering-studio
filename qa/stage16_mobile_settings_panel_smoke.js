...
assert(index.includes('1.5.60-kakao-inapp-entry-memory-governor'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.60-kakao-inapp-entry-memory-governor'), 'service worker cache should use Stage16 cache key');
