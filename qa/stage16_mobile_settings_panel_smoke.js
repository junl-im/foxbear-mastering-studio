...
assert(index.includes('1.4.26-wake-lock-state-sync'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.4.26-wake-lock-state-sync'), 'service worker cache should use Stage16 cache key');
