...
assert(index.includes('1.5.62-incident-delivery-watchdog-package-gate'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.62-incident-delivery-watchdog-package-gate'), 'service worker cache should use Stage16 cache key');
