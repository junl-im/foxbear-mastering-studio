...
assert(index.includes('1.6.12-mastering-tone-loudness-fastpath'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.6.12-mastering-tone-loudness-fastpath'), 'service worker cache should use Stage16 cache key');
