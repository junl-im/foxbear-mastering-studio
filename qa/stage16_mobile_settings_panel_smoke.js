...
assert(index.includes('1.6.92-spectrum-panel-mount-lifecycle-recovery'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.6.92-spectrum-panel-mount-lifecycle-recovery'), 'service worker cache should use Stage16 cache key');
