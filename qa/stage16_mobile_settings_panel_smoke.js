...
assert(index.includes('1.5.45-export-queue-recovery'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.45-export-queue-recovery'), 'service worker cache should use Stage16 cache key');
