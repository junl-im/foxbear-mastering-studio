...
assert(index.includes('1.6.83-browser-ui-mode-fixture-source-hygiene-recovery'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.6.83-browser-ui-mode-fixture-source-hygiene-recovery'), 'service worker cache should use Stage16 cache key');
