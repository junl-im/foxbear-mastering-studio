...
assert(index.includes('1.5.36-interaction-lifecycle-hardening'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.36-interaction-lifecycle-hardening'), 'service worker cache should use Stage16 cache key');
