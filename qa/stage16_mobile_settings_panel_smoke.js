...
assert(index.includes('1.4.0-stage27-waveform-control-service'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.4.0-stage27-waveform-control-service'), 'service worker cache should use Stage16 cache key');
