...
assert(index.includes('1.6.9-incident-readiness-history-recovery-copy-events'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.6.9-incident-readiness-history-recovery-copy-events'), 'service worker cache should use Stage16 cache key');
