...
assert(index.includes('1.5.55-automatic-incident-mail-reporting'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.55-automatic-incident-mail-reporting'), 'service worker cache should use Stage16 cache key');
