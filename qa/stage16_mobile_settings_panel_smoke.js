...
assert(index.includes('1.5.32-kakao-external-browser-local-flow'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.32-kakao-external-browser-local-flow'), 'service worker cache should use Stage16 cache key');
