...
assert(index.includes('1.4.7-dock-fft-removal'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.4.7-dock-fft-removal'), 'service worker cache should use Stage16 cache key');
