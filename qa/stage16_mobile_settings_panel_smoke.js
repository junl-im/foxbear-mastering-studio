...
assert(index.includes('1.5.22-header-preview-routing-polish'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.22-header-preview-routing-polish'), 'service worker cache should use Stage16 cache key');
