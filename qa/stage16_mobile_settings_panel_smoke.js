...
assert(index.includes('1.6.22-incident-recovery-coalescing-time-decay'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.6.22-incident-recovery-coalescing-time-decay'), 'service worker cache should use Stage16 cache key');
