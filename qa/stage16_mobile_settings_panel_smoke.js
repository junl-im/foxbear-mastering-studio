...
assert(index.includes('1.5.98-worker-retry-health-levels'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.98-worker-retry-health-levels'), 'service worker cache should use Stage16 cache key');
