...
assert(index.includes('1.6.91-runtime-health-hidden-geometry-contract-recovery'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.6.91-runtime-health-hidden-geometry-contract-recovery'), 'service worker cache should use Stage16 cache key');
