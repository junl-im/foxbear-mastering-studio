...
assert(index.includes('1.4.4-fft-live-hotfix'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.4.4-fft-live-hotfix'), 'service worker cache should use Stage16 cache key');
