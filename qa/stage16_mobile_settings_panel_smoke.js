...
assert(index.includes('1.6.76-download-viewport-runtime-fault-diagnostics'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.6.76-download-viewport-runtime-fault-diagnostics'), 'service worker cache should use Stage16 cache key');
