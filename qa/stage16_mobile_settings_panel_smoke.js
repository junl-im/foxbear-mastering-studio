...
assert(index.includes('1.6.105-header-dock-css-ownership-hardening'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.6.105-header-dock-css-ownership-hardening'), 'service worker cache should use Stage16 cache key');
