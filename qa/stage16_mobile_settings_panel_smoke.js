...
assert(index.includes('1.5.37-memory-import-waveform-hardening'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.37-memory-import-waveform-hardening'), 'service worker cache should use Stage16 cache key');
