...
assert(index.includes('1.5.27-device-glyph-sri-hardening'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.27-device-glyph-sri-hardening'), 'service worker cache should use Stage16 cache key');
