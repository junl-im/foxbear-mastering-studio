...
assert(index.includes('1.4.5-stability-audit'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.4.5-stability-audit'), 'service worker cache should use Stage16 cache key');
