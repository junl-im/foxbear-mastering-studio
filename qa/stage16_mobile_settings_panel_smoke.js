...
assert(index.includes('1.6.34-history-hard-stall-sw-activity-lifecycle'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.6.34-history-hard-stall-sw-activity-lifecycle'), 'service worker cache should use Stage16 cache key');
