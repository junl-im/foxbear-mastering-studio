...
assert(index.includes('1.5.61-worker-mail-delivery-recovery'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.61-worker-mail-delivery-recovery'), 'service worker cache should use Stage16 cache key');
