...
assert(index.includes('1.6.42-spark-google-admin-auth'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.6.42-spark-google-admin-auth'), 'service worker cache should use Stage16 cache key');
