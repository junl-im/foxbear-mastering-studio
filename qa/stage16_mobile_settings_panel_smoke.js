...
assert(index.includes('1.5.91-cancellable-audio-pipeline-performance-guards'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.91-cancellable-audio-pipeline-performance-guards'), 'service worker cache should use Stage16 cache key');
