...
assert(index.includes('1.5.81-master-preview-cancellation-native-result-isolation'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.81-master-preview-cancellation-native-result-isolation'), 'service worker cache should use Stage16 cache key');
