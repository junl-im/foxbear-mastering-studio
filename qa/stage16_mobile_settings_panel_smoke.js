...
assert(index.includes('1.5.17-browser-contract-fix'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.17-browser-contract-fix'), 'service worker cache should use Stage16 cache key');
