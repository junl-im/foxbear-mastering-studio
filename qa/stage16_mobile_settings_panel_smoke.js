...
assert(index.includes('1.4.12-download-diagnostics'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.4.12-download-diagnostics'), 'service worker cache should use Stage16 cache key');
