...
assert(index.includes('1.4.6-stability-polish'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.4.6-stability-polish'), 'service worker cache should use Stage16 cache key');
