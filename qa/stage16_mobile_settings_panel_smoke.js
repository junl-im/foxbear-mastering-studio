...
assert(index.includes('1.5.96-modal-focus-memory-diagnostics'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.96-modal-focus-memory-diagnostics'), 'service worker cache should use Stage16 cache key');
