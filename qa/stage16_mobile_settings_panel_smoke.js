...
assert(index.includes('1.6.66-static-gate-hygiene-repair'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.6.66-static-gate-hygiene-repair'), 'service worker cache should use Stage16 cache key');
