...
assert(index.includes('1.5.23-e2e-preview-readiness'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.23-e2e-preview-readiness'), 'service worker cache should use Stage16 cache key');
