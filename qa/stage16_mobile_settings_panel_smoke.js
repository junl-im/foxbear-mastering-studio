...
assert(index.includes('1.6.13-download-format-context-menu'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.6.13-download-format-context-menu'), 'service worker cache should use Stage16 cache key');
