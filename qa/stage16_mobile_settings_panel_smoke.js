...
assert(index.includes('1.6.88-mobile-header-grid-ownership-recovery'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.6.88-mobile-header-grid-ownership-recovery'), 'service worker cache should use Stage16 cache key');
