...
assert(index.includes('1.5.97-worker-recovery-diagnostics'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.97-worker-recovery-diagnostics'), 'service worker cache should use Stage16 cache key');
