...
assert(index.includes('1.7.0-adaptive-mastering-decision-phase1'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.7.0-adaptive-mastering-decision-phase1'), 'service worker cache should use Stage16 cache key');
