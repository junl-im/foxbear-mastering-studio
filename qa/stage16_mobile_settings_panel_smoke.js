...
assert(index.includes('1.5.7-release-foundation'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.7-release-foundation'), 'service worker cache should use Stage16 cache key');
