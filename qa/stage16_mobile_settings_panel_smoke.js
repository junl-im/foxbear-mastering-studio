...
assert(index.includes('1.6.47-external-host-admin-auth-opaque-error-recovery'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.6.47-external-host-admin-auth-opaque-error-recovery'), 'service worker cache should use Stage16 cache key');
