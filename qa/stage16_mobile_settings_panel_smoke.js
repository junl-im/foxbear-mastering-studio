...
assert(index.includes('1.5.29-analysis-update-lifecycle'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.29-analysis-update-lifecycle'), 'service worker cache should use Stage16 cache key');
