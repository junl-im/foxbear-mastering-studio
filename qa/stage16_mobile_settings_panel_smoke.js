...
assert(index.includes('1.5.73-bulk-control-eta-result-filter-ui'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.73-bulk-control-eta-result-filter-ui'), 'service worker cache should use Stage16 cache key');
