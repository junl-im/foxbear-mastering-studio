...
assert(index.includes('1.5.99-incident-callable-mail-recovery'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.99-incident-callable-mail-recovery'), 'service worker cache should use Stage16 cache key');
