...
assert(index.includes('1.5.11-audio-context-ci-stability'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.11-audio-context-ci-stability'), 'service worker cache should use Stage16 cache key');
