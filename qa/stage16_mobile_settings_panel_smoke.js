...
assert(index.includes('1.5.19-ci-runtime-isolation-package-hardening'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.19-ci-runtime-isolation-package-hardening'), 'service worker cache should use Stage16 cache key');
