...
assert(index.includes('1.6.75-download-progress-admission-fallback-closure'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.6.75-download-progress-admission-fallback-closure'), 'service worker cache should use Stage16 cache key');
