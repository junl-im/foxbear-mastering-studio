...
assert(index.includes('1.4.10-perf-polish'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.4.10-perf-polish'), 'service worker cache should use Stage16 cache key');
