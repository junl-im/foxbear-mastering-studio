...
assert(index.includes('1.6.1-transient-performance-diagnostics'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.6.1-transient-performance-diagnostics'), 'service worker cache should use Stage16 cache key');
