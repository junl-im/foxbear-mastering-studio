...
assert(index.includes('1.5.31-player-download-stability'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.31-player-download-stability'), 'service worker cache should use Stage16 cache key');
