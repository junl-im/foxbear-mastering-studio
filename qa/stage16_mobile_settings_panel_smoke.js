...
assert(index.includes('1.6.84-tracked-windows-cleanup-static-gate-recovery'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.6.84-tracked-windows-cleanup-static-gate-recovery'), 'service worker cache should use Stage16 cache key');
