...
assert(index.includes('1.6.56-playback-blob-source-resilience'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.6.56-playback-blob-source-resilience'), 'service worker cache should use Stage16 cache key');
