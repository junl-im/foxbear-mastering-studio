...
assert(index.includes('1.5.10-header-settings-relocation'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.10-header-settings-relocation'), 'service worker cache should use Stage16 cache key');
