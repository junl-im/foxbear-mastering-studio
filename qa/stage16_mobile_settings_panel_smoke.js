...
assert(index.includes('1.6.73-csp-memory-admission-runtime-config'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.6.73-csp-memory-admission-runtime-config'), 'service worker cache should use Stage16 cache key');
