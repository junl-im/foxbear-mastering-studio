...
assert(index.includes('1.5.90-browser-retry-integrity-metadata-aware-scope'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.90-browser-retry-integrity-metadata-aware-scope'), 'service worker cache should use Stage16 cache key');
