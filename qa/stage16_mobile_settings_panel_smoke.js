...
assert(index.includes('1.6.80-ai-mastering-expert-workspace'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.6.80-ai-mastering-expert-workspace'), 'service worker cache should use Stage16 cache key');
