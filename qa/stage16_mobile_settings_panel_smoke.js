...
assert(index.includes('1.6.61-human-readable-download-filenames'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.6.61-human-readable-download-filenames'), 'service worker cache should use Stage16 cache key');
