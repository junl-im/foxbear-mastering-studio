...
assert(index.includes('1.6.40-ui-shell-retry-replacement-settlement'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.6.40-ui-shell-retry-replacement-settlement'), 'service worker cache should use Stage16 cache key');
