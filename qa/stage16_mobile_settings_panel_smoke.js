...
assert(index.includes('1.4.0-stage22-playback-link-audit'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.4.0-stage22-playback-link-audit'), 'service worker cache should use Stage16 cache key');
