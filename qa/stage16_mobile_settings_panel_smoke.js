...
assert(index.includes('1.5.80-mobile-return-media-focus-recovery'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.80-mobile-return-media-focus-recovery'), 'service worker cache should use Stage16 cache key');
