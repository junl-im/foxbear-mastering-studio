...
assert(index.includes('1.5.30-inapp-playback-recovery'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.30-inapp-playback-recovery'), 'service worker cache should use Stage16 cache key');
