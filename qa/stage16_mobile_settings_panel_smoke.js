...
assert(index.includes('1.6.39-ui-shell-partial-script-probe-isolation'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.6.39-ui-shell-partial-script-probe-isolation'), 'service worker cache should use Stage16 cache key');
