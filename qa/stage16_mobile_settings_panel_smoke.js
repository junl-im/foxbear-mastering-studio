...
assert(index.includes('1.6.59-readiness-corp-security-hardening'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.6.59-readiness-corp-security-hardening'), 'service worker cache should use Stage16 cache key');
