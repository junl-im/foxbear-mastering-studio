...
assert(index.includes('1.5.51-ci-runtime-contract-hardening'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.5.51-ci-runtime-contract-hardening'), 'service worker cache should use Stage16 cache key');
