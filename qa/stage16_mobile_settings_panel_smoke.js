...
assert(index.includes('1.4.2-crossfade-zoom-spectrum'), 'index asset query should use Stage16 cache key');
assert(sw.includes('foxbear-shell-v1.4.2-crossfade-zoom-spectrum'), 'service worker cache should use Stage16 cache key');
