...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.6.75-download-progress-admission-fallback-closure')"), 'ZIP worker should import the same filename policy');
