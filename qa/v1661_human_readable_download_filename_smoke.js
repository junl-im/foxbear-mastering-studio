...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.6.92-spectrum-panel-mount-lifecycle-recovery')"), 'ZIP worker should import the same filename policy');
