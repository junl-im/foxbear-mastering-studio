...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.6.74-incident-admission-spark-retention-download-memory')"), 'ZIP worker should import the same filename policy');
