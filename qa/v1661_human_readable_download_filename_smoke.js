...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.6.65-firestore-write-fencing')"), 'ZIP worker should import the same filename policy');
