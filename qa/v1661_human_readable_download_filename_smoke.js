...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.6.86-header-order-mobile-overflow-browser-gate-recovery')"), 'ZIP worker should import the same filename policy');
