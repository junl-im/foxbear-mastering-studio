...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.6.64-github-desktop-delivery-contract')"), 'ZIP worker should import the same filename policy');
