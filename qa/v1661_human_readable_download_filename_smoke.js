...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.6.85-browser-sentinel-ui-mode-header-recovery')"), 'ZIP worker should import the same filename policy');
