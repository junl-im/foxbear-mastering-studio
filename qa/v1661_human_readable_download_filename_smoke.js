...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.6.113-incident-finalizer-p1-hardening')"), 'ZIP worker should import the same filename policy');
