...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.6.98-spectrum-retirement-mobile-header-integrity')"), 'ZIP worker should import the same filename policy');
