...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.6.71-pwa-share-lease-handoff-deploy-policy-e2e')"), 'ZIP worker should import the same filename policy');
