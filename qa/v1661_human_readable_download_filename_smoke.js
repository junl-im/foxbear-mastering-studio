...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery')"), 'ZIP worker should import the same filename policy');
