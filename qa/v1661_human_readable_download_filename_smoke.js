...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.6.70-share-retry-policy-drift-ci-efficiency')"), 'ZIP worker should import the same filename policy');
