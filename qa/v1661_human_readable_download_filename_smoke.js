...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.7.2-expert-workspace-default-entry')"), 'ZIP worker should import the same filename policy');
