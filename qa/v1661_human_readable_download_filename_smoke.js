...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.6.93-mobile-dock-visibility-integrity-recovery')"), 'ZIP worker should import the same filename policy');
