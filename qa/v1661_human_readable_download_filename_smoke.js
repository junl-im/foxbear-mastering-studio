...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.6.106-browser-geometry-history-recovery')"), 'ZIP worker should import the same filename policy');
