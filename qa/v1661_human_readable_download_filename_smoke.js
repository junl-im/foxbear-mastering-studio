...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.6.78-release-generation-assist-url-playback-invalidation')"), 'ZIP worker should import the same filename policy');
