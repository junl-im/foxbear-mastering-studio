...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.6.97-boot-payload-delivery-privacy-hardening')"), 'ZIP worker should import the same filename policy');
