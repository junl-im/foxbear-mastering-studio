...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.6.110-ui-mode-early-boot-recovery')"), 'ZIP worker should import the same filename policy');
