...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.6.79-manifestless-patch-playback-retirement')"), 'ZIP worker should import the same filename policy');
