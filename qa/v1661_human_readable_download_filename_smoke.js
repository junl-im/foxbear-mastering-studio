...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics')"), 'ZIP worker should import the same filename policy');
