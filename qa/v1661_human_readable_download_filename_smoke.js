...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.6.95-release-artifact-safety')"), 'ZIP worker should import the same filename policy');
