...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.6.91-runtime-health-hidden-geometry-contract-recovery')"), 'ZIP worker should import the same filename policy');
