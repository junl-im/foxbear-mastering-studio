...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.6.104-boot-emergency-visit-privacy-hardening')"), 'ZIP worker should import the same filename policy');
