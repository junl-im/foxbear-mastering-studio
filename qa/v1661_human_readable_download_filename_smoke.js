...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.6.72-ci-safe-hygiene-self-repair')"), 'ZIP worker should import the same filename policy');
