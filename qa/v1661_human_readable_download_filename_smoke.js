...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.6.88-mobile-header-grid-ownership-recovery')"), 'ZIP worker should import the same filename policy');
