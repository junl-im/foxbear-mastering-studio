...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.6.83-browser-ui-mode-fixture-source-hygiene-recovery')"), 'ZIP worker should import the same filename policy');
