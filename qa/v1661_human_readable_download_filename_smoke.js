...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.7.0-adaptive-mastering-decision-phase1')"), 'ZIP worker should import the same filename policy');
