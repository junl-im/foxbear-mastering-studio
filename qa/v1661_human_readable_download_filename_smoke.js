...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.6.102-admin-lazyload-sw-hygiene-hardening')"), 'ZIP worker should import the same filename policy');
