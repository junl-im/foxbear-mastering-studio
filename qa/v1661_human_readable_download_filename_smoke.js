...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.6.109-mastering-cooperative-pcm-responsiveness')"), 'ZIP worker should import the same filename policy');
