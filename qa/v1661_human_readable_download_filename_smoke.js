...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.6.105-header-dock-css-ownership-hardening')"), 'ZIP worker should import the same filename policy');
