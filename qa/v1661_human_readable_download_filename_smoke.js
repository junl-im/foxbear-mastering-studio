...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.6.101-admin-lazyload-repo-cleanup')"), 'ZIP worker should import the same filename policy');
