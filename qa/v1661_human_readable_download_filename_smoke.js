...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.6.99-header-role-focus-integrity')"), 'ZIP worker should import the same filename policy');
