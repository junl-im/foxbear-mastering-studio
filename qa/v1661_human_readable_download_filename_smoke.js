...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.6.94-release-integrity-hardening')"), 'ZIP worker should import the same filename policy');
