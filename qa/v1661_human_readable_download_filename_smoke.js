...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.6.66-static-gate-hygiene-repair')"), 'ZIP worker should import the same filename policy');
