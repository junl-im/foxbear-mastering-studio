...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.6.87-mobile-header-device-label-overlap-recovery')"), 'ZIP worker should import the same filename policy');
