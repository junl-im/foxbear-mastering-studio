...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.7.4-reload-reentry-mode-chooser')"), 'ZIP worker should import the same filename policy');
