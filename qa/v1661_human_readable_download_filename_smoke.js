...
assert(workerSource.includes("importScripts('../download/file-name-policy-service.js?v=1.6.84-tracked-windows-cleanup-static-gate-recovery')"), 'ZIP worker should import the same filename policy');
