...
must(app.includes("const APP_VERSION = 'Pro v1.6.111'"), 'v1.4.0 app version missing');
must(html.includes('data-build="1.6.111"'), 'v1.4.0 build marker missing');
...
must(css.includes('grid-template-columns: minmax(0,1fr) minmax(120px,auto) minmax(0,1fr)'), 'Requested action layout CSS missing');
