...
must(html.includes('assets/icons/foxbear-icon-512.png?v=1.6.66-static-gate-hygiene-repair'),'512 icon cache key');
must(html.includes('assets/icons/apple-touch-icon.png?v=1.6.66-static-gate-hygiene-repair'),'apple icon cache key');
