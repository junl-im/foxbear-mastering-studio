...
must(app.includes("const APP_VERSION = 'Pro v1.6.86'"),'app version');
must(html.includes('assets/icons/foxbear-icon-512.png?v=1.6.86-header-order-mobile-overflow-browser-gate-recovery'),'512 icon cache key');
must(html.includes('assets/icons/apple-touch-icon.png?v=1.6.86-header-order-mobile-overflow-browser-gate-recovery'),'apple icon cache key');
