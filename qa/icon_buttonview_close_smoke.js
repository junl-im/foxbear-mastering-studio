...
must(html.includes('assets/icons/foxbear-icon-512.png?v=1.6.65-firestore-write-fencing'),'512 icon cache key');
must(html.includes('assets/icons/apple-touch-icon.png?v=1.6.65-firestore-write-fencing'),'apple icon cache key');
