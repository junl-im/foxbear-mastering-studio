...
must(html.includes('assets/icons/foxbear-icon-512.png?v=1.4.0-stage16-version-release'),'512 icon cache key');
must(html.includes('assets/icons/apple-touch-icon.png?v=1.4.0-stage16-version-release'),'apple icon cache key');
