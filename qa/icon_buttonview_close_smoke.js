...
must(html.includes('assets/icons/foxbear-icon-512.png?v=1.4.0-stage28-waveform-control-view'),'512 icon cache key');
must(html.includes('assets/icons/apple-touch-icon.png?v=1.4.0-stage28-waveform-control-view'),'apple icon cache key');
