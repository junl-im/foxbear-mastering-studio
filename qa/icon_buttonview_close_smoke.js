...
must(pkg.version==='1.4.18','package version');
must(html.includes('data-build="1.4.18"'),'build');
must(app.includes("const APP_VERSION = 'Pro v1.4.18'"),'app version');
must(html.includes('assets/icons/foxbear-icon-512.png?v=1.4.18-download-dialog-micro-hint'),'512 icon cache key');
must(html.includes('assets/icons/apple-touch-icon.png?v=1.4.18-download-dialog-micro-hint'),'apple icon cache key');
