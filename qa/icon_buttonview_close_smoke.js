...
must(app.includes("const APP_VERSION = 'Pro v1.6.99'"),'app version');
must(html.includes('assets/icons/foxbear-icon-512.png?v=1.6.99-header-role-focus-integrity'),'512 icon cache key');
must(html.includes('assets/icons/apple-touch-icon.png?v=1.6.99-header-role-focus-integrity'),'apple icon cache key');
