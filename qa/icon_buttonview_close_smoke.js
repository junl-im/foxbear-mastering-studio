...
must(app.includes("const APP_VERSION = 'Pro v1.5.61'"),'app version');
must(html.includes('assets/icons/foxbear-icon-512.png?v=1.5.61-worker-mail-delivery-recovery'),'512 icon cache key');
must(html.includes('assets/icons/apple-touch-icon.png?v=1.5.61-worker-mail-delivery-recovery'),'apple icon cache key');
