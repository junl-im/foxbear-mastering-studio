...
must(pkg.version==='1.4.24','package version');
must(html.includes('data-build="1.4.24"'),'build');
must(app.includes("const APP_VERSION = 'Pro v1.4.24'"),'app version');
must(html.includes('assets/icons/foxbear-icon-512.png?v=1.4.24-bulk-import-hud'),'512 icon cache key');
must(html.includes('assets/icons/apple-touch-icon.png?v=1.4.24-bulk-import-hud'),'apple icon cache key');
