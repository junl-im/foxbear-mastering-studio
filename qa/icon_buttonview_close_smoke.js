...
must(html.includes('assets/icons/foxbear-icon-512.png?v=1.4.0-stage24-settings-overlay-cleanup'),'512 icon cache key');
must(html.includes('assets/icons/apple-touch-icon.png?v=1.4.0-stage24-settings-overlay-cleanup'),'apple icon cache key');
