...
must(pkg.version==='1.6.110','package version');
must(html.includes('data-build="1.6.110"'),'build');
must(app.includes("const APP_VERSION = 'Pro v1.6.110'"),'app version');
must(html.includes('assets/icons/foxbear-icon-512.png?v=1.6.110-ui-mode-early-boot-recovery'),'512 icon cache key');
must(html.includes('assets/icons/apple-touch-icon.png?v=1.6.110-ui-mode-early-boot-recovery'),'apple icon cache key');
