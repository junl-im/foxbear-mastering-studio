...
must(html.includes('data-build="1.6.113"'),'build');
must(app.includes("const APP_VERSION = 'Pro v1.6.113'"),'app version');
must(html.includes('assets/icons/foxbear-icon-512.png?v=1.6.113-incident-finalizer-p1-hardening'),'512 icon cache key');
must(html.includes('assets/icons/apple-touch-icon.png?v=1.6.113-incident-finalizer-p1-hardening'),'apple icon cache key');
