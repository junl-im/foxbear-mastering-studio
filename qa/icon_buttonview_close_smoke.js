...
must(app.includes("const APP_VERSION = 'Pro v1.5.7'"),'app version');
must(html.includes('assets/icons/foxbear-icon-512.png?v=1.5.7-release-foundation'),'512 icon cache key');
must(html.includes('assets/icons/apple-touch-icon.png?v=1.5.7-release-foundation'),'apple icon cache key');
