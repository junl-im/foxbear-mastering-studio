...
must(html.includes('assets/icons/foxbear-icon-512.png?v=1.4.0-stage17-highlight-compare-sync'),'512 icon cache key');
must(html.includes('assets/icons/apple-touch-icon.png?v=1.4.0-stage17-highlight-compare-sync'),'apple icon cache key');
