...
must(app.includes("const APP_VERSION = 'Pro v1.6.85'"),'app version');
must(html.includes('assets/icons/foxbear-icon-512.png?v=1.6.85-browser-sentinel-ui-mode-header-recovery'),'512 icon cache key');
must(html.includes('assets/icons/apple-touch-icon.png?v=1.6.85-browser-sentinel-ui-mode-header-recovery'),'apple icon cache key');
