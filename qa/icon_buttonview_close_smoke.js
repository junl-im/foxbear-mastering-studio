...
must(html.includes('assets/icons/foxbear-icon-512.png?v=1.3.84-stage13-runtime-safety'),'512 icon cache key');
must(html.includes('assets/icons/apple-touch-icon.png?v=1.3.84-stage13-runtime-safety'),'apple icon cache key');
