...
must(html.includes('data-build="1.7.4"'),'build');
must(app.includes("const APP_VERSION = 'Pro v1.7.4'"),'app version');
must(html.includes('assets/icons/foxbear-icon-512.png?v=1.7.4-reload-reentry-mode-chooser'),'512 icon cache key');
must(html.includes('assets/icons/apple-touch-icon.png?v=1.7.4-reload-reentry-mode-chooser'),'apple icon cache key');
