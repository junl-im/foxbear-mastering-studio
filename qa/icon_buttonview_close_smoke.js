...
must(html.includes('assets/icons/foxbear-icon-512.png?v=1.3.82-pc-dock-modal-rootfix'), '512 icon link should use new icon');
must(html.includes('assets/icons/apple-touch-icon.png?v=1.3.82-pc-dock-modal-rootfix'), 'apple touch icon should use generated icon');
...
must(css.includes('v1.3.82 PC Dock / Modal Root Fix'), 'CSS close repair section missing');
