...
must(html.includes('data-build="1.6.112"'),'build');
must(app.includes("const APP_VERSION = 'Pro v1.6.112'"),'app version');
must(html.includes('assets/icons/foxbear-icon-512.png?v=1.6.112-mastering-lifecycle-race-hardening'),'512 icon cache key');
must(html.includes('assets/icons/apple-touch-icon.png?v=1.6.112-mastering-lifecycle-race-hardening'),'apple icon cache key');
