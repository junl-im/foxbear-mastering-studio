...
must(html.includes('assets/icons/foxbear-icon-512.png?v=1.6.64-github-desktop-delivery-contract'),'512 icon cache key');
must(html.includes('assets/icons/apple-touch-icon.png?v=1.6.64-github-desktop-delivery-contract'),'apple icon cache key');
