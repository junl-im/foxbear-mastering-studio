...
must(pkg.version==='1.7.1','package version');
must(html.includes('data-build="1.7.1"'),'build');
must(app.includes("const APP_VERSION = 'Pro v1.7.1'"),'app version');
must(html.includes('assets/icons/foxbear-icon-512.png?v=1.7.1-reference-match-2-phase1'),'512 icon cache key');
must(html.includes('assets/icons/apple-touch-icon.png?v=1.7.1-reference-match-2-phase1'),'apple icon cache key');
