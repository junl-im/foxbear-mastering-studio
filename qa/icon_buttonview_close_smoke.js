...
must(html.includes('assets/icons/foxbear-icon-512.png?v=1.3.84-stage12.2-cachefix'),'512 icon cache key');
must(html.includes('assets/icons/apple-touch-icon.png?v=1.3.84-stage12.2-cachefix'),'apple icon cache key');
