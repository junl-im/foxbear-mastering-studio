...
must(html.includes('assets/icons/foxbear-icon-512.png?v=1.3.84-dock-modal-state-machine'),'512 icon cache key');
must(html.includes('assets/icons/apple-touch-icon.png?v=1.3.84-dock-modal-state-machine'),'apple icon cache key');
...
must(dockCss.includes('v1.3.84 Dock / Modal State Machine Refactor'),'css state machine section');
