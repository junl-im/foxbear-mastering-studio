...
must(pkg.version==='1.4.10','package version');
must(html.includes('data-build="1.4.10"'),'build');
must(app.includes("const APP_VERSION = 'Pro v1.4.10'"),'app version');
must(html.includes('assets/icons/foxbear-icon-512.png?v=1.4.10-perf-polish'),'512 icon cache key');
must(html.includes('assets/icons/apple-touch-icon.png?v=1.4.10-perf-polish'),'apple icon cache key');
