...
must(index.includes('1.6.102-admin-lazyload-sw-hygiene-hardening'),'asset version');
must(sw.includes('foxbear-shell-v1.6.102-admin-lazyload-sw-hygiene-hardening'),'cache version');
