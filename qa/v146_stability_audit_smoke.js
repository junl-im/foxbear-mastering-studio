...
must(index.includes('1.6.109-mastering-cooperative-pcm-responsiveness'),'asset version');
must(sw.includes('foxbear-shell-v1.6.109-mastering-cooperative-pcm-responsiveness'),'cache version');
