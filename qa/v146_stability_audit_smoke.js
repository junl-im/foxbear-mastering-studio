...
must(index.includes('1.7.0-adaptive-mastering-decision-phase1'),'asset version');
must(sw.includes('foxbear-shell-v1.7.0-adaptive-mastering-decision-phase1'),'cache version');
