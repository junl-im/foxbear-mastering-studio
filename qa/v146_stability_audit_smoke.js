...
must(index.includes('1.6.103-ci-hygiene-mail-routing-hardening'),'asset version');
must(sw.includes('foxbear-shell-v1.6.103-ci-hygiene-mail-routing-hardening'),'cache version');
