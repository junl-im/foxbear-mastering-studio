...
must(index.includes('1.6.111-ui-mode-session-contract-hardening'),'asset version');
must(sw.includes('foxbear-shell-v1.6.111-ui-mode-session-contract-hardening'),'cache version');
