...
assert(app.includes('afterBatch: payload => afterMasteringBatchMemorySweep'), 'mastering orchestrator afterBatch hook missing');
...
assert(app.split(/\r?\n/).length < 13300, 'app.js should remain under the v1.4.28 slim-down line budget');
