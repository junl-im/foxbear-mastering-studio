...
assert((readme.includes('v1.5.1 Real Browser Automation') || readme.includes('v1.5.0 Engine Quality Gate')) && readme.includes('v1.4.29 Memory Stabilization'), 'README missing v1.5.0 and v1.4.29 carry-forward');
assert((handoff.includes('v1.5.1 Real Browser Automation') || handoff.includes('v1.5.0 Engine Quality Gate')) && handoff.includes('v1.4.29 Memory Stabilization'), 'HANDOFF missing v1.5.0 and v1.4.29 carry-forward');
assert(qaReport.includes('170/170 PASS'), 'QA report missing 170/170 PASS');
assert((changelog.startsWith('# v1.5.1 - Real Browser Automation') || changelog.startsWith('# v1.5.0 - Engine Quality Gate')) && changelog.includes('# v1.4.29 - Memory Stabilization'), 'CHANGELOG missing v1.5.0 top and v1.4.29 carry-forward');
