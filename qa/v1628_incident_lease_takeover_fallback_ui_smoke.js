...
async function main() {
    ...
    assert.strictEqual(tabA.context.FoxBearIncidentQueueCoordination.version, '1.7.4');
    assert.strictEqual(tabA.context.FoxBearIncidentDiagnosticsView.version, '1.7.4');
