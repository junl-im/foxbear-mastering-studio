...
async function main() {
    ...
    assert.strictEqual(tabA.context.FoxBearIncidentQueueCoordination.version, '1.7.0');
    assert.strictEqual(tabA.context.FoxBearIncidentDiagnosticsView.version, '1.7.0');
