...
async function main() {
    ...
    assert.strictEqual(tabA.context.FoxBearIncidentQueueCoordination.version, '1.6.43');
    assert.strictEqual(tabA.context.FoxBearIncidentDiagnosticsView.version, '1.6.43');
