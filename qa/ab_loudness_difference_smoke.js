...
must(app.includes("const APP_VERSION = 'Pro v1.3.50'"), 'app version not updated');
...
must(!html.includes('bottomPreviewAbMatchBtn'), 'Dock level-match button should be removed in v1.3.50');
must(!html.includes('bottomPreviewDifferenceBtn'), 'Dock difference button should be removed in v1.3.50');
