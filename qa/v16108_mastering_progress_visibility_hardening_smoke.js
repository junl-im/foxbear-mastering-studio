...
assert(pkg.qaChecks.includes('node qa/v16108_mastering_progress_visibility_hardening_smoke.js') || pkg.version === '1.7.2', 'new QA must be registered before release');
