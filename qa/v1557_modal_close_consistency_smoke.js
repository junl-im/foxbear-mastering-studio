...
assert(index.includes('assets/css/components/modal-close-system.css?v=1.5.81-master-preview-cancellation-native-result-isolation'));
assert(sw.includes('./assets/css/components/modal-close-system.css?v=1.5.81-master-preview-cancellation-native-result-isolation'));
