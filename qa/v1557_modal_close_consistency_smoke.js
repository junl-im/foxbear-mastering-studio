...
assert(index.includes('assets/css/components/modal-close-system.css?v=1.5.64-incident-operations-health-self-diagnostics'));
assert(sw.includes('./assets/css/components/modal-close-system.css?v=1.5.64-incident-operations-health-self-diagnostics'));
