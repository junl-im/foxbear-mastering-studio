...
assert(index.includes('assets/css/components/modal-close-system.css?v=1.5.90-browser-retry-integrity-metadata-aware-scope'));
assert(sw.includes('./assets/css/components/modal-close-system.css?v=1.5.90-browser-retry-integrity-metadata-aware-scope'));
