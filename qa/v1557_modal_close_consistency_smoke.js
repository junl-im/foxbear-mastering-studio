...
assert.strictEqual(pkg.version, '1.5.57');
assert.strictEqual(pkg.foxbearRelease.assetVersion, '1.5.57-modal-close-consistency');
assert(index.includes('assets/css/components/modal-close-system.css?v=1.5.57-modal-close-consistency'));
assert(sw.includes('./assets/css/components/modal-close-system.css?v=1.5.57-modal-close-consistency'));
