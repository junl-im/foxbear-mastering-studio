...
assert(/foxbear-shell-v1\.3\.84/.test(sw) && /stage(?:9(?:\.1)?|10|11|12(?:\.1|\.2)?|13)/.test(sw), 'service worker cache should be bumped to stage9 or later');
assert(sw.includes('./assets/css/dock-waveform.css?v=1.3.84-stage13-runtime-safety'), 'service worker should precache dock-waveform.css');
