...
assert(html.includes('assets/css/bulk-import-hud.css?v=1.5.32-kakao-external-browser-local-flow&h=bulk-hud-close-hotfix'), 'index must load bulk HUD CSS with a targeted stale-cache bust key');
...
assert(sw.includes('./assets/css/bulk-import-hud.css?v=1.5.32-kakao-external-browser-local-flow&h=bulk-hud-close-hotfix'), 'service worker should precache the cache-busted bulk HUD CSS');
