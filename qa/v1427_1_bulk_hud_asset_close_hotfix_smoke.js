...
assert(html.includes('assets/css/bulk-import-hud.css?v=1.6.82-overlay-focus-ancestor-hardening&h=bulk-hud-close-hotfix'), 'index must load bulk HUD CSS with a targeted stale-cache bust key');
...
assert(sw.includes('./assets/css/bulk-import-hud.css?v=1.6.82-overlay-focus-ancestor-hardening&h=bulk-hud-close-hotfix'), 'service worker should precache the cache-busted bulk HUD CSS');
