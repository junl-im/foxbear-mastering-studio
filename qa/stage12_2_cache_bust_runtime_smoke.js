...
const version = '1.3.84-stage14-runtime-recovery';
...
assert(sw.includes('foxbear-shell-v1.3.84-stage14-runtime-recovery'), 'service worker cache name should be stage12.2 cachefix');
assert(!index.includes('?v=1.3.84-dock-modal-state-machine'), 'index.html should not keep the stale immutable asset query');
assert(!sw.includes('?v=1.3.84-dock-modal-state-machine'), 'sw.js should not keep the stale immutable asset query');
