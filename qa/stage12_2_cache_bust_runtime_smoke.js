...
const version = '1.3.84-stage12.2-cachefix';
...
assert(sw.includes('foxbear-shell-v1.3.84-stage12.2-cachefix'), 'service worker cache name should be stage12.2 cachefix');
