...
const version = '1.3.84-stage15-settings-panel';
...
assert(sw.includes('foxbear-shell-v1.3.84-stage15-settings-panel'), 'service worker cache name should be stage12.2 cachefix');
