...
assert(sw.includes(`foxbear-shell-v1.4.14-download-action-clarity`), 'service worker cache name should be stage16');
...
assert(overwrite.includes('v1.4.14'), 'overwrite package default should be latest stage');
