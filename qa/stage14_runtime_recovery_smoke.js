...
assert(sw.includes(`foxbear-shell-v1.4.6-stability-polish`), 'service worker cache name should be stage16');
...
assert(overwrite.includes('v1.4.6'), 'overwrite package default should be latest stage');
