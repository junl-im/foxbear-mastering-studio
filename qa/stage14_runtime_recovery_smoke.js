...
assert(sw.includes(`foxbear-shell-v1.4.12-download-diagnostics`), 'service worker cache name should be stage16');
...
assert(overwrite.includes('v1.4.12'), 'overwrite package default should be latest stage');
