...
assert(sw.includes(`foxbear-shell-v1.4.7-dock-fft-removal`), 'service worker cache name should be stage16');
...
assert(overwrite.includes('v1.4.7'), 'overwrite package default should be latest stage');
