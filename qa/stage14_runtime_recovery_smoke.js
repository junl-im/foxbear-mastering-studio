...
assert(sw.includes(`foxbear-shell-v1.4.11-download-share-reliability`), 'service worker cache name should be stage16');
...
assert(overwrite.includes('v1.4.11'), 'overwrite package default should be latest stage');
