...
assert(sw.includes(`foxbear-shell-v1.4.5-stability-audit`), 'service worker cache name should be stage16');
...
assert(overwrite.includes('v1.4.5'), 'overwrite package default should be latest stage');
