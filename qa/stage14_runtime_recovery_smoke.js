...
assert(sw.includes(`foxbear-shell-v1.4.0-stage18-settings-persistence`), 'service worker cache name should be stage16');
...
assert(overwrite.includes('v1.4.0-stage18'), 'overwrite package default should be latest stage');
