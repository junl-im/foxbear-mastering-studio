...
assert(sw.includes(`foxbear-shell-v1.4.0-stage25-compare-controls-rehome`), 'service worker cache name should be stage16');
...
assert(overwrite.includes('v1.4.0-stage25'), 'overwrite package default should be latest stage');
