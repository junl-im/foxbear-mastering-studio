...
assert(sw.includes(`foxbear-shell-v1.3.84-stage14-runtime-recovery`), 'service worker cache name should be stage14');
...
assert(overwrite.includes('v1.3.84-stage14'), 'overwrite package default should be stage14');
