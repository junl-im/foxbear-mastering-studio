...
assert(sw.includes(`foxbear-shell-v1.4.20-bulk-import-guard`), 'service worker cache name should be stage16');
...
assert(overwrite.includes('v1.4.20'), 'overwrite package default should be latest stage');
