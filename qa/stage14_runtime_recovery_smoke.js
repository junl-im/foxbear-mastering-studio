...
assert(sw.includes(`foxbear-shell-v1.4.23-audio-decode-memory-guard`), 'service worker cache name should be stage16');
...
assert(overwrite.includes('v1.4.23'), 'overwrite package default should be latest stage');
