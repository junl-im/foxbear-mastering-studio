...
assert(sw.includes(`foxbear-shell-v1.4.0-stage16-version-release`), 'service worker cache name should be stage16');
...
assert(overwrite.includes('v1.4.0-stage16'), 'overwrite package default should be stage16');
