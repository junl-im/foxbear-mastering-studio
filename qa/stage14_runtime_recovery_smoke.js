...
assert(sw.includes(`foxbear-shell-v1.4.0-stage19-highlight-diagnostics`), 'service worker cache name should be stage16');
...
assert(overwrite.includes('v1.4.0-stage19'), 'overwrite package default should be latest stage');
