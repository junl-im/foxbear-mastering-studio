...
assert(sw.includes(`foxbear-shell-v1.6.91-runtime-health-hidden-geometry-contract-recovery`), 'service worker cache name should be stage16');
...
assert(overwrite.includes('package.json') && overwrite.includes("'v' + (p.version || 'dev')"), 'overwrite package default should be latest stage');
