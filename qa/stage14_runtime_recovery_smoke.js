...
assert(sw.includes(`foxbear-shell-v1.4.0-stage17-highlight-compare-sync`), 'service worker cache name should be stage16');
...
assert(overwrite.includes('v1.4.0-stage17'), 'overwrite package default should be latest stage');
