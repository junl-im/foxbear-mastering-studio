...
assert(sw.includes(`foxbear-shell-v1.4.0-stage23-playback-orchestration`), 'service worker cache name should be stage16');
...
assert(overwrite.includes('v1.4.0-stage23'), 'overwrite package default should be latest stage');
