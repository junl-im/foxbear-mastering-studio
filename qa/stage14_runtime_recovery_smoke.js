...
assert(sw.includes(`foxbear-shell-v1.4.18-download-dialog-micro-hint`), 'service worker cache name should be stage16');
...
assert(overwrite.includes('v1.4.18'), 'overwrite package default should be latest stage');
