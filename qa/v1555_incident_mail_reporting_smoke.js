...
assert(index.includes('src/boot/incident-reporter.js?v=1.5.67-incident-admin-audit-webhook-failover-index-health'));
...
assert(sw.includes('./src/boot/incident-reporter.js?v=1.5.67-incident-admin-audit-webhook-failover-index-health'));
