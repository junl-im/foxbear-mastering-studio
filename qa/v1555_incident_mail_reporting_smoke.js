...
assert.strictEqual(pkg.version, '1.5.55');
assert.strictEqual(pkg.foxbearRelease.assetVersion, '1.5.55-automatic-incident-mail-reporting');
assert(index.includes('src/boot/incident-reporter.js?v=1.5.55-automatic-incident-mail-reporting'));
...
assert(sw.includes('./src/boot/incident-reporter.js?v=1.5.55-automatic-incident-mail-reporting'));
