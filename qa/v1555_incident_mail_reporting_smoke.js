...
assert(index.includes('src/boot/incident-reporter.js?v=1.5.80-mobile-return-media-focus-recovery'));
...
assert(sw.includes('./src/boot/incident-reporter.js?v=1.5.80-mobile-return-media-focus-recovery'));
