...
assert(index.includes('src/boot/incident-reporter.js?v=1.5.92-python-bytecode-ci-hygiene-node24-cache'));
...
assert(sw.includes('./src/boot/incident-reporter.js?v=1.5.92-python-bytecode-ci-hygiene-node24-cache'));
