...
assert(index.includes('src/boot/incident-reporter.js?v=1.5.57-modal-close-consistency'));
...
assert(sw.includes('./src/boot/incident-reporter.js?v=1.5.57-modal-close-consistency'));
