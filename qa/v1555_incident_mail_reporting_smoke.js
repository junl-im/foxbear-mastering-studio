...
assert(index.includes('src/boot/incident-reporter.js?v=1.5.73-bulk-control-eta-result-filter-ui'));
...
assert(sw.includes('./src/boot/incident-reporter.js?v=1.5.73-bulk-control-eta-result-filter-ui'));
