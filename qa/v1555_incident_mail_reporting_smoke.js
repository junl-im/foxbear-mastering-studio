...
assert.strictEqual(pkg.version, '1.5.56');
assert.strictEqual(pkg.foxbearRelease.assetVersion, '1.5.56-incident-operations-app-check');
assert(index.includes('src/boot/incident-reporter.js?v=1.5.56-incident-operations-app-check'));
...
assert(sw.includes('./src/boot/incident-reporter.js?v=1.5.56-incident-operations-app-check'));
