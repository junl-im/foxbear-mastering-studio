...
assert(index.includes('src/boot/incident-reporter.js?v=1.5.74-bulk-pause-skip-reorder-mobile-download'));
...
assert(sw.includes('./src/boot/incident-reporter.js?v=1.5.74-bulk-pause-skip-reorder-mobile-download'));
