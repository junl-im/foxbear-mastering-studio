...
must(app.includes("const SHARED_DSP_PROFILE_VERSION = 'v1.3.84-dock-modal-state-machine'"),'slug');
...
must(dockCss.includes('v1.3.84 Dock / Modal State Machine Refactor'),'dock css v1.3.84 section');
