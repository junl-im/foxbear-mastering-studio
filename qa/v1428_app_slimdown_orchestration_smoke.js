...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.73-bulk-control-eta-result-filter-ui'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.73-bulk-control-eta-result-filter-ui'), 'mastering orchestrator not precached');
...
assert(app.split(/\r?\n/).length < 13300, 'app.js should remain under the v1.5.73 adaptive governor integration line budget');
