...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.6.76-download-viewport-runtime-fault-diagnostics'), 'mastering orchestrator not precached');
...
assert(app.split(/\r?\n/).length < 13300, 'app.js should remain under the v1.6.76 adaptive governor integration line budget');
