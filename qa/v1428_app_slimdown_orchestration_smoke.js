...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.46-engine-recommendation-api-audit'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.46-engine-recommendation-api-audit'), 'mastering orchestrator not precached');
