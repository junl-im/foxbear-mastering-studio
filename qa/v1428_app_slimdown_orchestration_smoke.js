...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.74-bulk-pause-skip-reorder-mobile-download'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.74-bulk-pause-skip-reorder-mobile-download'), 'mastering orchestrator not precached');
...
assert(app.split(/\r?\n/).length < 13300, 'app.js should remain under the v1.5.74 adaptive governor integration line budget');
