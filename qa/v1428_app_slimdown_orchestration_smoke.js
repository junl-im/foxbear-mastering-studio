...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.38-preflight-worker-multitab-hardening'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.38-preflight-worker-multitab-hardening'), 'mastering orchestrator not precached');
