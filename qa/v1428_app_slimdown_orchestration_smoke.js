...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.69-mail-receipt-confirmation-history-branded-template'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.69-mail-receipt-confirmation-history-branded-template'), 'mastering orchestrator not precached');
...
assert(app.split(/\r?\n/).length < 13300, 'app.js should remain under the v1.5.69 adaptive governor integration line budget');
