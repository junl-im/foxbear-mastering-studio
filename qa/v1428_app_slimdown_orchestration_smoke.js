...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.21-history-csp-console-contract-fix'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.21-history-csp-console-contract-fix'), 'mastering orchestrator not precached');
