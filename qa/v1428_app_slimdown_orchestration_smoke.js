...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.17-browser-contract-fix'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.17-browser-contract-fix'), 'mastering orchestrator not precached');
