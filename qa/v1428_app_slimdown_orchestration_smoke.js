...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.15-e2e-runtime-classification'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.15-e2e-runtime-classification'), 'mastering orchestrator not precached');
