...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.91-cancellable-audio-pipeline-performance-guards'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.91-cancellable-audio-pipeline-performance-guards'), 'mastering orchestrator not precached');
...
assert(app.split(/\r?\n/).length < 13300, 'app.js should remain under the v1.5.91 adaptive governor integration line budget');
