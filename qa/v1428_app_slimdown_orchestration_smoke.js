...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.23-e2e-preview-readiness'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.23-e2e-preview-readiness'), 'mastering orchestrator not precached');
