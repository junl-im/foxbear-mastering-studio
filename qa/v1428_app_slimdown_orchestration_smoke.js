...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.6.10-incident-readiness-contract-csp-cache-hardening'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.6.10-incident-readiness-contract-csp-cache-hardening'), 'mastering orchestrator not precached');
...
assert(app.split(/\r?\n/).length < 13300, 'app.js should remain under the v1.6.10 adaptive governor integration line budget');
