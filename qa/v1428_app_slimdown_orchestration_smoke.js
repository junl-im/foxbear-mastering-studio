...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.43-export-pipeline-integrity'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.43-export-pipeline-integrity'), 'mastering orchestrator not precached');
