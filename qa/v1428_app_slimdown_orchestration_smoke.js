...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.33-codec-truth-download-hardening'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.33-codec-truth-download-hardening'), 'mastering orchestrator not precached');
