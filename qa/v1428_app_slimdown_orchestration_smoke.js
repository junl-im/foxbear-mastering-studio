...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.6.47-external-host-admin-auth-opaque-error-recovery'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.6.47-external-host-admin-auth-opaque-error-recovery'), 'mastering orchestrator not precached');
...
assert(app.split(/\r?\n/).length < 13300, 'app.js should remain under the v1.6.47 adaptive governor integration line budget');
