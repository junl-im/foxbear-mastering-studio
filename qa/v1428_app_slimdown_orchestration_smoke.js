...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.16-e2e-server-pipe-deadlock-fix'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.16-e2e-server-pipe-deadlock-fix'), 'mastering orchestrator not precached');
