...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.37-memory-import-waveform-hardening'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.37-memory-import-waveform-hardening'), 'mastering orchestrator not precached');
