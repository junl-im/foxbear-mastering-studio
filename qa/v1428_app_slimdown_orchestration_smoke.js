...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.29-analysis-update-lifecycle'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.29-analysis-update-lifecycle'), 'mastering orchestrator not precached');
