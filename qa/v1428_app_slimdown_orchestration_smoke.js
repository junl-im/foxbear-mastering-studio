...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.51-ci-runtime-contract-hardening'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.51-ci-runtime-contract-hardening'), 'mastering orchestrator not precached');
