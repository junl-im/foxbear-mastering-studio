...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.42-zip-worker-cancellation'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.42-zip-worker-cancellation'), 'mastering orchestrator not precached');
