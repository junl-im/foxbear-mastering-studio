...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.53-engine-recovery-performance-diagnostics'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.53-engine-recovery-performance-diagnostics'), 'mastering orchestrator not precached');
...
assert(app.split(/\r?\n/).length < 13200, 'app.js should remain under the v1.5.53 recovery integration line budget');
