...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.66-incident-operations-action-guard-deploy-verification'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.66-incident-operations-action-guard-deploy-verification'), 'mastering orchestrator not precached');
...
assert(app.split(/\r?\n/).length < 13300, 'app.js should remain under the v1.5.66 adaptive governor integration line budget');
