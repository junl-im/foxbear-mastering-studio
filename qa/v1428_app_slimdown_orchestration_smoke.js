...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.32-kakao-external-browser-local-flow'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.32-kakao-external-browser-local-flow'), 'mastering orchestrator not precached');
