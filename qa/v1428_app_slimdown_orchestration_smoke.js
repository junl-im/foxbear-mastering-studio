...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.7.1-reference-match-2-phase1'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.7.1-reference-match-2-phase1'), 'mastering orchestrator not precached');
...
assert(app.split(/\r?\n/).length < 13300, 'app.js should remain under the v1.7.1 adaptive governor integration line budget');
