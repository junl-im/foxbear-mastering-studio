...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.18-ci-diagnostics-pwa-readiness'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.18-ci-diagnostics-pwa-readiness'), 'mastering orchestrator not precached');
