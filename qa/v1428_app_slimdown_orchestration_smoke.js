...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.26-engraved-command-header'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.26-engraved-command-header'), 'mastering orchestrator not precached');
