...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.20-idempotent-pwa-cache-warm'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.20-idempotent-pwa-cache-warm'), 'mastering orchestrator not precached');
