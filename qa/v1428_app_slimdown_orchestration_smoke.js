...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.19-ci-runtime-isolation-package-hardening'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.19-ci-runtime-isolation-package-hardening'), 'mastering orchestrator not precached');
