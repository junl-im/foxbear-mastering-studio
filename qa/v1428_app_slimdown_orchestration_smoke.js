...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.6.0-incident-mail-pipeline-health'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.6.0-incident-mail-pipeline-health'), 'mastering orchestrator not precached');
...
assert(app.split(/\r?\n/).length < 13300, 'app.js should remain under the v1.6.0 adaptive governor integration line budget');
