...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.22-header-preview-routing-polish'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.22-header-preview-routing-polish'), 'mastering orchestrator not precached');
