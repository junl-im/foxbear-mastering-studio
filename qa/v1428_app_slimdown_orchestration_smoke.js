...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.4.26-wake-lock-state-sync'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.4.26-wake-lock-state-sync'), 'mastering orchestrator not precached');
...
assert(changelog.includes('v1.4.28') && handoff.includes('v1.4.29') && (qaReport.includes('170/170 PASS') || qaReport.includes('178/178 PASS')), 'docs should carry forward v1.4.28 and report current QA count');
