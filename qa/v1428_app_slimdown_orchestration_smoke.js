...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.47-engine-edgecase-quality-gate'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.47-engine-edgecase-quality-gate'), 'mastering orchestrator not precached');
