...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.34-kakao-landing-recovery'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.34-kakao-landing-recovery'), 'mastering orchestrator not precached');
