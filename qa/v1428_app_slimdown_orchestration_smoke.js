...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.36-interaction-lifecycle-hardening'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.36-interaction-lifecycle-hardening'), 'mastering orchestrator not precached');
