...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.27-device-glyph-sri-hardening'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.27-device-glyph-sri-hardening'), 'mastering orchestrator not precached');
