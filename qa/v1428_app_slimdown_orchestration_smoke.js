...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.14-github-desktop-handoff-preflight'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.14-github-desktop-handoff-preflight'), 'mastering orchestrator not precached');
