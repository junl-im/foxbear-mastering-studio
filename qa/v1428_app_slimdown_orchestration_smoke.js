...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.30-inapp-playback-recovery'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.30-inapp-playback-recovery'), 'mastering orchestrator not precached');
