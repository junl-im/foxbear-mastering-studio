...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.24-e2e-responsive-preview-control'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.24-e2e-responsive-preview-control'), 'mastering orchestrator not precached');
