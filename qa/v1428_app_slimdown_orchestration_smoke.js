...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.7-release-foundation'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.7-release-foundation'), 'mastering orchestrator not precached');
