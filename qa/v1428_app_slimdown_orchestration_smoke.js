...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.31-player-download-stability'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.31-player-download-stability'), 'mastering orchestrator not precached');
