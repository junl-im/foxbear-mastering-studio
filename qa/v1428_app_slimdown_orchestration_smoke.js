...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.50-pwa-current-cache-test-recovery'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.50-pwa-current-cache-test-recovery'), 'mastering orchestrator not precached');
