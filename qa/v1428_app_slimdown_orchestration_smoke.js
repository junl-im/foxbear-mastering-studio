...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.58-kakao-mastering-runtime-recovery'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.58-kakao-mastering-runtime-recovery'), 'mastering orchestrator not precached');
...
assert(app.split(/\r?\n/).length < 13250, 'app.js should remain under the v1.5.58 recovery integration line budget');
