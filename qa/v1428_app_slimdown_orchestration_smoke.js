...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.10-header-settings-relocation'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.10-header-settings-relocation'), 'mastering orchestrator not precached');
