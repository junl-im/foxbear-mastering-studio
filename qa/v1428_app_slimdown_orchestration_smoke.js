...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.28-resilience-lifecycle-offline-recovery'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.28-resilience-lifecycle-offline-recovery'), 'mastering orchestrator not precached');
