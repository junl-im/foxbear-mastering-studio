...
assert(index.includes('src/audio/mastering-orchestrator-service.js?v=1.5.52-ci-parallel-release-gate'), 'mastering orchestrator not loaded in index');
...
assert(sw.includes('./src/audio/mastering-orchestrator-service.js?v=1.5.52-ci-parallel-release-gate'), 'mastering orchestrator not precached');
