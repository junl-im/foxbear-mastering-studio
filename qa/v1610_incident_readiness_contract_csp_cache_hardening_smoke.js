...
const sandbox = {
  ...
  document: {
    body: { dataset: { build: '1.6.104' }, appendChild() {} }, visibilityState: 'visible',
    getElementById: () => null,
  ...
  FoxBearBuildInfo: { productVersion: '1.6.104', assetVersion: '1.6.104-boot-emergency-visit-privacy-hardening' }
};
const completeRemote = () => {
  ...
  return {
    ...
    service: { status: 'ready', productVersion: '1.6.104', functionsOrigin: origin },
    checks: {
