...
const sandbox = {
  ...
  document: {
    body: { dataset: { build: '1.7.4' }, appendChild() {} }, visibilityState: 'visible',
    getElementById: () => null,
  ...
  FoxBearBuildInfo: { productVersion: '1.7.4', assetVersion: '1.7.4-reload-reentry-mode-chooser' }
};
const completeRemote = () => {
  ...
  return {
    ...
    service: { status: 'ready', productVersion: '1.7.4', functionsOrigin: origin },
    checks: {
