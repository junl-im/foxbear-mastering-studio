...
const sandbox = {
  ...
  document: {
    body: { dataset: { build: '1.6.108' }, appendChild() {} }, visibilityState: 'visible',
    getElementById: () => null,
  ...
  FoxBearBuildInfo: { productVersion: '1.6.108', assetVersion: '1.6.108-mastering-progress-visibility-hardening' }
};
const completeRemote = () => {
  ...
  return {
    ...
    service: { status: 'ready', productVersion: '1.6.108', functionsOrigin: origin },
    checks: {
