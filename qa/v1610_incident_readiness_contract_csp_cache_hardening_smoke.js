...
const sandbox = {
  ...
  document: {
    body: { dataset: { build: '1.6.105' }, appendChild() {} }, visibilityState: 'visible',
    getElementById: () => null,
  ...
  FoxBearBuildInfo: { productVersion: '1.6.105', assetVersion: '1.6.105-header-dock-css-ownership-hardening' }
};
const completeRemote = () => {
  ...
  return {
    ...
    service: { status: 'ready', productVersion: '1.6.105', functionsOrigin: origin },
    checks: {
