...
const sandbox = {
  ...
  document: {
    body: { dataset: { build: '1.6.106' }, appendChild() {} }, visibilityState: 'visible',
    getElementById: () => null,
  ...
  FoxBearBuildInfo: { productVersion: '1.6.106', assetVersion: '1.6.106-browser-geometry-history-recovery' }
};
const completeRemote = () => {
  ...
  return {
    ...
    service: { status: 'ready', productVersion: '1.6.106', functionsOrigin: origin },
    checks: {
