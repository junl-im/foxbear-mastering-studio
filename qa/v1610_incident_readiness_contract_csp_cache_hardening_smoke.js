...
const sandbox = {
  ...
  document: {
    body: { dataset: { build: '1.6.110' }, appendChild() {} }, visibilityState: 'visible',
    getElementById: () => null,
  ...
  FoxBearBuildInfo: { productVersion: '1.6.110', assetVersion: '1.6.110-ui-mode-early-boot-recovery' }
};
const completeRemote = () => {
  ...
  return {
    ...
    service: { status: 'ready', productVersion: '1.6.110', functionsOrigin: origin },
    checks: {
