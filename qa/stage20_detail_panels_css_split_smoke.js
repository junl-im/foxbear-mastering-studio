...
assert(sw.includes('foxbear-shell-v1.4.23-audio-decode-memory-guard'), 'service worker cache should use Stage20 key');
...
assert(overwrite.includes('v1.4.23'), 'overwrite package default should be Stage20');
