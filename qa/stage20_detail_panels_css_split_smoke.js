...
assert(sw.includes('foxbear-shell-v1.4.5-stability-audit'), 'service worker cache should use Stage20 key');
...
assert(overwrite.includes('v1.4.5'), 'overwrite package default should be Stage20');
