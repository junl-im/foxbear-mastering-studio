...
assert(sw.includes('foxbear-shell-v1.4.12-download-diagnostics'), 'service worker cache should use Stage20 key');
...
assert(overwrite.includes('v1.4.12'), 'overwrite package default should be Stage20');
