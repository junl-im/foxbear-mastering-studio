...
assert(sw.includes('foxbear-shell-v1.4.14-download-action-clarity'), 'service worker cache should use Stage20 key');
...
assert(overwrite.includes('v1.4.14'), 'overwrite package default should be Stage20');
