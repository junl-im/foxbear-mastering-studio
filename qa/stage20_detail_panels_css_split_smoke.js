...
assert(sw.includes('foxbear-shell-v1.4.11-download-share-reliability'), 'service worker cache should use Stage20 key');
...
assert(overwrite.includes('v1.4.11'), 'overwrite package default should be Stage20');
