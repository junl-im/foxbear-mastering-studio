...
assert(sw.includes('foxbear-shell-v1.4.0-stage22-playback-link-audit'), 'service worker cache should use Stage20 key');
...
assert(overwrite.includes('v1.4.0-stage22'), 'overwrite package default should be Stage20');
