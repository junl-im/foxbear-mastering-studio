...
assert(sw.includes('foxbear-shell-v1.4.24-bulk-import-hud'), 'service worker cache should use Stage20 key');
...
assert(overwrite.includes('v1.4.24'), 'overwrite package default should be Stage20');
