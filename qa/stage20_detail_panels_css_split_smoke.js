...
assert(sw.includes('foxbear-shell-v1.4.0-stage26-unified-waveform-controls'), 'service worker cache should use Stage20 key');
...
assert(overwrite.includes('v1.4.0-stage26'), 'overwrite package default should be Stage20');
