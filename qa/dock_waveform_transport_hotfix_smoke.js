...
must(app.includes("const APP_VERSION = 'Pro v1.6.110'"), 'app version should be v1.4.0');
...
must(app.includes("captureBottomPreviewTransport(track, state.bottomPreviewMode);\n    clearPreviewDialogBody('waveform-compare-open')"), 'waveform popup does not preserve Dock transport before opening');
