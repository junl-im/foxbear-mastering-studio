...
must(css.includes('v1.3.80 Icon Refresh / Button View Close Repair'), 'v1.3.80 waveform CSS section missing');
...
must(dockCss.includes('v1.3.80 Icon Refresh / Button View Close Repair'), 'dock CSS v1.3.80 section missing');
