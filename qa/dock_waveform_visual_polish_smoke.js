...
must(css.includes('v1.3.78 Cleanup / Button View Layer Repair'), 'v1.3.78 waveform CSS section missing');
...
must(dockCss.includes('v1.3.78 Cleanup / Button View Layer Repair'), 'dock CSS v1.3.78 section missing');
console.log('PASS cleanup button view layer repair smoke');
