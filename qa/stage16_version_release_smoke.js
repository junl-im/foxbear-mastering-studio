...
const version = '1.4.0';
const assetVersion = '1.4.0-stage28-waveform-control-view';
...
assert(pkg.description.includes('v1.4.0') && pkg.description.includes('Stage28') || pkg.description.includes('Stage27') || pkg.description.includes('Stage26'), 'package description should identify latest v1.4.0 stage');
...
assert(overwrite.includes('v1.4.0-stage28'), 'overwrite package default should be latest v1.4.0 stage');
