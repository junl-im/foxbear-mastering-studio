...
assert(pkg.description.includes('v1.4.0') && pkg.description.includes('Stage22'), 'package description should identify latest v1.4.0 stage');
...
assert(overwrite.includes('v1.4.0-stage22'), 'overwrite package default should be latest v1.4.0 stage');
