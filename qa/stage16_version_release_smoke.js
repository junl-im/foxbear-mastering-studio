...
assert(pkg.description.includes('v1.4.0') && pkg.description.includes('Stage25'), 'package description should identify latest v1.4.0 stage');
...
assert(overwrite.includes('v1.4.0-stage25'), 'overwrite package default should be latest v1.4.0 stage');
