...
(async () => {
  ...
  assert(pkg.qaChecks.includes('node qa/v16109_mastering_cooperative_pcm_responsiveness_smoke.js') || pkg.version === '1.6.111', 'v1.6.111 QA must be registered before release');
