...
(async () => {
  ...
  assert(pkg.qaChecks.includes('node qa/v16109_mastering_cooperative_pcm_responsiveness_smoke.js') || pkg.version === '1.6.112', 'v1.6.112 QA must be registered before release');
