...
must(html.includes('data-build="1.3.81"'), 'index build should be 1.3.81');
...
must(css.includes('v1.3.81 Modal / Dock Layout Integrity Audit'), 'CSS layer repair section missing');
