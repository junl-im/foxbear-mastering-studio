...
must(html.includes('data-build="1.3.78"'), 'index build should be 1.3.78');
must(app.includes("const APP_VERSION = 'Pro v1.3.78'"), 'app version should be Pro v1.3.78');
must(app.includes("const SHARED_DSP_PROFILE_VERSION = 'v1.3.78-cleanup-buttonview-layer'"), 'DSP slug should be v1.3.78');
...
must(css.includes('v1.3.78 Button View layer repair'), 'CSS layer repair section missing');
