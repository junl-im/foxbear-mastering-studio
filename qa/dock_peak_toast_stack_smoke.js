...
expect(index.includes('v1.6.34'), 'index should show v1.6.34');
expect(index.includes('1.6.34-history-hard-stall-sw-activity-lifecycle'), 'index asset query should use stage12.2 cache-bust key');
expect(pkg.version === '1.6.34', 'package version should be 1.6.34');
expect(app.includes("const APP_VERSION = 'Pro v1.6.34'"), 'app version constant should be v1.4.0');
