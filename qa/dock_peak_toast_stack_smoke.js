...
expect(index.includes('v1.6.44'), 'index should show v1.6.44');
expect(index.includes('1.6.44-google-auth-gapi-module-trusted-types-recovery'), 'index asset query should use stage12.2 cache-bust key');
expect(pkg.version === '1.6.44', 'package version should be 1.6.44');
expect(app.includes("const APP_VERSION = 'Pro v1.6.44'"), 'app version constant should be v1.4.0');
