...
expect(index.includes('v1.5.45'), 'index should show v1.5.45');
expect(index.includes('1.5.45-export-queue-recovery'), 'index asset query should use stage12.2 cache-bust key');
expect(pkg.version === '1.5.45', 'package version should be 1.5.45');
expect(app.includes("const APP_VERSION = 'Pro v1.5.45'"), 'app version constant should be v1.4.0');
