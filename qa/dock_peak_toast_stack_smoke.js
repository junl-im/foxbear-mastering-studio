...
expect(index.includes('v1.3.83'), 'index should show v1.3.83');
expect(index.includes('1.3.83-pc-dock-modal-hardfix'), 'index asset query should use v1.3.83 cache key');
expect(pkg.version === '1.3.83', 'package version should be 1.3.83');
expect(app.includes("const APP_VERSION = 'Pro v1.3.83'"), 'app version constant should be v1.3.83');
...
expect(studioCss.includes('v1.3.83 PC Dock / Modal Hard Fix') || studioCss.includes('v1.3.83 Dock integrated waveform remote'), 'studio CSS should include v1.3.83 section');
