...
expect(index.includes('v1.6.100'), 'index should show v1.6.100');
expect(index.includes('1.6.100-sw-stereo-ci-cleanup-hardening'), 'index asset query should use stage12.2 cache-bust key');
expect(pkg.version === '1.6.100', 'package version should be 1.6.100');
expect(app.includes("const APP_VERSION = 'Pro v1.6.100'"), 'app version constant should be v1.4.0');
