...
expect(index.includes('v1.5.16'), 'index should show v1.5.16');
expect(index.includes('1.5.16-e2e-server-pipe-deadlock-fix'), 'index asset query should use stage12.2 cache-bust key');
expect(pkg.version === '1.5.16', 'package version should be 1.5.16');
expect(app.includes("const APP_VERSION = 'Pro v1.5.16'"), 'app version constant should be v1.4.0');
