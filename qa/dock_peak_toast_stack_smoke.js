...
expect(index.includes('v1.3.78'), 'index should show v1.3.78');
expect(index.includes('1.3.78-cleanup-buttonview-layer'), 'index asset query should use v1.3.78 cache key');
expect(pkg.version === '1.3.78', 'package version should be 1.3.78');
expect(app.includes("const APP_VERSION = 'Pro v1.3.78'"), 'app version constant should be v1.3.78');
...
expect(studioCss.includes('v1.3.78 Dock integrated waveform remote'), 'studio CSS should include v1.3.78 section');
