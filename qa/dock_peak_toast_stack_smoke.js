...
expect(index.includes('v1.4.18'), 'index should show v1.4.18');
expect(index.includes('1.4.18-download-dialog-micro-hint'), 'index asset query should use stage12.2 cache-bust key');
expect(pkg.version === '1.4.18', 'package version should be 1.4.18');
expect(app.includes("const APP_VERSION = 'Pro v1.4.18'"), 'app version constant should be v1.4.0');
