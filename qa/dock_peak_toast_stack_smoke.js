...
expect(index.includes('v1.6.74'), 'index should show v1.6.74');
expect(index.includes('1.6.74-incident-admission-spark-retention-download-memory'), 'index asset query should use stage12.2 cache-bust key');
expect(pkg.version === '1.6.74', 'package version should be 1.6.74');
expect(app.includes("const APP_VERSION = 'Pro v1.6.74'"), 'app version constant should be v1.4.0');
