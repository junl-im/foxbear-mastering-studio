...
expect(index.includes('v1.6.89'), 'index should show v1.6.89');
expect(index.includes('1.6.89-mobile-header-flex-ownership-browser-gate-recovery'), 'index asset query should use stage12.2 cache-bust key');
expect(pkg.version === '1.6.89', 'package version should be 1.6.89');
expect(app.includes("const APP_VERSION = 'Pro v1.6.89'"), 'app version constant should be v1.4.0');
