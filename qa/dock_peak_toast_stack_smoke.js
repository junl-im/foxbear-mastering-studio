...
expect(index.includes('v1.3.79'), 'index should show v1.3.79');
expect(index.includes('1.3.79-dock-purpose-realign'), 'index asset query should use v1.3.79 cache key');
expect(pkg.version === '1.3.79', 'package version should be 1.3.79');
expect(app.includes("const APP_VERSION = 'Pro v1.3.79'"), 'app version constant should be v1.3.79');
...
expect(studioCss.includes('v1.3.79 Dock integrated waveform remote'), 'studio CSS should include v1.3.79 section');
