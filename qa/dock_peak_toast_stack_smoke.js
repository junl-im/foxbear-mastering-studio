...
expect(index.includes('v1.6.76'), 'index should show v1.6.76');
expect(index.includes('1.6.76-download-viewport-runtime-fault-diagnostics'), 'index asset query should use stage12.2 cache-bust key');
expect(pkg.version === '1.6.76', 'package version should be 1.6.76');
expect(app.includes("const APP_VERSION = 'Pro v1.6.76'"), 'app version constant should be v1.4.0');
