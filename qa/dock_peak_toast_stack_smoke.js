...
expect(index.includes('v1.3.76'), 'index should show v1.3.76');
expect(index.includes('1.3.76-dock-regression-buttonview'), 'index asset query should use v1.3.76 cache key');
expect(pkg.version === '1.3.76', 'package version should be 1.3.76');
expect(app.includes("const APP_VERSION = 'Pro v1.3.76'"), 'app version constant should be v1.3.76');
...
expect(studioCss.includes('v1.3.76 Dock integrated waveform remote'), 'studio CSS should include v1.3.76 section');
