...
expect(index.includes('v1.6.61'), 'index should show v1.6.61');
expect(index.includes('1.6.61-human-readable-download-filenames'), 'index asset query should use stage12.2 cache-bust key');
expect(pkg.version === '1.6.61', 'package version should be 1.6.61');
expect(app.includes("const APP_VERSION = 'Pro v1.6.61'"), 'app version constant should be v1.4.0');
