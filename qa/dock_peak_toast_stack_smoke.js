...
expect(index.includes('v1.7.1'), 'index should show v1.7.1');
expect(index.includes('1.7.1-reference-match-2-phase1'), 'index asset query should use stage12.2 cache-bust key');
expect(pkg.version === '1.7.1', 'package version should be 1.7.1');
expect(app.includes("const APP_VERSION = 'Pro v1.7.1'"), 'app version constant should be v1.4.0');
