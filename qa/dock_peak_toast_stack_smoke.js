...
expect(index.includes('v1.5.94'), 'index should show v1.5.94');
expect(index.includes('1.5.94-aiff-fallback-worker-diagnostics-reporting-contract'), 'index asset query should use stage12.2 cache-bust key');
expect(pkg.version === '1.5.94', 'package version should be 1.5.94');
expect(app.includes("const APP_VERSION = 'Pro v1.5.94'"), 'app version constant should be v1.4.0');
