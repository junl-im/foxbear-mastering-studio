...
expect(index.includes('v1.3.80'), 'index should show v1.3.80');
expect(index.includes('1.3.80-icons-buttonview-close'), 'index asset query should use v1.3.80 cache key');
expect(pkg.version === '1.3.80', 'package version should be 1.3.80');
expect(app.includes("const APP_VERSION = 'Pro v1.3.80'"), 'app version constant should be v1.3.80');
...
expect(studioCss.includes('v1.3.80 Dock integrated waveform remote'), 'studio CSS should include v1.3.80 section');
