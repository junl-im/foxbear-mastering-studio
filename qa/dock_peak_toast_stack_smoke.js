...
expect(index.includes('v1.6.7'), 'index should show v1.6.7');
expect(index.includes('1.6.7-incident-readiness-history-sync-performance-hud'), 'index asset query should use stage12.2 cache-bust key');
expect(pkg.version === '1.6.7', 'package version should be 1.6.7');
expect(app.includes("const APP_VERSION = 'Pro v1.6.7'"), 'app version constant should be v1.4.0');
