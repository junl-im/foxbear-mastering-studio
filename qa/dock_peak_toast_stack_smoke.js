...
expect(index.includes('v1.3.71'), 'index should show v1.3.71');
expect(index.includes('1.3.71-dock-main-action-bridge'), 'index asset query should use v1.3.71 cache key');
expect(pkg.version === '1.3.71', 'package version should be 1.3.71');
expect(app.includes("const APP_VERSION = 'Pro v1.3.71'"), 'app version constant should be v1.3.71');
...
expect(dockCss.includes('Dock main action bridge'), 'dock css should include v1.3.71 section');
