...
expect(index.includes('v1.3.77'), 'index should show v1.3.77');
expect(index.includes('1.3.77-dock-waveform-polish'), 'index asset query should use v1.3.77 cache key');
expect(pkg.version === '1.3.77', 'package version should be 1.3.77');
expect(app.includes("const APP_VERSION = 'Pro v1.3.77'"), 'app version constant should be v1.3.77');
...
expect(studioCss.includes('v1.3.77 Dock integrated waveform remote'), 'studio CSS should include v1.3.77 section');
