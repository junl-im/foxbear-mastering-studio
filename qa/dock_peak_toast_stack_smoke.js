...
expect(index.includes('v1.6.47'), 'index should show v1.6.47');
expect(index.includes('1.6.47-external-host-admin-auth-opaque-error-recovery'), 'index asset query should use stage12.2 cache-bust key');
expect(pkg.version === '1.6.47', 'package version should be 1.6.47');
expect(app.includes("const APP_VERSION = 'Pro v1.6.47'"), 'app version constant should be v1.4.0');
