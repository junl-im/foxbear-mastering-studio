...
expect(index.includes('v1.6.91'), 'index should show v1.6.91');
expect(index.includes('1.6.91-runtime-health-hidden-geometry-contract-recovery'), 'index asset query should use stage12.2 cache-bust key');
expect(pkg.version === '1.6.91', 'package version should be 1.6.91');
expect(app.includes("const APP_VERSION = 'Pro v1.6.91'"), 'app version constant should be v1.4.0');
