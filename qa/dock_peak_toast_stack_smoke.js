...
expect(index.includes('v1.7.2'), 'index should show v1.7.2');
expect(index.includes('1.7.2-expert-workspace-default-entry'), 'index asset query should use stage12.2 cache-bust key');
expect(pkg.version === '1.7.2', 'package version should be 1.7.2');
expect(app.includes("const APP_VERSION = 'Pro v1.7.2'"), 'app version constant should be v1.4.0');
