...
expect(index.includes('v1.6.71'), 'index should show v1.6.71');
expect(index.includes('1.6.71-pwa-share-lease-handoff-deploy-policy-e2e'), 'index asset query should use stage12.2 cache-bust key');
expect(pkg.version === '1.6.71', 'package version should be 1.6.71');
expect(app.includes("const APP_VERSION = 'Pro v1.6.71'"), 'app version constant should be v1.4.0');
