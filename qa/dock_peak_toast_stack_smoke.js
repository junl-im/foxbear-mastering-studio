...
expect(index.includes('v1.3.70'), 'index should show v1.3.70');
expect(index.includes('1.3.70-dock-peak-toast-stack'), 'index asset query should use v1.3.70 cache key');
expect(pkg.version === '1.3.70', 'package version should be 1.3.70');
expect(app.includes("const APP_VERSION = 'Pro v1.3.70'"), 'app version constant should be v1.3.70');
...
expect(dockCss.includes('Dock peak popup, aligned gauges'), 'dock css should include v1.3.70 section');
