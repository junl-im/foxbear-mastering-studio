...
expect(index.includes('v1.5.30'), 'index should show v1.5.30');
expect(index.includes('1.5.30-inapp-playback-recovery'), 'index asset query should use stage12.2 cache-bust key');
expect(pkg.version === '1.5.30', 'package version should be 1.5.30');
expect(app.includes("const APP_VERSION = 'Pro v1.5.30'"), 'app version constant should be v1.4.0');
