...
expect(index.includes('v1.5.41'), 'index should show v1.5.41');
expect(index.includes('1.5.41-export-eta-download-recovery'), 'index asset query should use stage12.2 cache-bust key');
expect(pkg.version === '1.5.41', 'package version should be 1.5.41');
expect(app.includes("const APP_VERSION = 'Pro v1.5.41'"), 'app version constant should be v1.4.0');
