...
expect(index.includes('v1.6.45'), 'index should show v1.6.45');
expect(index.includes('1.6.45-windows-release-gate-spark-hosting-no-app-check'), 'index asset query should use stage12.2 cache-bust key');
expect(pkg.version === '1.6.45', 'package version should be 1.6.45');
expect(app.includes("const APP_VERSION = 'Pro v1.6.45'"), 'app version constant should be v1.4.0');
