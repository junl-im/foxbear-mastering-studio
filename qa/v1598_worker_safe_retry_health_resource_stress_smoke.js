...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.2-nonblocking-health-status-design-polish'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.2-nonblocking-health-status-design-polish'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.2-nonblocking-health-status-design-polish'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.2-nonblocking-health-status-design-polish'));
...
assert(handoff.startsWith('# Handoff - v1.6.2'));
