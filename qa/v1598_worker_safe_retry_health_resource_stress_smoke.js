...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.111-ui-mode-session-contract-hardening'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.111-ui-mode-session-contract-hardening'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.111-ui-mode-session-contract-hardening'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.111-ui-mode-session-contract-hardening'));
