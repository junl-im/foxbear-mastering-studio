...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.106-browser-geometry-history-recovery'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.106-browser-geometry-history-recovery'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.106-browser-geometry-history-recovery'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.106-browser-geometry-history-recovery'));
...
assert(handoff.startsWith('# Handoff - v1.6.106'));
