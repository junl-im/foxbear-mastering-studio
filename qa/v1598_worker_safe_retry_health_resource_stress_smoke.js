...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.103-ci-hygiene-mail-routing-hardening'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.103-ci-hygiene-mail-routing-hardening'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.103-ci-hygiene-mail-routing-hardening'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.103-ci-hygiene-mail-routing-hardening'));
