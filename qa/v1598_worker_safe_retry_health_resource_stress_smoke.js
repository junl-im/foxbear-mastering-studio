...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.76-download-viewport-runtime-fault-diagnostics'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.76-download-viewport-runtime-fault-diagnostics'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.76-download-viewport-runtime-fault-diagnostics'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.76-download-viewport-runtime-fault-diagnostics'));
...
assert(handoff.startsWith('# Handoff - v1.6.76'));
