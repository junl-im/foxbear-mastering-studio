...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.105-header-dock-css-ownership-hardening'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.105-header-dock-css-ownership-hardening'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.105-header-dock-css-ownership-hardening'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.105-header-dock-css-ownership-hardening'));
...
assert(handoff.startsWith('# Handoff - v1.6.105'));
