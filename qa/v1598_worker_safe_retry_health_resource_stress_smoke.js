...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.7.1-reference-match-2-phase1'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.7.1-reference-match-2-phase1'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.7.1-reference-match-2-phase1'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.7.1-reference-match-2-phase1'));
...
assert(handoff.startsWith('# Handoff - v1.7.1'));
