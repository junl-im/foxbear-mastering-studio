...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.10-incident-readiness-contract-csp-cache-hardening'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.10-incident-readiness-contract-csp-cache-hardening'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.10-incident-readiness-contract-csp-cache-hardening'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.10-incident-readiness-contract-csp-cache-hardening'));
