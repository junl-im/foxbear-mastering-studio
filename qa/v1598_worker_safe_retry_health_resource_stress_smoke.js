...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.92-spectrum-panel-mount-lifecycle-recovery'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.92-spectrum-panel-mount-lifecycle-recovery'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.92-spectrum-panel-mount-lifecycle-recovery'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.92-spectrum-panel-mount-lifecycle-recovery'));
...
assert(handoff.startsWith('# Handoff - v1.6.92'));
