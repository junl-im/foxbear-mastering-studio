...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.78-release-generation-assist-url-playback-invalidation'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.78-release-generation-assist-url-playback-invalidation'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.78-release-generation-assist-url-playback-invalidation'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.78-release-generation-assist-url-playback-invalidation'));
...
assert(handoff.startsWith('# Handoff - v1.6.78'));
