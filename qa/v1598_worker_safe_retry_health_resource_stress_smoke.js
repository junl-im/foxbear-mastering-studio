...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.93-mobile-dock-visibility-integrity-recovery'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.93-mobile-dock-visibility-integrity-recovery'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.93-mobile-dock-visibility-integrity-recovery'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.93-mobile-dock-visibility-integrity-recovery'));
