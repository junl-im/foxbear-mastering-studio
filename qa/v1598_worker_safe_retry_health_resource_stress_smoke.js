...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.109-mastering-cooperative-pcm-responsiveness'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.109-mastering-cooperative-pcm-responsiveness'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.109-mastering-cooperative-pcm-responsiveness'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.109-mastering-cooperative-pcm-responsiveness'));
...
assert(handoff.startsWith('# Handoff - v1.6.109'));
