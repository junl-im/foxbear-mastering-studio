...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.43-google-auth-trusted-types-csp-recovery'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.43-google-auth-trusted-types-csp-recovery'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.43-google-auth-trusted-types-csp-recovery'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.43-google-auth-trusted-types-csp-recovery'));
...
assert(handoff.startsWith('# Handoff - v1.6.43'));
