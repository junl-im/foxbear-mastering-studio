...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.110-ui-mode-early-boot-recovery'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.110-ui-mode-early-boot-recovery'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.110-ui-mode-early-boot-recovery'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.110-ui-mode-early-boot-recovery'));
...
assert(handoff.startsWith('# Handoff - v1.6.110'));
