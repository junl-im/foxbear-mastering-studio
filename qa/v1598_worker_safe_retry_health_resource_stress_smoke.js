...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.65-firestore-write-fencing'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.65-firestore-write-fencing'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.65-firestore-write-fencing'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.65-firestore-write-fencing'));
