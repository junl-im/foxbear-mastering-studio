...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.104-boot-emergency-visit-privacy-hardening'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.104-boot-emergency-visit-privacy-hardening'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.104-boot-emergency-visit-privacy-hardening'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.104-boot-emergency-visit-privacy-hardening'));
...
assert(handoff.startsWith('# Handoff - v1.6.104'));
