...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.50-kakao-centered-entry-notice'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.50-kakao-centered-entry-notice'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.50-kakao-centered-entry-notice'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.50-kakao-centered-entry-notice'));
...
assert(handoff.startsWith('# Handoff - v1.6.50'));
