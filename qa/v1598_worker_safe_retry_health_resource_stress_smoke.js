...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.90-engine-control-overlay-isolation-header-contract-recovery'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.90-engine-control-overlay-isolation-header-contract-recovery'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.90-engine-control-overlay-isolation-header-contract-recovery'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.90-engine-control-overlay-isolation-header-contract-recovery'));
...
assert(handoff.startsWith('# Handoff - v1.6.90'));
