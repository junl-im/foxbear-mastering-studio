...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.74-incident-admission-spark-retention-download-memory'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.74-incident-admission-spark-retention-download-memory'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.74-incident-admission-spark-retention-download-memory'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.74-incident-admission-spark-retention-download-memory'));
...
assert(handoff.startsWith('# Handoff - v1.6.74'));
