...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.88-mobile-header-grid-ownership-recovery'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.88-mobile-header-grid-ownership-recovery'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.88-mobile-header-grid-ownership-recovery'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.88-mobile-header-grid-ownership-recovery'));
...
assert(handoff.startsWith('# Handoff - v1.6.88'));
