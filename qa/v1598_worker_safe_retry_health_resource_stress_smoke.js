...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.79-manifestless-patch-playback-retirement'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.79-manifestless-patch-playback-retirement'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.79-manifestless-patch-playback-retirement'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.79-manifestless-patch-playback-retirement'));
...
assert(handoff.startsWith('# Handoff - v1.6.79'));
