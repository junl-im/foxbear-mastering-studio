...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.64-github-desktop-delivery-contract'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.64-github-desktop-delivery-contract'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.64-github-desktop-delivery-contract'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.64-github-desktop-delivery-contract'));
