...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.39-ui-shell-partial-script-probe-isolation'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.39-ui-shell-partial-script-probe-isolation'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.39-ui-shell-partial-script-probe-isolation'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.39-ui-shell-partial-script-probe-isolation'));
...
assert(handoff.startsWith('# Handoff - v1.6.39'));
