...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.83-browser-ui-mode-fixture-source-hygiene-recovery'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.83-browser-ui-mode-fixture-source-hygiene-recovery'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.83-browser-ui-mode-fixture-source-hygiene-recovery'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.83-browser-ui-mode-fixture-source-hygiene-recovery'));
...
assert(handoff.startsWith('# Handoff - v1.6.83'));
