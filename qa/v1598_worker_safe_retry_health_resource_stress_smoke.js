...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.72-ci-safe-hygiene-self-repair'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.72-ci-safe-hygiene-self-repair'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.72-ci-safe-hygiene-self-repair'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.72-ci-safe-hygiene-self-repair'));
...
assert(handoff.startsWith('# Handoff - v1.6.72'));
