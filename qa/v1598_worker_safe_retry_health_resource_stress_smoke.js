...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.95-release-artifact-safety'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.95-release-artifact-safety'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.95-release-artifact-safety'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.95-release-artifact-safety'));
