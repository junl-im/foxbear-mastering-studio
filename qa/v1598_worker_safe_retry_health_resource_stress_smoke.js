...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.20-incident-background-sync-network-decay'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.20-incident-background-sync-network-decay'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.20-incident-background-sync-network-decay'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.20-incident-background-sync-network-decay'));
