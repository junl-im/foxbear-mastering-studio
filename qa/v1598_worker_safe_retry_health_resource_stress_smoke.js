...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.108-mastering-progress-visibility-hardening'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.108-mastering-progress-visibility-hardening'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.108-mastering-progress-visibility-hardening'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.108-mastering-progress-visibility-hardening'));
...
assert(handoff.startsWith('# Handoff - v1.6.108'));
