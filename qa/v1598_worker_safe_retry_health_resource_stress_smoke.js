...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.98-spectrum-retirement-mobile-header-integrity'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.98-spectrum-retirement-mobile-header-integrity'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.98-spectrum-retirement-mobile-header-integrity'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.98-spectrum-retirement-mobile-header-integrity'));
...
assert(handoff.startsWith('# Handoff - v1.6.98'));
