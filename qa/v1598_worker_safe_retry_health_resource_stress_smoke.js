...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.87-mobile-header-device-label-overlap-recovery'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.87-mobile-header-device-label-overlap-recovery'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.87-mobile-header-device-label-overlap-recovery'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.87-mobile-header-device-label-overlap-recovery'));
...
assert(handoff.startsWith('# Handoff - v1.6.87'));
