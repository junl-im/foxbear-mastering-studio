...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.40-ui-shell-retry-replacement-settlement'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.40-ui-shell-retry-replacement-settlement'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.40-ui-shell-retry-replacement-settlement'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.40-ui-shell-retry-replacement-settlement'));
...
assert(handoff.startsWith('# Handoff - v1.6.40'));
