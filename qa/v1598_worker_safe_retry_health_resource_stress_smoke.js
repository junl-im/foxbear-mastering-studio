...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.7.4-reload-reentry-mode-chooser'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.7.4-reload-reentry-mode-chooser'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.7.4-reload-reentry-mode-chooser'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.7.4-reload-reentry-mode-chooser'));
...
assert(handoff.startsWith('# Handoff - v1.7.4'));
