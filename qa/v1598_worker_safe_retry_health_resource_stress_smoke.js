...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.101-admin-lazyload-repo-cleanup'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.101-admin-lazyload-repo-cleanup'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.101-admin-lazyload-repo-cleanup'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.101-admin-lazyload-repo-cleanup'));
...
assert(handoff.startsWith('# Handoff - v1.6.101'));
