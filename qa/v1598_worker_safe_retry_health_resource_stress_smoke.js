...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.82-overlay-focus-ancestor-hardening'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.82-overlay-focus-ancestor-hardening'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.82-overlay-focus-ancestor-hardening'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.82-overlay-focus-ancestor-hardening'));
...
assert(handoff.startsWith('# Handoff - v1.6.82'));
