...
assert.strictEqual(pkg.foxbearRelease.buildId, 'worker-retry-health-levels');
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.5.98-worker-retry-health-levels'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.5.98-worker-retry-health-levels'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.5.98-worker-retry-health-levels'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.5.98-worker-retry-health-levels'));
...
assert(handoff.startsWith('# Handoff - v1.5.98'));
