...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.100-sw-stereo-ci-cleanup-hardening'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.100-sw-stereo-ci-cleanup-hardening'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.100-sw-stereo-ci-cleanup-hardening'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.100-sw-stereo-ci-cleanup-hardening'));
...
assert(handoff.startsWith('# Handoff - v1.6.100'));
