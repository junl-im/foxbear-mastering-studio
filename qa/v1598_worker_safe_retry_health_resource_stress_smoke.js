...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.45-windows-release-gate-spark-hosting-no-app-check'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.45-windows-release-gate-spark-hosting-no-app-check'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.45-windows-release-gate-spark-hosting-no-app-check'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.45-windows-release-gate-spark-hosting-no-app-check'));
