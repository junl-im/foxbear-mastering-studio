...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.41-admin-secret-pin-session'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.41-admin-secret-pin-session'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.41-admin-secret-pin-session'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.41-admin-secret-pin-session'));
