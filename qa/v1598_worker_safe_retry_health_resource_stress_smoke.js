...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.37-ui-shell-cross-generation-recovery'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.37-ui-shell-cross-generation-recovery'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.37-ui-shell-cross-generation-recovery'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.37-ui-shell-cross-generation-recovery'));
...
assert(handoff.startsWith('# Handoff - v1.6.37'));
