...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.42-spark-google-admin-auth'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.42-spark-google-admin-auth'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.42-spark-google-admin-auth'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.42-spark-google-admin-auth'));
