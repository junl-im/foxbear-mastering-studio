...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.7.2-expert-workspace-default-entry'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.7.2-expert-workspace-default-entry'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.7.2-expert-workspace-default-entry'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.7.2-expert-workspace-default-entry'));
...
assert(handoff.startsWith('# Handoff - v1.7.2'));
