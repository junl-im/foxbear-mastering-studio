...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.73-csp-memory-admission-runtime-config'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.73-csp-memory-admission-runtime-config'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.73-csp-memory-admission-runtime-config'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.73-csp-memory-admission-runtime-config'));
...
assert(handoff.startsWith('# Handoff - v1.6.73'));
