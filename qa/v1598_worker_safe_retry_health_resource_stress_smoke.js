...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.80-ai-mastering-expert-workspace'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.80-ai-mastering-expert-workspace'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.80-ai-mastering-expert-workspace'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.80-ai-mastering-expert-workspace'));
...
assert(handoff.startsWith('# Handoff - v1.6.80'));
