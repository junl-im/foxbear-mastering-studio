...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.46-google-auth-same-origin-network-recovery'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.46-google-auth-same-origin-network-recovery'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.46-google-auth-same-origin-network-recovery'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.46-google-auth-same-origin-network-recovery'));
