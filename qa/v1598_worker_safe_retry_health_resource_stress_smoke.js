...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.75-download-progress-admission-fallback-closure'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.75-download-progress-admission-fallback-closure'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.75-download-progress-admission-fallback-closure'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.75-download-progress-admission-fallback-closure'));
...
assert(handoff.startsWith('# Handoff - v1.6.75'));
