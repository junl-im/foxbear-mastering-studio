...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.6.97-boot-payload-delivery-privacy-hardening'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.6.97-boot-payload-delivery-privacy-hardening'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.6.97-boot-payload-delivery-privacy-hardening'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.6.97-boot-payload-delivery-privacy-hardening'));
...
assert(handoff.startsWith('# Handoff - v1.6.97'));
