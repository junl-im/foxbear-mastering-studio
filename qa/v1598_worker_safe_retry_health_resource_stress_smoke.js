...
assert(index.includes('src/boot/worker-recovery-coordinator.js?v=1.5.99-incident-callable-mail-recovery'));
assert(index.includes('src/boot/worker-recovery-app-bridge.js?v=1.5.99-incident-callable-mail-recovery'));
assert(sw.includes('./src/boot/worker-recovery-coordinator.js?v=1.5.99-incident-callable-mail-recovery'));
assert(sw.includes('./src/boot/worker-recovery-app-bridge.js?v=1.5.99-incident-callable-mail-recovery'));
