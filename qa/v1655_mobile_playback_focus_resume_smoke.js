...
assert(index.includes('src/audio/playback-lifecycle-recovery-service.js?v=1.6.111-ui-mode-session-contract-hardening'));
assert(sw.includes("'./src/audio/playback-lifecycle-recovery-service.js?v=1.6.111-ui-mode-session-contract-hardening'"));
