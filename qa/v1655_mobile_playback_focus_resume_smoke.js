...
assert(index.includes('src/audio/playback-lifecycle-recovery-service.js?v=1.6.95-release-artifact-safety'));
assert(sw.includes("'./src/audio/playback-lifecycle-recovery-service.js?v=1.6.95-release-artifact-safety'"));
