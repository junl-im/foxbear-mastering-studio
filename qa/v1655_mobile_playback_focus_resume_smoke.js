...
assert(index.includes('src/audio/playback-lifecycle-recovery-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery'));
assert(sw.includes("'./src/audio/playback-lifecycle-recovery-service.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery'"));
