...
assert(index.includes('src/audio/playback-lifecycle-recovery-service.js?v=1.6.75-download-progress-admission-fallback-closure'));
assert(sw.includes("'./src/audio/playback-lifecycle-recovery-service.js?v=1.6.75-download-progress-admission-fallback-closure'"));
