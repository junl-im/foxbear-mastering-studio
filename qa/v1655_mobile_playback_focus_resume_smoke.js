...
assert(index.includes('src/audio/playback-lifecycle-recovery-service.js?v=1.6.110-ui-mode-early-boot-recovery'));
assert(sw.includes("'./src/audio/playback-lifecycle-recovery-service.js?v=1.6.110-ui-mode-early-boot-recovery'"));
