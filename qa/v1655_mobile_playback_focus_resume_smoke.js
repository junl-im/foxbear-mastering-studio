...
assert(index.includes('src/audio/playback-lifecycle-recovery-service.js?v=1.6.105-header-dock-css-ownership-hardening'));
assert(sw.includes("'./src/audio/playback-lifecycle-recovery-service.js?v=1.6.105-header-dock-css-ownership-hardening'"));
