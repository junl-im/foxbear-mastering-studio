...
assert(index.includes('src/audio/playback-lifecycle-recovery-service.js?v=1.6.98-spectrum-retirement-mobile-header-integrity'));
assert(sw.includes("'./src/audio/playback-lifecycle-recovery-service.js?v=1.6.98-spectrum-retirement-mobile-header-integrity'"));
