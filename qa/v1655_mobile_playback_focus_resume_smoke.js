...
assert(index.includes('src/audio/playback-lifecycle-recovery-service.js?v=1.6.91-runtime-health-hidden-geometry-contract-recovery'));
assert(sw.includes("'./src/audio/playback-lifecycle-recovery-service.js?v=1.6.91-runtime-health-hidden-geometry-contract-recovery'"));
