...
assert(index.includes('src/audio/playback-lifecycle-recovery-service.js?v=1.6.74-incident-admission-spark-retention-download-memory'));
assert(sw.includes("'./src/audio/playback-lifecycle-recovery-service.js?v=1.6.74-incident-admission-spark-retention-download-memory'"));
