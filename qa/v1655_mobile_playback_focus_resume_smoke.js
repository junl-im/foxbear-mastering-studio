...
assert(index.includes('src/audio/playback-lifecycle-recovery-service.js?v=1.6.64-github-desktop-delivery-contract'));
assert(sw.includes("'./src/audio/playback-lifecycle-recovery-service.js?v=1.6.64-github-desktop-delivery-contract'"));
