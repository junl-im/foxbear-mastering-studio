...
const reporterSandbox = {
  ...
  document: {
    body: { dataset: { build: '1.6.95' } }, visibilityState: 'visible',
    getElementById: () => null,
  ...
  FoxBearBuildInfo: { productVersion: '1.6.95', assetVersion: '1.6.95-release-artifact-safety' }
};
reporterSandbox.FoxBearFirebase = {
  ...
  checkIncidentDeploymentReadiness: async () => ({
    ...
    service: { productVersion: '1.6.95', functionsOrigin: 'https://asia-northeast3-foxbear-music.cloudfunctions.net' },
    checks: {
