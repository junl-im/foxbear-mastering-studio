...
const reporterSandbox = {
  ...
  document: {
    body: { dataset: { build: '1.6.64' } }, visibilityState: 'visible',
    getElementById: () => null,
  ...
  FoxBearBuildInfo: { productVersion: '1.6.64', assetVersion: '1.6.64-github-desktop-delivery-contract' }
};
reporterSandbox.FoxBearFirebase = {
  ...
  checkIncidentDeploymentReadiness: async () => ({
    ...
    service: { productVersion: '1.6.64', functionsOrigin: 'https://asia-northeast3-foxbear-music.cloudfunctions.net' },
    checks: {
