...
const reporterSandbox = {
  ...
  document: {
    body: { dataset: { build: '1.6.65' } }, visibilityState: 'visible',
    getElementById: () => null,
  ...
  FoxBearBuildInfo: { productVersion: '1.6.65', assetVersion: '1.6.65-firestore-write-fencing' }
};
reporterSandbox.FoxBearFirebase = {
  ...
  checkIncidentDeploymentReadiness: async () => ({
    ...
    service: { productVersion: '1.6.65', functionsOrigin: 'https://asia-northeast3-foxbear-music.cloudfunctions.net' },
    checks: {
