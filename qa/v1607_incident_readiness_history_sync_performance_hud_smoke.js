...
const reporterSandbox = {
  ...
  document: {
    body: { dataset: { build: '1.6.85' } }, visibilityState: 'visible',
    getElementById: () => null,
  ...
  FoxBearBuildInfo: { productVersion: '1.6.85', assetVersion: '1.6.85-browser-sentinel-ui-mode-header-recovery' }
};
reporterSandbox.FoxBearFirebase = {
  ...
  checkIncidentDeploymentReadiness: async () => ({
    ...
    service: { productVersion: '1.6.85', functionsOrigin: 'https://asia-northeast3-foxbear-music.cloudfunctions.net' },
    checks: {
