...
const reporterSandbox = {
  ...
  document: {
    body: { dataset: { build: '1.6.86' } }, visibilityState: 'visible',
    getElementById: () => null,
  ...
  FoxBearBuildInfo: { productVersion: '1.6.86', assetVersion: '1.6.86-header-order-mobile-overflow-browser-gate-recovery' }
};
reporterSandbox.FoxBearFirebase = {
  ...
  checkIncidentDeploymentReadiness: async () => ({
    ...
    service: { productVersion: '1.6.86', functionsOrigin: 'https://asia-northeast3-foxbear-music.cloudfunctions.net' },
    checks: {
