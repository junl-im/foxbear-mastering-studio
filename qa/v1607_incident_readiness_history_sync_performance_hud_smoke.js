...
const reporterSandbox = {
  ...
  document: {
    body: { dataset: { build: '1.6.111' } }, visibilityState: 'visible',
    getElementById: () => null,
...
reporterSandbox.FoxBearFirebase = {
  ...
  checkIncidentDeploymentReadiness: async () => ({
    ...
    service: { productVersion: '1.6.111', functionsOrigin: 'https://asia-northeast3-foxbear-music.cloudfunctions.net' },
    checks: {
