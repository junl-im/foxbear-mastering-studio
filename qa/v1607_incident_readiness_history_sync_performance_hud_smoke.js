...
const reporterSandbox = {
  ...
  document: {
    body: { dataset: { build: '1.6.112' } }, visibilityState: 'visible',
    getElementById: () => null,
...
reporterSandbox.FoxBearFirebase = {
  ...
  checkIncidentDeploymentReadiness: async () => ({
    ...
    service: { productVersion: '1.6.112', functionsOrigin: 'https://asia-northeast3-foxbear-music.cloudfunctions.net' },
    checks: {
