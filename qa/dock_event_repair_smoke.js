...
must(app.includes("const APP_VERSION = 'Pro v1.6.10'"),'version');
must(html.includes('data-build="1.6.10"'),'build');
must(pkg.version==='1.6.10','package version');
must(sw.includes('foxbear-shell-v1.6.10-incident-readiness-contract-csp-cache-hardening'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.10-incident-readiness-contract-csp-cache-hardening'),'dock controller loaded');
