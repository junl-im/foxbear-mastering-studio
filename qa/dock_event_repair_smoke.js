...
must(app.includes("const APP_VERSION = 'Pro v1.3.76'"), 'app version should be v1.3.76');
must(html.includes('data-build="1.3.76"'), 'index build should be v1.3.76');
must(pkg.version === '1.3.76', 'package version should be v1.3.76');
must(sw.includes('foxbear-shell-v1.3.76-dock-regression-buttonview'), 'SW cache key should be v1.3.76');
must(html.includes('src/app.js?v=1.3.76-dock-regression-buttonview'), 'app cache-bust key should be v1.3.76');
...
must(studioCss.includes('v1.3.76 Dock integrated waveform remote'), 'studio css should include integrated waveform section');
