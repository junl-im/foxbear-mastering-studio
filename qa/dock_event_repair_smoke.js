...
must(app.includes("const APP_VERSION = 'Pro v1.6.106'"),'version');
must(html.includes('data-build="1.6.106"'),'build');
must(pkg.version==='1.6.106','package version');
must(sw.includes('foxbear-shell-v1.6.106-browser-geometry-history-recovery'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.106-browser-geometry-history-recovery'),'dock controller loaded');
