...
must(app.includes("const APP_VERSION = 'Pro v1.5.46'"),'version');
must(html.includes('data-build="1.5.46"'),'build');
must(pkg.version==='1.5.46','package version');
must(sw.includes('foxbear-shell-v1.5.46-engine-recommendation-api-audit'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.5.46-engine-recommendation-api-audit'),'dock controller loaded');
