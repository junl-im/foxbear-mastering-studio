...
must(app.includes("const APP_VERSION = 'Pro v1.6.4'"),'version');
must(html.includes('data-build="1.6.4"'),'build');
must(pkg.version==='1.6.4','package version');
must(sw.includes('foxbear-shell-v1.6.4-incident-callable-csp-recovery'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.4-incident-callable-csp-recovery'),'dock controller loaded');
