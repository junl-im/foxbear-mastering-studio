...
must(sw.includes('foxbear-shell-v1.4.0-stage21-unified-preview-system'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.4.0-stage21-unified-preview-system'),'dock controller loaded');
