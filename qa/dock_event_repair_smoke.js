...
must(sw.includes('foxbear-shell-v1.3.84-stage13-runtime-safety'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.3.84-stage13-runtime-safety'),'dock controller loaded');
