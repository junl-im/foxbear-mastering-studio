...
must(sw.includes('foxbear-shell-v1.4.0-stage26-unified-waveform-controls'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.4.0-stage26-unified-waveform-controls'),'dock controller loaded');
