...
must(sw.includes('foxbear-shell-v1.4.0-stage22-playback-link-audit'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.4.0-stage22-playback-link-audit'),'dock controller loaded');
