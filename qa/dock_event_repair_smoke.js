...
must(app.includes("const APP_VERSION = 'Pro v1.6.40'"),'version');
must(html.includes('data-build="1.6.40"'),'build');
must(pkg.version==='1.6.40','package version');
must(sw.includes('foxbear-shell-v1.6.40-ui-shell-retry-replacement-settlement'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.40-ui-shell-retry-replacement-settlement'),'dock controller loaded');
