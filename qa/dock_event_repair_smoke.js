...
must(app.includes("const APP_VERSION = 'Pro v1.6.105'"),'version');
must(html.includes('data-build="1.6.105"'),'build');
must(pkg.version==='1.6.105','package version');
must(sw.includes('foxbear-shell-v1.6.105-header-dock-css-ownership-hardening'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.105-header-dock-css-ownership-hardening'),'dock controller loaded');
