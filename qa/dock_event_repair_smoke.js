...
must(pkg.version === '1.3.81', 'package version should be v1.3.81');
must(sw.includes('foxbear-shell-v1.3.81-modal-dock-layout-integrity'), 'SW cache key should be v1.3.81');
must(html.includes('src/app.js?v=1.3.81-modal-dock-layout-integrity'), 'app cache-bust key should be v1.3.81');
...
must(studioCss.includes('v1.3.81 Dock integrated waveform remote'), 'studio css should include integrated waveform section');
