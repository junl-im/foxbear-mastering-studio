...
must(sw.includes('foxbear-shell-v1.6.63-download-filename-review-hardening'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.63-download-filename-review-hardening'),'dock controller loaded');
