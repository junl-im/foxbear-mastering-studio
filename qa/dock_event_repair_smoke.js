...
must(app.includes("const APP_VERSION = 'Pro v1.5.55'"),'version');
must(html.includes('data-build="1.5.55"'),'build');
must(pkg.version==='1.5.55','package version');
must(sw.includes('foxbear-shell-v1.5.55-automatic-incident-mail-reporting'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.5.55-automatic-incident-mail-reporting'),'dock controller loaded');
