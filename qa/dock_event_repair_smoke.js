...
must(app.includes("const APP_VERSION = 'Pro v1.5.82'"),'version');
must(html.includes('data-build="1.5.82"'),'build');
must(pkg.version==='1.5.82','package version');
must(sw.includes('foxbear-shell-v1.5.82-mastering-cancel-playback-resume-recovery'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.5.82-mastering-cancel-playback-resume-recovery'),'dock controller loaded');
