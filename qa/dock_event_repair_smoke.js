...
must(app.includes("const APP_VERSION = 'Pro v1.4.4'"),'version');
must(html.includes('data-build="1.4.4"'),'build');
must(pkg.version==='1.4.4','package version');
must(sw.includes('foxbear-shell-v1.4.4-fft-live-hotfix'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.4.4-fft-live-hotfix'),'dock controller loaded');
