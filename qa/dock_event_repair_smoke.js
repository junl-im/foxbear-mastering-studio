...
must(sw.includes('foxbear-shell-v1.4.0-stage19-highlight-diagnostics'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.4.0-stage19-highlight-diagnostics'),'dock controller loaded');
