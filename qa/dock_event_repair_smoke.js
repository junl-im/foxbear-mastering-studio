...
must(app.includes("const APP_VERSION = 'Pro v1.5.57'"),'version');
must(html.includes('data-build="1.5.57"'),'build');
must(pkg.version==='1.5.57','package version');
must(sw.includes('foxbear-shell-v1.5.57-modal-close-consistency'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.5.57-modal-close-consistency'),'dock controller loaded');
