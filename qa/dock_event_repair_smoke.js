...
must(app.includes("const APP_VERSION = 'Pro v1.6.64'"),'version');
must(html.includes('data-build="1.6.64"'),'build');
must(pkg.version==='1.6.64','package version');
must(sw.includes('foxbear-shell-v1.6.64-github-desktop-delivery-contract'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.64-github-desktop-delivery-contract'),'dock controller loaded');
