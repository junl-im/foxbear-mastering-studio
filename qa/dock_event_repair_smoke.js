...
must(app.includes("const APP_VERSION = 'Pro v1.4.24'"),'version');
must(html.includes('data-build="1.4.24"'),'build');
must(pkg.version==='1.4.24','package version');
must(sw.includes('foxbear-shell-v1.4.24-bulk-import-hud'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.4.24-bulk-import-hud'),'dock controller loaded');
