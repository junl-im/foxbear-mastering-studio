...
must(app.includes("const APP_VERSION = 'Pro v1.5.29'"),'version');
must(html.includes('data-build="1.5.29"'),'build');
must(pkg.version==='1.5.29','package version');
must(sw.includes('foxbear-shell-v1.5.29-analysis-update-lifecycle'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.5.29-analysis-update-lifecycle'),'dock controller loaded');
