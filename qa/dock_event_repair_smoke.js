...
must(app.includes("const APP_VERSION = 'Pro v1.5.37'"),'version');
must(html.includes('data-build="1.5.37"'),'build');
must(pkg.version==='1.5.37','package version');
must(sw.includes('foxbear-shell-v1.5.37-memory-import-waveform-hardening'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.5.37-memory-import-waveform-hardening'),'dock controller loaded');
