...
must(app.includes("const APP_VERSION = 'Pro v1.5.10'"),'version');
must(html.includes('data-build="1.5.10"'),'build');
must(pkg.version==='1.5.10','package version');
must(sw.includes('foxbear-shell-v1.5.10-header-settings-relocation'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.5.10-header-settings-relocation'),'dock controller loaded');
