...
must(sw.includes('foxbear-shell-v1.5.18-ci-diagnostics-pwa-readiness'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.5.18-ci-diagnostics-pwa-readiness'),'dock controller loaded');
