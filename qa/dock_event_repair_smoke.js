...
must(app.includes("const APP_VERSION = 'Pro v1.5.11'"),'version');
must(html.includes('data-build="1.5.11"'),'build');
must(pkg.version==='1.5.11','package version');
must(sw.includes('foxbear-shell-v1.5.11-audio-context-ci-stability'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.5.11-audio-context-ci-stability'),'dock controller loaded');
