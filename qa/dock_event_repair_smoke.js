...
must(app.includes("const APP_VERSION = 'Pro v1.6.50'"),'version');
must(html.includes('data-build="1.6.50"'),'build');
must(pkg.version==='1.6.50','package version');
must(sw.includes('foxbear-shell-v1.6.50-kakao-centered-entry-notice'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.50-kakao-centered-entry-notice'),'dock controller loaded');
