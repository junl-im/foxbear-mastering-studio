...
must(app.includes("const APP_VERSION = 'Pro v1.5.93'"),'version');
must(html.includes('data-build="1.5.93"'),'build');
must(pkg.version==='1.5.93','package version');
must(sw.includes('foxbear-shell-v1.5.93-external-engine-transfer-admin-export-openai-readiness'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.5.93-external-engine-transfer-admin-export-openai-readiness'),'dock controller loaded');
