...
must(app.includes("const APP_VERSION = 'Pro v1.6.79'"),'version');
must(html.includes('data-build="1.6.79"'),'build');
must(pkg.version==='1.6.79','package version');
must(sw.includes('foxbear-shell-v1.6.79-manifestless-patch-playback-retirement'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.79-manifestless-patch-playback-retirement'),'dock controller loaded');
