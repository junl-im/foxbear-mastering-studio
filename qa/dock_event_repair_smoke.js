...
must(app.includes("const APP_VERSION = 'Pro v1.6.66'"),'version');
must(html.includes('data-build="1.6.66"'),'build');
must(pkg.version==='1.6.66','package version');
must(sw.includes('foxbear-shell-v1.6.66-static-gate-hygiene-repair'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.66-static-gate-hygiene-repair'),'dock controller loaded');
