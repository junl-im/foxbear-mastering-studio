...
must(app.includes("const APP_VERSION = 'Pro v1.6.65'"),'version');
must(html.includes('data-build="1.6.65"'),'build');
must(pkg.version==='1.6.65','package version');
must(sw.includes('foxbear-shell-v1.6.65-firestore-write-fencing'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.65-firestore-write-fencing'),'dock controller loaded');
