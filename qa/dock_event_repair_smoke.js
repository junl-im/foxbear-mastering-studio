...
must(app.includes("const APP_VERSION = 'Pro v1.7.0'"),'version');
must(html.includes('data-build="1.7.0"'),'build');
must(pkg.version==='1.7.0','package version');
must(sw.includes('foxbear-shell-v1.7.0-adaptive-mastering-decision-phase1'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.7.0-adaptive-mastering-decision-phase1'),'dock controller loaded');
