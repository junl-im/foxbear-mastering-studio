...
must(app.includes("const APP_VERSION = 'Pro v1.6.58'"),'version');
must(html.includes('data-build="1.6.58"'),'build');
must(pkg.version==='1.6.58','package version');
must(sw.includes('foxbear-shell-v1.6.58-piano-transient-integrity'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.58-piano-transient-integrity'),'dock controller loaded');
