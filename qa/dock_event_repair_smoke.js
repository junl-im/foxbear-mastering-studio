...
must(app.includes("const APP_VERSION = 'Pro v1.5.47'"),'version');
must(html.includes('data-build="1.5.47"'),'build');
must(pkg.version==='1.5.47','package version');
must(sw.includes('foxbear-shell-v1.5.47-engine-edgecase-quality-gate'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.5.47-engine-edgecase-quality-gate'),'dock controller loaded');
