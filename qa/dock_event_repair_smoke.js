...
must(app.includes("const APP_VERSION = 'Pro v1.6.91'"),'version');
must(html.includes('data-build="1.6.91"'),'build');
must(pkg.version==='1.6.91','package version');
must(sw.includes('foxbear-shell-v1.6.91-runtime-health-hidden-geometry-contract-recovery'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.91-runtime-health-hidden-geometry-contract-recovery'),'dock controller loaded');
