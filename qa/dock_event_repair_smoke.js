...
must(app.includes("const APP_VERSION = 'Pro v1.6.83'"),'version');
must(html.includes('data-build="1.6.83"'),'build');
must(pkg.version==='1.6.83','package version');
must(sw.includes('foxbear-shell-v1.6.83-browser-ui-mode-fixture-source-hygiene-recovery'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.83-browser-ui-mode-fixture-source-hygiene-recovery'),'dock controller loaded');
