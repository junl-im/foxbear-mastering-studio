...
must(app.includes("const APP_VERSION = 'Pro v1.5.54'"),'version');
must(html.includes('data-build="1.5.54"'),'build');
must(pkg.version==='1.5.54','package version');
must(sw.includes('foxbear-shell-v1.5.54-quality-recovery-profiles-browser-qa'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.5.54-quality-recovery-profiles-browser-qa'),'dock controller loaded');
