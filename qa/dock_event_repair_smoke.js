...
must(app.includes("const APP_VERSION = 'Pro v1.6.104'"),'version');
must(html.includes('data-build="1.6.104"'),'build');
must(pkg.version==='1.6.104','package version');
must(sw.includes('foxbear-shell-v1.6.104-boot-emergency-visit-privacy-hardening'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.104-boot-emergency-visit-privacy-hardening'),'dock controller loaded');
