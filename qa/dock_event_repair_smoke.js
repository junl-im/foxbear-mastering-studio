...
must(sw.includes('foxbear-shell-v1.6.99-header-role-focus-integrity'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.99-header-role-focus-integrity'),'dock controller loaded');
