...
must(sw.includes('foxbear-shell-v1.3.84-stage14-runtime-recovery'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.3.84-stage14-runtime-recovery'),'dock controller loaded');
...
must(dockCss.includes('v1.3.84 Dock / Modal State Machine Refactor'),'css section');
