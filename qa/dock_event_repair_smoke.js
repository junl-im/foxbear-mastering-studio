...
must(sw.includes('foxbear-shell-v1.4.0-stage28-waveform-control-view'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.4.0-stage28-waveform-control-view'),'dock controller loaded');
