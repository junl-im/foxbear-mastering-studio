...
must(app.includes("const APP_VERSION = 'Pro v1.6.113'"),'version');
must(html.includes('data-build="1.6.113"'),'build');
must(pkg.version==='1.6.113','package version');
must(sw.includes('foxbear-shell-v1.6.113-incident-finalizer-p1-hardening'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.113-incident-finalizer-p1-hardening'),'dock controller loaded');
