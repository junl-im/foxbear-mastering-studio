...
must(app.includes("const APP_VERSION = 'Pro v1.6.84'"),'version');
must(html.includes('data-build="1.6.84"'),'build');
must(pkg.version==='1.6.84','package version');
must(sw.includes('foxbear-shell-v1.6.84-tracked-windows-cleanup-static-gate-recovery'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.84-tracked-windows-cleanup-static-gate-recovery'),'dock controller loaded');
