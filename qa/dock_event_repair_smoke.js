...
must(app.includes("const APP_VERSION = 'Pro v1.5.33'"),'version');
must(html.includes('data-build="1.5.33"'),'build');
must(pkg.version==='1.5.33','package version');
must(sw.includes('foxbear-shell-v1.5.33-codec-truth-download-hardening'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.5.33-codec-truth-download-hardening'),'dock controller loaded');
