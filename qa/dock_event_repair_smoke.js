...
must(app.includes("const APP_VERSION = 'Pro v1.6.39'"),'version');
must(html.includes('data-build="1.6.39"'),'build');
must(pkg.version==='1.6.39','package version');
must(sw.includes('foxbear-shell-v1.6.39-ui-shell-partial-script-probe-isolation'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.39-ui-shell-partial-script-probe-isolation'),'dock controller loaded');
