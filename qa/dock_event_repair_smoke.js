...
must(app.includes("const APP_VERSION = 'Pro v1.5.80'"),'version');
must(html.includes('data-build="1.5.80"'),'build');
must(pkg.version==='1.5.80','package version');
must(sw.includes('foxbear-shell-v1.5.80-mobile-return-media-focus-recovery'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.5.80-mobile-return-media-focus-recovery'),'dock controller loaded');
