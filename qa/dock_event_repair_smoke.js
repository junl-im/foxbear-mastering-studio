...
must(sw.includes('foxbear-shell-v1.4.0-stage24-settings-overlay-cleanup'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.4.0-stage24-settings-overlay-cleanup'),'dock controller loaded');
