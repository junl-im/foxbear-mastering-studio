...
must(app.includes("const APP_VERSION = 'Pro v1.6.112'"),'version');
must(html.includes('data-build="1.6.112"'),'build');
must(pkg.version==='1.6.112','package version');
must(sw.includes('foxbear-shell-v1.6.112-mastering-lifecycle-race-hardening'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.112-mastering-lifecycle-race-hardening'),'dock controller loaded');
