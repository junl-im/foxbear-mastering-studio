...
must(app.includes("const APP_VERSION = 'Pro v1.4.18'"),'version');
must(html.includes('data-build="1.4.18"'),'build');
must(pkg.version==='1.4.18','package version');
must(sw.includes('foxbear-shell-v1.4.18-download-dialog-micro-hint'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.4.18-download-dialog-micro-hint'),'dock controller loaded');
