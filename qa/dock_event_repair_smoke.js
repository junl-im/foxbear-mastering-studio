...
must(app.includes("const APP_VERSION = 'Pro v1.4.7'"),'version');
must(html.includes('data-build="1.4.7"'),'build');
must(pkg.version==='1.4.7','package version');
must(sw.includes('foxbear-shell-v1.4.7-dock-fft-removal'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.4.7-dock-fft-removal'),'dock controller loaded');
