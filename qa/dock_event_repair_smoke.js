...
must(app.includes("const APP_VERSION = 'Pro v1.5.14'"),'version');
must(html.includes('data-build="1.5.14"'),'build');
must(pkg.version==='1.5.14','package version');
must(sw.includes('foxbear-shell-v1.5.14-github-desktop-handoff-preflight'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.5.14-github-desktop-handoff-preflight'),'dock controller loaded');
