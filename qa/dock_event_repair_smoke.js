...
must(sw.includes('foxbear-shell-v1.4.0-stage16-version-release'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.4.0-stage16-version-release'),'dock controller loaded');
