...
must(app.includes("const APP_VERSION = 'Pro v1.5.68'"),'version');
must(html.includes('data-build="1.5.68"'),'build');
must(pkg.version==='1.5.68','package version');
must(sw.includes('foxbear-shell-v1.5.68-mail-delivery-verification-sender-subject-rules'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.5.68-mail-delivery-verification-sender-subject-rules'),'dock controller loaded');
