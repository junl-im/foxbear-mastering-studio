...
must(pkg.version === '1.3.80', 'package version should be v1.3.80');
must(sw.includes('foxbear-shell-v1.3.80-icons-buttonview-close'), 'SW cache key should be v1.3.80');
must(html.includes('src/app.js?v=1.3.80-icons-buttonview-close'), 'app cache-bust key should be v1.3.80');
...
must(studioCss.includes('v1.3.80 Dock integrated waveform remote'), 'studio css should include integrated waveform section');
