...
must(app.includes("const APP_VERSION = 'Pro v1.6.109'"),'version');
must(html.includes('data-build="1.6.109"'),'build');
must(pkg.version==='1.6.109','package version');
must(sw.includes('foxbear-shell-v1.6.109-mastering-cooperative-pcm-responsiveness'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.109-mastering-cooperative-pcm-responsiveness'),'dock controller loaded');
