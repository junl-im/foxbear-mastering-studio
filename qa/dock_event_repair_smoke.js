...
must(sw.includes('foxbear-shell-v1.4.0-stage23-playback-orchestration'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.4.0-stage23-playback-orchestration'),'dock controller loaded');
