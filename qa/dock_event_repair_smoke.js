...
must(sw.includes('foxbear-shell-v1.3.84-stage15-settings-panel'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.3.84-stage15-settings-panel'),'dock controller loaded');
