...
must(app.includes("const APP_VERSION = 'Pro v1.5.51'"),'version');
must(html.includes('data-build="1.5.51"'),'build');
must(pkg.version==='1.5.51','package version');
must(sw.includes('foxbear-shell-v1.5.51-ci-runtime-contract-hardening'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.5.51-ci-runtime-contract-hardening'),'dock controller loaded');
