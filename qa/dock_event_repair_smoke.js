...
must(app.includes("const APP_VERSION = 'Pro v1.5.15'"),'version');
must(html.includes('data-build="1.5.15"'),'build');
must(pkg.version==='1.5.15','package version');
must(sw.includes('foxbear-shell-v1.5.15-e2e-runtime-classification'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.5.15-e2e-runtime-classification'),'dock controller loaded');
