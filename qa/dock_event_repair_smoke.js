...
must(app.includes("const APP_VERSION = 'Pro v1.6.0'"),'version');
must(html.includes('data-build="1.6.0"'),'build');
must(pkg.version==='1.6.0','package version');
must(sw.includes('foxbear-shell-v1.6.0-incident-mail-pipeline-health'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.0-incident-mail-pipeline-health'),'dock controller loaded');
