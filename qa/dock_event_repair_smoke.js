...
must(app.includes("const APP_VERSION = 'Pro v1.5.21'"),'version');
must(html.includes('data-build="1.5.21"'),'build');
must(pkg.version==='1.5.21','package version');
must(sw.includes('foxbear-shell-v1.5.21-history-csp-console-contract-fix'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.5.21-history-csp-console-contract-fix'),'dock controller loaded');
