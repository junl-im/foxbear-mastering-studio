...
must(app.includes("const APP_VERSION = 'Pro v1.6.110'"),'version');
must(html.includes('data-build="1.6.110"'),'build');
must(pkg.version==='1.6.110','package version');
must(sw.includes('foxbear-shell-v1.6.110-ui-mode-early-boot-recovery'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.110-ui-mode-early-boot-recovery'),'dock controller loaded');
