...
must(app.includes("const APP_VERSION = 'Pro v1.6.92'"),'version');
must(html.includes('data-build="1.6.92"'),'build');
must(pkg.version==='1.6.92','package version');
must(sw.includes('foxbear-shell-v1.6.92-spectrum-panel-mount-lifecycle-recovery'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.92-spectrum-panel-mount-lifecycle-recovery'),'dock controller loaded');
