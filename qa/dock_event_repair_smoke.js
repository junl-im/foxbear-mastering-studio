...
must(app.includes("const APP_VERSION = 'Pro v1.4.11'"),'version');
must(html.includes('data-build="1.4.11"'),'build');
must(pkg.version==='1.4.11','package version');
must(sw.includes('foxbear-shell-v1.4.11-download-share-reliability'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.4.11-download-share-reliability'),'dock controller loaded');
