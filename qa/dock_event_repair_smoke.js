...
must(app.includes("const APP_VERSION = 'Pro v1.6.98'"),'version');
must(html.includes('data-build="1.6.98"'),'build');
must(pkg.version==='1.6.98','package version');
must(sw.includes('foxbear-shell-v1.6.98-spectrum-retirement-mobile-header-integrity'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.98-spectrum-retirement-mobile-header-integrity'),'dock controller loaded');
