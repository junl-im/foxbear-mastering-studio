...
must(app.includes("const APP_VERSION = 'Pro v1.6.76'"),'version');
must(html.includes('data-build="1.6.76"'),'build');
must(pkg.version==='1.6.76','package version');
must(sw.includes('foxbear-shell-v1.6.76-download-viewport-runtime-fault-diagnostics'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.76-download-viewport-runtime-fault-diagnostics'),'dock controller loaded');
