...
must(app.includes("const APP_VERSION = 'Pro v1.6.103'"),'version');
must(html.includes('data-build="1.6.103"'),'build');
must(pkg.version==='1.6.103','package version');
must(sw.includes('foxbear-shell-v1.6.103-ci-hygiene-mail-routing-hardening'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.103-ci-hygiene-mail-routing-hardening'),'dock controller loaded');
