...
must(app.includes("const APP_VERSION = 'Pro v1.5.19'"),'version');
must(html.includes('data-build="1.5.19"'),'build');
must(pkg.version==='1.5.19','package version');
must(sw.includes('foxbear-shell-v1.5.19-ci-runtime-isolation-package-hardening'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.5.19-ci-runtime-isolation-package-hardening'),'dock controller loaded');
