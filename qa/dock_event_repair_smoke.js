...
must(app.includes("const APP_VERSION = 'Pro v1.6.56'"),'version');
must(html.includes('data-build="1.6.56"'),'build');
must(pkg.version==='1.6.56','package version');
must(sw.includes('foxbear-shell-v1.6.56-playback-blob-source-resilience'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.56-playback-blob-source-resilience'),'dock controller loaded');
