...
must(sw.includes('foxbear-shell-v1.6.61-human-readable-download-filenames'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.61-human-readable-download-filenames'),'dock controller loaded');
