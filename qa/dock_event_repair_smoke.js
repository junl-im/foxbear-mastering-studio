...
must(app.includes("const APP_VERSION = 'Pro v1.6.70'"),'version');
must(html.includes('data-build="1.6.70"'),'build');
must(pkg.version==='1.6.70','package version');
must(sw.includes('foxbear-shell-v1.6.70-share-retry-policy-drift-ci-efficiency'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.70-share-retry-policy-drift-ci-efficiency'),'dock controller loaded');
