...
must(app.includes("const APP_VERSION = 'Pro v1.6.72'"),'version');
must(html.includes('data-build="1.6.72"'),'build');
must(pkg.version==='1.6.72','package version');
must(sw.includes('foxbear-shell-v1.6.72-ci-safe-hygiene-self-repair'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.72-ci-safe-hygiene-self-repair'),'dock controller loaded');
