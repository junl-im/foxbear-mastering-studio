...
must(app.includes("const APP_VERSION = 'Pro v1.4.8'"),'version');
must(html.includes('data-build="1.4.8"'),'build');
must(pkg.version==='1.4.8','package version');
must(sw.includes('foxbear-shell-v1.4.8-dock-spectrum-cleanup'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.4.8-dock-spectrum-cleanup'),'dock controller loaded');
