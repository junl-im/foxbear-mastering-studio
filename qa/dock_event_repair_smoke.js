...
must(sw.includes('foxbear-shell-v1.5.17-browser-contract-fix'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.5.17-browser-contract-fix'),'dock controller loaded');
