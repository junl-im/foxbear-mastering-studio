...
must(app.includes("const APP_VERSION = 'Pro v1.5.31'"),'version');
must(html.includes('data-build="1.5.31"'),'build');
must(pkg.version==='1.5.31','package version');
must(sw.includes('foxbear-shell-v1.5.31-player-download-stability'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.5.31-player-download-stability'),'dock controller loaded');
