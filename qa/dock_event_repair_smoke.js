...
must(app.includes("const APP_VERSION = 'Pro v1.5.13'"),'version');
must(html.includes('data-build="1.5.13"'),'build');
must(pkg.version==='1.5.13','package version');
must(sw.includes('foxbear-shell-v1.5.13-handoff-package-integrity'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.5.13-handoff-package-integrity'),'dock controller loaded');
