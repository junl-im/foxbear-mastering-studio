...
must(sw.includes('foxbear-shell-v1.6.44-google-auth-gapi-module-trusted-types-recovery'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.44-google-auth-gapi-module-trusted-types-recovery'),'dock controller loaded');
