...
must(app.includes("const APP_VERSION = 'Pro v1.6.78'"),'version');
must(html.includes('data-build="1.6.78"'),'build');
must(pkg.version==='1.6.78','package version');
must(sw.includes('foxbear-shell-v1.6.78-release-generation-assist-url-playback-invalidation'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.78-release-generation-assist-url-playback-invalidation'),'dock controller loaded');
