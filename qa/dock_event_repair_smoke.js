...
must(pkg.version === '1.3.82', 'package version should be v1.3.82');
must(sw.includes('foxbear-shell-v1.3.82-pc-dock-modal-rootfix'), 'SW cache key should be v1.3.82');
must(html.includes('src/app.js?v=1.3.82-pc-dock-modal-rootfix'), 'app cache-bust key should be v1.3.82');
...
must(studioCss.includes('v1.3.82 PC Dock / Modal Root Fix') || studioCss.includes('v1.3.82 Dock integrated waveform remote'), 'studio css should include integrated waveform section');
