...
must(app.includes("const APP_VERSION = 'Pro v1.6.93'"),'version');
must(html.includes('data-build="1.6.93"'),'build');
must(pkg.version==='1.6.93','package version');
must(sw.includes('foxbear-shell-v1.6.93-mobile-dock-visibility-integrity-recovery'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.93-mobile-dock-visibility-integrity-recovery'),'dock controller loaded');
