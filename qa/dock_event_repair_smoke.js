...
must(app.includes("const APP_VERSION = 'Pro v1.6.108'"),'version');
must(html.includes('data-build="1.6.108"'),'build');
must(pkg.version==='1.6.108','package version');
must(sw.includes('foxbear-shell-v1.6.108-mastering-progress-visibility-hardening'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.6.108-mastering-progress-visibility-hardening'),'dock controller loaded');
