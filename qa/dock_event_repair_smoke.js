...
must(app.includes("const APP_VERSION = 'Pro v1.4.2'"),'version');
must(html.includes('data-build="1.4.2"'),'build');
must(pkg.version==='1.4.2','package version');
must(sw.includes('foxbear-shell-v1.4.2-crossfade-zoom-spectrum'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.4.2-crossfade-zoom-spectrum'),'dock controller loaded');
