...
must(sw.includes('foxbear-shell-v1.4.0-stage27-waveform-control-service'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.4.0-stage27-waveform-control-service'),'dock controller loaded');
