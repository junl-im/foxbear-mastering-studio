...
must(app.includes("const APP_VERSION = 'Pro v1.4.5'"),'version');
must(html.includes('data-build="1.4.5"'),'build');
must(pkg.version==='1.4.5','package version');
must(sw.includes('foxbear-shell-v1.4.5-stability-audit'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.4.5-stability-audit'),'dock controller loaded');
