...
must(sw.includes('foxbear-shell-v1.4.0-stage25-compare-controls-rehome'),'sw cache');
must(html.includes('src/ui/dock-controller.js?v=1.4.0-stage25-compare-controls-rehome'),'dock controller loaded');
