...
assert.strictEqual(pkg.foxbearRelease.buildId, 'modal-focus-memory-diagnostics');
...
assert(handoff.startsWith('# Handoff - v1.5.96'), 'handoff must lead with the current release');
