...
assert(html.includes('data-build="1.6.58"'), 'index build should be 1.6.58');
assert(config.includes("ASSET_VERSION = '1.6.58-piano-transient-integrity'"), 'asset key should be v1.6.58 bulk import guard');
assert(sw.includes("foxbear-shell-v1.6.58-piano-transient-integrity"), 'service worker cache should be v1.6.58 bulk import guard');
