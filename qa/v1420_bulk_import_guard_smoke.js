...
assert(html.includes('data-build="1.5.66"'), 'index build should be 1.5.66');
assert(config.includes("ASSET_VERSION = '1.5.66-incident-operations-action-guard-deploy-verification'"), 'asset key should be v1.5.66 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.66-incident-operations-action-guard-deploy-verification"), 'service worker cache should be v1.5.66 bulk import guard');
