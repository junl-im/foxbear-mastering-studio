...
assert(html.includes('data-build="1.5.11"'), 'index build should be 1.5.11');
assert(config.includes("ASSET_VERSION = '1.5.11-audio-context-ci-stability'"), 'asset key should be v1.5.11 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.11-audio-context-ci-stability"), 'service worker cache should be v1.5.11 bulk import guard');
