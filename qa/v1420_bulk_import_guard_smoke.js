...
assert(html.includes('data-build="1.5.43"'), 'index build should be 1.5.43');
assert(config.includes("ASSET_VERSION = '1.5.43-export-pipeline-integrity'"), 'asset key should be v1.5.43 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.43-export-pipeline-integrity"), 'service worker cache should be v1.5.43 bulk import guard');
