...
assert(html.includes('data-build="1.5.54"'), 'index build should be 1.5.54');
assert(config.includes("ASSET_VERSION = '1.5.54-quality-recovery-profiles-browser-qa'"), 'asset key should be v1.5.54 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.54-quality-recovery-profiles-browser-qa"), 'service worker cache should be v1.5.54 bulk import guard');
