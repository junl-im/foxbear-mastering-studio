...
assert(html.includes('data-build="1.6.78"'), 'index build should be 1.6.78');
assert(config.includes("ASSET_VERSION = '1.6.78-release-generation-assist-url-playback-invalidation'"), 'asset key should be v1.6.78 bulk import guard');
assert(sw.includes("foxbear-shell-v1.6.78-release-generation-assist-url-playback-invalidation"), 'service worker cache should be v1.6.78 bulk import guard');
