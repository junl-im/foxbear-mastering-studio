...
assert(html.includes('data-build="1.7.0"'), 'index build should be 1.7.0');
assert(config.includes("ASSET_VERSION = '1.7.0-adaptive-mastering-decision-phase1'"), 'asset key should be v1.7.0 bulk import guard');
assert(sw.includes("foxbear-shell-v1.7.0-adaptive-mastering-decision-phase1"), 'service worker cache should be v1.7.0 bulk import guard');
