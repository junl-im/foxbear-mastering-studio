...
assert(html.includes('data-build="1.5.97"'), 'index build should be 1.5.97');
assert(config.includes("ASSET_VERSION = '1.5.97-worker-recovery-diagnostics'"), 'asset key should be v1.5.97 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.97-worker-recovery-diagnostics"), 'service worker cache should be v1.5.97 bulk import guard');
