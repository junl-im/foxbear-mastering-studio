...
assert(html.includes('data-build="1.6.85"'), 'index build should be 1.6.85');
assert(config.includes("ASSET_VERSION = '1.6.85-browser-sentinel-ui-mode-header-recovery'"), 'asset key should be v1.6.85 bulk import guard');
assert(sw.includes("foxbear-shell-v1.6.85-browser-sentinel-ui-mode-header-recovery"), 'service worker cache should be v1.6.85 bulk import guard');
