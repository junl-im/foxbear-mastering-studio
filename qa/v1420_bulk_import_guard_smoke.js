...
assert(html.includes('data-build="1.5.56"'), 'index build should be 1.5.56');
assert(config.includes("ASSET_VERSION = '1.5.56-incident-operations-app-check'"), 'asset key should be v1.5.56 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.56-incident-operations-app-check"), 'service worker cache should be v1.5.56 bulk import guard');
