...
assert(html.includes('data-build="1.6.0"'), 'index build should be 1.6.0');
assert(config.includes("ASSET_VERSION = '1.6.0-incident-mail-pipeline-health'"), 'asset key should be v1.6.0 bulk import guard');
assert(sw.includes("foxbear-shell-v1.6.0-incident-mail-pipeline-health"), 'service worker cache should be v1.6.0 bulk import guard');
