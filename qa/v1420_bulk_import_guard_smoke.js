...
assert(html.includes('data-build="1.5.69"'), 'index build should be 1.5.69');
assert(config.includes("ASSET_VERSION = '1.5.69-mail-receipt-confirmation-history-branded-template'"), 'asset key should be v1.5.69 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.69-mail-receipt-confirmation-history-branded-template"), 'service worker cache should be v1.5.69 bulk import guard');
