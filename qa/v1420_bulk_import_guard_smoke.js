...
assert(html.includes('data-build="1.6.63"'), 'index build should be 1.6.63');
assert(config.includes("ASSET_VERSION = '1.6.63-download-filename-review-hardening'"), 'asset key should be v1.6.63 bulk import guard');
assert(sw.includes("foxbear-shell-v1.6.63-download-filename-review-hardening"), 'service worker cache should be v1.6.63 bulk import guard');
