...
assert(html.includes('data-build="1.5.15"'), 'index build should be 1.5.15');
assert(config.includes("ASSET_VERSION = '1.5.15-e2e-runtime-classification'"), 'asset key should be v1.5.15 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.15-e2e-runtime-classification"), 'service worker cache should be v1.5.15 bulk import guard');
