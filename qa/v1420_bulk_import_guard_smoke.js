...
assert(html.includes('data-build="1.5.24"'), 'index build should be 1.5.24');
assert(config.includes("ASSET_VERSION = '1.5.24-e2e-responsive-preview-control'"), 'asset key should be v1.5.24 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.24-e2e-responsive-preview-control"), 'service worker cache should be v1.5.24 bulk import guard');
