...
assert(html.includes('data-build="1.5.33"'), 'index build should be 1.5.33');
assert(config.includes("ASSET_VERSION = '1.5.33-codec-truth-download-hardening'"), 'asset key should be v1.5.33 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.33-codec-truth-download-hardening"), 'service worker cache should be v1.5.33 bulk import guard');
