...
assert(html.includes('data-build="1.6.10"'), 'index build should be 1.6.10');
assert(config.includes("ASSET_VERSION = '1.6.10-incident-readiness-contract-csp-cache-hardening'"), 'asset key should be v1.6.10 bulk import guard');
assert(sw.includes("foxbear-shell-v1.6.10-incident-readiness-contract-csp-cache-hardening"), 'service worker cache should be v1.6.10 bulk import guard');
