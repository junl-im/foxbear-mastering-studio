...
assert(html.includes('data-build="1.5.57"'), 'index build should be 1.5.57');
assert(config.includes("ASSET_VERSION = '1.5.57-modal-close-consistency'"), 'asset key should be v1.5.57 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.57-modal-close-consistency"), 'service worker cache should be v1.5.57 bulk import guard');
