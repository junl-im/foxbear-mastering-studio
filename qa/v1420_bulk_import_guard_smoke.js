...
assert(html.includes('data-build="1.5.12"'), 'index build should be 1.5.12');
assert(config.includes("ASSET_VERSION = '1.5.12-ci-runtime-readiness'"), 'asset key should be v1.5.12 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.12-ci-runtime-readiness"), 'service worker cache should be v1.5.12 bulk import guard');
