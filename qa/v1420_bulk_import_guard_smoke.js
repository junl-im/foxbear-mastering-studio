...
assert(html.includes('data-build="1.7.4"'), 'index build should be 1.7.4');
assert(config.includes("ASSET_VERSION = '1.7.4-reload-reentry-mode-chooser'"), 'asset key should be v1.7.4 bulk import guard');
assert(sw.includes("foxbear-shell-v1.7.4-reload-reentry-mode-chooser"), 'service worker cache should be v1.7.4 bulk import guard');
