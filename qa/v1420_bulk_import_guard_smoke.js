...
assert(html.includes('data-build="1.5.96"'), 'index build should be 1.5.96');
assert(config.includes("ASSET_VERSION = '1.5.96-modal-focus-memory-diagnostics'"), 'asset key should be v1.5.96 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.96-modal-focus-memory-diagnostics"), 'service worker cache should be v1.5.96 bulk import guard');
