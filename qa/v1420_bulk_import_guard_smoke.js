...
assert(html.includes('data-build="1.5.37"'), 'index build should be 1.5.37');
assert(config.includes("ASSET_VERSION = '1.5.37-memory-import-waveform-hardening'"), 'asset key should be v1.5.37 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.37-memory-import-waveform-hardening"), 'service worker cache should be v1.5.37 bulk import guard');
