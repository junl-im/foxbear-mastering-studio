...
assert(html.includes('data-build="1.5.9"'), 'index build should be 1.5.9');
assert(config.includes("ASSET_VERSION = '1.5.9-version-display-cache-recovery'"), 'asset key should be v1.5.9 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.9-version-display-cache-recovery"), 'service worker cache should be v1.5.9 bulk import guard');
