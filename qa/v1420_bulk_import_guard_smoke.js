...
assert(html.includes('data-build="1.6.43"'), 'index build should be 1.6.43');
assert(config.includes("ASSET_VERSION = '1.6.43-google-auth-trusted-types-csp-recovery'"), 'asset key should be v1.6.43 bulk import guard');
assert(sw.includes("foxbear-shell-v1.6.43-google-auth-trusted-types-csp-recovery"), 'service worker cache should be v1.6.43 bulk import guard');
