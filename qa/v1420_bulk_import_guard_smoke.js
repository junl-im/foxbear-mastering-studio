...
assert(html.includes('data-build="1.6.71"'), 'index build should be 1.6.71');
assert(config.includes("ASSET_VERSION = '1.6.71-pwa-share-lease-handoff-deploy-policy-e2e'"), 'asset key should be v1.6.71 bulk import guard');
assert(sw.includes("foxbear-shell-v1.6.71-pwa-share-lease-handoff-deploy-policy-e2e"), 'service worker cache should be v1.6.71 bulk import guard');
