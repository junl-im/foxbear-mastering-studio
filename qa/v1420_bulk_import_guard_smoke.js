...
assert(html.includes('data-build="1.5.30"'), 'index build should be 1.5.30');
assert(config.includes("ASSET_VERSION = '1.5.30-inapp-playback-recovery'"), 'asset key should be v1.5.30 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.30-inapp-playback-recovery"), 'service worker cache should be v1.5.30 bulk import guard');
