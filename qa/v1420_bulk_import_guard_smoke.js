...
assert(html.includes('data-build="1.5.90"'), 'index build should be 1.5.90');
assert(config.includes("ASSET_VERSION = '1.5.90-browser-retry-integrity-metadata-aware-scope'"), 'asset key should be v1.5.90 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.90-browser-retry-integrity-metadata-aware-scope"), 'service worker cache should be v1.5.90 bulk import guard');
