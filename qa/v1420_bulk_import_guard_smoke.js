...
assert(html.includes('data-build="1.6.64"'), 'index build should be 1.6.64');
assert(config.includes("ASSET_VERSION = '1.6.64-github-desktop-delivery-contract'"), 'asset key should be v1.6.64 bulk import guard');
assert(sw.includes("foxbear-shell-v1.6.64-github-desktop-delivery-contract"), 'service worker cache should be v1.6.64 bulk import guard');
