...
assert(html.includes('data-build="1.5.28"'), 'index build should be 1.5.28');
assert(config.includes("ASSET_VERSION = '1.5.28-resilience-lifecycle-offline-recovery'"), 'asset key should be v1.5.28 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.28-resilience-lifecycle-offline-recovery"), 'service worker cache should be v1.5.28 bulk import guard');
