...
assert(html.includes('data-build="1.6.73"'), 'index build should be 1.6.73');
assert(config.includes("ASSET_VERSION = '1.6.73-csp-memory-admission-runtime-config'"), 'asset key should be v1.6.73 bulk import guard');
assert(sw.includes("foxbear-shell-v1.6.73-csp-memory-admission-runtime-config"), 'service worker cache should be v1.6.73 bulk import guard');
