...
assert(html.includes('data-build="1.6.111"'), 'index build should be 1.6.111');
assert(config.includes("ASSET_VERSION = '1.6.111-ui-mode-session-contract-hardening'"), 'asset key should be v1.6.111 bulk import guard');
assert(sw.includes("foxbear-shell-v1.6.111-ui-mode-session-contract-hardening"), 'service worker cache should be v1.6.111 bulk import guard');
