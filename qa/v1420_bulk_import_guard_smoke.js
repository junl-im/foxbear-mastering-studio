...
assert(html.includes('data-build="1.5.22"'), 'index build should be 1.5.22');
assert(config.includes("ASSET_VERSION = '1.5.22-header-preview-routing-polish'"), 'asset key should be v1.5.22 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.22-header-preview-routing-polish"), 'service worker cache should be v1.5.22 bulk import guard');
