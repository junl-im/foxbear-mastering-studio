...
assert(html.includes('data-build="1.5.19"'), 'index build should be 1.5.19');
assert(config.includes("ASSET_VERSION = '1.5.19-ci-runtime-isolation-package-hardening'"), 'asset key should be v1.5.19 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.19-ci-runtime-isolation-package-hardening"), 'service worker cache should be v1.5.19 bulk import guard');
