...
assert(html.includes('data-build="1.5.20"'), 'index build should be 1.5.20');
assert(config.includes("ASSET_VERSION = '1.5.20-idempotent-pwa-cache-warm'"), 'asset key should be v1.5.20 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.20-idempotent-pwa-cache-warm"), 'service worker cache should be v1.5.20 bulk import guard');
