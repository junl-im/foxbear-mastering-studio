...
assert(html.includes('data-build="1.5.34"'), 'index build should be 1.5.34');
assert(config.includes("ASSET_VERSION = '1.5.34-kakao-landing-recovery'"), 'asset key should be v1.5.34 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.34-kakao-landing-recovery"), 'service worker cache should be v1.5.34 bulk import guard');
