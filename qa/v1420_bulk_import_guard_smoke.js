...
assert(html.includes('data-build="1.6.70"'), 'index build should be 1.6.70');
assert(config.includes("ASSET_VERSION = '1.6.70-share-retry-policy-drift-ci-efficiency'"), 'asset key should be v1.6.70 bulk import guard');
assert(sw.includes("foxbear-shell-v1.6.70-share-retry-policy-drift-ci-efficiency"), 'service worker cache should be v1.6.70 bulk import guard');
