...
assert(html.includes('data-build="1.6.94"'), 'index build should be 1.6.94');
assert(config.includes("ASSET_VERSION = '1.6.94-release-integrity-hardening'"), 'asset key should be v1.6.94 bulk import guard');
assert(sw.includes("foxbear-shell-v1.6.94-release-integrity-hardening"), 'service worker cache should be v1.6.94 bulk import guard');
