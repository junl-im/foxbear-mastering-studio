...
assert(html.includes('data-build="1.5.21"'), 'index build should be 1.5.21');
assert(config.includes("ASSET_VERSION = '1.5.21-history-csp-console-contract-fix'"), 'asset key should be v1.5.21 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.21-history-csp-console-contract-fix"), 'service worker cache should be v1.5.21 bulk import guard');
