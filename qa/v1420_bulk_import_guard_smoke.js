...
assert(html.includes('data-build="1.6.86"'), 'index build should be 1.6.86');
assert(config.includes("ASSET_VERSION = '1.6.86-header-order-mobile-overflow-browser-gate-recovery'"), 'asset key should be v1.6.86 bulk import guard');
assert(sw.includes("foxbear-shell-v1.6.86-header-order-mobile-overflow-browser-gate-recovery"), 'service worker cache should be v1.6.86 bulk import guard');
