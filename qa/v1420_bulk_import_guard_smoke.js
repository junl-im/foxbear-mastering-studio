...
assert(html.includes('data-build="1.6.65"'), 'index build should be 1.6.65');
assert(config.includes("ASSET_VERSION = '1.6.65-firestore-write-fencing'"), 'asset key should be v1.6.65 bulk import guard');
assert(sw.includes("foxbear-shell-v1.6.65-firestore-write-fencing"), 'service worker cache should be v1.6.65 bulk import guard');
