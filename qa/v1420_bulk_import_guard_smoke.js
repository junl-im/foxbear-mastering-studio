...
assert(html.includes('data-build="1.5.10"'), 'index build should be 1.5.10');
assert(config.includes("ASSET_VERSION = '1.5.10-header-settings-relocation'"), 'asset key should be v1.5.10 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.10-header-settings-relocation"), 'service worker cache should be v1.5.10 bulk import guard');
