...
assert(html.includes('data-build="1.6.37"'), 'index build should be 1.6.37');
assert(config.includes("ASSET_VERSION = '1.6.37-ui-shell-cross-generation-recovery'"), 'asset key should be v1.6.37 bulk import guard');
assert(sw.includes("foxbear-shell-v1.6.37-ui-shell-cross-generation-recovery"), 'service worker cache should be v1.6.37 bulk import guard');
