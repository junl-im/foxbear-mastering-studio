...
assert(html.includes('data-build="1.5.65"'), 'index build should be 1.5.65');
assert(config.includes("ASSET_VERSION = '1.5.65-incident-recovery-control-alert-history'"), 'asset key should be v1.5.65 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.65-incident-recovery-control-alert-history"), 'service worker cache should be v1.5.65 bulk import guard');
