...
assert(html.includes('data-build="1.5.45"'), 'index build should be 1.5.45');
assert(config.includes("ASSET_VERSION = '1.5.45-export-queue-recovery'"), 'asset key should be v1.5.45 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.45-export-queue-recovery"), 'service worker cache should be v1.5.45 bulk import guard');
