...
assert(html.includes('data-build="1.5.49"'), 'index build should be 1.5.49');
assert(config.includes("ASSET_VERSION = '1.5.49-asset-generation-route-recovery'"), 'asset key should be v1.5.49 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.49-asset-generation-route-recovery"), 'service worker cache should be v1.5.49 bulk import guard');
