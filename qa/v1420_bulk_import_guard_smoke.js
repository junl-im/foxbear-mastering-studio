...
assert(html.includes('data-build="1.5.73"'), 'index build should be 1.5.73');
assert(config.includes("ASSET_VERSION = '1.5.73-bulk-control-eta-result-filter-ui'"), 'asset key should be v1.5.73 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.73-bulk-control-eta-result-filter-ui"), 'service worker cache should be v1.5.73 bulk import guard');
