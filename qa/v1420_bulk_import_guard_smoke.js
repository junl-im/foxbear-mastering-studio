...
assert(html.includes('data-build="1.5.18"'), 'index build should be 1.5.18');
assert(config.includes("ASSET_VERSION = '1.5.18-ci-diagnostics-pwa-readiness'"), 'asset key should be v1.5.18 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.18-ci-diagnostics-pwa-readiness"), 'service worker cache should be v1.5.18 bulk import guard');
