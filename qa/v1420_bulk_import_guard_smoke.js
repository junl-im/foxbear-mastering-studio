...
assert(html.includes('data-build="1.6.84"'), 'index build should be 1.6.84');
assert(config.includes("ASSET_VERSION = '1.6.84-tracked-windows-cleanup-static-gate-recovery'"), 'asset key should be v1.6.84 bulk import guard');
assert(sw.includes("foxbear-shell-v1.6.84-tracked-windows-cleanup-static-gate-recovery"), 'service worker cache should be v1.6.84 bulk import guard');
