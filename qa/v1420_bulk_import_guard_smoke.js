...
assert(html.includes('data-build="1.6.39"'), 'index build should be 1.6.39');
assert(config.includes("ASSET_VERSION = '1.6.39-ui-shell-partial-script-probe-isolation'"), 'asset key should be v1.6.39 bulk import guard');
assert(sw.includes("foxbear-shell-v1.6.39-ui-shell-partial-script-probe-isolation"), 'service worker cache should be v1.6.39 bulk import guard');
