...
assert(html.includes('data-build="1.6.25"'), 'index build should be 1.6.25');
assert(config.includes("ASSET_VERSION = '1.6.25-incident-recovery-timeout-abort-stress'"), 'asset key should be v1.6.25 bulk import guard');
assert(sw.includes("foxbear-shell-v1.6.25-incident-recovery-timeout-abort-stress"), 'service worker cache should be v1.6.25 bulk import guard');
