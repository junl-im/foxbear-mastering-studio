...
assert(html.includes('data-build="1.5.36"'), 'index build should be 1.5.36');
assert(config.includes("ASSET_VERSION = '1.5.36-interaction-lifecycle-hardening'"), 'asset key should be v1.5.36 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.36-interaction-lifecycle-hardening"), 'service worker cache should be v1.5.36 bulk import guard');
