...
assert(html.includes('data-build="1.5.93"'), 'index build should be 1.5.93');
assert(config.includes("ASSET_VERSION = '1.5.93-external-engine-transfer-admin-export-openai-readiness'"), 'asset key should be v1.5.93 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.93-external-engine-transfer-admin-export-openai-readiness"), 'service worker cache should be v1.5.93 bulk import guard');
