...
assert(html.includes('data-build="1.5.29"'), 'index build should be 1.5.29');
assert(config.includes("ASSET_VERSION = '1.5.29-analysis-update-lifecycle'"), 'asset key should be v1.5.29 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.29-analysis-update-lifecycle"), 'service worker cache should be v1.5.29 bulk import guard');
