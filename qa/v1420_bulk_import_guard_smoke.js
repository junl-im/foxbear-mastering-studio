...
assert(html.includes('data-build="1.5.38"'), 'index build should be 1.5.38');
assert(config.includes("ASSET_VERSION = '1.5.38-preflight-worker-multitab-hardening'"), 'asset key should be v1.5.38 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.38-preflight-worker-multitab-hardening"), 'service worker cache should be v1.5.38 bulk import guard');
