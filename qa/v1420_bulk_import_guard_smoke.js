...
assert(html.includes('data-build="1.5.74"'), 'index build should be 1.5.74');
assert(config.includes("ASSET_VERSION = '1.5.74-bulk-pause-skip-reorder-mobile-download'"), 'asset key should be v1.5.74 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.74-bulk-pause-skip-reorder-mobile-download"), 'service worker cache should be v1.5.74 bulk import guard');
