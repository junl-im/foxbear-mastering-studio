...
assert(html.includes('data-build="1.5.50"'), 'index build should be 1.5.50');
assert(config.includes("ASSET_VERSION = '1.5.50-pwa-current-cache-test-recovery'"), 'asset key should be v1.5.50 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.50-pwa-current-cache-test-recovery"), 'service worker cache should be v1.5.50 bulk import guard');
