...
assert(html.includes('data-build="1.6.98"'), 'index build should be 1.6.98');
assert(config.includes("ASSET_VERSION = '1.6.98-spectrum-retirement-mobile-header-integrity'"), 'asset key should be v1.6.98 bulk import guard');
assert(sw.includes("foxbear-shell-v1.6.98-spectrum-retirement-mobile-header-integrity"), 'service worker cache should be v1.6.98 bulk import guard');
