...
assert(html.includes('data-build="1.5.81"'), 'index build should be 1.5.81');
assert(config.includes("ASSET_VERSION = '1.5.81-master-preview-cancellation-native-result-isolation'"), 'asset key should be v1.5.81 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.81-master-preview-cancellation-native-result-isolation"), 'service worker cache should be v1.5.81 bulk import guard');
