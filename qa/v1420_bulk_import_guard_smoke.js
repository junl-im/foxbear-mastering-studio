...
assert(html.includes('data-build="1.6.72"'), 'index build should be 1.6.72');
assert(config.includes("ASSET_VERSION = '1.6.72-ci-safe-hygiene-self-repair'"), 'asset key should be v1.6.72 bulk import guard');
assert(sw.includes("foxbear-shell-v1.6.72-ci-safe-hygiene-self-repair"), 'service worker cache should be v1.6.72 bulk import guard');
