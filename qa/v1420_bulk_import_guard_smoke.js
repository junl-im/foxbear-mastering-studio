...
assert(html.includes('data-build="1.5.23"'), 'index build should be 1.5.23');
assert(config.includes("ASSET_VERSION = '1.5.23-e2e-preview-readiness'"), 'asset key should be v1.5.23 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.23-e2e-preview-readiness"), 'service worker cache should be v1.5.23 bulk import guard');
