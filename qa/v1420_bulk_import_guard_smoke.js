...
assert(html.includes('data-build="1.6.66"'), 'index build should be 1.6.66');
assert(config.includes("ASSET_VERSION = '1.6.66-static-gate-hygiene-repair'"), 'asset key should be v1.6.66 bulk import guard');
assert(sw.includes("foxbear-shell-v1.6.66-static-gate-hygiene-repair"), 'service worker cache should be v1.6.66 bulk import guard');
