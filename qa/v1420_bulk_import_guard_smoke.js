...
assert(html.includes('data-build="1.6.83"'), 'index build should be 1.6.83');
assert(config.includes("ASSET_VERSION = '1.6.83-browser-ui-mode-fixture-source-hygiene-recovery'"), 'asset key should be v1.6.83 bulk import guard');
assert(sw.includes("foxbear-shell-v1.6.83-browser-ui-mode-fixture-source-hygiene-recovery"), 'service worker cache should be v1.6.83 bulk import guard');
