...
assert(html.includes('data-build="1.5.25"'), 'index build should be 1.5.25');
assert(config.includes("ASSET_VERSION = '1.5.25-e2e-preview-stability'"), 'asset key should be v1.5.25 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.25-e2e-preview-stability"), 'service worker cache should be v1.5.25 bulk import guard');
