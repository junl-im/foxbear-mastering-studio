...
assert(html.includes('data-build="1.6.49"'), 'index build should be 1.6.49');
assert(config.includes("ASSET_VERSION = '1.6.49-download-variant-cache-reuse'"), 'asset key should be v1.6.49 bulk import guard');
assert(sw.includes("foxbear-shell-v1.6.49-download-variant-cache-reuse"), 'service worker cache should be v1.6.49 bulk import guard');
