...
assert(html.includes('data-build="1.6.34"'), 'index build should be 1.6.34');
assert(config.includes("ASSET_VERSION = '1.6.34-history-hard-stall-sw-activity-lifecycle'"), 'asset key should be v1.6.34 bulk import guard');
assert(sw.includes("foxbear-shell-v1.6.34-history-hard-stall-sw-activity-lifecycle"), 'service worker cache should be v1.6.34 bulk import guard');
