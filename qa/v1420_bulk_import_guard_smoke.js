...
assert(html.includes('data-build="1.5.31"'), 'index build should be 1.5.31');
assert(config.includes("ASSET_VERSION = '1.5.31-player-download-stability'"), 'asset key should be v1.5.31 bulk import guard');
assert(sw.includes("foxbear-shell-v1.5.31-player-download-stability"), 'service worker cache should be v1.5.31 bulk import guard');
