...
must(index.includes('1.4.20-bulk-import-guard'), 'index asset key should be v1.4.20 cache key');
must(sw.includes('foxbear-shell-v1.4.20-bulk-import-guard'), 'service worker cache should be bumped');
...
must(!index.includes('id="bottomPreviewSpectrum"'), 'Dock mini spectrum host should be removed in v1.4.20');
...
must(pkg.qaChecks.includes('node qa/v142_crossfade_zoom_spectrum_smoke.js'), 'v1.4.20 smoke should be in package qaChecks');

console.log('PASS v1.4.20 crossfade zoom spectrum smoke');
