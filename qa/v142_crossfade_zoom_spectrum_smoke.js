...
must(index.includes('1.4.7-dock-fft-removal'), 'index asset key should be v1.4.7 cache key');
must(sw.includes('foxbear-shell-v1.4.7-dock-fft-removal'), 'service worker cache should be bumped');
...
must(!index.includes('id="bottomPreviewSpectrum"'), 'Dock mini spectrum host should be removed in v1.4.7');
...
must(pkg.qaChecks.includes('node qa/v142_crossfade_zoom_spectrum_smoke.js'), 'v1.4.7 smoke should be in package qaChecks');

console.log('PASS v1.4.7 crossfade zoom spectrum smoke');
