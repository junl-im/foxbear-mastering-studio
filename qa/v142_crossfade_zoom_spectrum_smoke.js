...
must(index.includes('1.6.59-readiness-corp-security-hardening'), 'index asset key should be v1.6.59 cache key');
must(sw.includes('foxbear-shell-v1.6.59-readiness-corp-security-hardening'), 'service worker cache should be bumped');
...
must(!index.includes('id="bottomPreviewSpectrum"'), 'Dock mini spectrum host should be removed in v1.6.59');
...
must(pkg.qaChecks.includes('node qa/v142_crossfade_zoom_spectrum_smoke.js'), 'v1.6.59 smoke should be in package qaChecks');
