...
must(index.includes('id="bottomPreviewSpectrum"'), 'Dock mini spectrum host missing');
must(app.includes('bottomPreviewSpectrum'), 'Dock mini spectrum element not cached');
must(app.includes('function renderBottomMiniSpectrum'), 'Dock mini spectrum renderer missing');
must(spectrum.includes('miniCanvases: new Set()'), 'spectrum visualizer should manage mini canvases');
must(spectrum.includes('function renderMini'), 'spectrum visualizer renderMini missing');
must(spectrum.includes('spectrum-mini-panel'), 'mini spectrum markup missing');
must(spectrumCss.includes('.spectrum-mini-panel'), 'mini spectrum CSS missing');
