...
must(index.includes('1.6.40-ui-shell-retry-replacement-settlement'), 'index asset key should be v1.6.40 cache key');
must(sw.includes('foxbear-shell-v1.6.40-ui-shell-retry-replacement-settlement'), 'service worker cache should be bumped');
...
must(!index.includes('id="bottomPreviewSpectrum"'), 'Dock mini spectrum host should be removed in v1.6.40');
...
must(pkg.qaChecks.includes('node qa/v142_crossfade_zoom_spectrum_smoke.js'), 'v1.6.40 smoke should be in package qaChecks');
