...
must(index.includes('1.5.51-ci-runtime-contract-hardening'), 'index asset key should be v1.5.51 cache key');
must(sw.includes('foxbear-shell-v1.5.51-ci-runtime-contract-hardening'), 'service worker cache should be bumped');
...
must(!index.includes('id="bottomPreviewSpectrum"'), 'Dock mini spectrum host should be removed in v1.5.51');
...
must(pkg.qaChecks.includes('node qa/v142_crossfade_zoom_spectrum_smoke.js'), 'v1.5.51 smoke should be in package qaChecks');
