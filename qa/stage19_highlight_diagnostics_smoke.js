...
assert(sw.includes(`foxbear-shell-v1.4.0-stage24-settings-overlay-cleanup`), 'service worker cache should use Stage19 key');
...
assert(overwrite.includes('v1.4.0-stage24'), 'overwrite package default should be Stage19');
