...
assert(sw.includes(`foxbear-shell-v1.4.26-wake-lock-state-sync`), 'service worker cache should use Stage19 key');
...
assert(overwrite.includes('v1.4.26'), 'overwrite package default should be Stage19');
