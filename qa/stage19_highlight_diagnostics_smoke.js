...
assert(sw.includes(`foxbear-shell-v1.4.18-download-dialog-micro-hint`), 'service worker cache should use Stage19 key');
...
assert(overwrite.includes('v1.4.18'), 'overwrite package default should be Stage19');
