...
assert(sw.includes(`foxbear-shell-v1.4.0-stage22-playback-link-audit`), 'service worker cache should use Stage19 key');
...
assert(overwrite.includes('v1.4.0-stage22'), 'overwrite package default should be Stage19');
