...
assert(sw.includes(`foxbear-shell-v1.4.4-fft-live-hotfix`), 'service worker cache should use Stage19 key');
...
assert(overwrite.includes('v1.4.4'), 'overwrite package default should be Stage19');
