...
assert(sw.includes(`foxbear-shell-v1.4.6-stability-polish`), 'service worker cache should use Stage19 key');
...
assert(overwrite.includes('v1.4.6'), 'overwrite package default should be Stage19');
