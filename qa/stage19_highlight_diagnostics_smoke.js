...
assert(sw.includes(`foxbear-shell-v1.4.7-dock-fft-removal`), 'service worker cache should use Stage19 key');
...
assert(overwrite.includes('v1.4.7'), 'overwrite package default should be Stage19');
