...
assert(sw.includes(`foxbear-shell-v1.4.2-crossfade-zoom-spectrum`), 'service worker cache should use Stage19 key');
...
assert(overwrite.includes('v1.4.2'), 'overwrite package default should be Stage19');
