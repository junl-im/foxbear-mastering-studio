...
assert(sw.includes(`foxbear-shell-v1.4.20-bulk-import-guard`), 'service worker cache should use Stage19 key');
...
assert(overwrite.includes('v1.4.20'), 'overwrite package default should be Stage19');
