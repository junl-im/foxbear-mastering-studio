...
assert(html.includes('v1.6.72'), 'index version updated');
assert(app.includes("const APP_VERSION = 'Pro v1.6.72'"), 'app version updated');
...
assert(pkg.version === '1.6.72', 'package version updated');
