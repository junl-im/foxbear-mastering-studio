...
assert(html.includes('v1.4.2'), 'index version updated');
assert(app.includes("const APP_VERSION = 'Pro v1.4.2'"), 'app version updated');
...
assert(pkg.version === '1.4.2', 'package version updated');
