...
assert(html.includes('v1.3.79'), 'index version updated');
assert(app.includes("const APP_VERSION = 'Pro v1.3.79'"), 'app version updated');
...
assert(pkg.version === '1.3.79', 'package version updated');
