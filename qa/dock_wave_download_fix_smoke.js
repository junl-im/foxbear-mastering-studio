...
assert(html.includes('v1.3.78'), 'index version updated');
assert(app.includes("const APP_VERSION = 'Pro v1.3.78'"), 'app version updated');
...
assert(pkg.version === '1.3.78', 'package version updated');
