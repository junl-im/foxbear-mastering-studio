...
assert(html.includes('v1.4.8'), 'index version updated');
assert(app.includes("const APP_VERSION = 'Pro v1.4.8'"), 'app version updated');
...
assert(pkg.version === '1.4.8', 'package version updated');
