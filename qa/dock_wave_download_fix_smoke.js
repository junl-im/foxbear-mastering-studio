...
assert(html.includes('v1.4.23'), 'index version updated');
assert(app.includes("const APP_VERSION = 'Pro v1.4.23'"), 'app version updated');
...
assert(pkg.version === '1.4.23', 'package version updated');
