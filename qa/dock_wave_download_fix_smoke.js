...
assert(html.includes('v1.6.41'), 'index version updated');
assert(app.includes("const APP_VERSION = 'Pro v1.6.41'"), 'app version updated');
...
assert(pkg.version === '1.6.41', 'package version updated');
