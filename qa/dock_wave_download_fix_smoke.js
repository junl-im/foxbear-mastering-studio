...
assert(html.includes('v1.7.0'), 'index version updated');
assert(app.includes("const APP_VERSION = 'Pro v1.7.0'"), 'app version updated');
...
assert(pkg.version === '1.7.0', 'package version updated');
