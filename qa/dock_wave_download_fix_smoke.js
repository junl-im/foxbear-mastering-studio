...
assert(html.includes('v1.7.1'), 'index version updated');
assert(app.includes("const APP_VERSION = 'Pro v1.7.1'"), 'app version updated');
...
assert(pkg.version === '1.7.1', 'package version updated');
