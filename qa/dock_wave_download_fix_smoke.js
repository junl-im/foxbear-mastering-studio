...
assert(html.includes('v1.5.73'), 'index version updated');
assert(app.includes("const APP_VERSION = 'Pro v1.5.73'"), 'app version updated');
...
assert(pkg.version === '1.5.73', 'package version updated');
