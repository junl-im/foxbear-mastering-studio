...
assert(html.includes('v1.5.20'), 'index version updated');
assert(app.includes("const APP_VERSION = 'Pro v1.5.20'"), 'app version updated');
...
assert(pkg.version === '1.5.20', 'package version updated');
