...
assert(html.includes('v1.6.20'), 'index version updated');
assert(app.includes("const APP_VERSION = 'Pro v1.6.20'"), 'app version updated');
...
assert(pkg.version === '1.6.20', 'package version updated');
