...
assert(html.includes('v1.6.42'), 'index version updated');
assert(app.includes("const APP_VERSION = 'Pro v1.6.42'"), 'app version updated');
...
assert(pkg.version === '1.6.42', 'package version updated');
