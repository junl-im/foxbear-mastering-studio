...
assert(html.includes('v1.3.77'), 'index version updated');
assert(app.includes("const APP_VERSION = 'Pro v1.3.77'"), 'app version updated');
...
assert(pkg.version === '1.3.77', 'package version updated');
