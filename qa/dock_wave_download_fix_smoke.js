...
assert(html.includes('v1.3.83'), 'index version updated');
assert(app.includes("const APP_VERSION = 'Pro v1.3.83'"), 'app version updated');
...
assert(pkg.version === '1.3.83', 'package version updated');
