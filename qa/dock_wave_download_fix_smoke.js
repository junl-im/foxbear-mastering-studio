...
assert(html.includes('v1.5.58'), 'index version updated');
assert(app.includes("const APP_VERSION = 'Pro v1.5.58'"), 'app version updated');
...
assert(pkg.version === '1.5.58', 'package version updated');
