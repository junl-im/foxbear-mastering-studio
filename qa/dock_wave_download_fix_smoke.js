...
assert(html.includes('v1.6.97'), 'index version updated');
assert(app.includes("const APP_VERSION = 'Pro v1.6.97'"), 'app version updated');
...
assert(pkg.version === '1.6.97', 'package version updated');
