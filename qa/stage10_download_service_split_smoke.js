...
assert(sw.includes('./src/download/download-service.js?v=1.3.84-stage13-runtime-safety'), 'service worker should precache download service');
assert(/stage(?:10|11|12|13)/.test(sw), 'service worker cache should be bumped to stage10');
