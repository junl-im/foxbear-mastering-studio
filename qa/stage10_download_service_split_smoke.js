...
assert(sw.includes('./src/download/download-service.js?v=1.4.0-stage16-version-release'), 'service worker should precache download service');
assert(/stage(?:10|11|12|13|14|15|16)/.test(sw), 'service worker cache should be bumped to stage10');
