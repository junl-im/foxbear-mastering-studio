# Browser / Download QA Matrix - v1.4.21
...
## v1.4.21 Download recovery compact checklist
...
- v1.4.21 stability focus: confirm debounce, navigation guard, and Dock mini FFT removal remain valid.
...
- v1.4.21 Download flow polish: recommended flow card, advanced actions hidden behind 추가 옵션, and diagnostics copy / 진단 복사 remain available.
