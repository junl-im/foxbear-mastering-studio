# Browser / Download QA Matrix - v1.4.18

## v1.4.18 Download action clarity
...
## v1.4.18 Download recovery compact checklist
...
- v1.4.18 stability focus: confirm debounce, navigation guard, and Dock mini FFT removal remain valid.
...
- v1.4.18 Download flow polish: recommended flow card, advanced actions hidden behind 추가 옵션, and diagnostics copy / 진단 복사 remain available.
