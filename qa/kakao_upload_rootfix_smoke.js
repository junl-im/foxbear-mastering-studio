...
must(html.includes('data-build="1.5.58"'), 'index data-build must be v1.5.58');
...
must(html.includes('src/app.js?v=1.5.58-kakao-mastering-runtime-recovery'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.58-kakao-mastering-runtime-recovery'), 'SW cache key missing');
