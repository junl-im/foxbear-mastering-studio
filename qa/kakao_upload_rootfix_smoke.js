...
must(html.includes('data-build="1.6.44"'), 'index data-build must be v1.6.44');
...
must(html.includes('src/app.js?v=1.6.44-google-auth-gapi-module-trusted-types-recovery'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.44-google-auth-gapi-module-trusted-types-recovery'), 'SW cache key missing');
