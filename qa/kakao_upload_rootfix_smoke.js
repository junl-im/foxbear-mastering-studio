...
must(html.includes('data-build="1.6.95"'), 'index data-build must be v1.6.95');
...
must(html.includes('src/app.js?v=1.6.95-release-artifact-safety'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.95-release-artifact-safety'), 'SW cache key missing');
