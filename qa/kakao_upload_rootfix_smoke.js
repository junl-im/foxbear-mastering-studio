...
must(html.includes('data-build="1.5.11"'), 'index data-build must be v1.5.11');
...
must(html.includes('src/app.js?v=1.5.11-audio-context-ci-stability'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.11-audio-context-ci-stability'), 'SW cache key missing');
