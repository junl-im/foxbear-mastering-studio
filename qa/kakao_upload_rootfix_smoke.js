...
must(html.includes('data-build="1.6.37"'), 'index data-build must be v1.6.37');
...
must(html.includes('src/app.js?v=1.6.37-ui-shell-cross-generation-recovery'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.37-ui-shell-cross-generation-recovery'), 'SW cache key missing');
