...
must(app.includes("const APP_VERSION = 'Pro v1.3.75'"), 'app version must be v1.3.75');
must(html.includes('data-build="1.3.75"'), 'index data-build must be v1.3.75');
...
must(html.includes('src/app.js?v=1.3.75-dock-wave-download-fix'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.75-dock-wave-download-fix'), 'SW cache key missing');
