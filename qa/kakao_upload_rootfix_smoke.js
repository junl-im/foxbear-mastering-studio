...
must(html.includes('src/app.js?v=1.4.0-stage27-waveform-control-service'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.4.0-stage27-waveform-control-service'), 'SW cache key missing');
