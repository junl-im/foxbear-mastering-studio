...
must(html.includes('data-build="1.6.46"'), 'index data-build must be v1.6.46');
...
must(html.includes('src/app.js?v=1.6.46-google-auth-same-origin-network-recovery'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.46-google-auth-same-origin-network-recovery'), 'SW cache key missing');
