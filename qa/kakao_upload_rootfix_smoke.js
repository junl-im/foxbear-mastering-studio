...
must(html.includes('data-build="1.5.52"'), 'index data-build must be v1.5.52');
...
must(html.includes('src/app.js?v=1.5.52-ci-parallel-release-gate'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.52-ci-parallel-release-gate'), 'SW cache key missing');
