...
must(html.includes('data-build="1.6.1"'), 'index data-build must be v1.6.1');
...
must(html.includes('src/app.js?v=1.6.1-transient-performance-diagnostics'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.1-transient-performance-diagnostics'), 'SW cache key missing');
