...
must(html.includes('data-build="1.4.8"'), 'index data-build must be v1.4.8');
...
must(html.includes('src/app.js?v=1.4.8-dock-spectrum-cleanup'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.4.8-dock-spectrum-cleanup'), 'SW cache key missing');
