...
must(html.includes('data-build="1.5.7"'), 'index data-build must be v1.5.7');
...
must(html.includes('src/app.js?v=1.5.7-release-foundation'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.7-release-foundation'), 'SW cache key missing');
