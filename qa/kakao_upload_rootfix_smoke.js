...
must(html.includes('data-build="1.5.56"'), 'index data-build must be v1.5.56');
...
must(html.includes('src/app.js?v=1.5.56-incident-operations-app-check'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.56-incident-operations-app-check'), 'SW cache key missing');
