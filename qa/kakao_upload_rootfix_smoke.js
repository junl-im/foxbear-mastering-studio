...
must(html.includes('data-build="1.5.43"'), 'index data-build must be v1.5.43');
...
must(html.includes('src/app.js?v=1.5.43-export-pipeline-integrity'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.43-export-pipeline-integrity'), 'SW cache key missing');
