...
must(html.includes('src/app.js?v=1.4.0-stage22-playback-link-audit'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.4.0-stage22-playback-link-audit'), 'SW cache key missing');
