...
must(html.includes('data-build="1.5.24"'), 'index data-build must be v1.5.24');
...
must(html.includes('src/app.js?v=1.5.24-e2e-responsive-preview-control'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.24-e2e-responsive-preview-control'), 'SW cache key missing');
