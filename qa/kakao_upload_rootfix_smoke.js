...
must(app.includes("const APP_VERSION = 'Pro v1.3.81'"), 'app version must be v1.3.81');
must(html.includes('data-build="1.3.81"'), 'index data-build must be v1.3.81');
...
must(html.includes('src/app.js?v=1.3.81-modal-dock-layout-integrity'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.81-modal-dock-layout-integrity'), 'SW cache key missing');
