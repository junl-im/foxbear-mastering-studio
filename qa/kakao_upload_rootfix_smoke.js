...
must(html.includes('data-build="1.6.91"'), 'index data-build must be v1.6.91');
...
must(html.includes('src/app.js?v=1.6.91-runtime-health-hidden-geometry-contract-recovery'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.91-runtime-health-hidden-geometry-contract-recovery'), 'SW cache key missing');
