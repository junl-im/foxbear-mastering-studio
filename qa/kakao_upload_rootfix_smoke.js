...
must(html.includes('data-build="1.6.102"'), 'index data-build must be v1.6.102');
...
must(html.includes('src/app.js?v=1.6.102-admin-lazyload-sw-hygiene-hardening'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.102-admin-lazyload-sw-hygiene-hardening'), 'SW cache key missing');
