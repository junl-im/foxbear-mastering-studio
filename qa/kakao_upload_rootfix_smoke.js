...
must(html.includes('data-build="1.6.97"'), 'index data-build must be v1.6.97');
...
must(html.includes('src/app.js?v=1.6.97-boot-payload-delivery-privacy-hardening'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.97-boot-payload-delivery-privacy-hardening'), 'SW cache key missing');
