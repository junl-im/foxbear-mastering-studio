...
must(html.includes('data-build="1.6.34"'), 'index data-build must be v1.6.34');
...
must(html.includes('src/app.js?v=1.6.34-history-hard-stall-sw-activity-lifecycle'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.34-history-hard-stall-sw-activity-lifecycle'), 'SW cache key missing');
