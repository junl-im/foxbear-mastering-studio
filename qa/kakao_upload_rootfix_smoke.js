...
must(html.includes('data-build="1.6.59"'), 'index data-build must be v1.6.59');
...
must(html.includes('src/app.js?v=1.6.59-readiness-corp-security-hardening'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.59-readiness-corp-security-hardening'), 'SW cache key missing');
