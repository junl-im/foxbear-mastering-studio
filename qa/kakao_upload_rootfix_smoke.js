...
must(html.includes('data-build="1.5.54"'), 'index data-build must be v1.5.54');
...
must(html.includes('src/app.js?v=1.5.54-quality-recovery-profiles-browser-qa'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.54-quality-recovery-profiles-browser-qa'), 'SW cache key missing');
