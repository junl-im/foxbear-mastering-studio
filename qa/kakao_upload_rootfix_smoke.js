...
must(html.includes('data-build="1.5.64"'), 'index data-build must be v1.5.64');
...
must(html.includes('src/app.js?v=1.5.64-incident-operations-health-self-diagnostics'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.64-incident-operations-health-self-diagnostics'), 'SW cache key missing');
