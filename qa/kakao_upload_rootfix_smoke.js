...
must(html.includes('data-build="1.6.65"'), 'index data-build must be v1.6.65');
...
must(html.includes('src/app.js?v=1.6.65-firestore-write-fencing'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.65-firestore-write-fencing'), 'SW cache key missing');
