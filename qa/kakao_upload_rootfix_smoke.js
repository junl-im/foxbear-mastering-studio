...
must(html.includes('data-build="1.6.94"'), 'index data-build must be v1.6.94');
...
must(html.includes('src/app.js?v=1.6.94-release-integrity-hardening'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.94-release-integrity-hardening'), 'SW cache key missing');
