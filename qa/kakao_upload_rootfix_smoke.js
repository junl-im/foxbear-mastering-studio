...
must(html.includes('data-build="1.5.25"'), 'index data-build must be v1.5.25');
...
must(html.includes('src/app.js?v=1.5.25-e2e-preview-stability'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.25-e2e-preview-stability'), 'SW cache key missing');
