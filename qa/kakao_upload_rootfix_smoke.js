...
must(html.includes('data-build="1.5.55"'), 'index data-build must be v1.5.55');
...
must(html.includes('src/app.js?v=1.5.55-automatic-incident-mail-reporting'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.55-automatic-incident-mail-reporting'), 'SW cache key missing');
