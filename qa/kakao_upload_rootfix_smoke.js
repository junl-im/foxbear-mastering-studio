...
must(html.includes('data-build="1.3.72"'), 'index data-build must be v1.3.72');
...
must(html.includes('src/app.js?v=1.3.72-dock-remote-controller'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.72-dock-remote-controller'), 'SW cache key missing');
