...
must(html.includes('data-build="1.6.83"'), 'index data-build must be v1.6.83');
...
must(html.includes('src/app.js?v=1.6.83-browser-ui-mode-fixture-source-hygiene-recovery'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.83-browser-ui-mode-fixture-source-hygiene-recovery'), 'SW cache key missing');
