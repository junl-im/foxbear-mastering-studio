...
must(html.includes('data-build="1.5.65"'), 'index data-build must be v1.5.65');
...
must(html.includes('src/app.js?v=1.5.65-incident-recovery-control-alert-history'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.65-incident-recovery-control-alert-history'), 'SW cache key missing');
