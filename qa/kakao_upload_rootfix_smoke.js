...
must(app.includes("const APP_VERSION = 'Pro v1.3.70'"), 'app version must be v1.3.70');
must(html.includes('data-build="1.3.70"'), 'index data-build must be v1.3.70');
...
must(html.includes('src/app.js?v=1.3.70-dock-peak-toast-stack'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.70-dock-peak-toast-stack'), 'SW cache key missing');
