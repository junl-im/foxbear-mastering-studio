...
must(html.includes('data-build="1.5.90"'), 'index data-build must be v1.5.90');
...
must(html.includes('src/app.js?v=1.5.90-browser-retry-integrity-metadata-aware-scope'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.90-browser-retry-integrity-metadata-aware-scope'), 'SW cache key missing');
