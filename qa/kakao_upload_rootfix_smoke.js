...
must(html.includes('data-build="1.5.10"'), 'index data-build must be v1.5.10');
...
must(html.includes('src/app.js?v=1.5.10-header-settings-relocation'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.10-header-settings-relocation'), 'SW cache key missing');
