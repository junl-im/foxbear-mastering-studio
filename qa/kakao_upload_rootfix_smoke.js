...
must(html.includes('data-build="1.7.0"'), 'index data-build must be v1.7.0');
...
must(html.includes('src/app.js?v=1.7.0-adaptive-mastering-decision-phase1'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.7.0-adaptive-mastering-decision-phase1'), 'SW cache key missing');
