...
must(html.includes('data-build="1.5.49"'), 'index data-build must be v1.5.49');
...
must(html.includes('src/app.js?v=1.5.49-asset-generation-route-recovery'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.49-asset-generation-route-recovery'), 'SW cache key missing');
