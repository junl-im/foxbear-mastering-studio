...
must(html.includes('data-build="1.6.0"'), 'index data-build must be v1.6.0');
...
must(html.includes('src/app.js?v=1.6.0-incident-mail-pipeline-health'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.0-incident-mail-pipeline-health'), 'SW cache key missing');
