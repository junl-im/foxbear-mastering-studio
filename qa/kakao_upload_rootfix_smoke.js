...
must(html.includes('data-build="1.4.18"'), 'index data-build must be v1.4.18');
...
must(html.includes('src/app.js?v=1.4.18-download-dialog-micro-hint'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.4.18-download-dialog-micro-hint'), 'SW cache key missing');
