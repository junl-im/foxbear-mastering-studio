...
must(html.includes('data-build="1.6.39"'), 'index data-build must be v1.6.39');
...
must(html.includes('src/app.js?v=1.6.39-ui-shell-partial-script-probe-isolation'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.39-ui-shell-partial-script-probe-isolation'), 'SW cache key missing');
