...
must(html.includes('data-build="1.4.11"'), 'index data-build must be v1.4.11');
...
must(html.includes('src/app.js?v=1.4.11-download-share-reliability'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.4.11-download-share-reliability'), 'SW cache key missing');
