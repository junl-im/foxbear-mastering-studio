...
must(html.includes('src/app.js?v=1.3.84-stage13-runtime-safety'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.84-stage13-runtime-safety'), 'SW cache key missing');
