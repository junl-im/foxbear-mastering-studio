...
must(html.includes('data-build="1.5.41"'), 'index data-build must be v1.5.41');
...
must(html.includes('src/app.js?v=1.5.41-export-eta-download-recovery'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.41-export-eta-download-recovery'), 'SW cache key missing');
