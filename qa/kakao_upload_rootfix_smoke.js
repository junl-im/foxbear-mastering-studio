...
must(html.includes('data-build="1.4.26"'), 'index data-build must be v1.4.26');
...
must(html.includes('src/app.js?v=1.4.26-wake-lock-state-sync'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.4.26-wake-lock-state-sync'), 'SW cache key missing');
