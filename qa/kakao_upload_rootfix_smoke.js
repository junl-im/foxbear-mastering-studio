...
must(html.includes('data-build="1.5.22"'), 'index data-build must be v1.5.22');
...
must(html.includes('src/app.js?v=1.5.22-header-preview-routing-polish'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.22-header-preview-routing-polish'), 'SW cache key missing');
