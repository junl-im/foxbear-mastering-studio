...
must(html.includes('data-build="1.4.23"'), 'index data-build must be v1.4.23');
...
must(html.includes('src/app.js?v=1.4.23-audio-decode-memory-guard'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.4.23-audio-decode-memory-guard'), 'SW cache key missing');
