...
must(html.includes('data-build="1.5.60"'), 'index data-build must be v1.5.60');
...
must(html.includes('src/app.js?v=1.5.60-kakao-inapp-entry-memory-governor'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.60-kakao-inapp-entry-memory-governor'), 'SW cache key missing');
