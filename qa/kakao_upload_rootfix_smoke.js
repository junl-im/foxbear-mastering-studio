...
must(html.includes('data-build="1.6.2"'), 'index data-build must be v1.6.2');
...
must(html.includes('src/app.js?v=1.6.2-nonblocking-health-status-design-polish'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.2-nonblocking-health-status-design-polish'), 'SW cache key missing');
