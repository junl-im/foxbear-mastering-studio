...
must(html.includes('data-build="1.6.92"'), 'index data-build must be v1.6.92');
...
must(html.includes('src/app.js?v=1.6.92-spectrum-panel-mount-lifecycle-recovery'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.92-spectrum-panel-mount-lifecycle-recovery'), 'SW cache key missing');
