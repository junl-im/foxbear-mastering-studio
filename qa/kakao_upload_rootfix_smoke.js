...
must(html.includes('data-build="1.6.112"'), 'index data-build must be v1.6.112');
...
must(html.includes('src/app.js?v=1.6.112-mastering-lifecycle-race-hardening'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.112-mastering-lifecycle-race-hardening'), 'SW cache key missing');
