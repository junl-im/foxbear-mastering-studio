...
must(html.includes('data-build="1.6.111"'), 'index data-build must be v1.6.111');
...
must(html.includes('src/app.js?v=1.6.111-ui-mode-session-contract-hardening'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.111-ui-mode-session-contract-hardening'), 'SW cache key missing');
