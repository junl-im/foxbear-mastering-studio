...
must(html.includes('data-build="1.6.90"'), 'index data-build must be v1.6.90');
...
must(html.includes('src/app.js?v=1.6.90-engine-control-overlay-isolation-header-contract-recovery'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.90-engine-control-overlay-isolation-header-contract-recovery'), 'SW cache key missing');
