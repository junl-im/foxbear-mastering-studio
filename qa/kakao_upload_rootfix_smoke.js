...
must(html.includes('data-build="1.4.7"'), 'index data-build must be v1.4.7');
...
must(html.includes('src/app.js?v=1.4.7-dock-fft-removal'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.4.7-dock-fft-removal'), 'SW cache key missing');
