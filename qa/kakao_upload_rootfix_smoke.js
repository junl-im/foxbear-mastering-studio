...
must(html.includes('data-build="1.4.2"'), 'index data-build must be v1.4.2');
...
must(html.includes('src/app.js?v=1.4.2-crossfade-zoom-spectrum'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.4.2-crossfade-zoom-spectrum'), 'SW cache key missing');
