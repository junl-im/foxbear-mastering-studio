...
must(html.includes('data-build="1.5.14"'), 'index data-build must be v1.5.14');
...
must(html.includes('src/app.js?v=1.5.14-github-desktop-handoff-preflight'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.14-github-desktop-handoff-preflight'), 'SW cache key missing');
