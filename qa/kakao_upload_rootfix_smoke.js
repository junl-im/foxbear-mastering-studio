...
must(html.includes('data-build="1.6.71"'), 'index data-build must be v1.6.71');
...
must(html.includes('src/app.js?v=1.6.71-pwa-share-lease-handoff-deploy-policy-e2e'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.71-pwa-share-lease-handoff-deploy-policy-e2e'), 'SW cache key missing');
