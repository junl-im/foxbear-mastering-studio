...
must(app.includes("const APP_VERSION = 'Pro v1.3.77'"), 'app version must be v1.3.77');
must(html.includes('data-build="1.3.77"'), 'index data-build must be v1.3.77');
...
must(html.includes('src/app.js?v=1.3.77-dock-waveform-polish'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.77-dock-waveform-polish'), 'SW cache key missing');
