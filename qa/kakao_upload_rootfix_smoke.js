...
must(html.includes('data-build="1.6.98"'), 'index data-build must be v1.6.98');
...
must(html.includes('src/app.js?v=1.6.98-spectrum-retirement-mobile-header-integrity'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.98-spectrum-retirement-mobile-header-integrity'), 'SW cache key missing');
