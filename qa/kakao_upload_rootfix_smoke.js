...
must(html.includes('src/app.js?v=1.4.0-stage16-version-release'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.4.0-stage16-version-release'), 'SW cache key missing');
