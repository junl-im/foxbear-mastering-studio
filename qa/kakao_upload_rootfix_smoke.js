...
must(html.includes('data-build="1.6.50"'), 'index data-build must be v1.6.50');
...
must(html.includes('src/app.js?v=1.6.50-kakao-centered-entry-notice'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.50-kakao-centered-entry-notice'), 'SW cache key missing');
