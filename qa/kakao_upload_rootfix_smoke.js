...
must(html.includes('data-build="1.5.28"'), 'index data-build must be v1.5.28');
...
must(html.includes('src/app.js?v=1.5.28-resilience-lifecycle-offline-recovery'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.28-resilience-lifecycle-offline-recovery'), 'SW cache key missing');
