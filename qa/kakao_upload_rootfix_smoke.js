...
must(html.includes('data-build="1.5.53"'), 'index data-build must be v1.5.53');
...
must(html.includes('src/app.js?v=1.5.53-engine-recovery-performance-diagnostics'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.53-engine-recovery-performance-diagnostics'), 'SW cache key missing');
