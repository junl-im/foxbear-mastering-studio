...
must(html.includes('data-build="1.5.62"'), 'index data-build must be v1.5.62');
...
must(html.includes('src/app.js?v=1.5.62-incident-delivery-watchdog-package-gate'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.62-incident-delivery-watchdog-package-gate'), 'SW cache key missing');
