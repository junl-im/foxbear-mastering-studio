...
must(html.includes('data-build="1.6.93"'), 'index data-build must be v1.6.93');
...
must(html.includes('src/app.js?v=1.6.93-mobile-dock-visibility-integrity-recovery'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.93-mobile-dock-visibility-integrity-recovery'), 'SW cache key missing');
