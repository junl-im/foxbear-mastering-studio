...
must(html.includes('data-build="1.6.104"'), 'index data-build must be v1.6.104');
...
must(html.includes('src/app.js?v=1.6.104-boot-emergency-visit-privacy-hardening'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.104-boot-emergency-visit-privacy-hardening'), 'SW cache key missing');
