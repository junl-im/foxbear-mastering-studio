...
must(app.includes("const APP_VERSION = 'Pro v1.3.68'"), 'app version must be v1.3.68');
must(html.includes('data-build="1.3.68"'), 'index data-build must be v1.3.68');
...
must(html.includes('src/app.js?v=1.3.68-dock-action-runtime-fix'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.68-dock-action-runtime-fix'), 'SW cache key missing');
