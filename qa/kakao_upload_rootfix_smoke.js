...
must(html.includes('data-build="1.6.76"'), 'index data-build must be v1.6.76');
...
must(html.includes('src/app.js?v=1.6.76-download-viewport-runtime-fault-diagnostics'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.76-download-viewport-runtime-fault-diagnostics'), 'SW cache key missing');
