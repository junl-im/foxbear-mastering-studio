...
must(html.includes('data-build="1.4.5"'), 'index data-build must be v1.4.5');
...
must(html.includes('src/app.js?v=1.4.5-stability-audit'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.4.5-stability-audit'), 'SW cache key missing');
