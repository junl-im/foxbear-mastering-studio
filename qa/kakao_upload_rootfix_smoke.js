...
must(html.includes('data-build="1.5.21"'), 'index data-build must be v1.5.21');
...
must(html.includes('src/app.js?v=1.5.21-history-csp-console-contract-fix'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.21-history-csp-console-contract-fix'), 'SW cache key missing');
