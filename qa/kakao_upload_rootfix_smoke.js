...
must(app.includes("const APP_VERSION = 'Pro v1.3.73'"), 'app version must be v1.3.73');
must(html.includes('data-build="1.3.73"'), 'index data-build must be v1.3.73');
...
must(html.includes('src/app.js?v=1.3.73-dock-event-repair'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.73-dock-event-repair'), 'SW cache key missing');
