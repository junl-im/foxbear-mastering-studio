...
must(app.includes("const APP_VERSION = 'Pro v1.3.65'"), 'app version must be v1.3.65');
must(html.includes('data-build="1.3.65"'), 'index data-build must be v1.3.65');
...
must(html.includes('src/app.js?v=1.3.65-dock-import-init-cleanup'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.65-dock-import-init-cleanup'), 'SW cache key missing');
