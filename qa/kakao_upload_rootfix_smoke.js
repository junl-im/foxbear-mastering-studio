...
must(html.includes('src/app.js?v=1.4.0-stage21-unified-preview-system'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.4.0-stage21-unified-preview-system'), 'SW cache key missing');
