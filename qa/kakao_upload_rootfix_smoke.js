...
must(html.includes('data-build="1.5.37"'), 'index data-build must be v1.5.37');
...
must(html.includes('src/app.js?v=1.5.37-memory-import-waveform-hardening'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.37-memory-import-waveform-hardening'), 'SW cache key missing');
