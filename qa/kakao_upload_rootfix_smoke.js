...
must(html.includes('data-build="1.6.79"'), 'index data-build must be v1.6.79');
...
must(html.includes('src/app.js?v=1.6.79-manifestless-patch-playback-retirement'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.79-manifestless-patch-playback-retirement'), 'SW cache key missing');
