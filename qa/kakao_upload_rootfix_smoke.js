...
must(html.includes('data-build="1.6.82"'), 'index data-build must be v1.6.82');
...
must(html.includes('src/app.js?v=1.6.82-overlay-focus-ancestor-hardening'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.82-overlay-focus-ancestor-hardening'), 'SW cache key missing');
