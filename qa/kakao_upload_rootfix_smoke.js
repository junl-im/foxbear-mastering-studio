...
must(html.includes('data-build="1.6.103"'), 'index data-build must be v1.6.103');
...
must(html.includes('src/app.js?v=1.6.103-ci-hygiene-mail-routing-hardening'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.103-ci-hygiene-mail-routing-hardening'), 'SW cache key missing');
