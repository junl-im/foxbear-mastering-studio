...
must(html.includes('data-build="1.5.23"'), 'index data-build must be v1.5.23');
...
must(html.includes('src/app.js?v=1.5.23-e2e-preview-readiness'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.23-e2e-preview-readiness'), 'SW cache key missing');
