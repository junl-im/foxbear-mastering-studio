...
must(html.includes('data-build="1.5.57"'), 'index data-build must be v1.5.57');
...
must(html.includes('src/app.js?v=1.5.57-modal-close-consistency'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.57-modal-close-consistency'), 'SW cache key missing');
