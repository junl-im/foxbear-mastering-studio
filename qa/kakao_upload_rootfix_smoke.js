...
must(html.includes('data-build="1.5.20"'), 'index data-build must be v1.5.20');
...
must(html.includes('src/app.js?v=1.5.20-idempotent-pwa-cache-warm'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.20-idempotent-pwa-cache-warm'), 'SW cache key missing');
