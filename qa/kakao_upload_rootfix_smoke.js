...
must(html.includes('data-build="1.5.84"'), 'index data-build must be v1.5.84');
...
must(html.includes('src/app.js?v=1.5.84-trusted-types-browser-gate-recovery'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.84-trusted-types-browser-gate-recovery'), 'SW cache key missing');
