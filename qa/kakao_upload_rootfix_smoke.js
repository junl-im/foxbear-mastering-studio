...
must(html.includes('data-build="1.6.42"'), 'index data-build must be v1.6.42');
...
must(html.includes('src/app.js?v=1.6.42-spark-google-admin-auth'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.42-spark-google-admin-auth'), 'SW cache key missing');
