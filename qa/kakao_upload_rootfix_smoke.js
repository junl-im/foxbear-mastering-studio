...
must(html.includes('src/app.js?v=1.4.0-stage17-highlight-compare-sync'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.4.0-stage17-highlight-compare-sync'), 'SW cache key missing');
