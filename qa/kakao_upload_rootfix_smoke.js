...
must(html.includes('data-build="1.5.17"'), 'index data-build must be v1.5.17');
...
must(html.includes('src/app.js?v=1.5.17-browser-contract-fix'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.17-browser-contract-fix'), 'SW cache key missing');
