...
must(html.includes('data-build="1.5.15"'), 'index data-build must be v1.5.15');
...
must(html.includes('src/app.js?v=1.5.15-e2e-runtime-classification'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.15-e2e-runtime-classification'), 'SW cache key missing');
