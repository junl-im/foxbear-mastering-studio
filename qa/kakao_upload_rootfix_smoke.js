...
must(html.includes('data-build="1.5.97"'), 'index data-build must be v1.5.97');
...
must(html.includes('src/app.js?v=1.5.97-worker-recovery-diagnostics'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.97-worker-recovery-diagnostics'), 'SW cache key missing');
