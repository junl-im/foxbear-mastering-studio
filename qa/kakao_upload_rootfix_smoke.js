...
must(html.includes('data-build="1.5.95"'), 'index data-build must be v1.5.95');
...
must(html.includes('src/app.js?v=1.5.95-popup-settings-mail-test-recovery'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.95-popup-settings-mail-test-recovery'), 'SW cache key missing');
