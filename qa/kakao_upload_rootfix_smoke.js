...
must(html.includes('data-build="1.5.45"'), 'index data-build must be v1.5.45');
...
must(html.includes('src/app.js?v=1.5.45-export-queue-recovery'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.45-export-queue-recovery'), 'SW cache key missing');
