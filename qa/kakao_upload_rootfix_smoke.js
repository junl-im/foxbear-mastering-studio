...
must(html.includes('data-build="1.5.42"'), 'index data-build must be v1.5.42');
...
must(html.includes('src/app.js?v=1.5.42-zip-worker-cancellation'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.42-zip-worker-cancellation'), 'SW cache key missing');
