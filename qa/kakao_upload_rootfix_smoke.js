...
must(html.includes('data-build="1.6.86"'), 'index data-build must be v1.6.86');
...
must(html.includes('src/app.js?v=1.6.86-header-order-mobile-overflow-browser-gate-recovery'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.86-header-order-mobile-overflow-browser-gate-recovery'), 'SW cache key missing');
