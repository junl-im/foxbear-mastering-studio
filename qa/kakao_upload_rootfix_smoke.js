...
must(html.includes('data-build="1.6.70"'), 'index data-build must be v1.6.70');
...
must(html.includes('src/app.js?v=1.6.70-share-retry-policy-drift-ci-efficiency'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.70-share-retry-policy-drift-ci-efficiency'), 'SW cache key missing');
