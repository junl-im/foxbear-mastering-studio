...
must(html.includes('data-build="1.4.14"'), 'index data-build must be v1.4.14');
...
must(html.includes('src/app.js?v=1.4.14-download-action-clarity'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.4.14-download-action-clarity'), 'SW cache key missing');
