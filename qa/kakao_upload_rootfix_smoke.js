...
must(html.includes('data-build="1.5.94"'), 'index data-build must be v1.5.94');
...
must(html.includes('src/app.js?v=1.5.94-aiff-fallback-worker-diagnostics-reporting-contract'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.94-aiff-fallback-worker-diagnostics-reporting-contract'), 'SW cache key missing');
