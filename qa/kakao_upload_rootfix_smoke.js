...
must(html.includes('data-build="1.5.38"'), 'index data-build must be v1.5.38');
...
must(html.includes('src/app.js?v=1.5.38-preflight-worker-multitab-hardening'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.38-preflight-worker-multitab-hardening'), 'SW cache key missing');
