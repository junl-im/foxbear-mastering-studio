...
must(html.includes('data-build="1.6.63"'), 'index data-build must be v1.6.63');
...
must(html.includes('src/app.js?v=1.6.63-download-filename-review-hardening'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.63-download-filename-review-hardening'), 'SW cache key missing');
