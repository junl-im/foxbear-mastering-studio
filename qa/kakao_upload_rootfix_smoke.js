...
must(html.includes('data-build="1.5.92"'), 'index data-build must be v1.5.92');
...
must(html.includes('src/app.js?v=1.5.92-python-bytecode-ci-hygiene-node24-cache'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.92-python-bytecode-ci-hygiene-node24-cache'), 'SW cache key missing');
