...
must(html.includes('data-build="1.5.99"'), 'index data-build must be v1.5.99');
...
must(html.includes('src/app.js?v=1.5.99-incident-callable-mail-recovery'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.99-incident-callable-mail-recovery'), 'SW cache key missing');
