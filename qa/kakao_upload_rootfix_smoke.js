...
must(app.includes("const APP_VERSION = 'Pro v1.3.74'"), 'app version must be v1.3.74');
must(html.includes('data-build="1.3.74"'), 'index data-build must be v1.3.74');
...
must(html.includes('src/app.js?v=1.3.74-dock-integrated-waveform'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.74-dock-integrated-waveform'), 'SW cache key missing');
