...
must(html.includes('src/app.js?v=1.4.0-stage28-waveform-control-view'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.4.0-stage28-waveform-control-view'), 'SW cache key missing');
