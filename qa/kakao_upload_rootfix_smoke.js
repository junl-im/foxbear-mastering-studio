...
must(html.includes('data-build="1.5.61"'), 'index data-build must be v1.5.61');
...
must(html.includes('src/app.js?v=1.5.61-worker-mail-delivery-recovery'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.61-worker-mail-delivery-recovery'), 'SW cache key missing');
