...
must(html.includes('data-build="1.5.46"'), 'index data-build must be v1.5.46');
...
must(html.includes('src/app.js?v=1.5.46-engine-recommendation-api-audit'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.46-engine-recommendation-api-audit'), 'SW cache key missing');
