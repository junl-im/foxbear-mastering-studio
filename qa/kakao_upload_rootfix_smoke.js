...
must(html.includes('data-build="1.5.18"'), 'index data-build must be v1.5.18');
...
must(html.includes('src/app.js?v=1.5.18-ci-diagnostics-pwa-readiness'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.18-ci-diagnostics-pwa-readiness'), 'SW cache key missing');
