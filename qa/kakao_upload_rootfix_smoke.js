...
must(html.includes('data-build="1.5.73"'), 'index data-build must be v1.5.73');
...
must(html.includes('src/app.js?v=1.5.73-bulk-control-eta-result-filter-ui'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.73-bulk-control-eta-result-filter-ui'), 'SW cache key missing');
