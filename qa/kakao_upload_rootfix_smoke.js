...
must(html.includes('data-build="1.5.79"'), 'index data-build must be v1.5.79');
...
must(html.includes('src/app.js?v=1.5.79-preview-download-ownership-recovery'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.79-preview-download-ownership-recovery'), 'SW cache key missing');
