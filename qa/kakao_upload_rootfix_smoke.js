...
must(html.includes('data-build="1.4.10"'), 'index data-build must be v1.4.10');
...
must(html.includes('src/app.js?v=1.4.10-perf-polish'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.4.10-perf-polish'), 'SW cache key missing');
