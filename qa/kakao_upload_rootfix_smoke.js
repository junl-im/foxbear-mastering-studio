...
must(html.includes('data-build="1.5.19"'), 'index data-build must be v1.5.19');
...
must(html.includes('src/app.js?v=1.5.19-ci-runtime-isolation-package-hardening'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.19-ci-runtime-isolation-package-hardening'), 'SW cache key missing');
