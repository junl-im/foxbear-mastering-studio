...
must(html.includes('data-build="1.6.100"'), 'index data-build must be v1.6.100');
...
must(html.includes('src/app.js?v=1.6.100-sw-stereo-ci-cleanup-hardening'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.100-sw-stereo-ci-cleanup-hardening'), 'SW cache key missing');
