...
must(html.includes('data-build="1.6.88"'), 'index data-build must be v1.6.88');
...
must(html.includes('src/app.js?v=1.6.88-mobile-header-grid-ownership-recovery'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.88-mobile-header-grid-ownership-recovery'), 'SW cache key missing');
