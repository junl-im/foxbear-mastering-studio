...
must(html.includes('src/app.js?v=1.4.0-stage23-playback-orchestration'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.4.0-stage23-playback-orchestration'), 'SW cache key missing');
