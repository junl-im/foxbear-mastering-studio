...
must(html.includes('data-build="1.6.9"'), 'index data-build must be v1.6.9');
...
must(html.includes('src/app.js?v=1.6.9-incident-readiness-history-recovery-copy-events'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.9-incident-readiness-history-recovery-copy-events'), 'SW cache key missing');
