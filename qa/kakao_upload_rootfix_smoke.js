...
must(html.includes('data-build="1.5.47"'), 'index data-build must be v1.5.47');
...
must(html.includes('src/app.js?v=1.5.47-engine-edgecase-quality-gate'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.47-engine-edgecase-quality-gate'), 'SW cache key missing');
