...
must(html.includes('data-build="1.6.40"'), 'index data-build must be v1.6.40');
...
must(html.includes('src/app.js?v=1.6.40-ui-shell-retry-replacement-settlement'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.40-ui-shell-retry-replacement-settlement'), 'SW cache key missing');
