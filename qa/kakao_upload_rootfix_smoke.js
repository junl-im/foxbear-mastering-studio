...
must(html.includes('data-build="1.5.27"'), 'index data-build must be v1.5.27');
...
must(html.includes('src/app.js?v=1.5.27-device-glyph-sri-hardening'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.27-device-glyph-sri-hardening'), 'SW cache key missing');
