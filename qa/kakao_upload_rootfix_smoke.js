...
must(app.includes("const APP_VERSION = 'Pro v1.3.82'"), 'app version must be v1.3.82');
must(html.includes('data-build="1.3.82"'), 'index data-build must be v1.3.82');
...
must(html.includes('src/app.js?v=1.3.82-pc-dock-modal-rootfix'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.82-pc-dock-modal-rootfix'), 'SW cache key missing');
