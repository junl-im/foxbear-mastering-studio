...
must(html.includes('data-build="1.6.109"'), 'index data-build must be v1.6.109');
...
must(html.includes('src/app.js?v=1.6.109-mastering-cooperative-pcm-responsiveness'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.109-mastering-cooperative-pcm-responsiveness'), 'SW cache key missing');
