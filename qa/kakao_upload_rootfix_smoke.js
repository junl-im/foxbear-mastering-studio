...
must(html.includes('data-build="1.6.25"'), 'index data-build must be v1.6.25');
...
must(html.includes('src/app.js?v=1.6.25-incident-recovery-timeout-abort-stress'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.25-incident-recovery-timeout-abort-stress'), 'SW cache key missing');
