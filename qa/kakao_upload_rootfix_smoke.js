...
must(html.includes('data-build="1.5.80"'), 'index data-build must be v1.5.80');
...
must(html.includes('src/app.js?v=1.5.80-mobile-return-media-focus-recovery'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.80-mobile-return-media-focus-recovery'), 'SW cache key missing');
