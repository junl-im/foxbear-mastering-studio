...
must(html.includes('data-build="1.4.4"'), 'index data-build must be v1.4.4');
...
must(html.includes('src/app.js?v=1.4.4-fft-live-hotfix'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.4.4-fft-live-hotfix'), 'SW cache key missing');
