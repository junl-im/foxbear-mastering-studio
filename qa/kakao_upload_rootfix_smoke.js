...
must(html.includes('data-build="1.6.85"'), 'index data-build must be v1.6.85');
...
must(html.includes('src/app.js?v=1.6.85-browser-sentinel-ui-mode-header-recovery'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.85-browser-sentinel-ui-mode-header-recovery'), 'SW cache key missing');
