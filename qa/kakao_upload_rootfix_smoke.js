...
must(html.includes('data-build="1.6.43"'), 'index data-build must be v1.6.43');
...
must(html.includes('src/app.js?v=1.6.43-google-auth-trusted-types-csp-recovery'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.43-google-auth-trusted-types-csp-recovery'), 'SW cache key missing');
