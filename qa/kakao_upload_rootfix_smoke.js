...
must(html.includes('data-build="1.5.12"'), 'index data-build must be v1.5.12');
...
must(html.includes('src/app.js?v=1.5.12-ci-runtime-readiness'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.12-ci-runtime-readiness'), 'SW cache key missing');
