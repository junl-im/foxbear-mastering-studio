...
must(html.includes('data-build="1.6.78"'), 'index data-build must be v1.6.78');
...
must(html.includes('src/app.js?v=1.6.78-release-generation-assist-url-playback-invalidation'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.78-release-generation-assist-url-playback-invalidation'), 'SW cache key missing');
