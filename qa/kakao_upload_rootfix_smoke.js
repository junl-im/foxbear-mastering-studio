...
must(html.includes('data-build="1.5.59"'), 'index data-build must be v1.5.59');
...
must(html.includes('src/app.js?v=1.5.59-kakao-session-handoff-memory-diagnostics'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.59-kakao-session-handoff-memory-diagnostics'), 'SW cache key missing');
