...
must(html.includes('data-build="1.6.73"'), 'index data-build must be v1.6.73');
...
must(html.includes('src/app.js?v=1.6.73-csp-memory-admission-runtime-config'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.73-csp-memory-admission-runtime-config'), 'SW cache key missing');
