...
must(html.includes('data-build="1.6.106"'), 'index data-build must be v1.6.106');
...
must(html.includes('src/app.js?v=1.6.106-browser-geometry-history-recovery'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.106-browser-geometry-history-recovery'), 'SW cache key missing');
