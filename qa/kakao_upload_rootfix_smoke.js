...
must(html.includes('src/app.js?v=1.4.0-stage18-settings-persistence'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.4.0-stage18-settings-persistence'), 'SW cache key missing');
