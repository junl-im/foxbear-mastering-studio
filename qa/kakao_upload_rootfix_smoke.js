...
must(html.includes('data-build="1.5.13"'), 'index data-build must be v1.5.13');
...
must(html.includes('src/app.js?v=1.5.13-handoff-package-integrity'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.13-handoff-package-integrity'), 'SW cache key missing');
