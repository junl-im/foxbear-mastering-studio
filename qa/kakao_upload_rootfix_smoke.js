...
must(html.includes('data-build="1.6.110"'), 'index data-build must be v1.6.110');
...
must(html.includes('src/app.js?v=1.6.110-ui-mode-early-boot-recovery'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.110-ui-mode-early-boot-recovery'), 'SW cache key missing');
