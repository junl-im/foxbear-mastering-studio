...
must(html.includes('data-build="1.6.101"'), 'index data-build must be v1.6.101');
...
must(html.includes('src/app.js?v=1.6.101-admin-lazyload-repo-cleanup'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.101-admin-lazyload-repo-cleanup'), 'SW cache key missing');
