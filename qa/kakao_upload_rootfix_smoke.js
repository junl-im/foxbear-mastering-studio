...
must(html.includes('data-build="1.6.72"'), 'index data-build must be v1.6.72');
...
must(html.includes('src/app.js?v=1.6.72-ci-safe-hygiene-self-repair'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.72-ci-safe-hygiene-self-repair'), 'SW cache key missing');
