...
must(html.includes('data-build="1.5.98"'), 'index data-build must be v1.5.98');
...
must(html.includes('src/app.js?v=1.5.98-worker-retry-health-levels'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.98-worker-retry-health-levels'), 'SW cache key missing');
