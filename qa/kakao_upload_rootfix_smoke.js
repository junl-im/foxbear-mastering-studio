...
must(html.includes('data-build="1.5.93"'), 'index data-build must be v1.5.93');
...
must(html.includes('src/app.js?v=1.5.93-external-engine-transfer-admin-export-openai-readiness'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.93-external-engine-transfer-admin-export-openai-readiness'), 'SW cache key missing');
