...
must(html.includes('data-build="1.5.26"'), 'index data-build must be v1.5.26');
...
must(html.includes('src/app.js?v=1.5.26-engraved-command-header'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.26-engraved-command-header'), 'SW cache key missing');
