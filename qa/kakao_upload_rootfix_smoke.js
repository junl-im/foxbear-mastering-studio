...
must(html.includes('data-build="1.6.20"'), 'index data-build must be v1.6.20');
...
must(html.includes('src/app.js?v=1.6.20-incident-background-sync-network-decay'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.20-incident-background-sync-network-decay'), 'SW cache key missing');
