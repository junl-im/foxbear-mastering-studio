...
must(html.includes('data-build="1.5.36"'), 'index data-build must be v1.5.36');
...
must(html.includes('src/app.js?v=1.5.36-interaction-lifecycle-hardening'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.36-interaction-lifecycle-hardening'), 'SW cache key missing');
