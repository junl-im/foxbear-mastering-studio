...
must(html.includes('data-build="1.5.67"'), 'index data-build must be v1.5.67');
...
must(html.includes('src/app.js?v=1.5.67-incident-admin-audit-webhook-failover-index-health'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.67-incident-admin-audit-webhook-failover-index-health'), 'SW cache key missing');
