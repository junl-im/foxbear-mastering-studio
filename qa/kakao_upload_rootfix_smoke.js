...
must(html.includes('data-build="1.5.74"'), 'index data-build must be v1.5.74');
...
must(html.includes('src/app.js?v=1.5.74-bulk-pause-skip-reorder-mobile-download'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.74-bulk-pause-skip-reorder-mobile-download'), 'SW cache key missing');
