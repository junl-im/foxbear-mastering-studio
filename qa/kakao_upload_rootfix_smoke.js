...
must(html.includes('data-build="1.6.66"'), 'index data-build must be v1.6.66');
...
must(html.includes('src/app.js?v=1.6.66-static-gate-hygiene-repair'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.66-static-gate-hygiene-repair'), 'SW cache key missing');
