...
must(html.includes('data-build="1.5.31"'), 'index data-build must be v1.5.31');
...
must(html.includes('src/app.js?v=1.5.31-player-download-stability'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.31-player-download-stability'), 'SW cache key missing');
