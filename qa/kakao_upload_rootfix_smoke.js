...
must(html.includes('data-build="1.6.61"'), 'index data-build must be v1.6.61');
...
must(html.includes('src/app.js?v=1.6.61-human-readable-download-filenames'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.61-human-readable-download-filenames'), 'SW cache key missing');
