...
must(html.includes('data-build="1.6.41"'), 'index data-build must be v1.6.41');
...
must(html.includes('src/app.js?v=1.6.41-admin-secret-pin-session'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.41-admin-secret-pin-session'), 'SW cache key missing');
