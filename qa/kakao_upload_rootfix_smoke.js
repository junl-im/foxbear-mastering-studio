...
must(app.includes("const APP_VERSION = 'Pro v1.3.66'"), 'app version must be v1.3.66');
must(html.includes('data-build="1.3.66"'), 'index data-build must be v1.3.66');
...
must(html.includes('src/app.js?v=1.3.66-dock-master-player-order'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.66-dock-master-player-order'), 'SW cache key missing');
