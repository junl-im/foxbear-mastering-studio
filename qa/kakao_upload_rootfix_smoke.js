...
must(html.includes('data-build="1.5.68"'), 'index data-build must be v1.5.68');
...
must(html.includes('src/app.js?v=1.5.68-mail-delivery-verification-sender-subject-rules'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.68-mail-delivery-verification-sender-subject-rules'), 'SW cache key missing');
