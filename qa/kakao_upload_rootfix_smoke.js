...
must(html.includes('data-build="1.5.82"'), 'index data-build must be v1.5.82');
...
must(html.includes('src/app.js?v=1.5.82-mastering-cancel-playback-resume-recovery'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.82-mastering-cancel-playback-resume-recovery'), 'SW cache key missing');
