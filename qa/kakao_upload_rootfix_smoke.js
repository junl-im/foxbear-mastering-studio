...
must(app.includes("const APP_VERSION = 'Pro v1.3.80'"), 'app version must be v1.3.80');
must(html.includes('data-build="1.3.80"'), 'index data-build must be v1.3.80');
...
must(html.includes('src/app.js?v=1.3.80-icons-buttonview-close'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.80-icons-buttonview-close'), 'SW cache key missing');
