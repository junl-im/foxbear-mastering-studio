...
must(html.includes('data-build="1.5.51"'), 'index data-build must be v1.5.51');
...
must(html.includes('src/app.js?v=1.5.51-ci-runtime-contract-hardening'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.51-ci-runtime-contract-hardening'), 'SW cache key missing');
