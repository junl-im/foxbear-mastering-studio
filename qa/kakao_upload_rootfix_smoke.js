...
must(html.includes('data-build="1.5.9"'), 'index data-build must be v1.5.9');
...
must(html.includes('src/app.js?v=1.5.9-version-display-cache-recovery'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.9-version-display-cache-recovery'), 'SW cache key missing');
