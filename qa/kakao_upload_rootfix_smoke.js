...
must(html.includes('data-build="1.3.71"'), 'index data-build must be v1.3.71');
...
must(html.includes('src/app.js?v=1.3.71-dock-main-action-bridge'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.71-dock-main-action-bridge'), 'SW cache key missing');
