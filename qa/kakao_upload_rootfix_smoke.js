...
must(app.includes("const APP_VERSION = 'Pro v1.3.83'"), 'app version must be v1.3.83');
must(html.includes('data-build="1.3.83"'), 'index data-build must be v1.3.83');
...
must(html.includes('src/app.js?v=1.3.83-pc-dock-modal-hardfix'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.83-pc-dock-modal-hardfix'), 'SW cache key missing');
