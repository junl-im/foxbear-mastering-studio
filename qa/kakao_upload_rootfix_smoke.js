...
must(app.includes("const APP_VERSION = 'Pro v1.3.76'"), 'app version must be v1.3.76');
must(html.includes('data-build="1.3.76"'), 'index data-build must be v1.3.76');
...
must(html.includes('src/app.js?v=1.3.76-dock-regression-buttonview'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.76-dock-regression-buttonview'), 'SW cache key missing');
