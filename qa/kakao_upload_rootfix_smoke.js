...
must(html.includes('data-build="1.6.99"'), 'index data-build must be v1.6.99');
...
must(html.includes('src/app.js?v=1.6.99-header-role-focus-integrity'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.99-header-role-focus-integrity'), 'SW cache key missing');
