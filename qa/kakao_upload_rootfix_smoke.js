...
must(html.includes('data-build="1.6.10"'), 'index data-build must be v1.6.10');
...
must(html.includes('src/app.js?v=1.6.10-incident-readiness-contract-csp-cache-hardening'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.10-incident-readiness-contract-csp-cache-hardening'), 'SW cache key missing');
