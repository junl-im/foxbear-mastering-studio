...
must(html.includes('data-build="1.6.13"'), 'index data-build must be v1.6.13');
...
must(html.includes('src/app.js?v=1.6.13-download-format-context-menu'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.13-download-format-context-menu'), 'SW cache key missing');
