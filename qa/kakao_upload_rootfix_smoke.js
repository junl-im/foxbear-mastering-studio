...
must(html.includes('data-build="1.5.66"'), 'index data-build must be v1.5.66');
...
must(html.includes('src/app.js?v=1.5.66-incident-operations-action-guard-deploy-verification'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.66-incident-operations-action-guard-deploy-verification'), 'SW cache key missing');
