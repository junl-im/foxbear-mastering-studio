...
must(html.includes('src/app.js?v=1.3.84-stage15-settings-panel'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.84-stage15-settings-panel'), 'SW cache key missing');
