...
must(html.includes('data-build="1.5.29"'), 'index data-build must be v1.5.29');
...
must(html.includes('src/app.js?v=1.5.29-analysis-update-lifecycle'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.29-analysis-update-lifecycle'), 'SW cache key missing');
