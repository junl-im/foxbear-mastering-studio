...
must(html.includes('data-build="1.6.22"'), 'index data-build must be v1.6.22');
...
must(html.includes('src/app.js?v=1.6.22-incident-recovery-coalescing-time-decay'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.22-incident-recovery-coalescing-time-decay'), 'SW cache key missing');
