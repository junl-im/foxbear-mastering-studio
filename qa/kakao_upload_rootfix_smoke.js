...
must(html.includes('data-build="1.5.34"'), 'index data-build must be v1.5.34');
...
must(html.includes('src/app.js?v=1.5.34-kakao-landing-recovery'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.34-kakao-landing-recovery'), 'SW cache key missing');
