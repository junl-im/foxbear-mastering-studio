...
must(app.includes("const APP_VERSION = 'Pro v1.3.78'"), 'app version must be v1.3.78');
must(html.includes('data-build="1.3.78"'), 'index data-build must be v1.3.78');
...
must(html.includes('src/app.js?v=1.3.78-cleanup-buttonview-layer'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.78-cleanup-buttonview-layer'), 'SW cache key missing');
