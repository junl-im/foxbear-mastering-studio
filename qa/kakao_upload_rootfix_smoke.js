...
must(html.includes('data-build="1.6.89"'), 'index data-build must be v1.6.89');
...
must(html.includes('src/app.js?v=1.6.89-mobile-header-flex-ownership-browser-gate-recovery'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.89-mobile-header-flex-ownership-browser-gate-recovery'), 'SW cache key missing');
