...
must(html.includes('data-build="1.6.80"'), 'index data-build must be v1.6.80');
...
must(html.includes('src/app.js?v=1.6.80-ai-mastering-expert-workspace'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.80-ai-mastering-expert-workspace'), 'SW cache key missing');
