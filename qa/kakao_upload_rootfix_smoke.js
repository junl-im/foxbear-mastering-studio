...
must(html.includes('data-build="1.4.6"'), 'index data-build must be v1.4.6');
...
must(html.includes('src/app.js?v=1.4.6-stability-polish'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.4.6-stability-polish'), 'SW cache key missing');
