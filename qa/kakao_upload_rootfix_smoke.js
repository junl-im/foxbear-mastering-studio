...
must(html.includes('src/app.js?v=1.4.0-stage19-highlight-diagnostics'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.4.0-stage19-highlight-diagnostics'), 'SW cache key missing');
