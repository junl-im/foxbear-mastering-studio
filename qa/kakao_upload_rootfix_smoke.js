...
must(html.includes('data-build="1.6.75"'), 'index data-build must be v1.6.75');
...
must(html.includes('src/app.js?v=1.6.75-download-progress-admission-fallback-closure'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.75-download-progress-admission-fallback-closure'), 'SW cache key missing');
