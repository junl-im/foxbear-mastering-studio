...
must(html.includes('data-build="1.6.64"'), 'index data-build must be v1.6.64');
...
must(html.includes('src/app.js?v=1.6.64-github-desktop-delivery-contract'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.64-github-desktop-delivery-contract'), 'SW cache key missing');
