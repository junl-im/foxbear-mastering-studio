...
must(html.includes('data-build="1.6.56"'), 'index data-build must be v1.6.56');
...
must(html.includes('src/app.js?v=1.6.56-playback-blob-source-resilience'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.56-playback-blob-source-resilience'), 'SW cache key missing');
