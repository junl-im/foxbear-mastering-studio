...
must(html.includes('data-build="1.6.12"'), 'index data-build must be v1.6.12');
...
must(html.includes('src/app.js?v=1.6.12-mastering-tone-loudness-fastpath'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.12-mastering-tone-loudness-fastpath'), 'SW cache key missing');
