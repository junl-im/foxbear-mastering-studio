...
must(html.includes('data-build="1.6.74"'), 'index data-build must be v1.6.74');
...
must(html.includes('src/app.js?v=1.6.74-incident-admission-spark-retention-download-memory'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.74-incident-admission-spark-retention-download-memory'), 'SW cache key missing');
