...
must(html.includes('data-build="1.5.69"'), 'index data-build must be v1.5.69');
...
must(html.includes('src/app.js?v=1.5.69-mail-receipt-confirmation-history-branded-template'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.69-mail-receipt-confirmation-history-branded-template'), 'SW cache key missing');
