...
must(html.includes('data-build="1.4.24"'), 'index data-build must be v1.4.24');
...
must(html.includes('src/app.js?v=1.4.24-bulk-import-hud'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.4.24-bulk-import-hud'), 'SW cache key missing');
