...
must(html.includes('data-build="1.6.45"'), 'index data-build must be v1.6.45');
...
must(html.includes('src/app.js?v=1.6.45-windows-release-gate-spark-hosting-no-app-check'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.45-windows-release-gate-spark-hosting-no-app-check'), 'SW cache key missing');
