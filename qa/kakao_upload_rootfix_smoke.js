...
must(app.includes("const APP_VERSION = 'Pro v1.3.64'"), 'app version must be v1.3.64');
must(html.includes('data-build="1.3.64"'), 'index data-build must be v1.3.64');
...
must(html.includes('src/app.js?v=1.3.64-kakao-upload-rootfix'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.64-kakao-upload-rootfix'), 'SW cache key missing');
