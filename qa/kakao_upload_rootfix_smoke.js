...
must(app.includes("const APP_VERSION = 'Pro v1.3.79'"), 'app version must be v1.3.79');
must(html.includes('data-build="1.3.79"'), 'index data-build must be v1.3.79');
...
must(html.includes('src/app.js?v=1.3.79-dock-purpose-realign'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.79-dock-purpose-realign'), 'SW cache key missing');
