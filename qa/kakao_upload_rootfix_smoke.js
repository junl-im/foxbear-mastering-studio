...
must(html.includes('data-build="1.5.91"'), 'index data-build must be v1.5.91');
...
must(html.includes('src/app.js?v=1.5.91-cancellable-audio-pipeline-performance-guards'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.91-cancellable-audio-pipeline-performance-guards'), 'SW cache key missing');
