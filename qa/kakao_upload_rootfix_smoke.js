...
must(html.includes('data-build="1.5.81"'), 'index data-build must be v1.5.81');
...
must(html.includes('src/app.js?v=1.5.81-master-preview-cancellation-native-result-isolation'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.81-master-preview-cancellation-native-result-isolation'), 'SW cache key missing');
