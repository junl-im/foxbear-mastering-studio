...
must(html.includes('data-build="1.5.30"'), 'index data-build must be v1.5.30');
...
must(html.includes('src/app.js?v=1.5.30-inapp-playback-recovery'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.30-inapp-playback-recovery'), 'SW cache key missing');
