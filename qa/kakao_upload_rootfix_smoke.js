...
must(html.includes('data-build="1.7.4"'), 'index data-build must be v1.7.4');
...
must(html.includes('src/app.js?v=1.7.4-reload-reentry-mode-chooser'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.7.4-reload-reentry-mode-chooser'), 'SW cache key missing');
