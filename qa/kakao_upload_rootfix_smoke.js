...
must(html.includes('src/app.js?v=1.3.84-stage14-runtime-recovery'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.84-stage14-runtime-recovery'), 'SW cache key missing');
