...
must(html.includes('data-build="1.6.49"'), 'index data-build must be v1.6.49');
...
must(html.includes('src/app.js?v=1.6.49-download-variant-cache-reuse'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.49-download-variant-cache-reuse'), 'SW cache key missing');
