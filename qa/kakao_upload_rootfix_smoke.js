...
must(html.includes('data-build="1.6.7"'), 'index data-build must be v1.6.7');
...
must(html.includes('src/app.js?v=1.6.7-incident-readiness-history-sync-performance-hud'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.7-incident-readiness-history-sync-performance-hud'), 'SW cache key missing');
