...
must(html.includes('data-build="1.5.96"'), 'index data-build must be v1.5.96');
...
must(html.includes('src/app.js?v=1.5.96-modal-focus-memory-diagnostics'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.96-modal-focus-memory-diagnostics'), 'SW cache key missing');
