...
must(html.includes('data-build="1.4.12"'), 'index data-build must be v1.4.12');
...
must(html.includes('src/app.js?v=1.4.12-download-diagnostics'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.4.12-download-diagnostics'), 'SW cache key missing');
