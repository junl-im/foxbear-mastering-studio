...
must(html.includes('data-build="1.6.47"'), 'index data-build must be v1.6.47');
...
must(html.includes('src/app.js?v=1.6.47-external-host-admin-auth-opaque-error-recovery'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.47-external-host-admin-auth-opaque-error-recovery'), 'SW cache key missing');
