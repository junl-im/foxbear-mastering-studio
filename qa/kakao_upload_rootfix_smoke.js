...
must(html.includes('src/app.js?v=1.3.84-stage12.2-cachefix'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.84-stage12.2-cachefix'), 'SW cache key missing');
