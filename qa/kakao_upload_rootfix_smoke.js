...
must(html.includes('data-build="1.6.113"'), 'index data-build must be v1.6.113');
...
must(html.includes('src/app.js?v=1.6.113-incident-finalizer-p1-hardening'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.113-incident-finalizer-p1-hardening'), 'SW cache key missing');
