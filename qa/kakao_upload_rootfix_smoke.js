...
must(html.includes('data-build="1.5.16"'), 'index data-build must be v1.5.16');
...
must(html.includes('src/app.js?v=1.5.16-e2e-server-pipe-deadlock-fix'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.5.16-e2e-server-pipe-deadlock-fix'), 'SW cache key missing');
