...
must(html.includes('data-build="1.6.105"'), 'index data-build must be v1.6.105');
...
must(html.includes('src/app.js?v=1.6.105-header-dock-css-ownership-hardening'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.105-header-dock-css-ownership-hardening'), 'SW cache key missing');
