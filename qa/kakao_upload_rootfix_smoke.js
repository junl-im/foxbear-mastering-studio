...
must(html.includes('data-build="1.6.108"'), 'index data-build must be v1.6.108');
...
must(html.includes('src/app.js?v=1.6.108-mastering-progress-visibility-hardening'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.108-mastering-progress-visibility-hardening'), 'SW cache key missing');
