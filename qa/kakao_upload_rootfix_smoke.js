...
must(html.includes('data-build="1.6.87"'), 'index data-build must be v1.6.87');
...
must(html.includes('src/app.js?v=1.6.87-mobile-header-device-label-overlap-recovery'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.87-mobile-header-device-label-overlap-recovery'), 'SW cache key missing');
