...
must(html.includes('data-build="1.6.84"'), 'index data-build must be v1.6.84');
...
must(html.includes('src/app.js?v=1.6.84-tracked-windows-cleanup-static-gate-recovery'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.84-tracked-windows-cleanup-static-gate-recovery'), 'SW cache key missing');
