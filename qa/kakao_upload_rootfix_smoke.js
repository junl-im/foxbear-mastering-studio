...
must(html.includes('data-build="1.4.20"'), 'index data-build must be v1.4.20');
...
must(html.includes('src/app.js?v=1.4.20-bulk-import-guard'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.4.20-bulk-import-guard'), 'SW cache key missing');
