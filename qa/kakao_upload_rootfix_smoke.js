...
must(html.includes('data-build="1.7.2"'), 'index data-build must be v1.7.2');
...
must(html.includes('src/app.js?v=1.7.2-expert-workspace-default-entry'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.7.2-expert-workspace-default-entry'), 'SW cache key missing');
