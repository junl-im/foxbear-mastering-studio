...
must(html.includes('data-build="1.6.58"'), 'index data-build must be v1.6.58');
...
must(html.includes('src/app.js?v=1.6.58-piano-transient-integrity'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.6.58-piano-transient-integrity'), 'SW cache key missing');
