...
must(app.includes("const APP_VERSION = 'Pro v1.3.67'"), 'app version must be v1.3.67');
must(html.includes('data-build="1.3.67"'), 'index data-build must be v1.3.67');
...
must(html.includes('src/app.js?v=1.3.67-dock-action-single-line'), 'app cache bust key missing');
must(sw.includes('foxbear-shell-v1.3.67-dock-action-single-line'), 'SW cache key missing');
