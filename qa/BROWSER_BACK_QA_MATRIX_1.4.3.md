# FoxBear v1.4.4 Browser Back / Refresh QA Matrix

Purpose: verify that the v1.4.1 exit guard still protects active mastering sessions after v1.4.4 Dock/player changes.
