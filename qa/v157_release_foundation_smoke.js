...
assert(!changelog.includes('## v1.6.71 carry-forward anchors') && !changelog.includes('## v1.6.71 Carry-forward Documentation Anchors'), 'carry-forward anchor sections should not return');
...
assert((pkg.qaChecks || []).includes('node qa/v157_release_foundation_smoke.js'), 'v1.6.71 smoke missing from qaChecks');
