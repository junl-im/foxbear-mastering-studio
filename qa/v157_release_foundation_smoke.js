...
assert(!changelog.includes('## v1.5.53 carry-forward anchors') && !changelog.includes('## v1.5.53 Carry-forward Documentation Anchors'), 'carry-forward anchor sections should not return');
...
assert((pkg.qaChecks || []).includes('node qa/v157_release_foundation_smoke.js'), 'v1.5.53 smoke missing from qaChecks');
