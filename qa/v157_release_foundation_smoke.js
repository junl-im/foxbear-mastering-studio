...
assert(!changelog.includes('## v1.6.97 carry-forward anchors') && !changelog.includes('## v1.6.97 Carry-forward Documentation Anchors'), 'carry-forward anchor sections should not return');
...
assert((pkg.qaChecks || []).includes('node qa/v157_release_foundation_smoke.js'), 'v1.6.97 smoke missing from qaChecks');
